...
Функция ТипТребуетРасшифровки(Тип, ОписаниеТипов = Неопределено) Экспорт
	...
	ИначеЕсли Тип = Тип("Строка") Тогда
		...
		Если ОписаниеТипов = Неопределено Тогда
			Результат = Ложь;
		Иначе
			Результат = ОписаниеТипов.КвалификаторыСтроки.Длина = 0 
				ИЛИ ОписаниеТипов.КвалификаторыСтроки.Длина > 30;
		КонецЕсли;
...
Функция ЗначениеТребуетРасшифровки(Значение) Экспорт
	
	Если ТипТребуетРасшифровки(ТипЗнч(Значение)) Тогда
		Результат = Истина;
	ИначеЕсли ТипЗнч(Значение) = Тип("Строка") Тогда
		Результат = СтрДлина(Значение) > 30;
	Иначе
		Результат = Ложь;
	КонецЕсли;
