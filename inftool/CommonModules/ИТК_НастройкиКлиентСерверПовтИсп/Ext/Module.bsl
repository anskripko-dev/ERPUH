...
Функция Список(ВидИнструмента = Неопределено) Экспорт
	...
	Если ВидИнструмента = Неопределено Тогда
		...
		Результат.Вставить("ПроверятьИСообщатьНаличиеНовойВерсии", Истина);
		Результат.Вставить("АнализироватьОткрытыеФормыПриБыстромЗапускеИнструментов", Истина);
		...
		Результат.Вставить("РедакторОтображениеРазличий", Истина);
		Результат.Вставить("РедакторСворачиваниеБлоков", Истина);
		...
		Если ИТК_ФормаКлиентСерверПовтИсп.ЭтоИнтерфейс8_5() Тогда
			ШрифтРедактора = Новый Шрифт("Courier New", 18);
		КонецЕсли;
	...
	ИначеЕсли ВидИнструмента = ИТК_Перечисления.ИнструментКонсольРазработчика() Тогда
		...
		Результат.Вставить("ОтображатьКартинкуКолонки", Истина);
