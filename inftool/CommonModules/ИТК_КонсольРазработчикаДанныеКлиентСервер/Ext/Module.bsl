...
Функция НовыйЭлемент(ТипСтроки, Сохранение = Ложь) Экспорт
	...
	ИначеЕсли ИТК_КонсолиКлиентСервер.ЭтоТипСтрокиДереваДанныхЗапросСтруктуры(ТипСтроки) Тогда // Подзапрос не сохраняется
		...
		Результат.Вставить("Ошибка", Неопределено);
		Результат.Вставить("ОшибкаПриВыполнении", Неопределено);
		Если ТипСтроки = ИТК_Перечисления.ЭлементДанныхЗапросПакета() Тогда
			Результат.Вставить("ИндексВСтруктуре", Неопределено);
		КонецЕсли;
...
Функция ТипыСтрокЗапросПодзапрос() Экспорт
	...
	Результат.Добавить(ИТК_Перечисления.ЭлементДанныхЗапросПакета());
	Результат.Добавить(ИТК_Перечисления.ЭлементДанныхЗапросВСтруктуре());
...
Функция ЭтоТипСтрокиСИспользованиемТекста(Тип) Экспорт
	...
	Возврат	Тип = ИТК_Перечисления.ЭлементДанныхЗапрос()
				ИЛИ ИТК_КонсолиКлиентСервер.ЭтоТипСтрокиДереваДанныхЗапросСтруктуры(Тип)
				ИЛИ Тип = ИТК_Перечисления.ЭлементДанныхСхемаКомпоновкиДанных()
