...
//
Процедура ПросмотрТекущегоСобытияВОтдельномОкне(Владелец, Данные, ХранилищеДанных) Экспорт
	...
	ОткрытьФорму("Обработка.ИТК_ЖурналРегистрации.Форма.Событие", ПараметрыОткрытияФормы, Владелец);
...
Процедура СобытияВыбор(Параметры) Экспорт
	...
	ПросмотрТекущегоСобытияВОтдельномОкне(Параметры.Владелец, Параметры.ТекущиеДанные, Параметры.ХранилищеДанных);
