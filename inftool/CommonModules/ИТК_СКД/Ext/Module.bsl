...
Функция ПолучитьРезультат(Параметры, АдресРезультата = Неопределено) Экспорт
	...
	Попытка
		...
		НастройкиКомпоновкиДанных = ИТК_ЗащитаЛицензирование.СКД_НастройкиКомпоновкиДанных(СхемаКомпоновкиДанных, Данные);
		...
		МакетКомпоновкиДанных = ИТК_ЗащитаЛицензирование.СКД_МакетКомпоновкиДанных(СхемаКомпоновкиДанных,
			НастройкиКомпоновкиДанных, ДанныеРасшифровки, АнализИсполняемыхЗапросов);
		
		// Конец замера { ---------------------------------------------------------------------------------------------------
		ВремяВыполнения = ТекущаяУниверсальнаяДатаВМиллисекундах() - НачалоЗамера;
		
		Если АнализИсполняемыхЗапросов Тогда
			ИсполняемыеЗапросы = ИТК_ЗащитаЛицензирование.СКД_ИсполняемыеЗапросы(СхемаКомпоновкиДанных, МакетКомпоновкиДанных);
		КонецЕсли;
		...
		Если ВыводРезультата Тогда
			...
			ИТК_ЗащитаЛицензирование.СКД_ВывестиРезультатВТабличныйДокумент(ТабличныйДокументРезультат, МакетКомпоновкиДанных,
				ВнешниеИсточники, МенеджерВременныхТаблиц, ДанныеРасшифровки, Данные.ИспользованиеВнешнихФункций);
