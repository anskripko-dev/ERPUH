...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ЖурналСправка.Видимость = НЕ ЭтоИнтерфейс8_5;
...
Процедура ЖурналВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	ПараметрыВыбора.Вставить("Владелец", ЭтотОбъект);
...
Процедура ПросмотрТекущегоСобытияВОтдельномОкне(Данные, ХранилищеДанных) Экспорт
	ИТК_ЖурналРегистрацииКлиент.ПросмотрТекущегоСобытияВОтдельномОкне(ЭтотОбъект, Элементы.Журнал.ТекущиеДанные, ХранилищеДанных);
КонецПроцедуры
...
Процедура УстановитьОтборНаКлиенте()
	...
	ОткрытьФорму("Обработка.ИТК_ЖурналРегистрации.Форма.ОтборЖурналаРегистрации",
		Новый Структура("Отбор, СобытияПоУмолчанию", ОтборФормы, ОтборЖурналаРегистрацииПоУмолчанию.Событие), ЭтотОбъект);
