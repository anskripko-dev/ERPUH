...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИТК_Перечисления.ЗаполнитьСписок(Элементы.ТипСравнения, ИТК_Перечисления.ВариантыСравненияДанных(), Параметры.ТипОбъектов);
	...
	ИТК_Форма.УстановитьНазначениеДействияКоманды(Команды.Сравнить, "Завершение");
