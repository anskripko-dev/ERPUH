...
Процедура СоздатьНачислениеНадбавкаЗаВредностьАУСН(КоллекторНачислений = Неопределено, СвойстваНачислений = Неопределено, НастройкиРасчетаЗарплаты = Неопределено)
	...
	Описание.Код					= НСтр("ru = 'НВР';
											|en = 'НВР'");
	Описание.Наименование			= НСтр("ru = 'Надбавка за вредные условия труда';
											|en = 'Надбавка за вредные условия труда'");
	Описание.КраткоеНаименование 	= НСтр("ru = 'Вредность';
											|en = 'Вредность'");
	Описание.ФормулаРасчета 		= "ПроцентНадбавкиЗаВредность / 100 * РасчетнаяБаза";
	Описание.ВидВремени 			= Перечисления.ВидыРабочегоВремениСотрудников.ДополнительноОплачиваемоеВПределахНормы;
		...
		Попытка
			...
			Если ИспользоватьГосударственнуюСлужбу Тогда
				...
				Описание.Наименование								= НСтр("ru = 'Компенсация за неотработанные дни при увольнении ГС (сохр. ден. содержание)';
																			|en = 'Компенсация за неотработанные дни при увольнении ГС (сохр. ден. содержание)'");
			...
			Иначе
				...
				Описание.Наименование								= НСтр("ru = 'Компенсация за неотработанные дни при увольнении МС (сохр. ден. содержание)';
																			|en = 'Компенсация за неотработанные дни при увольнении МС (сохр. ден. содержание)'");
...
Процедура ЗарегистрироватьОбработчикиОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий     = НСтр("ru = 'Уточнение кода дохода, категории по НДФЛ для РК и СН';
										|en = 'Clarification of income code and PIT category for RF and NA'");
	...
	Обработчик.Комментарий     = НСтр("ru = 'Создание начислений компенсации неиспользованных отгулов';
										|en = 'Creating accruals for unused day off compensation'");
	...
	Обработчик.Комментарий     = НСтр("ru = 'Изменение настроек НДФЛ, страховых взносов начислений с категорией ""Компенсация неиспользованных дней часов отдыха""';
										|en = 'Changing personal income tax settings, insurance contributions, and accruals with the ""Compensation of unused leave days hours"" category '");
	...
	Обработчик.Комментарий     = НСтр("ru = 'Изменение вида начисления для НУ начислений с категорией ""Компенсация неиспользованных дней часов отдыха""';
										|en = 'Изменение вида начисления для НУ начислений с категорией ""Компенсация неиспользованных дней часов отдыха""'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия          = "3.1.34.128";
	Обработчик.РежимВыполнения = "Монопольно";
	...
	Обработчик.Комментарий     = НСтр("ru = 'Изменение признака учета в среднем заработке начислений с категорией ""Компенсация неиспользованных дней часов отдыха""';
										|en = 'Изменение признака учета в среднем заработке начислений с категорией ""Компенсация неиспользованных дней часов отдыха""'");
	...
	Обработчик.Комментарий     = НСтр("ru = 'Заполнение категории статистического наблюдения для Формы №1 (рабочая сила)';
										|en = 'Заполнение категории статистического наблюдения для Формы №1 (рабочая сила)'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия          = "3.1.34.228";
	Обработчик.РежимВыполнения = "Монопольно";
	...
	Обработчик.Комментарий     = НСтр("ru = 'Выделяются начисления, редактируемые в отдельных полях';
										|en = 'Выделяются начисления, редактируемые в отдельных полях'");
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(
			НСтр("ru = 'Ошибка создания начислений «Компенсации не испольованного времени отдыха»';
				|en = 'Error creating the ""Compensation for unused leave time"" accruals'", ОбщегоНазначения.КодОсновногоЯзыка()), 
			УровеньЖурналаРегистрации.Предупреждение,
			Метаданные.ПланыВидовРасчета.Начисления, ,
			НСтр("ru = 'Не удалось создать начисления «Компенсации не испольованного времени отдыха» из-за предположительно неверной (зацикленной) настройки плана видов расчета.';
				|en = 'Cannot create the ""Compensation for unused leave time"" accruals, as the setting of the chart of calculation types may be incorrect (looped).'", 
				ОбщегоНазначения.КодОсновногоЯзыка()));
		...
		Исключение
			ЖурналРегистрации.ДобавитьСообщениеДляЖурналаРегистрации("", УровеньЖурналаРегистрации.Информация, , ,
				НСтр("ru = 'Не удалось выделить начисления, редактируемые в отдельных полях';
					|en = 'Не удалось выделить начисления, редактируемые в отдельных полях'"));
		КонецПопытки;
	КонецЕсли;
