...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	|en = 'Updates register records of fixed and intangible asset cost adjustment documents with the ""Adjustment due to change of accounting policy"" checkbox selected.
	|Do not work with documents while the handler is running, as the register information is incorrect.'");
