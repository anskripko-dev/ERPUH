...
&НаКлиенте
Процедура НастроитьРасписаниеРеглЗаданияСверткаРегистраСтруктураЗаказа(Команда)
	
	ОписаниеОповещения = Новый ОписаниеОповещения("ИзменитьРасписаниеРеглЗаданияСверткаРегистраСтруктураЗаказа", ЭтотОбъект);
	
	Если РасписаниеРеглЗаданияСверткаРегистраСтруктураЗаказа = Неопределено Тогда
		РасписаниеРегламентногоЗадания = Новый РасписаниеРегламентногоЗадания;
	Иначе
		РасписаниеРегламентногоЗадания = РасписаниеРеглЗаданияСверткаРегистраСтруктураЗаказа;
	КонецЕсли;
...
&НаКлиенте
Процедура ИзменитьРасписаниеРеглЗаданияСверткаРегистраСтруктураЗаказа(РасписаниеЗадания, ДополнительныеПараметры) Экспорт
	
	Если РасписаниеЗадания = Неопределено Тогда
		Возврат;
	КонецЕсли;
	
	РасписаниеРеглЗаданияСверткаРегистраСтруктураЗаказа = РасписаниеЗадания;
	
	УстановитьТекстРасписанияРеглЗаданияСверткаРегистраСтруктураЗаказа();
...
Процедура НастроитьЭлементыФормы()
	...
	Если Задания.Количество() = 1 Тогда
		РасписаниеРеглЗаданияСверткаРегистраСтруктураЗаказа = Задания[0].Расписание;
	КонецЕсли;
...
Процедура НастроитьЗависимыеРеквизитыФормы(Форма, СписокРеквизитов = "")
	...
	Если СтруктураРеквизитов.Свойство("РассчитыватьИзменения") ИЛИ Инициализация Тогда
		...
		Элементы.НастроитьРасписаниеРеглЗаданияСверткаРегистраСтруктураЗаказа.Доступность = Форма.РассчитыватьИзменения;
...
&НаСервере
Процедура УстановитьТекстРасписанияРеглЗаданияСверткаРегистраСтруктураЗаказа()
	...
	Иначе
		...
		ТекстРасписания = Строка(РасписаниеРеглЗаданияСверткаРегистраСтруктураЗаказа);
		
	КонецЕсли;
	
	Элементы.НастроитьРасписаниеРеглЗаданияСверткаРегистраСтруктураЗаказа.Заголовок = ТекстРасписания;
...
Процедура ЗаписатьНастройкиРасчетаСтруктурыЗаказа()
	...
	СтруктураЗаказаСлужебный.УстановитьРасписаниеРеглЗаданияСверткаРегистраСтруктураЗаказа(РасписаниеРеглЗаданияСверткаРегистраСтруктураЗаказа);
