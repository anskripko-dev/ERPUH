...
Функция ИзменитьПометкуУдаленияЭлементов(ВыбранныеЭлементы, Пометка)
	...
	ШаблонОшибки = ?(Пометка, 
		НСтр("ru = 'Недостаточно прав на пометку на удаление ""%1"".';
			|en = 'Недостаточно прав на пометку на удаление ""%1"".'"), 
		Нстр("ru = 'Недостаточно прав на снятие пометки на удаление ""%1"".';
			|en = 'Недостаточно прав на снятие пометки на удаление ""%1"".'"));
...
Функция ОбработанныеДокументы(ВыбранныеДокументы, Режим, Ошибки)
	...
	ШаблонОшибки = ?(Режим = РежимЗаписиДокумента.Проведение, НСтр("ru = 'Недостаточно прав на проведение ""%1"".';
																	|en = 'Недостаточно прав на проведение ""%1"".'"), Нстр("ru = 'Недостаточно прав на отмену проведения ""%1"".';
																															|en = 'Недостаточно прав на отмену проведения ""%1"".'"));
