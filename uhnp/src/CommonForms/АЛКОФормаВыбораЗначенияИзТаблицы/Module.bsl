...
Процедура ПриОткрытии(Отказ)
	...
	ТекстПредупреждения = НСтр("ru = 'Данная форма вспомогательная, предназначена для выбора значений
										|из списков в формах регламентированных отчетов!';
										|en = 'Данная форма вспомогательная, предназначена для выбора значений
										|из списков в формах регламентированных отчетов!'");
	...
	Если УправляемаяФормаВладелец = Неопределено Тогда
		...
		Отказ = Истина;		
		ПоказатьПредупреждение(, ТекстПредупреждения, , НСтр("ru = 'Форма выбора значений из таблицы.';
															|en = 'Форма выбора значений из таблицы.'"));
