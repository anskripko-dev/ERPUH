...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтрокаИзмерений.НаименованиеБД 	= ?(ДляЗаполненияОбъектаБД ИЛИ ДляФормированияКорректировок,Нстр("ru = 'Контекст вызова обмена'"),Нстр("ru = 'Реквизиты экземпляра отчета'"));
	ЭтаФорма.Заголовок				= ?(ДляЗаполненияОбъектаБД ИЛИ ДляФормированияКорректировок,Нстр("ru = 'Выберите реквизит контекста загрузки'"),Нстр("ru = 'Выберите реквизит экземпляра отчета'"));
...
Процедура ЗаполнитьСписокПолей(мТаблицаПоказателейБД,мТаблицаВидовАналитикВидаОтчета=Неопределено)
	...
	ПолеАналитика.НаименованиеБД=Нстр("ru = 'Организационная единица'");
	ПолеАналитика.ПредставлениеПоля = "["+ПолеАналитика.НаименованиеБД+"]";
	...
	ПолеАналитика.НаименованиеБД=Нстр("ru = 'Период'");
	ПолеАналитика.ПредставлениеПоля = "["+ПолеАналитика.НаименованиеБД+"]";
	...
	ПолеАналитика.НаименованиеБД=Нстр("ru = 'Сценарий'");
	ПолеАналитика.ПредставлениеПоля = "["+ПолеАналитика.НаименованиеБД+"]";
	...
	ПолеАналитика.НаименованиеБД=Нстр("ru = 'Валюта'");
	ПолеАналитика.ПредставлениеПоля = "["+ПолеАналитика.НаименованиеБД+"]";
	...
	Если ДляФормированияКорректировок Тогда
		...
		ПолеАналитика.НаименованиеБД=Нстр("ru = 'Вид операции'");
		ПолеАналитика.ПредставлениеПоля = "["+ПолеАналитика.НаименованиеБД+"]";
	...
	ПолеАналитика.НаименованиеБД=Нстр("ru = 'Используемая ИБ'");
	ПолеАналитика.ПредставлениеПоля = "["+ПолеАналитика.НаименованиеБД+"]";
...
Функция СформироватьСтруктуруСтрокиБД(ДанныеСтрокиАналитики)
	...
	СтрокаБД.Вставить("ТаблицаODBC",				ДанныеСтрокиАналитики.ТаблицаODBC);
