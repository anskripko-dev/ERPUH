...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ВзаиморасчетыВстраиваниеУХ.ВалютыИКурсПлатежаПриСозданииНаСервере(ЭтотОбъект, Отказ, СтандартнаяОбработка);
	#КонецОбласти
...
Процедура ПересчитатьСуммуДокумента(Команда)
	...
	#Область УХ_Казначейство
	ВзаиморасчетыВстраиваниеУХКлиент.ВалютыИКурсПлатежаПересчитатьСумму(ЭтотОбъект, "СуммаДокумента");
	#КонецОбласти 
...
Процедура ПересчитатьСуммуВзаиморасчетов(Команда)
	...
	#Область УХ_Казначейство
	ВзаиморасчетыВстраиваниеУХКлиент.ВалютыИКурсПлатежаПересчитатьСумму(ЭтотОбъект, "СуммаВзаиморасчетов");
	#КонецОбласти
...
Процедура ПересчитатьКурсЧислительВзаиморасчетов(Команда)
	...
	#Область УХ_Казначейство
	ВзаиморасчетыВстраиваниеУХКлиент.ВалютыИКурсПлатежаПересчитатьСумму(ЭтотОбъект, "КурсЧислительВзаиморасчетов");
	#КонецОбласти  
...
Процедура ПересчитатьКурсЗнаменательВзаиморасчетов(Команда)
	...
	#Область УХ_Казначейство
	ВзаиморасчетыВстраиваниеУХКлиент.ВалютыИКурсПлатежаПересчитатьСумму(ЭтотОбъект, "КурсЗнаменательВзаиморасчетов");
	#КонецОбласти  
