...
Процедура ЗаписатьИЗакрыть(Команда)
	...
	ТекстКнопкиДа = НСтр("ru = 'Изменились сведения о бронировании';
						|en = 'Exemption information is changed'");
	ТекстВопроса = СтрШаблон(
		НСтр("ru = 'При редактировании Вы изменили сведения о бронировании.
		           ...
		           |en = 'You changed exemption information while editing.
		           |If you corrected the previous exemption information (it was incorrect), click ""Error is corrected"".
		           |If the exemption information changed from %1, click ""%2""'"), 
