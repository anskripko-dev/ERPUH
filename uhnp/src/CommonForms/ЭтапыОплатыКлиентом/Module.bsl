...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("ДатаЗаказа") И ЗначениеЗаполнено(Параметры.ДатаЗаказа) Тогда
		ЭтотОбъект.ДатаЗаказа = Параметры.ДатаЗаказа;	
	КонецЕсли;	
	#КонецОбласти
...
&НаКлиенте
Процедура Подключаемый_ЗаполнитьПоДоговору()
...
Процедура ЗаполнитьЭтапыГрафикаОплатыПоДоговору()
	...
	ПараметрыЗаполнения = Новый Структура;
	ПараметрыЗаполнения.Вставить("ПерезаполнитьЭтапы", Ложь);
	ПараметрыЗаполнения.Вставить("ЭтоРасчетыСКлиентами", Истина);
	ПараметрыЗаполнения.Вставить("Товары", ТабличнаяЧасть);
...
Процедура ЗаполнитьЭтапыПоЗаказамПоДоговоруСервер(Знач ПараметрыЭтапы)
	...
	ПараметрыЭтапы.Вставить("Этапы", ЭтапыГрафикаОплаты.Выгрузить()); 
