...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭтоГруппа = Параметры.ВыборГруппИЭлементов = ИспользованиеГруппИЭлементов.Группы;
	
	Если НЕ ЭтоБДДС И НЕ ЭтоБДР Тогда
...
Процедура ИзменитьСвойстваДинамическогоСписка()
	...
	Если ЭтоГруппа Тогда
		ТекстЗапроса = ТекстЗапроса + " ГДЕ СтатьиБюджета.ЭтоГруппа = ИСТИНА";
	КонецЕсли;
