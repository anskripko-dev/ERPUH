...
Процедура ЗаполнитьДеревоОбъектовНаСервере(ПриОткрытии, ИдентификаторыРазворачиваемыхСтрок)
	...
	СортироватьОбъектыМетаданныхВДеревеПоПредставлению(ДеревоОбъектовМетаданных);
...
&НаСервере
Процедура СортироватьОбъектыМетаданныхВДеревеПоПредставлению(СтрокаРодителя)
	
	ЭлементыДерева = СтрокаРодителя.ПолучитьЭлементы();
	
	Для Каждого СтрокаДерева Из ЭлементыДерева Цикл
		СортироватьОбъектыМетаданныхВДеревеПоПредставлению(СтрокаДерева);
	КонецЦикла;
