...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		...
		Элементы.ПредставлениеЭлементаОтчета.СписокВыбора.Добавить(Перечисления.ПредставленияЭлементовОтчетов.Таблица, Нстр("ru = 'Таблица'"), , БиблиотекаКартинок.ТабличнаяЧасть);
