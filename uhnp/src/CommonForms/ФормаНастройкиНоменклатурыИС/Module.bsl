...
Процедура НастроитьЭлементыФормыНаСервере()
	...
	ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.МорепродуктыПодконтрольныеВЕТИС Тогда
		...
		Тексты.ЗаголовокГруппыЧастичноеВыбытие         = НСтр("ru = 'Продажа части потребительской упаковки морепродуктов';
																|en = 'Продажа части потребительской упаковки морепродуктов'");
		...
		Тексты.ГруппаБазоваяЕдиницаИмеетФиксированныйВесПодсказка = НСтр(
			...
			|en = 'Продукция, фасованная в заводских условиях, например: Ведро икры 3 кг.'");
		...
		Тексты.ТекущаяНоменклатураПодсказка = НСтр("ru = 'Морепродукты могут продаваться потребительскими упаковками или на развес. Единица хранения остатков %1соответствует одному килограмму морепродуктов.';
													|en = 'Морепродукты могут продаваться потребительскими упаковками или на развес. Единица хранения остатков %1соответствует одному килограмму морепродуктов.'");
		Тексты.Подвал                       = НСтр("ru = 'При продаже потребительской упаковки на ККТ тэги частичной реализации мерного товара не заполняются, код маркирови выбывает из оборота.';
													|en = 'При продаже потребительской упаковки на ККТ тэги частичной реализации мерного товара не заполняются, код маркирови выбывает из оборота.'");
		
		ДанныеПодсказкиНастроеннаяНоменклатура = Новый Массив();
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
			НСтр("ru = 'Для учета морепродуктов, продаваемых на развес используется отдельная номенклатура';
				|en = 'Для учета морепродуктов, продаваемых на развес используется отдельная номенклатура'"));
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(" ");
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
			НСтр("ru = 'с единицей хранения остатков соответствующей одному килограмму.';
				|en = 'с единицей хранения остатков соответствующей одному килограмму.'"));
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(Символы.ПС);
		...
		Если ВариантЧастичногоВыбытия = ПредопределенноеЗначение("Перечисление.ВариантыУчетаЧастичногоВыбытияИС.НастроеннаяНоменклатура")
			...
			ДанныеПодвала.Добавить(НСтр("ru = 'При продаже морепродуктов на развес с использованием ККТ тэг <1023> заполняется количеством продаваемых морепродуктов в килограммах.';
										|en = 'При продаже морепродуктов на развес с использованием ККТ тэг <1023> заполняется количеством продаваемых морепродуктов в килограммах.'"));
			ДанныеПодвала.Добавить(Символы.ПС);
			ДанныеПодвала.Добавить(НСтр("ru = 'Код маркировки потребительской упаковки морепродуктов выбывает из оборота при продаже последнего килограмма.';
										|en = 'Код маркировки потребительской упаковки морепродуктов выбывает из оборота при продаже последнего килограмма.'"));
		...
		Если ПредставленияДокументовСборкаРазборка.Количество() = 0 Тогда
			ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
				НСтр("ru = 'Для пересчета потребительской упаковки морепродуктов в килограммы необходимо выполнять отдельную операцию.';
					|en = 'Для пересчета потребительской упаковки морепродуктов в килограммы необходимо выполнять отдельную операцию.'"));
		ИначеЕсли ПредставленияДокументовСборкаРазборка.Количество() = 1 Тогда
			ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
				СтрШаблон(
					НСтр("ru = 'При передаче в торговый зал используется документ ""%1"" для пересчета потребительской упаковки морепродуктов в килограммы.';
						|en = 'При передаче в торговый зал используется документ ""%1"" для пересчета потребительской упаковки морепродуктов в килограммы.'"),
					СтрСоединить(ПредставленияДокументовСборкаРазборка)));
		Иначе
			ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
				СтрШаблон(
					НСтр("ru = 'При передаче в торговый зал используются документы ""%1"" для потребительской упаковки морепродуктов в килограммы.';
						|en = 'При передаче в торговый зал используются документы ""%1"" для потребительской упаковки морепродуктов в килограммы.'"),
					СтрСоединить(ПредставленияДокументовСборкаРазборка, ", ")));
		КонецЕсли;
		...
		Тексты.ВариантЕдиницыЧастьУпаковкиПодсказка    = НСтр("ru = 'Рекомендуемый вариант ведения учета для розничных продаж морепродуктов на развес.';
																|en = 'Рекомендуемый вариант ведения учета для розничных продаж морепродуктов на развес.'");
	...
	ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.БАДы
		...
		Если ВидПродукции = Перечисления.ВидыПродукцииИС.СпортивноеПитание Тогда
			Тексты.ТекущаяНоменклатураПодсказка = НСтр("ru = 'Спортивное питание может продаваться потребительскими упаковками или частями. Единица хранения остатков %1соответствует одной потребительской упаковке.';
														|en = 'Спортивное питание может продаваться потребительскими упаковками или частями. Единица хранения остатков %1соответствует одной потребительской упаковке.'");
		Иначе
	...
	ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.ВетеринарныеПрепараты Тогда 
		...
		Тексты.ТекущаяНоменклатураПодсказка = НСтр("ru = 'Ветеринарные препараты могут продаваться потребительскими упаковками или частями. Единица хранения остатков %1соответствует одной потребительской упаковке.';
													|en = 'Ветеринарные препараты могут продаваться потребительскими упаковками или частями. Единица хранения остатков %1соответствует одной потребительской упаковке.'");
		Тексты.Подвал                       = НСтр("ru = 'При продаже потребительской упаковки на ККТ тэг <1292> не заполняется, потребительская упаковка выбывает из оборота.';
													|en = 'При продаже потребительской упаковки на ККТ тэг <1292> не заполняется, потребительская упаковка выбывает из оборота.'");
		...
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
			НСтр("ru = 'Для поштучного учета ветеринарных препаратов используется отдельная номенклатура';
				|en = 'Для поштучного учета ветеринарных препаратов используется отдельная номенклатура'"));
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(" ");
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
			НСтр("ru = 'с единицей хранения остатков соответствующей одной единице продукции из вскрытой маркируемой потребительской упаковки.';
				|en = 'с единицей хранения остатков соответствующей одной единице продукции из вскрытой маркируемой потребительской упаковки.'"));
	...
	ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.РастительныеМасла Тогда 
		...
		Тексты.ТекущаяНоменклатураПодсказка = НСтр("ru = 'Растительные масла могут продаваться потребительскими упаковками или частями. Единица хранения остатков %1соответствует одной потребительской упаковке.';
													|en = 'Растительные масла могут продаваться потребительскими упаковками или частями. Единица хранения остатков %1соответствует одной потребительской упаковке.'");
		Тексты.Подвал = НСтр("ru = 'При продаже потребительской упаковки на ККТ тэг <1292> не заполняется, потребительская упаковка выбывает из оборота.';
							|en = 'При продаже потребительской упаковки на ККТ тэг <1292> не заполняется, потребительская упаковка выбывает из оборота.'");
		...
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
			НСтр("ru = 'Для учета продаваемой части потребительской упаковки растительных масел используется отдельная номенклатура';
				|en = 'Для учета продаваемой части потребительской упаковки растительных масел используется отдельная номенклатура'"));
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(" ");
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
			НСтр("ru = 'с единицей хранения остатков соответствующей одной единице продукции из вскрытой маркируемой потребительской упаковки.';
				|en = 'с единицей хранения остатков соответствующей одной единице продукции из вскрытой маркируемой потребительской упаковки.'"));
		...
		Если ВариантЧастичногоВыбытия = Перечисления.ВариантыУчетаЧастичногоВыбытияИС.НастроеннаяНоменклатура
			...
			ДанныеПодвала.Добавить(НСтр("ru = 'При продаже части продукции из вскрытой маркируемой потребительской упаковки на ККТ в чеке заполняется Тэг <1292>, который в печатной форме чека отображается как: <количество единиц>/';
										|en = 'При продаже части продукции из вскрытой маркируемой потребительской упаковки на ККТ в чеке заполняется Тэг <1292>, который в печатной форме чека отображается как: <количество единиц>/'"));
			ДанныеПодвала.Добавить(НСтр("ru = '<емкость потребительской упаковки>.';
										|en = '<емкость потребительской упаковки>.'"));
			ДанныеПодвала.Добавить(Символы.ПС);
			ДанныеПодвала.Добавить(НСтр("ru = 'Потребительская упаковка выбывает из оборота при продаже последней единицы продукции из вскрытой маркируемой потребительской упаковки.';
		...
		Тексты.ВариантЕдиницыЧастьУпаковкиПодсказка    = НСтр("ru = 'Рекомендуемый вариант ведения учета для продажи части продукции в розницу из вскрытой маркируемой потребительской упаковки.';
																|en = 'Рекомендуемый вариант ведения учета для продажи части продукции в розницу из вскрытой маркируемой потребительской упаковки.'");
		Тексты.Вставить(
			"ГруппаБазоваяЕдиницаИмеетФиксированныйВесПодсказка",
			НСтр("ru = 'Продукция, фасованная в заводских условиях, например:
	...
	ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.МоторныеМасла Тогда
		...
		Тексты.ТекущаяНоменклатураПодсказка = НСтр("ru = 'Моторные масла могут продаваться потребительскими упаковками или частями. Единица хранения остатков %1соответствует одной потребительской упаковке.';
													|en = 'Моторные масла могут продаваться потребительскими упаковками или частями. Единица хранения остатков %1соответствует одной потребительской упаковке.'");
		Тексты.Подвал = НСтр("ru = 'При продаже потребительской упаковки на ККТ тэг <1292> не заполняется, потребительская упаковка выбывает из оборота.';
							|en = 'При продаже потребительской упаковки на ККТ тэг <1292> не заполняется, потребительская упаковка выбывает из оборота.'");
		...
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
			НСтр("ru = 'Для учета продаваемой части потребительской упаковки моторных масел используется отдельная номенклатура';
				|en = 'Для учета продаваемой части потребительской упаковки моторных масел используется отдельная номенклатура'"));
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(" ");
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
			НСтр("ru = 'с единицей хранения остатков соответствующей одной единице продукции из вскрытой маркируемой потребительской упаковки.';
				|en = 'с единицей хранения остатков соответствующей одной единице продукции из вскрытой маркируемой потребительской упаковки.'"));
