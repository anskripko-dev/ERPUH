...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	Запрос.Текст = ТекстЗапросаНастроекОтправки();
...
Функция ТекстЗапросаНастроекОтправки()
	Текст = 
	"ВЫБРАТЬ РАЗЛИЧНЫЕ
	...
	|			И ВЫБОР КОГДА КлючевыеРеквизиты.Договор В (&ПустойДоговор)
	|				ТОГДА НастройкиОтправкиЭлектронныхДокументов.Договор В (&ПустойДоговор)
	|				ИНАЧЕ КлючевыеРеквизиты.Договор = НастройкиОтправкиЭлектронныхДокументов.Договор
	|			КОНЕЦ
	|ГДЕ
