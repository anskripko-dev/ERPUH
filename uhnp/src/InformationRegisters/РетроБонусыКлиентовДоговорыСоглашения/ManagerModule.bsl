...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение поля ""Номер строки документа"" в регистре сведений ""Ретро-бонусы клиентов: договоры/соглашения"".
								  ...
								  |en = 'Filling in the field ""Document line number"" in the ""Customer rebates: contracts/terms of sales"" information register.
								  |Until the moment of filling in the printed forms of the ""Conditions of customer rebates"" document, the order of lines may change when reprinting.'");
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	СписокОписаний.Добавить(НСтр("ru = 'Не удалось обработать записи регистра сведений ""Ретро-бонусы клиентов: договоры/соглашения"".';
								|en = 'Cannot process the ""Customer rebates: contracts/terms of sales"" information register records.'"));
	...
	ШаблонСообщения = НСтр("ru = 'Обработана порция документов условий по регистру сведений ""Ретро-бонусы клиентов: договоры/соглашения"": %1';
							|en = 'Batch of the ""Customer rebates: contracts/terms of sales"" information register records has been processed: %1'");
