...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	ТекстЗапросаВыборки = СтрЗаменить(ТекстЗапросаВыборки,
										"ТаблицаРегистра.Ссылка ССЫЛКА Документ.ЭтапПроизводства2_2",
										"ИСТИНА");
	ТекстЗапросаВыборки = СтрЗаменить(ТекстЗапросаВыборки,
										"ТаблицаРегистра.Ссылка = ДокументРегистратор.Ссылка",
										"ТаблицаРегистра.Этап = ДокументРегистратор.Ссылка
										|				И ТаблицаРегистра.КлючНабор = УНИКАЛЬНЫЙИДЕНТИФИКАТОР(ДокументРегистратор.Ссылка)");
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	|ГДЕ 
	|	НЕ ДанныеДляОбработки.КлючНабор В
	|		(ВЫБРАТЬ
	|			УНИКАЛЬНЫЙИДЕНТИФИКАТОР(ЗаблокированныеДанные.Ссылка)
	|		ИЗ
