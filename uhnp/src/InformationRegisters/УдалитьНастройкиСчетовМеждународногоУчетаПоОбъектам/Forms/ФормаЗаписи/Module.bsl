...
Процедура ПриЧтенииСозданииНаСервере()
	ОписаниеОбъектовУчета.Загрузить(Перечисления.УдалитьОбъектыФинансовогоУчета.РасширенноеОписаниеОбъектовУчетаДляНастройки());
	УправлениеФормой()
КонецПроцедуры
...
Процедура УправлениеФормой()
	...
	Если ОписанияОбъектаУчета.Количество() > 0 Тогда
		...
		Элементы.ОбъектНастройки.Заголовок = Перечисления.УдалитьОбъектыФинансовогоУчета.ЗаголовокОбъектаНастройкиПоОписаниюТипов(ОписаниеОбъектаУчета.ОписаниеТиповОбъектНастройки);
		Элементы.ОбъектНастройки.ПараметрыВыбора = Перечисления.УдалитьОбъектыФинансовогоУчета.ПараметрыВыбораОбъектаНастрйки(ОписаниеОбъектаУчета.ОтборОбъектовНастройки);
		...
		Элементы.МестоУчета.Заголовок = Перечисления.УдалитьОбъектыФинансовогоУчета.ЗаголовокМестаУчета(ОписаниеОбъектаУчета.ОписаниеТиповМестоУчета);
	Иначе
