...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	ОписаниеОбработчика.Добавить(НСтр("ru = ' - обновление записей регистра по документу ""Расходный кассовый ордер"".';
										|en = ' - обновление записей регистра по документу ""Расходный кассовый ордер"".'"));
	...
	Описания.Добавить(НСтр("ru = 'Обработка записей регистра сведений ""Реестр документов"":';
							|en = 'Process the ""Document registry"" information register records:'"));
	...
	Описания.Добавить(НСтр("ru = 'Обработка записей регистра сведений ""Реестр документов"" по документам ввода остатков';
							|en = 'Process records of the ""Document registry"" information register for the opening balance entry documents'"));
	Описания.Добавить(НСтр("ru = '- изменение значений ""Сумма"" и ""Валюта"" по документу ""Ввод остатков расчетов по эквайрингу""';
							|en = '- Change the ""Amount"" and ""Currency"" values for the ""OB entry: acquiring contract AR/AP"" document'"));
	Описания.Добавить(НСтр("ru = '- изменение значений ""Сумма"" и ""Валюта"" по документу ""Ввод остатков денежных средств""';
							|en = '- Change the ""Amount"" and ""Currency"" values for the ""OB entry: cash balance"" document'"));
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсиюЗаполнениеИдентификаторовЗаписей(Параметры) Экспорт
	...
	Попытка
		...
		ШаблонСообщения = НСтр("ru = 'Регистр сведений ""Реестр документов"". Обработана порция документов: %1';
								|en = 'The ""Document registry"" information register. A batch of documents is processed: %1'");
	...
	Если ОбновляемыеДанныеУспешноОбработаны = Ложь Тогда
		...
		СписокОписаний.Добавить(НСтр(
			...
			|en = 'Cannot process the documents of the ""Document registry"" information register handler:'"));
