...
Процедура ОбъектУчетаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка, ДтКт)
	...
	ОткрытьФорму("Перечисление.УдалитьОбъектыФинансовогоУчета.ФормаВыбора", ПараметрыФормы, Элемент);
...
Процедура НастройкиПоКорреспонденции(Команда)
	...
	ОткрытьФорму("РегистрСведений.УдалитьНастройкиОтраженияКорреспонденцийВМеждународномУчете.ФормаСписка", 
		ПараметрыФормы,
		ЭтотОбъект,
		,
		,
...
Процедура ПриЧтенииСозданииНаСервере()
	...
	ОписаниеОбъектаУчетаДт = Перечисления.УдалитьОбъектыФинансовогоУчета.ОписаниеОбъектаФинансовогоУчета(Запись.ОбъектУчетаДт, Истина);
	ОписаниеОбъектаУчетаКт = Перечисления.УдалитьОбъектыФинансовогоУчета.ОписаниеОбъектаФинансовогоУчета(Запись.ОбъектУчетаКт, Истина);
...
Функция ЭтоПрочиеАктивыПассивы(Запись, ДтКт)
	...
	Возврат Запись["ОбъектУчета" + ДтКт] = ПредопределенноеЗначение("Перечисление.УдалитьОбъектыФинансовогоУчета.ПрочиеАктивыПассивы");
...
Процедура СформироватьСсылкуНастройкиПоКорреспонденции()
	...
	ПараметрыПолученияДанных = РегистрыСведений.УдалитьНастройкиОтраженияКорреспонденцийВМеждународномУчете.ПараметрыПолученияДанныхНастройки();
	...
	КоличествоНастроекПоКорреспонденции = РегистрыСведений.УдалитьНастройкиОтраженияКорреспонденцийВМеждународномУчете.КоличествоНастроекКорренспонденции(ПараметрыПолученияДанных);
...
Процедура ЗаполнитьПорядокПримененияНастройки()
	...
	Запись.ПорядокПрименения = РегистрыСведений.УдалитьНастройкиОтраженияКорреспонденцийВМеждународномУчете.ПорядокПримененияНастройки(ПараметрыПолученияДанных);
...
Процедура УправлениеЭлементамиФормыСчетовОбъектаУчета(ДтКт)
	...
	Иначе
		...
		СчетаОбъектаУчетаМестоУчета.Заголовок = Перечисления.УдалитьОбъектыФинансовогоУчета.ЗаголовокМестаУчета(
		...
		СчетаОбъектаУчетаОбъектНастройки.Заголовок = Перечисления.УдалитьОбъектыФинансовогоУчета.ЗаголовокОбъектаНастройкиПоОписаниюТипов(
...
Процедура ОбъектУчетаПриИзмененииСервер(ДтКт)
	...
	ЭтотОбъект["ОписаниеОбъектаУчета" + ДтКт] = Перечисления.УдалитьОбъектыФинансовогоУчета.ОписаниеОбъектаФинансовогоУчета(
