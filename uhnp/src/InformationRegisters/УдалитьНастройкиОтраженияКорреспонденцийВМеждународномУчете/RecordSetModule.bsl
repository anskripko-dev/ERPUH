...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Для каждого Запись Из ЭтотОбъект Цикл
		...
		КлючЗаписи = РегистрыСведений.УдалитьНастройкиОтраженияКорреспонденцийВМеждународномУчете.СоздатьКлючЗаписи(СтруктураЗаписи);
		...
		ОписаниеОбъектовУчета = Перечисления.УдалитьОбъектыФинансовогоУчета.ОписаниеОбъектовФинансовогоУчета(НастройкиПроводок);
