...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Для каждого Запись Из ЭтотОбъект Цикл
		...
		НастройкиПроводок = Справочники.НастройкиФормированияПроводокМеждународногоУчета.НастройкиФормированияПроводок(
			Запись.НастройкаФормированияПроводок);
		...
		ОбъектыУчета.Добавить(Запись.ОбъектУчетаДт);
		ОбъектыУчета.Добавить(Запись.ОбъектУчетаКт);
		
		ОписаниеОбъектовУчета = ПланыВидовХарактеристик.СтатьиАктивовПассивов.ОписаниеОбъектовФинансовогоУчета(
			НастройкиУчета,, ОбъектыУчета);
...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	Если Количество() = 0
		И ЗначениеЗаполнено(Отбор.ПланСчетов.Значение)
		И ЗначениеЗаполнено(Отбор.НастройкаФормированияПроводок.Значение)
		И ЗначениеЗаполнено(Отбор.ОбъектУчетаДт.Значение)
		И ЗначениеЗаполнено(Отбор.ОбъектУчетаКт.Значение) Тогда
