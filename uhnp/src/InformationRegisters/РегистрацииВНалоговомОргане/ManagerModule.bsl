...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	//++ НЕ УТ
	ДобавитьОбработчикОбновлениеПриПереходеНаНовуюВерсию(Обработчики);
	//-- НЕ УТ
...
#Область ОбновлениеИнформационнойБазы
//++ НЕ УТ
Процедура ДобавитьОбработчикОбновлениеПриПереходеНаНовуюВерсию(Обработчики)
...
Процедура ДобавитьОбработчикЗаполнениеРеквизитовКрупнейшегоНалогоплательщика(Обработчики)
	...
	Обработчик.Комментарий = 
		НСтр("ru = 'Переносит из регистра ""История регистраций в налоговом органе"" в регистр 
					...
					|en = 'Transfers records of major taxpayer registrations from the 
					|""History of registrations with tax authority"" register to the 
					|""History of registrations in tax authority as major taxpayer"" register.'");
