...
//                - См. РегистрСведений.НастройкиОтправкиЭлектронныхДокументов.Отправитель
//  * Получатель - Неопределено
//               - См. РегистрСведений.НастройкиОтправкиЭлектронныхДокументов.Получатель
//  * Договор - Неопределено
//            - См. РегистрСведений.НастройкиОтправкиЭлектронныхДокументов.Договор
//  * ДатаНачалаДействия - См. РегистрСведений.НастройкиОтправкиЭлектронныхДокументов.ДатаНачалаДействия
//  * ИспользоватьУПД - Неопределено
//                    - См. РегистрСведений.НастройкиОтправкиЭлектронныхДокументов.ИспользоватьУПД
//  * ИспользоватьУКД - Неопределено
//                    - См. РегистрСведений.НастройкиОтправкиЭлектронныхДокументов.ИспользоватьУКД
//  * ЭтоИнтеркампани - Неопределено
//                    - См. РегистрСведений.НастройкиОтправкиЭлектронныхДокументов.ЭтоИнтеркампани
//  * ЭтоПрямойОбмен - Неопределено
//                   - См. РегистрСведений.НастройкиОтправкиЭлектронныхДокументов.ЭтоПрямойОбмен
Функция НоваяНастройкаОтправки() Экспорт
	...
	Настройка.Вставить("ДатаНачалаДействия", Дата(1, 1, 1));
	Настройка.Вставить("ИспользоватьУПД", Неопределено);
	Настройка.Вставить("ИспользоватьУКД", Неопределено);
	Настройка.Вставить("ЭтоИнтеркампани", Неопределено);
	Настройка.Вставить("ЭтоПрямойОбмен", Неопределено);
	Возврат Настройка;
	
КонецФункции

// Параметры:
//  Настройка - См. НоваяНастройкаОтправки
Процедура ИзменитьНастройкуОтправки(Настройка) Экспорт
	
	Менеджер = СоздатьМенеджерЗаписи();
	ЗаполнитьЗначенияСвойств(Менеджер, Настройка, "Отправитель, Получатель, Договор");
	Менеджер.Прочитать();
	Если Не Менеджер.Выбран() Тогда
		ЗаполнитьЗначенияСвойств(Менеджер, Настройка, "Отправитель, Получатель, Договор");
	КонецЕсли;

	Свойства = "ДатаНачалаДействия, ИспользоватьУПД, ИспользоватьУКД, ЭтоИнтеркампани, ЭтоПрямойОбмен";
	СписокСвойств = СтрРазделить(Свойства, ",");
...
Функция ВыборкаДанныхКОбработкеДляПереходаНаНовуюВерсию()
	...
	ДобавитьУсловиеОтбораЗаписейСОшибочнымЗначениемПоляДоговор(УсловияОтбораДанныхКОбработке, ПараметрыЗапроса);
...
Процедура ДобавитьУсловиеОтбораЗаписейСОшибочнымЗначениемПоляДоговор(УсловияОтбораДанныхКОбработке, ПараметрыЗапроса)
