	...
	Попытка
		...
		Если Запись.Выбран() Тогда
			ОбщегоНазначения.СообщитьПользователю(
				...
				|Небходимо удалить этот договор из списка.';
				|en = 'The list already contains the %1 contract for the %2 company and the %3 carrier.
				|Please delete the contract from the list.'", ОбщегоНазначения.КодОсновногоЯзыка()),
