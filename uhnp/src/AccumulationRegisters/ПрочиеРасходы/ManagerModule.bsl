...
Функция ПараметрыОтраженияДвиженийВФинансовомУчете(МетаданныеРегистра = Неопределено, РегистрацияКОтражению = Ложь) Экспорт
	...
	ПараметрыОтражения.ПутьКДаннымДопНастройкаХозОперации = СтрЗаменить(
		...
		|		КОГДА ПсевдонимИсточникаДанных.НастройкаХозяйственнойОперации = ЗНАЧЕНИЕ(Справочник.НастройкиХозяйственныхОпераций.СписаниеРасходовНаПартииПроизводства)
		...
		|			ИЛИ ПсевдонимИсточникаДанных.Регистратор ССЫЛКА Документ.РегистраторРасчетаСебестоимости
		|			ТОГДА ВЫБОР
...
Функция ТекстЗапросаТаблицаВтПрочиеРасходы(ДополнительныеПоля = "", ВозможныРазныеПериодыВДвижениях = Ложь) Экспорт
	...
	//++ НЕ УТ
	|
	// В конфигурации "Управление торговлей" не должна возникать постоянная разница, т.к. механизмы распределения расходов
	// в этой конфигурации не поддерживают распределение постоянной разницы.
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Устанавливает время записей для документов ""Бронирование"".';
									|en = 'Sets the record time for the ""Booking"" documents.'");
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	СписокОписаний.Добавить(НСтр("ru = 'Не удалось установить время записей для документов ""Бронирование"" в регистре накопления ""Прочие расходы"".';
								|en = 'Cannot set the record time for the ""Booking"" documents in the ""Other expenses"" accumulation register.'"));
