...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Обновляет движения документов по регистру накопления ""Стоимость ОС"":
								  ...
								  |en = 'Обновляет движения документов по регистру накопления ""Стоимость ОС"":
								  |- заполняет подразделение для движений, связанных с приростом стоимости при переоценке.'");
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	ЧитаемыеДанные.Добавить("Документ.ОбъединениеОС");
	ЧитаемыеДанные.Добавить("Документ.ПеремещениеОС2_4");
	ЧитаемыеДанные.Добавить("Документ.ПереоценкаОС2_4");
	ЧитаемыеДанные.Добавить("Документ.ПодготовкаКПередачеОС2_4");
	ЧитаемыеДанные.Добавить("Документ.РазукомплектацияОС");
	ЧитаемыеДанные.Добавить("Документ.СписаниеОС2_4");
	...
	Пока Выборка.Следующий() Цикл
		...
		Попытка
			...
			ИначеЕсли ТипДокумента = Тип("ДокументСсылка.ИзменениеПараметровОС2_4") Тогда
			...
			ИначеЕсли ТипДокумента = Тип("ДокументСсылка.ОбъединениеОС")
			...
			ИначеЕсли ТипДокумента = Тип("ДокументСсылка.ПеремещениеОС2_4") Тогда
