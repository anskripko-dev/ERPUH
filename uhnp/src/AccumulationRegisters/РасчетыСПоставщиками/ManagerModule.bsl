...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	|';
	|en = 'Changes the ""Payment to self-employed person"" business transaction to the ""Payment to vendor"" transaction.
	|Clears the ""Being paid"" resource records of payment requests with empty AR/AP objects.
	...
	|Corrects the ""Booking"" recorder date.
	|'"),
