...
Функция ТаблицаОформлено(ТаблицаОтбора, ОтборПоИзмерениям = Неопределено, ИсключитьЗаказ = Ложь) Экспорт
	...
	ТекстЗапроса =
		...
		|					ТОГДА ВЫБОР
		|							КОГДА -РегистрРаспоряжения.КОформлению > -РегистрРаспоряжения.КПередаче
		|								ТОГДА -РегистрРаспоряжения.КОформлению
		|							ИНАЧЕ -РегистрРаспоряжения.КПередаче
		|						  КОНЕЦ
		|				ИНАЧЕ
		...
		|					ТОГДА ВЫБОР
		|							КОГДА РегистрРаспоряжения.КОформлению > РегистрРаспоряжения.КПередаче
		|								ТОГДА РегистрРаспоряжения.КПередаче
		|							ИНАЧЕ РегистрРаспоряжения.КОформлению
		|						  КОНЕЦ
		|				ИНАЧЕ
		...
		|			ИЛИ ТИПЗНАЧЕНИЯ(Отбор.Ссылка) = ТИП(Документ.ЗаказДавальца2_5) И РегистрРаспоряжения.КПередаче <> 0
