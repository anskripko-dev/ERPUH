...
Функция ТаблицаМатериалыЗаказаНаПроизводствоКОбеспечению(Заказ) Экспорт
	...
	|///////////////////////////////////////////
	|ВЫБРАТЬ
	|	ЗаказыМатериалов.Распоряжение    КАК ЗаказКлиента,
	...
	|	ЗаказыМатериалов.ЗаказаноОборот - ЗаказыМатериалов.КОформлениюОборот КАК Количество
	...
	|
	|ГДЕ
	|	ЗаказыМатериалов.ЗаказаноОборот - ЗаказыМатериалов.КОформлениюОборот > 0
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
