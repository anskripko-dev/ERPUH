	...
	Если УчитыватьФО Тогда
		...
		Если ПолучитьФункциональнуюОпцию("ИспользоватьРетроБонусыКлиентов") Тогда
			...
			ОписаниеХозяйственнойОперации.ШаблонЗаголовкаДокумента            = НСтр("ru = 'Ввод начальных остатков задолженности по премиям клиентам %1';
																					|en = 'OB entry: customer bonus payables %1'");
		...
		Если ПолучитьФункциональнуюОпцию("ИспользоватьРетроБонусыПоставщиков") Тогда
			...
			ОписаниеХозяйственнойОперации.ШаблонЗаголовкаДокумента            = НСтр("ru = 'Ввод начальных остатков задолженности по премиям поставщиков %1';
																					|en = 'OB entry: vendor bonus payables %1'");
...
Функция ОписаниеХозяйственныхОперацийВводаОстатковТоваров()
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьКомиссиюПриПродажах")
		...
		ОписаниеХозяйственнойОперации.ШаблонЗаголовкаДокумента            = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Ввод остатков товаров, переданных на комиссию (%1) %2';
																																		|en = 'OB entry: consignment sales stock (%1)%2'"),
			Постфикс, "%1");
	...
	Если Не ПолучитьФункциональнуюОпцию("УправлениеТорговлей")
		...
		ОписаниеХозяйственнойОперации.ДокументВводаОстатков    = ИмяДокументаВводаНачальныхОстатков;
		ОписаниеХозяйственнойОперации.ШаблонЗаголовкаДокумента = НСтр("ru = 'Ввод остатков материалов, переданных переработчикам (2.4) %1';
																		|en = 'Enter remaining materials transferred to subcontractors (2.4) %1'");
		ОписаниеХозяйственнойОперации.ПорядокВДереве           = 5;
	КонецЕсли;
	//-- Устарело_Переработка24
	...
	Если ФункциональнаяОпцияИспользоватьПроизводствоНаСтороне2_5 Тогда
		...
		ОписаниеХозяйственнойОперации.ДокументВводаОстатков    = ИмяДокументаВводаНачальныхОстатков;
		ОписаниеХозяйственнойОперации.ШаблонЗаголовкаДокумента = НСтр("ru = 'Ввод остатков материалов, переданных переработчикам %1';
																		|en = 'Enter remaining materials transferred to subcontractors %1'");
		ОписаниеХозяйственнойОперации.ПорядокВДереве           = 4;
	КонецЕсли;
	//-- НЕ УТ
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьПроизводство")
		...
		ОписаниеХозяйственнойОперации.ШаблонЗаголовкаДокумента = НСтр("ru = 'Ввод остатков материалов, переданных в производство %1';
																		|en = 'Enter remaining materials transferred to production %1'");
		ОписаниеХозяйственнойОперации.ПорядокВДереве           = 3;
	КонецЕсли;
	...
	Если РасчетСебестоимостиПовтИсп.ИспользуетсяСреднескользящаяОценка() И Не ПолучитьФункциональнуюОпцию("БазоваяВерсия") Тогда
		...
		ОписаниеХозяйственнойОперации.ШаблонЗаголовкаДокумента = НСтр("ru = 'Ввод остатков отклонений в стоимости товаров %1';
																		|en = 'OB entry: goods cost variances %1'");
...
Функция ОписаниеХозяйственныхОперацийВводаОстатковВНА(УчитыватьФО)
	...
	ОписаниеХозяйственнойОперации = ОписаниеХозяйственныхОперацийВводаОстатков.Добавить();
	ОписаниеХозяйственнойОперации.ХозяйственнаяОперация    = Перечисления.ХозяйственныеОперации.ВводОстатковУзловКомпонентовАмортизации;
	ОписаниеХозяйственнойОперации.ДокументВводаОстатков    = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Документы.ВводОстатковУзловКомпонентовАмортизации);
	ОписаниеХозяйственнойОперации.ШаблонЗаголовкаДокумента = НСтр("ru = 'Ввод начальных остатков узлов, компонентов амортизации %1';
																	|en = 'OB entry: sub-assets and components of depreciation %1'");
	ОписаниеХозяйственнойОперации.ПорядокВДереве           = ПорядокВДереве;
	ПорядокВДереве = ПорядокВДереве + 1;
	...
	ВводОстатковЛокализация.ДополнитьОписаниеХозяйственныхОперацийВводаОстатковВНА(ОписаниеХозяйственныхОперацийВводаОстатков, УчитыватьФО, ПорядокВДереве);
