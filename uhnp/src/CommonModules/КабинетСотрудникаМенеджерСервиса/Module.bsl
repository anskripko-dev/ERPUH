...
Процедура СохранитьКлючиМенеджера(ИдентификаторКлиента, СекретКлиента)
	...
	Ключи = Новый Структура("ИдентификаторКлиента,СекретКлиента", ИдентификаторКлиента, СекретКлиента);

	УстановитьПривилегированныйРежим(Истина);
	ИнтеграцияУправлениеПерсоналом.СохранитьКлючиМенеджера(Перечисления.ПриложенияДляИнтеграции.КабинетСотрудника, Ключи);
...
Функция КлючиМенеджера()
	...
	УстановитьПривилегированныйРежим(Истина);
	Возврат ИнтеграцияУправлениеПерсоналом.КлючиМенеджера(Перечисления.ПриложенияДляИнтеграции.КабинетСотрудника);
...
Функция НовыйТокенАутентификации(Соединение, ПараметрыСоединения)
	...
	Если КлючиМенеджера.Свойство("АутентификацияSysToken") И КлючиМенеджера.АутентификацияSysToken = Истина Тогда
		АдресРесурса = СтрШаблон("/%1/%2", ПараметрыСоединения.ПутьНаСервере, "sys/token");
		Ответ = ОтправитьДляОбработкиПолученияТокена(АдресРесурса, Заголовки, СтрокаТела, Результат, Соединение, ПараметрыСоединения);
...
Функция ОтправитьДляОбработкиПолученияТокена(АдресРесурса, Заголовки, СтрокаТела, Результат, Соединение, ПараметрыСоединения)
...
Процедура ЗаписатьИспользоватьНовуюАвторизацию()
	...
	АдресХранениеяКлючей = ИнтеграцияУправлениеПерсоналом.АдресХраненияКлючейПриложения(Перечисления.ПриложенияДляИнтеграции.КабинетСотрудника);
