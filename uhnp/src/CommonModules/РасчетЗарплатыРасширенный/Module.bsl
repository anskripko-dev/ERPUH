			...
			Если СтрокиРаспределения.Количество() > 0 Тогда
				...
				Если РезультатРаспределения <> СтрокаТабличнойЧасти.Результат 
					...
					ТекстСообщения = НСтр("ru = 'В строке %1 таблицы ""%2"" обнаружены незаполненные поля распределения по территориям или результат строки отличается от распределения';
											|en = 'In row %1 of the ""%2"" table, unfilled fields of distribution by territories are found or the row result differs from the distribution'");
					ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
						ТекстСообщения,
...
Процедура ЗарегистрироватьОбработчикиОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Добавление показателя ""Исчисленный НДФЛ расчетной базы удержания""';
									|en = 'Add the ""Calculated personal income tax of the estimated deduction base"" indicator'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Создать показатель ""Среднемесячное количество часов""';
									|en = 'Create the ""Average monthly hours"" indicator'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Добавление показателя ""Стоимость дня(часа) с учетом разовых начислений""';
									|en = 'Add the ""Cost per day (hour) including one-time accruals"" indicator'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Добавление показателей среднего заработка РК и СН';
									|en = 'Add indicators of average earnings of RF and NA'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Создать показатель компенсации отгулов.';
									|en = 'Create a day off compensation indicator.'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполняет даты запрета редактирования документов ""Договор авторского заказа"".';
									|en = 'Fills in editing closing dates of the ""Copyright agreement"" documents.'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполняет даты запрета редактирования документов ""Договор (работы, услуги)"".';
									|en = 'Fills in editing closing dates of the ""Contract (works, services)"" documents.'");
