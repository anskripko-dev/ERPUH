...
Процедура ЗаполнитьНастройкиПоУмолчаниюОФР(Процессор)
	...
	Иначе
		...
		ДобавитьПоказатель(Процессор, НСтр("ru = 'Проценты к получению';
											|en = 'Interest receivable'", КодЯзыка)); // Только доходы
		ДополнитьОтбор(Процессор, Перечисления.ВидыПрочихДоходовИРасходов.ПроцентыКПолучению);
		ДополнитьОтбор(Процессор, Перечисления.ВидыПрочихДоходовИРасходов.ПроцентыПоГосударственнымЦеннымБумагам);
		ДополнитьОтбор(Процессор, Перечисления.ВидыПрочихДоходовИРасходов.ПроцентыПоГосударственнымЦеннымБумагамПоСтавке0);
	
		ДобавитьГруппуОтрицательныхЗначений(Процессор, КодГруппыПроцентыКУплате); // Проценты к уплате
		ДобавитьПоказатель(Процессор, НСтр("ru = 'Проценты к получению (уплате)';
											|en = 'Interest receivable (payable)'", КодЯзыка)); // Общий для доходов и расходов
		...
		ДобавитьПоказательРасходы(Процессор, НСтр("ru = 'Проценты к уплате';
													|en = 'Interest payable'", КодЯзыка)); // Только расходы
		ДополнитьОтбор(Процессор, Перечисления.ВидыПрочихДоходовИРасходов.ПроцентыКУплате);
		ДополнитьОтбор(Процессор, Перечисления.ВидыПрочихДоходовИРасходов.ПроцентыНачисленныеПоСт269);
	...
	ДобавитьПоказатель(Процессор, НСтр("ru = 'Результаты инвентаризации';
										|en = 'Stocktaking results'", КодЯзыка));
	...
	ДобавитьПоказатель(Процессор, НСтр("ru = 'Иная операционная деятельность';
										|en = 'Other operating activity'", КодЯзыка));
	УстановитьЗачетПоказателейПрочиеДоходыРасходы(Процессор, "СтатьиОбъекты");
	...
	ДобавитьПоказатель(Процессор, НСтр("ru = 'Курсовые разницы';
										|en = 'Exchange differences'", КодЯзыка));
	...
	ДобавитьОсновнойПоказатель(Процессор, НСтр("ru = 'Статьи, не включенные ни в один другой показатель отчета';
												|en = 'Items not included in any other report indicator'", КодЯзыка));
	УстановитьЗачетПоказателейПрочиеДоходыРасходы(Процессор, "СтатьиОбъекты");
	...
	ДобавитьГруппу(Процессор, "2410", НСтр("ru = 'Налог при упрощенной системе налогообложения';
											|en = 'Tax in simplified taxation system'", КодЯзыка));
	...
	ДобавитьГруппу(Процессор, "2410", НСтр("ru = 'Налог при Автоматизированной упрощенной системе налогообложения';
											|en = 'Tax in automated simplified taxation system'", КодЯзыка));
	...
	ДобавитьГруппу(Процессор, "2410", НСтр("ru = 'НДФЛ индивидуального предпринимателя';
											|en = 'Individual entrepreneur PIT'", КодЯзыка));
	...
	ДобавитьПоказатель(Процессор, НСтр("ru = 'Прирост стоимости основных средств';
										|en = 'Fixed asset cost gain'", КодЯзыка));
	...
	ДобавитьПоказатель(Процессор, НСтр("ru = 'Прирост стоимости нематериальных активов';
										|en = 'Intangible asset cost gain'", КодЯзыка));
	...
	ДобавитьОсновнойПоказатель(Процессор, НСтр("ru = 'Прирост стоимости прочих активов';
												|en = 'Other asset cost gain'", КодЯзыка));
...
Процедура ЗаполнитьНастройкиПоУмолчаниюОДДС(Процессор)
	...
	ДобавитьПоказательСвернутогоДенежногоПотока(Процессор, "АгентПродавца", НСтр("ru = 'Исключены суммы продаж в интересах комитента';
																				|en = 'Sales amounts for the benefit of the consignor are excluded'", КодЯзыка));
	
	ДобавитьПоказательДенежногоПотокаПоСчету(
		Процессор,
		НСтр("ru = 'Поступления от продаж по платежным картам';
			|en = 'Поступления от продаж по платежным картам'", КодЯзыка),
	...
	ДобавитьПоказательСвернутогоДенежногоПотока(Процессор, "ОбменВалют", НСтр("ru = 'Выгоды и потери от валютно-обменных операций';
																				|en = 'Gains and losses from currency exchange transactions'", КодЯзыка));
	ДобавитьОсновнойПоказатель(Процессор, НСтр("ru = 'Статьи, не включенные ни в один другой показатель отчета';
												|en = 'Items not included in any other report indicator'", КодЯзыка));
	...
	ДобавитьПоказательСвернутогоДенежногоПотока(
			...
			НСтр("ru = 'Исключены суммы приобретений в интересах комитента';
				|en = 'Purchase amounts for the benefit of the consignor are excluded'", КодЯзыка));
	...
	ДобавитьГруппуОтрицательныхЗначенийЕдиныйНалоговыйПлатеж(
			Процессор,
			"4124",
			НСтр("ru = 'Налоги (сборы, взносы) в составе единого налогового платежа';
				|en = 'Налоги (сборы, взносы) в составе единого налогового платежа'", КодЯзыка),
			ПоказательЕдиныйНалоговыйПлатеж);
		// В образце наименования групп являются продолжением фразы "в том числе [платежи]:".
		УстановитьНаименованиеГруппыИзОбразца(НСтр("ru = 'налогов (сборов, взносов) в составе единого налогового платежа';
													|en = 'налогов (сборов, взносов) в составе единого налогового платежа'", КодЯзыка), Процессор);
...
Процедура ДетализироватьГруппуПоказателейПродажи(Шаблон, Контекст, КодЯзыка)
	...
	Шаблон.НаименованиеОсновногоПоказателя = НСтр("ru = 'Номенклатурные группы, не приведенные выше';
													|en = 'Product categories not listed above'", КодЯзыка);
	...
	Если ДетализироватьНоменклатурныеГруппыОписания Тогда
		...
		Если ОтборНоменклатурныеГруппы.Количество() > 1 Тогда
			ШаблонОписания = НСтр("ru = 'Оборот по [Счету] по номенклатурной группе из списка:
                                   ...
                                   |en = 'Turnover by [Счету] by product category from the list:
		...
		Иначе
			ШаблонОписания = НСтр("ru = 'Оборот по [Счету] по номенклатурной группе [НоменклатурныеГруппы]';
									|en = 'Turnover by [Счету] by the [НоменклатурныеГруппы] product category'", КодЯзыка);
		КонецЕсли;
...
Процедура ПолучитьДанныеУчетаПрочиеДоходыРасходы(Процессор)
	...
	ОсновноеРазъяснениеПланСчетов = НСтр(
		...
		|en = 'Income is recorded on credit subaccounts, expenses are recorded on debit subaccounts.'",
		Процессор.КодЯзыка);
	...
	ШаблонРазъясненияЗачетПоказателей = НСтр(
		...
		|en = 'Thus, to calculate the indicator, the credit turnover by %1 is determined minus the debit turnover by %2.'",
		Процессор.КодЯзыка);
...
Процедура ОписатьПорядокЗаполненияПоказателяПрочиеДоходыРасходы(Описание, Показатель, ЭтоОсновнойПоказатель, Процессор)
	...
	Если ЗачетПоказателей = "СтатьиОбъекты" Тогда
		...
		ОписаниеЗачетПоказателей = НСтр(
			...
			|en = 'For each sold object, income (the sum of positive values) and expenses (the sum of negative values) are determined separately'",
			Процессор.КодЯзыка);
	...
	Иначе
		...
		Если ЗачетПоказателей = "Показатель" Тогда
			ОписаниеЗачетПоказателей = НСтр("ru = 'Положительная итоговая сумма включается в доходы, отрицательная - в расходы';
											|en = 'A positive total amount is included in income and a negative total amount is included in expenses'", Процессор.КодЯзыка);
		ИначеЕсли ЗачетПоказателей = "Нет" Тогда
			ОписаниеЗачетПоказателей = НСтр("ru = 'Суммы, учтенные по кредиту, включаются в доходы; по дебету - в расходы';
											|en = 'Amounts recorded on the credit side are included in income, and those recorded on the debit side are included in expenses'", Процессор.КодЯзыка);
		КонецЕсли;
	...
	Если ЭтоОсновнойПоказатель И ЕдинственныйПоказатель Тогда
		ШаблонТекста = СтрШаблон(НСтр("ru = 'Оборот по счету %1.';
										|en = 'Account %1 turnover.'", Процессор.КодЯзыка), Процессор.ДанныеАлгоритма.Счета.Группа);
	ИначеЕсли ОписаниеВидаСтатей <> Неопределено Тогда
		
		ШаблонТекста = СтрШаблон(
			НСтр("ru = 'Оборот по счету %1 по статьям [ВидСтатьи].';
				|en = 'Account %1 turnover by the [ВидСтатьи] items.'", Процессор.КодЯзыка),
		...
		Иначе
			...
			ШаблонТекста = СтрШаблон(
				НСтр("ru = 'Оборот по счету %1 по статьям [ВидСтатьи].
                      ...
                      |[Исключения]';
                      |en = 'Account %1 turnover by the [ВидСтатьи] items.
                      |Exceptions: items included in other indicators:
	...
	ИначеЕсли Не ЗначениеЗаполнено(СодержимоеПоказателя) Тогда
		...
		ШаблонТекста = НСтр("ru = 'Порядок заполнения не определен';
							|en = 'Filling order is not specified'", Процессор.КодЯзыка);
	Иначе
		...
		ШаблонТекста = СтрШаблон(
			НСтр("ru = 'Оборот по счету %1 по статьям из списка:
                  |[Статьи]';
                  |en = 'Account %1 turnover by items from the list:
	...
	Если ЭтоОсновнойПоказатель Тогда
		Текст.Добавить(НСтр("ru = 'Дополнительно включается оборот по счету 99.01 с видом убытка ""Чрезвычайные доходы (расходы)"".';
							|en = 'Additionally, the account  99.01 turnover with the ""Extraordinary income (expenses)"" loss type is included.'", Процессор.КодЯзыка));
	КонецЕсли;
	...
	Иначе
		...
		КомпонентыЗачета.Положительный.Пояснение = СтрШаблон(
			НСтр("ru = 'обороты по %1 (доход)';
				|en = 'turnovers by %1 (income)'", КодЯзыка),
		...
		КомпонентыЗачета.Отрицательный.Пояснение = СтрШаблон(
			НСтр("ru = 'обороты по %1 (расход)';
				|en = 'turnovers by %1 (expenses)'", КодЯзыка),
...
Процедура ПолучитьДанныеУчетаНалоги(Процессор)
	...
	РазъяснениеПланСчетов = НСтр(
		...
		|en = 'Expenses are recorded in ledger account debits. Thus, to calculate the indicator, the credit account turnover is determined minus the debit turnover.'",
		Процессор.КодЯзыка);
	...
	Если ИдентификаторПоказателя = ДанныеАлгоритма.Показатели.ОтложенныйНалог Тогда
		Описание.Текст = СтрШаблон(
			НСтр("ru = 'Оборот по счетам %1 в корреспонденции со счетами %2';
				|en = 'Account %1 turnover in correspondence with accounts %2'", КодЯзыка),
	...
	Иначе
		...
		Если СчетНалога <> Неопределено Тогда
			Описание.Текст = СтрШаблон(
				НСтр("ru = 'Оборот по счетам %1 в корреспонденции со счетом %2';
					|en = 'Account %1 turnover in correspondence with account %2'", КодЯзыка),
		...
		Иначе
			ШаблонТекста = НСтр("ru = 'Оборот по счетам
                                ...
                                |en = 'Turnover on accounts
                                |%1 in correspondence with account %2, except for those included in other lines
                                |%3, except for
                                | -- closing turnovers
                                | -- turnovers in correspondence with deferred tax accounts (%4)'",
								КодЯзыка);
			Описание.Текст = СтрШаблон(
				ШаблонТекста,
				ДанныеАлгоритма.ПредставленияСчетов.СокращеннаяСхемаУчета,
...
Процедура ПолучитьДанныеУчетаРезультатПереоценкиВнеоборотныхАктивов(Процессор)
	...
	Если ПредставлениеСубсчетовПрочие.Количество = 1 Тогда
		ШаблонСчетовПрочие = НСтр("ru = 'субсчету %1';
									|en = 'subaccount %1'", Процессор.КодЯзыка);
	Иначе
		ШаблонСчетовПрочие = НСтр("ru = 'субсчетам %1';
									|en = 'subaccounts %1'", Процессор.КодЯзыка);
	КонецЕсли;
	...
	РазъяснениеПланСчетов = НСтр(
		...
		|en = 'Capital increase is recorded on the capital account credit, so the credit account turnover is determined minus the debit turnover.'",
		Процессор.КодЯзыка);
	Процессор.ДанныеАлгоритма.Вставить("РазъяснениеПланСчетов", РазъяснениеПланСчетов);
...
Процедура ОписатьПорядокЗаполненияПоказателяРезультатПереоценкиВнеоборотныхАктивов(Описание, Показатель, ДанныеАлгоритма, КодЯзыка)
	...
	Если ИдентификаторПоказателя = ДанныеАлгоритма.Показатели.ОтложенныйНалог Тогда
		Описание.Текст = СтрШаблон(
			НСтр("ru = 'Оборот по счетам %1 в корреспонденции со счетами отложенного налога (%2)';
				|en = 'Accounts %1 turnover in correspondence with deferred tax accounts (%2)'", КодЯзыка),
		...
		Если Субсчет <> Неопределено Тогда
			Описание.Текст = СтрШаблон(
				НСтр("ru = 'Оборот по счету %1 в корреспонденции со счетами внеоборотных активов (%2)';
					|en = 'Account %1 turnover in correspondence with fixed asset accounts (%2)'", КодЯзыка),
				Субсчет,
		...
		Иначе
			Описание.Текст = СтрШаблон(
				НСтр("ru = 'Оборот по %1 в корреспонденции со счетами внеоборотных активов (%2)';
					|en = '%1 turnover in correspondence with fixed asset accounts (%2)'", КодЯзыка),
...
Процедура ОписатьПорядокЗаполненияПоказателяДенежныеСредства(Описание, Показатель, ДанныеАлгоритма, КодЯзыка)
	...
	Описание.Текст = НСтр("ru = 'Сальдо по счетам денежных средств и денежных эквивалентов, перечисленных ниже.';
							|en = 'The balance on cash accounts and cash equivalent accounts listed below.'", КодЯзыка);
...
Процедура СоздатьДенежныеПотоки(Процессор)
	...
	|ИНДЕКСИРОВАТЬ ПО
	|	Статья";
	НастраиваемаяБухгалтерскаяОтчетность.ПереопределитьДенежныеПотокиДДС(Процессор, Запрос);
	Запрос.Выполнить();
...
Функция ПредставлениеПоказателяКодыСтрок(Показатель, КодыСтрок, КодЯзыка)
	...
	ПредставлениеКодовСтрок = СтрСоединить(КодыСтрок, НСтр("ru = ', ';
															|en = ', '", КодЯзыка));
	Возврат СтрШаблон(НСтр("ru = '%1 (см. %2)';
							|en = '%1 (см. %2)'", КодЯзыка), Показатель.Наименование, ПредставлениеКодовСтрок);
...
Процедура ОписатьПорядокЗаполненияПоказателяДенежныеПотоки(Описание, Показатель, ДанныеАлгоритма, КодЯзыка)
	...
	Если СодержитДвижениеДенежныхСредств Тогда
		...
		Если Показатель.Заполнение.Отбор.Свойство("Счет") Тогда
			...
			Если ПредставлениеСчетовОтбора.Количество = 1 Тогда
				ШаблонТекста = НСтр("ru = 'Оборот по счету %1';
									|en = 'Account %1 turnover'", КодЯзыка);
			Иначе
				ШаблонТекста = НСтр("ru = 'Оборот по счетам %1';
									|en = 'Account %1 turnover'", КодЯзыка);
			КонецЕсли;
			...
			ТекстРазъяснения.Добавить(НСтр(
				...
				|en = 'Учет по статьям денежных средств на этом счете не ведется, весь его оборот относится к одному показателю отчета'",
				КодЯзыка));
		...
		Иначе
			...
			ШаблонТекста = НСтр("ru = 'Оборот по счетам денежных средств и денежных эквивалентов %1.';
								|en = 'Оборот по счетам денежных средств и денежных эквивалентов %1.'", КодЯзыка);
			ОписаниеСтатей = "";
			ДопускаетсяПустаяСтатья = Ложь;
			Если Не Показатель.Заполнение.Отбор.Свойство("ВидСтатьи") Тогда
				ОписаниеСтатей = НСтр("ru = 'по статьям и счетам, не включенным в другие показатели';
										|en = 'by items and accounts not included in other indicators'", КодЯзыка);
			...
			ИначеЕсли Показатель.Заполнение.Отбор.ВидСтатьи.Количество() = 1 Тогда
				ОписаниеСтатей = СтрШаблон(
					НСтр("ru = 'по статьям вида ""%1""';
						|en = 'by items of the ""%1"" type'", КодЯзыка),
					Показатель.Заполнение.Отбор.ВидСтатьи[0]);
			Иначе
				ОписаниеСтатей = СтрШаблон(
					НСтр("ru = 'по статьям видов %1';
						|en = 'by items of the ""%1"" types'", КодЯзыка),
			...
			Если Не КомбинированныйПоказатель Тогда
				ТекстОписания.Добавить(НСтр("ru = 'Список счетов приведен ниже.';
											|en = 'Список счетов приведен ниже.'", КодЯзыка));
			КонецЕсли;
		...
		Если Не ЗначениеЗаполнено(Сворачиваемые) Тогда
			ТекстОписания.Добавить(НСтр("ru = 'Исключаются обороты между счетами денежных средств и денежных эквивалентов.';
										|en = 'Turnovers between cash and cash equivalent accounts are excluded.'", КодЯзыка));
		Иначе
			...
			ТекстОписания.Добавить(НСтр("ru = 'Исключаются:
                                       ...
                                       |en = 'Excluded:
                                       |- Turnovers between cash and cash equivalent accounts
                                       |- Cash flows shown in the report in a collapsed form.'", КодЯзыка));
			ШаблонТекста = НСтр("ru = 'Свернуто отражаются %1.';
								|en = '%1 are displayed in a collapsed form.'", КодЯзыка);
			Если Сворачиваемые.Количество() = 1 Тогда
				НСтр("ru = 'Свернуто отражается %1.';
					|en = '%1 is displayed in a collapsed form.'", КодЯзыка);
			КонецЕсли;
			Союз = НСтр("ru = ', а также ';
						|en = ', as well as'", КодЯзыка); // используем нестандартный союз, так как описания сворачиваемых потоков уже содержат союз "и"
			...
			Если Не СодержитДвижениеДенежныхСредств Тогда
				ТекстОписания.Добавить(НСтр(
					"ru = 'Сальдирует денежные потоки по налогу на добавленную стоимость
                     ...
                     |en = 'Сальдирует денежные потоки по налогу на добавленную стоимость
                     |- исключенные из расчетов с контрагентами
                     |- перенесенные из состава единого налогового платежа.'", 
					КодЯзыка));
			Иначе
				ТекстОписания.Добавить(НСтр(
					...
					|en = 'Также сальдирует денежные потоки по налогу на добавленную стоимость, исключенные из расчетов с контрагентами.'",
					КодЯзыка));
			КонецЕсли;
		Иначе
	...
	Если БухгалтерскаяОтчетностьБРО.ИдентификаторПоказателя(Показатель) = ДанныеАлгоритма.ПоказательЕдиныйНалоговыйПлатежБезРаспределения Тогда
		ТекстРазъяснения.Добавить(НСтр(
			...
			|en = 'Единый налоговый платеж представляется в отчете общей суммой
			|(п. 2 Рекомендации БМЦ Р-175/2025-КпР ""Единый налоговый счет"")'",
			КодЯзыка));
	КонецЕсли;
...
Процедура ОписатьЗаполняемоеЗначениеДенежныеПотоки(ЗаписьРасчет, СоставШагаРасчета, ДанныеАлгоритма, КодЯзыка)
	...
	Если ЗаписьРасчет.ТипЗаписи = "ЭтоДвижениеДенежныхСредств" Тогда
		Если СоставШагаРасчета.ЭтоДвижениеДенежныхСредств Тогда
			ЗаписьРасчет.Описание = НСтр("ru = 'Оборот по счетам учета денежных средств';
										|en = 'Оборот по счетам учета денежных средств'", КодЯзыка);
		Иначе
			ЗаписьРасчет.Описание = НСтр("ru = 'Корректировки других показателей отчета';
										|en = 'Корректировки других показателей отчета'", КодЯзыка);
		КонецЕсли;
	ИначеЕсли ЗаписьРасчет.ТипЗаписи = "ВидКорректировки" Тогда
		...
		Иначе
			...
			Если ОписаниеКорректировки <> Неопределено Тогда
				...
				Иначе
					ЗаписьРасчет.Описание = СтрШаблон(НСтр("ru = 'Исключены %1';
															|en = 'Excluded %1'", КодЯзыка), ОписаниеКорректировки.Представление);
				КонецЕсли;
			ИначеЕсли СоставШагаРасчета.ВидКорректировки = "ВременныйУчетЕдиногоНалоговогоПлатежа" Тогда
				ЗаписьРасчет.Описание = НСтр("ru = 'Суммы единого налогового платежа перенесены в одноименный показатель';
											|en = 'Суммы единого налогового платежа перенесены в одноименный показатель'", КодЯзыка);
			КонецЕсли;
		КонецЕсли;
...
Функция ПредставлениеПредметаКорректировки(ВидКорректировки, ПредставленияСворачиваемыхДенежныхПотоков, КодЯзыка)
	...
	Если ВидКорректировки = "ВременныйУчетЕдиногоНалоговогоПлатежа" Тогда
		Возврат НСтр("ru = 'единый налоговый платеж';
					|en = 'единый налоговый платеж'", КодЯзыка);
	Иначе
...
Функция ПредставленияСворачиваемыхДенежныхПотоков(КодЯзыка)
	...
	Представления.Добавить("АгентПокупателя", НСтр("ru = 'поступления и платежи, относящиеся к деятельности агента при покупках в интересах комитента';
													|en = 'receipts and payments related to the purchase agent''s activities for the benefit of the consignor'", КодЯзыка));
	...
	Представления.Добавить("АгентПродавца", НСтр("ru = 'поступления и платежи, относящиеся к деятельности агента при продажах в интересах комитента';
												|en = 'receipts and payments related to the sales agent''s activities for the benefit of the consignor'", КодЯзыка));
	...
	Если БухгалтерскийУчетПереопределяемый.ИспользоватьВалютныйУчет() Тогда
		...
		Представления.Добавить("КурсовыеРазницы", НСтр("ru = 'последствия изменений курсов валют';
														|en = 'effects of exchange rate changes'", КодЯзыка));
	КонецЕсли;
