...
Процедура ПриОпределенииЗапросаТоварыДокументаОснования(МетаданныеОснования, МетаданныеДокументаСАТУРН,
	...
	Если МетаданныеОснования = Метаданные.Справочники.ИмпортируемаяПартияСАТУРН Тогда
		...
		|	ИмпортируемаяПартияСАТУРНТовары.Количество   КАК Количество
		|	
		|ПОМЕСТИТЬ %1
		|ИЗ
		|	Справочник.ИмпортируемаяПартияСАТУРН.Товары КАК ИмпортируемаяПартияСАТУРНТовары
		|ГДЕ
		|	ИмпортируемаяПартияСАТУРНТовары.Ссылка В (&МассивДокументов)
		|	И НЕ ИмпортируемаяПартияСАТУРНТовары.Ссылка.ПометкаУдаления";
