...
Процедура ОбновитьИнформациюОНовыхДокументахВСервисеЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	ИначеЕсли Результат.Статус = "Ошибка" Тогда
		ТекстСообщения = 
			СтрШаблон(
				НСтр(
					"ru = 'При получении списка документов из сервиса 1С:Бизнес-сеть произошла ошибка.%1';
					|en = 'An error occurred when receiving a list of documents from the 1C:Business Network service.%1'",
