...
// 
// Возвращаемое значение:
//  Адрес во временном хранилище - двоичные данные архива, содержащего файл с данными панели 1С:Аналитика - текущего подключения к 1С:Аналитика.
//
...
// 
// Возвращаемое значение:
//  Структура - описание схемы панели 1С:Аналитики
//
...
Функция ИнформацияОМакетеПанели(МакетПанели)
	...
	Для ИндексИнформации = 0 По 1 Цикл
