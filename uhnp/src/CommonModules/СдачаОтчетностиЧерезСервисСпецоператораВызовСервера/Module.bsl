...
Функция ПроверитьВозможностьВыгрузкиДоверенности(СведенияДоверенности)
	...
	Если СтрДлина(СведенияДоверенности.КодНО) <> 4 Тогда
		ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Указан некорректный код налогового органа!';
																		|en = 'Указан некорректный код налогового органа!'", СведенияДоверенности.РегистрацияВИФНС, "Код");
	КонецЕсли;
	...
	Если НЕ ЗначениеЗаполнено(УчСвДов.Дата) Тогда
		ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указана дата выдачи доверенности!';
																		|en = 'Не указана дата выдачи доверенности!'", СведенияДоверенности.Доверенность, "ДатаВыдачи");
	КонецЕсли;
	...
	Если СвПредст.ЯвляетсяФЛ Тогда
		...
		Если НЕ ЗначениеЗаполнено(ФИОПредстФЛ.Фамилия) Тогда
			ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указана фамилия представляемого лица!';
																			|en = 'Не указана фамилия представляемого лица!'", СведенияДоверенности.Организация, );
		КонецЕсли;
		
		Если НЕ ЗначениеЗаполнено(ФИОПредстФЛ.Имя) Тогда
			ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указано имя представляемого лица!';
																			|en = 'Не указано имя представляемого лица!'", СведенияДоверенности.Организация, );
		КонецЕсли;
		...
		Если ЗначениеЗаполнено(АдрПредстФЛ.Индекс) И СтрДлина(АдрПредстФЛ.Индекс) <> 6 Тогда
			ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'В адресе представляемого лица указан некорректный индекс!';
																			|en = 'В адресе представляемого лица указан некорректный индекс!'", СведенияДоверенности.Организация, );
		КонецЕсли;
		
		Если НЕ ЗначениеЗаполнено(АдрПредстФЛ.КодРегион) Тогда
			ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'В адресе представляемого лица не указан код региона!';
																			|en = 'В адресе представляемого лица не указан код региона!'", СведенияДоверенности.Организация, );
		ИначеЕсли СтрДлина(СтроковыеФункцииКлиентСервер.ДополнитьСтроку(АдрПредстФЛ.КодРегион, 2)) <> 2 Тогда
			ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'В адресе представляемого лица некорректно указан код региона!';
																			|en = 'В адресе представляемого лица некорректно указан код региона!'", СведенияДоверенности.Организация, );
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(УдЛичнПредстФЛ.ВидДок) Тогда
			ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указан код вида документа, удостоверяющего личность представляемого лица!';
																			|en = 'Не указан код вида документа, удостоверяющего личность представляемого лица!'", СведенияДоверенности.Организация, );
		ИначеЕсли СтрДлина(УдЛичнПредстФЛ.ВидДок) <> 2 Тогда
			ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Указан некорректный код вида документа, удостоверяющего личность представляемого лица!';
																			|en = 'Указан некорректный код вида документа, удостоверяющего личность представляемого лица!'", СведенияДоверенности.Организация, );
		КонецЕсли;
		
		Если НЕ ЗначениеЗаполнено(УдЛичнПредстФЛ.СерНомДок) Тогда
			ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указаны серия и номер документа, удостоверяющего личность представляемого лица!';
																			|en = 'Не указаны серия и номер документа, удостоверяющего личность представляемого лица!'", СведенияДоверенности.Организация, );
		КонецЕсли;
		
		Если НЕ ЗначениеЗаполнено(УдЛичнПредстФЛ.ДатаДок) Тогда
			ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указана дата документа, удостоверяющего личность представляемого лица!';
																			|en = 'Не указана дата документа, удостоверяющего личность представляемого лица!'", СведенияДоверенности.Организация, );
		КонецЕсли;
		
		Если НЕ ЗначениеЗаполнено(УдЛичнПредстФЛ.ВыдДок) Тогда
			ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указано наименование органа, выдавшего документ, удостоверяющий личность представляемого лица!';
																			|en = 'Не указано наименование органа, выдавшего документ, удостоверяющий личность представляемого лица!'", СведенияДоверенности.Организация, );
		КонецЕсли;
		
		Если ЗначениеЗаполнено(УдЛичнПредстФЛ.КодВыдДок) И СтрДлина(УдЛичнПредстФЛ.КодВыдДок) <> 7 Тогда
			ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Указан некорректный код подразделения органа, выдавшего документ, удостоверяющий личность представляемого лица!';
																			|en = 'Указан некорректный код подразделения органа, выдавшего документ, удостоверяющий личность представляемого лица!'", СведенияДоверенности.Организация, );
		КонецЕсли;
	...
	Иначе
		...
		Если НЕ ЗначениеЗаполнено(СвПредст.НаимОрг) Тогда
			ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указано наименование представляемой организации!';
																			|en = 'Не указано наименование представляемой организации!'", СведенияДоверенности.Организация, );
		КонецЕсли;
		
		Если НЕ ЗначениеЗаполнено(СвПредст.ИННЮЛ) Тогда
			ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указан ИНН организации - представляемого лица!';
																			|en = 'Не указан ИНН организации - представляемого лица!'", СведенияДоверенности.Организация, );
		...
		Если НЕ ЗначениеЗаполнено(СвПредст.КПП) Тогда
			ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указан КПП организации!';
																			|en = 'Не указан КПП организации!'", СведенияДоверенности.Доверенность, );
		...
		Если ЗначениеЗаполнено(АдрПредстЮЛ.Индекс) И СтрДлина(АдрПредстЮЛ.Индекс) <> 6 Тогда
			ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'В адресе представляемой организации указан некорректный индекс!';
																			|en = 'В адресе представляемой организации указан некорректный индекс!'", СведенияДоверенности.Организация, );
		КонецЕсли;
		
		Если НЕ ЗначениеЗаполнено(АдрПредстЮЛ.КодРегион) Тогда
			ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'В адресе представляемой организации не указан код региона!';
																			|en = 'В адресе представляемой организации не указан код региона!'", СведенияДоверенности.Организация, );
		ИначеЕсли СтрДлина(СтроковыеФункцииКлиентСервер.ДополнитьСтроку(АдрПредстЮЛ.КодРегион, 2)) <> 2 Тогда
			ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'В адресе представляемой организации некорректно указан код региона!';
																			|en = 'В адресе представляемой организации некорректно указан код региона!'", СведенияДоверенности.Организация, );
		КонецЕсли;
		...
		Если ЗначениеЗаполнено(СвРукПредстЮЛ.ИННФЛ) И НЕ РегламентированнаяОтчетностьВызовСервера.ИННСоответствуетТребованиямНаСервере(СвРукПредстЮЛ.ИННФЛ, Истина) Тогда
			ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Указан некорректный ИНН руководителя представляемой организации!';
																			|en = 'Указан некорректный ИНН руководителя представляемой организации!'", СведенияДоверенности.Организация, );
		КонецЕсли;
		
		ФИОРукПредстЮЛ = СвРукПредстЮЛ.ФИО;
		Если НЕ ЗначениеЗаполнено(ФИОРукПредстЮЛ.Фамилия) Тогда
			ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указана фамилия руководителя представляемой организации!';
																			|en = 'Не указана фамилия руководителя представляемой организации!'", СведенияДоверенности.Организация, );
		КонецЕсли;
		Если НЕ ЗначениеЗаполнено(ФИОРукПредстЮЛ.Имя) Тогда
			ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указано имя руководителя представляемой организации!';
																			|en = 'Не указано имя руководителя представляемой организации!'", СведенияДоверенности.Организация, );
		КонецЕсли;
	...
	Если СвДовер.ПрДов = 2 ИЛИ СвДовер.ПрДов = 3 Тогда
		...
		Если СвДовер.Свойство("СвЮЛ") Тогда
			...
			Если НЕ ЗначениеЗаполнено(СвДоверЮЛ.НаимОрг) Тогда
				ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указано наименование организации - доверителя!';
																				|en = 'Не указано наименование организации - доверителя!'", СведенияДоверенности.Доверенность, "ДоверительЮЛ_НаимОрг");
			КонецЕсли;
			
			Если НЕ ЗначениеЗаполнено(СвДоверЮЛ.ИННЮЛ) Тогда
				ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указан ИНН организации - доверителя!';
																				|en = 'Не указан ИНН организации - доверителя!'", СведенияДоверенности.Доверенность, "ДоверительЮЛ_ИНН");
			...
			Если НЕ ЗначениеЗаполнено(СвДоверЮЛ.КПП) Тогда
				ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указан КПП организации - доверителя!';
																				|en = 'Не указан КПП организации - доверителя!'", СведенияДоверенности.Доверенность, "ДоверительЮЛ_КПП");
			...
			Если ЗначениеЗаполнено(АдрДоверЮЛ) Тогда
				...
				Если ЗначениеЗаполнено(АдрДоверЮЛ.Индекс) И СтрДлина(АдрДоверЮЛ.Индекс) <> 6 Тогда
					ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'В адресе организации - доверителя указан некорректный индекс!';
																					|en = 'В адресе организации - доверителя указан некорректный индекс!'", СведенияДоверенности.Доверенность, , "ДоверительЮЛ_Адрес");
				КонецЕсли;
				
				Если НЕ ЗначениеЗаполнено(АдрДоверЮЛ.КодРегион) Тогда
					ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'В адресе организации - доверителя не указан код региона!';
																					|en = 'В адресе организации - доверителя не указан код региона!'", СведенияДоверенности.Доверенность, , "ДоверительЮЛ_Адрес");
				ИначеЕсли СтрДлина(СтроковыеФункцииКлиентСервер.ДополнитьСтроку(АдрДоверЮЛ.КодРегион, 2)) <> 2 Тогда
					ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'В адресе организации - доверителя некорректно указан код региона!';
																					|en = 'В адресе организации - доверителя некорректно указан код региона!'", СведенияДоверенности.Доверенность, , "ДоверительЮЛ_Адрес");
				КонецЕсли;
				
			Иначе
				ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указан адрес организации - доверителя!';
																				|en = 'Не указан адрес организации - доверителя!'", СведенияДоверенности.Доверенность, , "ДоверительЮЛ_Адрес");
			КонецЕсли;
			...
			Если ЗначениеЗаполнено(СвРукДоверЮЛ.ИННФЛ) И НЕ РегламентированнаяОтчетностьВызовСервера.ИННСоответствуетТребованиямНаСервере(СвРукДоверЮЛ.ИННФЛ, Истина) Тогда
				ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Указан некорректный ИНН руководителя организации - доверителя!';
																				|en = 'Указан некорректный ИНН руководителя организации - доверителя!'", СведенияДоверенности.Доверенность, "ДоверительРук_ИНН");
			КонецЕсли;
			...
			Если ЗначениеЗаполнено(ФИОРукДоверЮЛ) Тогда
				Если НЕ ЗначениеЗаполнено(ФИОРукДоверЮЛ.Фамилия) Тогда
					ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указана фамилия руководителя организации - доверителя!';
																					|en = 'Не указана фамилия руководителя организации - доверителя!'", СведенияДоверенности.Доверенность, , "ДоверительРук_ФИО");
				КонецЕсли;
				Если НЕ ЗначениеЗаполнено(ФИОРукДоверЮЛ.Имя) Тогда
					ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указано имя руководителя организации - доверителя!';
																					|en = 'Не указано имя руководителя организации - доверителя!'", СведенияДоверенности.Доверенность, , "ДоверительРук_ФИО");
				КонецЕсли;
			Иначе
				ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указано ФИО руководителя организации - доверителя!';
																				|en = 'Не указано ФИО руководителя организации - доверителя!'", СведенияДоверенности.Доверенность, , "ДоверительРук_ФИО");
			КонецЕсли;
		...
		Если СвДовер.Свойство("СвФЛ") Тогда
			...
			Если ЗначениеЗаполнено(ФИОДоверФЛ) Тогда
				Если НЕ ЗначениеЗаполнено(ФИОДоверФЛ.Фамилия) Тогда
					ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указана фамилия физического лица - доверителя!';
																					|en = 'Не указана фамилия физического лица - доверителя!'", СведенияДоверенности.Доверенность, , "ДоверительУЛ_ФИО");
				КонецЕсли;
				Если НЕ ЗначениеЗаполнено(ФИОДоверФЛ.Имя) Тогда
					ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указано имя физического лица - доверителя!';
																					|en = 'Не указано имя физического лица - доверителя!'", СведенияДоверенности.Доверенность, , "ДоверительУЛ_ФИО");
				КонецЕсли;
			Иначе
				ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указано ФИО физического лица - доверителя!';
																				|en = 'Не указано ФИО физического лица - доверителя!'", СведенияДоверенности.Доверенность, , "ДоверительУЛ_ФИО");
			КонецЕсли;
			...
			Если ЗначениеЗаполнено(АдрДоверФЛ) Тогда
				...
				Если ЗначениеЗаполнено(АдрДоверФЛ.Индекс) И СтрДлина(АдрДоверФЛ.Индекс) <> 6 Тогда
					ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'В адресе физического лица - доверителя указан некорректный индекс!';
																					|en = 'В адресе физического лица - доверителя указан некорректный индекс!'", СведенияДоверенности.Доверенность, , "ДоверительУЛ_Адрес");
				КонецЕсли;
				
				Если НЕ ЗначениеЗаполнено(АдрДоверФЛ.КодРегион) Тогда
					ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'В адресе физического лица - доверителя не указан код региона!';
																					|en = 'В адресе физического лица - доверителя не указан код региона!'", СведенияДоверенности.Доверенность, , "ДоверительУЛ_Адрес");
				ИначеЕсли СтрДлина(СтроковыеФункцииКлиентСервер.ДополнитьСтроку(АдрДоверФЛ.КодРегион, 2)) <> 2 Тогда
					ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'В адресе физического лица - доверителя некорректно указан код региона!';
																					|en = 'В адресе физического лица - доверителя некорректно указан код региона!'", СведенияДоверенности.Доверенность, , "ДоверительУЛ_Адрес");
				КонецЕсли;
				
			Иначе
				ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указан адрес физического лица - доверителя!';
																				|en = 'Не указан адрес физического лица - доверителя!'", СведенияДоверенности.Доверенность, , "ДоверительУЛ_Адрес");
			КонецЕсли;
			...
			Если ЗначениеЗаполнено(УдЛичнДоверФЛ) Тогда
				...
				Если НЕ ЗначениеЗаполнено(УдЛичнДоверФЛ.ВидДок) Тогда
					ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указан код вида документа, удостоверяющего личность физического лица - доверителя!';
																					|en = 'Не указан код вида документа, удостоверяющего личность физического лица - доверителя!'", СведенияДоверенности.Доверенность, , "ДоверительУЛ_Удост");
				ИначеЕсли СтрДлина(УдЛичнДоверФЛ.ВидДок) <> 2 Тогда
					ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Указан некорректный код вида документа, удостоверяющего личность физического лица - доверителя!';
																					|en = 'Указан некорректный код вида документа, удостоверяющего личность физического лица - доверителя!'", СведенияДоверенности.Доверенность, , "ДоверительУЛ_Удост");
				КонецЕсли;
				
				Если НЕ ЗначениеЗаполнено(УдЛичнДоверФЛ.СерНомДок) Тогда
					ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указаны серия и номер документа, удостоверяющего личность физического лица - доверителя!';
																					|en = 'Не указаны серия и номер документа, удостоверяющего личность физического лица - доверителя!'", СведенияДоверенности.Доверенность, , "ДоверительУЛ_Удост");
				КонецЕсли;
				
				Если НЕ ЗначениеЗаполнено(УдЛичнДоверФЛ.ДатаДок) Тогда
					ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указана дата документа, удостоверяющего личность физического лица - доверителя!';
																					|en = 'Не указана дата документа, удостоверяющего личность физического лица - доверителя!'", СведенияДоверенности.Доверенность, , "ДоверительУЛ_Удост");
				КонецЕсли;
				
				Если НЕ ЗначениеЗаполнено(УдЛичнДоверФЛ.ВыдДок) Тогда
					ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указано наименование органа, выдавшего документ, удостоверяющий личность физического лица - доверителя!';
																					|en = 'Не указано наименование органа, выдавшего документ, удостоверяющий личность физического лица - доверителя!'", СведенияДоверенности.Доверенность, , "ДоверительУЛ_Удост");
				КонецЕсли;
				
				Если ЗначениеЗаполнено(УдЛичнДоверФЛ.КодВыдДок) И СтрДлина(УдЛичнДоверФЛ.КодВыдДок) <> 7 Тогда
					ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Указан некорректный код подразделения органа, выдавшего документ, удостоверяющий личность физического лица - доверителя!';
																					|en = 'Указан некорректный код подразделения органа, выдавшего документ, удостоверяющий личность физического лица - доверителя!'", СведенияДоверенности.Доверенность, , "ДоверительУЛ_Удост");
				КонецЕсли;
				
			Иначе
				ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указаны сведения о документе, удостоверяющем личность физического лица - доверителя!';
																				|en = 'Не указаны сведения о документе, удостоверяющем личность физического лица - доверителя!'", СведенияДоверенности.Доверенность, , "ДоверительУЛ_Удост");
			КонецЕсли;
	...
	Если СвПред.Свойство("СвОрг") Тогда
		...
		Если НЕ ЗначениеЗаполнено(СвОрг.НаимОрг) Тогда
			ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указано наименование организации - представителя!';
																			|en = 'Не указано наименование организации - представителя!'", СведенияДоверенности.Доверенность, "ПредставительЮЛ_НаимОрг");
		КонецЕсли;
		
		Если НЕ ЗначениеЗаполнено(СвОрг.ИННЮЛ) Тогда
			ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указан ИНН организации - представителя!';
																			|en = 'Не указан ИНН организации - представителя!'", СведенияДоверенности.Доверенность, "ПредставительЮЛ_ИНН");
		...
		Если НЕ ЗначениеЗаполнено(СвОрг.КПП) Тогда
			ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указан КПП организации - представителя!';
																			|en = 'Не указан КПП организации - представителя!'", СведенияДоверенности.Доверенность, "ПредставительЮЛ_КПП");
		...
		Если НЕ ЗначениеЗаполнено(СвОрг.АдрРФ) Тогда
			ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указан адрес организации - представителя!';
																			|en = 'Не указан адрес организации - представителя!'", СведенияДоверенности.Доверенность, , "ПредставительЮЛ_Адрес");
		Иначе
			...
			Если ЗначениеЗаполнено(АдрПредстЮЛ.Индекс) И СтрДлина(АдрПредстЮЛ.Индекс) <> 6 Тогда
				ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'В адресе организации - представителя указан некорректный индекс!';
																				|en = 'В адресе организации - представителя указан некорректный индекс!'", СведенияДоверенности.Доверенность, , "ПредставительЮЛ_Адрес");
			КонецЕсли;
			
			Если НЕ ЗначениеЗаполнено(АдрПредстЮЛ.КодРегион) Тогда
				ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'В адресе организации - представителя не указан код региона!';
																				|en = 'В адресе организации - представителя не указан код региона!'", СведенияДоверенности.Доверенность, , "ПредставительЮЛ_Адрес");
			ИначеЕсли СтрДлина(СтроковыеФункцииКлиентСервер.ДополнитьСтроку(АдрПредстЮЛ.КодРегион, 2)) <> 2 Тогда
				ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'В адресе организации - представителя некорректно указан код региона!';
																				|en = 'В адресе организации - представителя некорректно указан код региона!'", СведенияДоверенности.Доверенность, , "ПредставительЮЛ_Адрес");
			КонецЕсли;
	...
	Если ЗначениеЗаполнено(ФИОПредстФЛ) Тогда
		Если НЕ ЗначениеЗаполнено(ФИОПредстФЛ.Фамилия) Тогда
			ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указана фамилия физического лица - представителя!';
																			|en = 'Не указана фамилия физического лица - представителя!'", СведенияДоверенности.Доверенность, , "ПредставительУЛ_ФИО");
		КонецЕсли;
		Если НЕ ЗначениеЗаполнено(ФИОПредстФЛ.Имя) Тогда
			ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указано имя физического лица - представителя!';
																			|en = 'Не указано имя физического лица - представителя!'", СведенияДоверенности.Доверенность, , "ПредставительУЛ_ФИО");
		КонецЕсли;
	Иначе
		ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указано ФИО физического лица - представителя!';
																		|en = 'Не указано ФИО физического лица - представителя!'", СведенияДоверенности.Доверенность, , "ПредставительУЛ_ФИО");
	КонецЕсли;
	...
	Если ЗначениеЗаполнено(АдрПредстФЛ) Тогда
		...
		Если ЗначениеЗаполнено(АдрПредстФЛ.Индекс) И СтрДлина(АдрПредстФЛ.Индекс) <> 6 Тогда
			ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'В адресе физического лица - представителя указан некорректный индекс!';
																			|en = 'В адресе физического лица - представителя указан некорректный индекс!'", СведенияДоверенности.Доверенность, , "ПредставительУЛ_Адрес");
		КонецЕсли;
		
		Если НЕ ЗначениеЗаполнено(АдрПредстФЛ.КодРегион) Тогда
			ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'В адресе физического лица - представителя не указан код региона!';
																			|en = 'В адресе физического лица - представителя не указан код региона!'", СведенияДоверенности.Доверенность, , "ПредставительУЛ_Адрес");
		ИначеЕсли СтрДлина(СтроковыеФункцииКлиентСервер.ДополнитьСтроку(АдрПредстФЛ.КодРегион, 2)) <> 2 Тогда
			ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'В адресе физического лица - представителя некорректно указан код региона!';
																			|en = 'В адресе физического лица - представителя некорректно указан код региона!'", СведенияДоверенности.Доверенность, , "ПредставительУЛ_Адрес");
		КонецЕсли;
		
	Иначе
		ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указан адрес физического лица - представителя!';
																		|en = 'Не указан адрес физического лица - представителя!'", СведенияДоверенности.Доверенность, , "ПредставительУЛ_Адрес");
	КонецЕсли;
	...
	Если ЗначениеЗаполнено(УдЛичнПредстФЛ) Тогда
		...
		Если НЕ ЗначениеЗаполнено(УдЛичнПредстФЛ.ВидДок) Тогда
			ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указан код вида документа, удостоверяющего личность физического лица - представителя!';
																			|en = 'Не указан код вида документа, удостоверяющего личность физического лица - представителя!'", СведенияДоверенности.Доверенность, , "ПредставительУЛ_Удост");
		ИначеЕсли СтрДлина(УдЛичнПредстФЛ.ВидДок) <> 2 Тогда
			ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Указан некорректный код вида документа, удостоверяющего личность физического лица - представителя!';
																			|en = 'Указан некорректный код вида документа, удостоверяющего личность физического лица - представителя!'", СведенияДоверенности.Доверенность, , "ПредставительУЛ_Удост");
		КонецЕсли;
		
		Если НЕ ЗначениеЗаполнено(УдЛичнПредстФЛ.СерНомДок) Тогда
			ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указаны серия и номер документа, удостоверяющего личность физического лица - представителя!';
																			|en = 'Не указаны серия и номер документа, удостоверяющего личность физического лица - представителя!'", СведенияДоверенности.Доверенность, , "ПредставительУЛ_Удост");
		КонецЕсли;
		
		Если НЕ ЗначениеЗаполнено(УдЛичнПредстФЛ.ДатаДок) Тогда
			ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указана дата документа, удостоверяющего личность физического лица - представителя!';
																			|en = 'Не указана дата документа, удостоверяющего личность физического лица - представителя!'", СведенияДоверенности.Доверенность, , "ПредставительУЛ_Удост");
		КонецЕсли;
		
		Если НЕ ЗначениеЗаполнено(УдЛичнПредстФЛ.ВыдДок) Тогда
			ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указано наименование органа, выдавшего документ, удостоверяющий личность физического лица - представителя!';
																			|en = 'Не указано наименование органа, выдавшего документ, удостоверяющий личность физического лица - представителя!'", СведенияДоверенности.Доверенность, , "ПредставительУЛ_Удост");
		КонецЕсли;
		
		Если ЗначениеЗаполнено(УдЛичнПредстФЛ.КодВыдДок) И СтрДлина(УдЛичнПредстФЛ.КодВыдДок) <> 7 Тогда
			ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Указан некорректный код подразделения органа, выдавшего документ, удостоверяющий личность физического лица - представителя!';
																			|en = 'Указан некорректный код подразделения органа, выдавшего документ, удостоверяющий личность физического лица - представителя!'", СведенияДоверенности.Доверенность, , "ПредставительУЛ_Удост");
		КонецЕсли;
		
	Иначе
		ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указаны сведения о документе, удостоверяющем личность физического лица - представителя!';
																		|en = 'Не указаны сведения о документе, удостоверяющем личность физического лица - представителя!'", СведенияДоверенности.Доверенность, , "ПредставительУЛ_Удост");
	КонецЕсли;
	
	// сведения о полномочиях представителя
	ПолнДов = СвУпПред.ПолнДов;
	Если НЕ ЗначениеЗаполнено(ПолнДов) Тогда
		ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не определены полномочия представителя!';
																		|en = 'Не определены полномочия представителя!'", СведенияДоверенности.Доверенность, "ПолномочияПредставителя");
	Иначе
	...
	Если СведенияДоверенности.Свойство("Нотариус") Тогда
		...
		Если СвНотариус.Свойство("СвОрган") Тогда
			...
			Если НЕ ЗначениеЗаполнено(СвОрган.НаимОрг) Тогда
				ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указано наименование организации нотариуса!';
																				|en = 'Не указано наименование организации нотариуса!'", СведенияДоверенности.Доверенность, "НотариусЮЛ_НаимОрг");
			КонецЕсли;
			
			Если НЕ ЗначениеЗаполнено(СвОрган.ИННЮЛ) Тогда
				ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указан ИНН организации нотариуса!';
																				|en = 'Не указан ИНН организации нотариуса!'", СведенияДоверенности.Доверенность, "НотариусЮЛ_ИНН");
			...
			Если НЕ ЗначениеЗаполнено(СвОрган.КПП) Тогда
				ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указан КПП организации нотариуса!';
																				|en = 'Не указан КПП организации нотариуса!'", СведенияДоверенности.Доверенность, "НотариусЮЛ_КПП");
		...
		Если ЗначениеЗаполнено(ФИОНотариусаФЛ) Тогда
			Если НЕ ЗначениеЗаполнено(ФИОНотариусаФЛ.Фамилия) Тогда
				ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указана фамилия нотариуса - физического лица!';
																				|en = 'Не указана фамилия нотариуса - физического лица!'", СведенияДоверенности.Доверенность, , "НотариусУЛ_ФИО");
			КонецЕсли;
			Если НЕ ЗначениеЗаполнено(ФИОНотариусаФЛ.Имя) Тогда
				ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указано имя нотариуса - физического лица!';
																				|en = 'Не указано имя нотариуса - физического лица!'", СведенияДоверенности.Доверенность, , "НотариусУЛ_ФИО");
			КонецЕсли;
		Иначе
			ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'Не указано ФИО нотариуса - физического лица!';
																			|en = 'Не указано ФИО нотариуса - физического лица!'", СведенияДоверенности.Доверенность, , "НотариусУЛ_ФИО");
		КонецЕсли;
		...
		Если СвФизЛиц.Свойство("АдрРФ") Тогда
			...
			Если ЗначениеЗаполнено(АдресНотариусаФЛ.Индекс) И СтрДлина(АдресНотариусаФЛ.Индекс) <> 6 Тогда
				ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'В адресе нотариуса - физического лица указан некорректный индекс!';
																				|en = 'В адресе нотариуса - физического лица указан некорректный индекс!'", СведенияДоверенности.Доверенность, , "НотариусУЛ_Адрес");
			КонецЕсли;
			
			Если НЕ ЗначениеЗаполнено(АдресНотариусаФЛ.КодРегион) Тогда
				ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'В адресе нотариуса - физического лица не указан код региона!';
																				|en = 'В адресе нотариуса - физического лица не указан код региона!'", СведенияДоверенности.Доверенность, , "НотариусУЛ_Адрес");
			ИначеЕсли СтрДлина(СтроковыеФункцииКлиентСервер.ДополнитьСтроку(АдресНотариусаФЛ.КодРегион, 2)) <> 2 Тогда
				ЗарегистрироватьОшибкуПроверки(ПризнакОшибки, ОшибкиПроверки, "ru = 'В адресе нотариуса - физического лица некорректно указан код региона!';
																				|en = 'В адресе нотариуса - физического лица некорректно указан код региона!'", СведенияДоверенности.Доверенность, , "НотариусУЛ_Адрес");
			КонецЕсли;
