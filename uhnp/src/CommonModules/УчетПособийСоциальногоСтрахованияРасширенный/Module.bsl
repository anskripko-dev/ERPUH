...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий     = НСтр("ru = 'Заполнение регистра ""Данные для расчета среднего заработка по начислениям (ФСС)"".';
										|en = 'Fill in the ""Data for average earnings calculation by accruals (SSF)"" register.'");
	...
	Обработчик.Комментарий     = НСтр("ru = 'Удаление записей регистра ""Данные для расчета среднего заработка по начислениям (ФСС)"".';
										|en = 'Delete the ""Data for average earnings calculation by accruals (SSF)"" register records.'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия          = "3.1.34.100";
	Обработчик.РежимВыполнения = "Отложенно";
	...
	Обработчик.Комментарий     = НСтр("ru = 'Заполнение дней нетрудоспособности регистра ""Периоды ухода за больными родственниками"".';
										|en = 'Fill in days of incapacity for work in the ""Periods of sick relative care"" register.'");
		...
		Исключение
			ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Ошибка при формировании движений документа по регистру Данные для расчета среднего заработка по начислениям (ФСС): %1';
					|en = 'Error when generating the document records in the Data for calculating average earnings by accruals (SSF) register: %1'"),
