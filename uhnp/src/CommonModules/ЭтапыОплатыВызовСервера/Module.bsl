...
Функция ДатыПоКалендарю(Знач ГрафикРаботы, Знач ДатаОт, Знач МассивДней, ВызыватьИсключение = Истина) 
	...
	#Область УХ_Встраивание
	КалендарныеГрафикиУХ.ЗаменитьТекстЗапроса_ЭтапыОплатыВызовСервера_ДатыПоКалендарю(Запрос);
	КалендарныеГрафикиУХ.МассивКалендарейВТекст(ГрафикРаботы);
	#КонецОбласти
...
Функция СдвигМеждуДатамиПоКалендарю(Знач ГрафикРаботы, Знач ДатаОт, Знач ДатаДо, ВызыватьИсключение = Ложь) 
	...
	#Область УХ_Встраивание
	КалендарныеГрафикиУХ.ЗаменитьТекстЗапроса_ЭтапыОплатыВызовСервера_СдвигМеждуДатамиПоКалендарю(Запрос); 
	КалендарныеГрафикиУХ.МассивКалендарейВТекст(ГрафикРаботы);
	#КонецОбласти  
