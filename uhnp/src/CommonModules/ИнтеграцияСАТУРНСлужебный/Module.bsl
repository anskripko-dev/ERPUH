...
Функция ОписаниеОперации(Описание, ОбъектСсылка, НомерВерсии = Неопределено, Постфикс = Неопределено, ЭтоКлассификатор = Ложь) Экспорт
	...
	ИначеЕсли НомерВерсии = Неопределено И ОбъектСсылка <> Неопределено Тогда
		Если ЭтоКлассификатор Тогда
			ТекстВозврата = СтрШаблон(НСтр("ru = '%1 по классификатору ""%2""';
											|en = '%1 по классификатору ""%2""'"), Описание, ОбъектСсылка);
		Иначе
			ТекстВозврата = СтрШаблон(НСтр("ru = '%1 по документу ""%2""';
											|en = '%1 по документу ""%2""'"), Описание, ОбъектСсылка);
		КонецЕсли;
	ИначеЕсли НомерВерсии <> Неопределено И ОбъектСсылка = Неопределено Тогда
	...
	Иначе
		Если ЭтоКлассификатор Тогда
			ТекстВозврата = СтрШаблон(НСтр("ru = '%1 по классификатору ""%2"". Версия %3';
											|en = '%1 по классификатору ""%2"". Версия %3'"), Описание, ОбъектСсылка, НомерВерсии);
		Иначе
			ТекстВозврата = СтрШаблон(НСтр("ru = '%1 по документу ""%2"". Версия %3';
											|en = '%1 по документу ""%2"". Версия %3'"), Описание, ОбъектСсылка, НомерВерсии);
		КонецЕсли;
	КонецЕсли;
...
Функция КатегорииОпераций() Экспорт
	...
	ПередачаДанных.Вставить(
		...
		НСтр("ru = 'Оформление накладной на экспорт (создание черновика)';
			|en = 'Оформление накладной на экспорт (создание черновика)'"));
	ПередачаДанных.Вставить(
	...
	ПередачаДанных.Вставить(
		...
		НСтр("ru = 'Аннулирование накладной на экспорт';
			|en = 'Аннулирование накладной на экспорт'"));
	ПередачаДанных.Вставить(
	...
	ПередачаДанных.Вставить(
		...
		НСтр("ru = 'Подтверждение входящей накладной (аннулирование частичной приемки)';
			|en = 'Подтверждение входящей накладной (аннулирование частичной приемки)'"));
	ПередачаДанных.Вставить(
	...
	ПередачаДанных.Вставить(
		...
		НСтр("ru = 'Аннулирование подтверждения утери груза';
			|en = 'Аннулирование подтверждения утери груза'"));
	ПередачаДанных.Вставить(
	...
	ПередачаДанных.Вставить(
		...
		НСтр("ru = 'Подтверждение возврата груза (аннулирование)';
			|en = 'Подтверждение возврата груза (аннулирование)'"));
	ПередачаДанных.Вставить(
	...
	ПередачаДанных.Вставить(
		...
		НСтр("ru = 'Аннулирование подтверждения чатичного возврата груза';
			|en = 'Аннулирование подтверждения чатичного возврата груза'"));
	ПередачаДанных.Вставить(
		...
		НСтр("ru = 'Подтверждение утери груза при возврате (частично)';
			|en = 'Подтверждение утери груза при возврате (частично)'"));
	ПередачаДанных.Вставить(
	...
	ПередачаДанных.Вставить(
		...
		НСтр("ru = 'Подтверждение утери груза при возврате (аннулирование)';
			|en = 'Подтверждение утери груза при возврате (аннулирование)'"));
	ПередачаДанных.Вставить(
	...
	ПередачаДанных.Вставить(
		...
		НСтр("ru = 'Аннулирование подтверждения утилизации';
			|en = 'Аннулирование подтверждения утилизации'"));
	...
	ПередачаДанных.Вставить(
		...
		НСтр("ru = 'Оформление импорта продукции из ЕАЭС (создание документа)';
			|en = 'Оформление импорта продукции из ЕАЭС (создание документа)'"));
	ПередачаДанных.Вставить(
		...
		НСтр("ru = 'Оформление импорта продукции из ЕАЭС (изменение документа)';
			|en = 'Оформление импорта продукции из ЕАЭС (изменение документа)'"));
	ПередачаДанных.Вставить(
		...
		НСтр("ru = 'Оформление импорта продукции из ЕАЭС (подтверждение приемки)';
			|en = 'Оформление импорта продукции из ЕАЭС (подтверждение приемки)'"));
	...
	ПередачаДанных.Вставить(
		...
		НСтр("ru = 'Оформление предварительного уведомления об импорте (создание документа)';
			|en = 'Оформление предварительного уведомления об импорте (создание документа)'"));
	ПередачаДанных.Вставить(
		...
		НСтр("ru = 'Оформление предварительного уведомления об импорте (изменение документа)';
			|en = 'Оформление предварительного уведомления об импорте (изменение документа)'"));
	ПередачаДанных.Вставить(
		...
		НСтр("ru = 'Оформление предварительного уведомления об импорте (принятие к учету)';
			|en = 'Оформление предварительного уведомления об импорте (принятие к учету)'"));
	...
	ПередачаДанных.Вставить(
		...
		НСтр("ru = 'Обновление ключа авториации';
			|en = 'Обновление ключа авториации'"));
	...
	ПередачаДанных.Вставить(
		...
		НСтр("ru = 'Регистрация классификатора Место хранения (создание черновика)';
			|en = 'Регистрация классификатора Место хранения (создание черновика)'"));
	...
	ПередачаДанных.Вставить(
		...
		НСтр("ru = 'Регистрация классификатора Место применения (создание черновика)';
			|en = 'Регистрация классификатора Место применения (создание черновика)'"));
			...
			Если ВозвращаемоеЗначение.КодСостояния = 401 Тогда
				...
				Если Не ЗначениеЗаполнено(ИсходныйТекстОтвета) Тогда
					ВозвращаемоеЗначение.ТекстОшибки = НСтр(
						...
						|en = 'Ошибка авторизации. Проверьте ключи авторизации и обновления в настройках подключения к ФГИС ""Сатурн"" и повторите попытку'");
				КонецЕсли;
