	...
	Для Каждого ИмяРеквизита Из МассивРеквизитов Цикл
		...
		Если СПрефиксом И ИмяРеквизита = "НомерСчета" Тогда
			...
			Если ЗначениеЗаполнено(ДополнительныеРеквизиты.СчетЦифровогоРубля)
				...
				ДополнениеОписания = СтрШаблон(НСтр("ru = 'счет цифрового рубля %1';
													|en = 'счет цифрового рубля %1'"), ЗначениеРеквизита);
...
Процедура ПриЗаполненииУправляющихМодулей(УправляющиеМодули) Экспорт
	...
	//++ НЕ УТКА
	УправляющиеМодули.Вставить(Метаданные.Документы.ЗаказДавальца2_5.ПолноеИмя());
	//-- НЕ УТКА
	УправляющиеМодули.Вставить(Метаданные.Документы.ЗаказПоставщику.ПолноеИмя());
	//++ НЕ УТ
	УправляющиеМодули.Вставить(Метаданные.Документы.ЗаказПереработчику2_5.ПолноеИмя());
	//-- НЕ УТ
