...
Функция КонтентМакетаПоставляемойПанели(МакетПанели)	Экспорт
	...
	//Контент = Новый Структура("Панель");//, ДополнительныеИсточники");
		
	ПутьКФайлам = ПутьКФайламМакета(МакетПанели);
	//Контент["Панель"] = КонтентПоставляемойПанели(ПутьКФайлам);
	Контент = КонтентПоставляемойПанели(ПутьКФайлам);
	//Контент["ДополнительныеИсточники"] = КонтентДополнительныхИсточников(ПутьКФайлам);
