...
Процедура ЗарегистрироватьОбработчикиОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение правил замены в статьях финансирования.';
									|en = 'Fill replacement rules in financing items.'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение правил замены в способах отражения зарплаты в бухучете.';
									|en = 'Fill replacement rules in methods of recording salary in accounting'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "3.1.34.246";
	...
	Обработчик.Комментарий = НСтр("ru = 'Перемещение данных Испр-регистра в основной ""Бухучет договоров ГПХ"".';
									|en = 'Перемещение данных Испр-регистра в основной ""Бухучет договоров ГПХ"".'");
