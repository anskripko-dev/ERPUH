...
Функция АктуальнаяВерсияГрафикаРасчетов(ОбъектРасчетов) Экспорт
	...
	АктуальнаяВерсияГрафикаРасчетов = 
		РегистрыСведений.ВерсииГрафиковРасчетов.ПолучитьАктуальнуюВерсиюФинансовогоИнструмента(ОбъектРасчетов);
...
Функция НастройкиУправленияДоговорами() Экспорт
	...
	Возврат ДоговорыКонтрагентовФормыУХ.НастройкиУправленияДоговорами();	

КонецФункции

Процедура ОбновитьЗаявкиПоГрафикуОплаты(Параметры) Экспорт

	ДоговорыКонтрагентовФормыУХ.ОбновитьЗаявкиПоГрафикуОплаты(Параметры);	
