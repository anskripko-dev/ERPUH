...
Функция ПолучитьАдресВременногоХранилища(Параметры1, Параметр2 = неопределено, Параметр3 = неопределено) Экспорт
	Возврат ПоместитьВоВременноеХранилище(Ложь);
КонецФункции

Функция ПолучитьЗначениеИспользованияРезервирования() Экспорт
	
	Возврат ПолучитьФункциональнуюОпцию("ИспользоватьРезервирование");
