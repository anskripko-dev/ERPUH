...
Процедура ПриОпределенииНастроек(Параметры) Экспорт
	...
	Объекты.Добавить(Метаданные.Справочники.ВидыОперацийУХ);
	Объекты.Добавить(Метаданные.Справочники.ВидыДоговоровКонтрагентовУХ);
	Объекты.Добавить(Метаданные.Справочники.ОперацииГрафиковДоговоров);
	
	ОбновлениеИнформационнойБазыБМ.ПриОпределенииНастроек(Параметры);
