...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.РежимВыполнения = "Оперативно";
	Обработчик.Комментарий = НСтр("ru = 'Обновление правил интеграции с 1С:Документооборотом""';
									|en = 'Update integration rules with 1C:Document Management'");
	...
	Обработчик.Комментарий = СтрШаблон(
		НСтр("ru = 'Перенос настроек в новое регламентное задание ""%1"", адаптированное для работы в режиме сервиса по технологии 1С:Фреш';
			|en = 'Transfer settings to the new ""%1"" scheduled job adapted for SaaS mode using 1C:Fresh technology'"),
