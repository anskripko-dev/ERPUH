...
Процедура ПроверитьЗаполнениеНомеровГТД(ДокументОбъект, Отказ, ПараметрыПроверки = Неопределено) Экспорт
	...
	ШаблонОшибкаНекорректныйНомерГТД = НСтр("ru = 'В строке %1 списка ""%2"" указан номер ГТД некорректного типа. Укажите номер ГТД типа ""ГТД""';
											|en = 'In line %1 of the ""%2"" list, the CCD number of the incorrect type is specified. Specify the CCD number of the ""CCD"" type'");
	...
	Если ИспользоватьУчетПрослеживаемыхИмпортныхТоваров Тогда
		ШаблонОшибкаНекорректныйРНПТ = НСтр("ru = 'В строке %1 списка ""%2"" указан номер ГТД некорректного типа. Укажите номер ГТД типа ""РНПТ"" или ""РНПТ комплекта""';
											|en = 'In line %1 of the ""%2"" list, the CCD number of the incorrect type is specified. Specify the CCD number of the ""RNPT"" or ""Kit RNPT"" type'");
	Иначе
...
Процедура ПроверитьНаличиеИзделийВШапкеСУчетомПоГТД(ДокументОбъект, Отказ) Экспорт
	...
	Если РеквизитыИзделия.ПрослеживаемыйТовар = Истина
		...
		ТекстСообщения = НСтр("ru = 'В документе выбрана прослеживаемая номенклатура.
							|При включенном учете прослеживаемых импортных товаров выбор такой номенклатуры запрещен.';
							|en = 'Traceable item is selected in the document.
							|If traceable imported goods accounting is enabled, such item cannot be selected.'");
		...
		Для Каждого СтрокаТаблицы Из ТаблицаОшибок Цикл
			...
			Если Не СтрокаТаблицы.НеУказанНомерГТД
				...
				ТекстСообщения = НСтр("ru = 'По организации %Организация%%ПробелСклад%%МестоХраненияНаименование%%ПробелСклад%%Склад% не хватает %Количество% %ЕдиницаИзмерения% %ПредставлениеТипаНоменклатуры% %ПредставлениеНоменклатуры%';
										|en = '%Количество% %ЕдиницаИзмерения% of the %ПредставлениеНоменклатуры% %ПредставлениеТипаНоменклатуры% items are missing in the %ПробелСклад%%МестоХраненияНаименование%%ПробелСклад%%Склад% of the %Организация% company'");
			ИначеЕсли Не СтрокаТаблицы.НеУказанНомерГТД Тогда
				ТекстСообщения = НСтр("ru = 'По организации %Организация%%ПробелСклад%%МестоХраненияНаименование%%ПробелСклад%%Склад% не хватает %Количество% %ЕдиницаИзмерения% %ПредставлениеТипаНоменклатуры% %ПредставлениеНоменклатуры% по налогообложению %НалогообложениеНДС%';
										|en = '%Количество% %ЕдиницаИзмерения% of the %ПредставлениеНоменклатуры% %ПредставлениеТипаНоменклатуры% items by the %НалогообложениеНДС% taxation are missing in the %ПробелСклад%%МестоХраненияНаименование%%ПробелСклад%%Склад% of the %Организация% company'");
			ИначеЕсли Не КонтролироватьНалогообложениеНДС
				...
				ТекстСообщения = НСтр("ru = 'По организации %Организация%%ПробелСклад%%МестоХраненияНаименование%%ПробелСклад%%Склад% не хватает %Количество% %ЕдиницаИзмерения% %ПредставлениеТипаНоменклатуры% %ПредставлениеНоменклатуры% с указанными номерами ГТД';
										|en = '%Количество% %ЕдиницаИзмерения% of the %ПредставлениеТипаНоменклатуры% %ПредставлениеНоменклатуры% with specified CCD numbers are missing in%ПробелСклад%%МестоХраненияНаименование%%ПробелСклад%%Склад% of the %Организация% company'");
			ИначеЕсли Не КонтролироватьНалогообложениеНДС Тогда
				ТекстСообщения = НСтр("ru = 'По организации %Организация%%ПробелСклад%%МестоХраненияНаименование%%ПробелСклад%%Склад% не хватает %Количество% %ЕдиницаИзмерения% %ПредставлениеТипаНоменклатуры% %ПредставлениеНоменклатуры% с указанными РНПТ';
										|en = '%Количество% %ЕдиницаИзмерения% of the %ПредставлениеТипаНоменклатуры% %ПредставлениеНоменклатуры% with specified RNPT are missing in%ПробелСклад%%МестоХраненияНаименование%%ПробелСклад%%Склад% of the %Организация% company'");
			ИначеЕсли СтрокаТаблицы.ПрослеживаемыйТовар Тогда
				ТекстСообщения = НСтр("ru = 'По организации %Организация%%ПробелСклад%%МестоХраненияНаименование%%ПробелСклад%%Склад% не хватает %Количество% %ЕдиницаИзмерения% %ПредставлениеТипаНоменклатуры% %ПредставлениеНоменклатуры% с указанными РНПТ по налогообложению %НалогообложениеНДС%';
										|en = '%Количество% %ЕдиницаИзмерения% of the %ПредставлениеНоменклатуры% %ПредставлениеТипаНоменклатуры% with specified RNPT by the %НалогообложениеНДС% taxation are missing in the %ПробелСклад%%МестоХраненияНаименование%%ПробелСклад%%Склад% of the %Организация% company'");
			Иначе
				ТекстСообщения = НСтр("ru = 'По организации %Организация%%ПробелСклад%%МестоХраненияНаименование%%ПробелСклад%%Склад% не хватает %Количество% %ЕдиницаИзмерения% %ПредставлениеТипаНоменклатуры% %ПредставлениеНоменклатуры% с указанными номерами ГТД по налогообложению %НалогообложениеНДС%';
										|en = '%Количество% %ЕдиницаИзмерения% of the %ПредставлениеНоменклатуры% %ПредставлениеТипаНоменклатуры% items with specified CCD numbers by the %НалогообложениеНДС% taxation are missing in the %ПробелСклад%%МестоХраненияНаименование%%ПробелСклад%%Склад% of the %Организация% company'");
			КонецЕсли;
		...
		Для Каждого СтрокаТаблицы Из ТаблицаОшибок Цикл
			...
			Если ЗначениеЗаполнено(СтрокаТаблицы.Склад)
				...
				ТекстСообщения = НСтр("ru = 'По организации %Организация% не хватает %ТипДвижения% %Количество% %ЕдиницаИзмерения% на сумму %Сумма%%Валюта% %ПредставлениеТипаНоменклатуры%: %ПредставлениеНоменклатуры%,%ПробелСклад%%МестоХраненияНаименование%%ПробелСклад%%Склад% %КонтрольГТД%';
										|en = '%ТипДвижения% %Количество% %ЕдиницаИзмерения% of %ПредставлениеТипаНоменклатуры% in the amount of %Сумма%%Валюта% are missing in the %Организация% company: %ПредставлениеНоменклатуры%,%ПробелСклад%%МестоХраненияНаименование%%ПробелСклад%%Склад% %КонтрольГТД%'");
			ИначеЕсли ЗначениеЗаполнено(СтрокаТаблицы.Склад) Тогда
				ТекстСообщения = НСтр("ru = 'По организации %Организация% не хватает %ТипДвижения% %Количество% %ЕдиницаИзмерения% %ПредставлениеТипаНоменклатуры%: %ПредставлениеНоменклатуры%,%ПробелСклад%%МестоХраненияНаименование%%ПробелСклад%%Склад% %КонтрольГТД%';
										|en = '%ТипДвижения% %Количество% %ЕдиницаИзмерения% of %ПредставлениеТипаНоменклатуры% are missing in the %Организация% company: %ПредставлениеНоменклатуры%,%ПробелСклад%%МестоХраненияНаименование%%ПробелСклад%%Склад% %КонтрольГТД%'");
			ИначеЕсли ЗначениеЗаполнено(СтрокаТаблицы.Сумма)
				...
				ТекстСообщения = НСтр("ru = 'По организации %Организация% не хватает %ТипДвижения% %Количество% %ЕдиницаИзмерения% на сумму %Сумма%%Валюта% %ПредставлениеТипаНоменклатуры%: %ПредставлениеНоменклатуры% %КонтрольГТД%';
										|en = '%ТипДвижения% %Количество% %ЕдиницаИзмерения% of %ПредставлениеТипаНоменклатуры% in the amount of %Сумма%%Валюта% are missing in the %Организация% company: %ПредставлениеНоменклатуры% %КонтрольГТД%'");
			Иначе
				ТекстСообщения = НСтр("ru = 'По организации %Организация% не хватает %ТипДвижения% %Количество% %ЕдиницаИзмерения% %ПредставлениеТипаНоменклатуры%: %ПредставлениеНоменклатуры% %КонтрольГТД%';
										|en = '%ТипДвижения% %Количество% %ЕдиницаИзмерения% of %ПредставлениеТипаНоменклатуры% are missing in the %Организация% company: %ПредставлениеНоменклатуры% %КонтрольГТД%'");
			КонецЕсли;	
