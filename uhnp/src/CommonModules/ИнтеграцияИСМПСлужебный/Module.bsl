	...
	Иначе
		...
		ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.СпортивноеПитание Тогда
			Возврат НСтр("ru = 'Поддерживается поштучная продажа спортивного питания из упаковки';
						|en = 'Поддерживается поштучная продажа спортивного питания из упаковки'");
		ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.КреслаКоляски
			Или ВидПродукции = Перечисления.ВидыПродукцииИС.МедицинскиеИзделия
			Или ВидПродукции = Перечисления.ВидыПродукцииИС.МедицинскиеИзделия20 Тогда
				...
				Если МассивОшибок.Количество() = 0 Тогда
					МассивОшибок.Добавить(СтрШаблон(
						Нстр("ru = 'Ошибка получения выгрузки ""%1"" по виду продукции ""%2"" из сервиса, описание ошибки отсутствует.';
							|en = 'Ошибка получения выгрузки ""%1"" по виду продукции ""%2"" из сервиса, описание ошибки отсутствует.'"),
						ЭлементОчереди.ИдентификаторЗаявки,
						ЭлементОчереди.ВидПродукции));
				Иначе
