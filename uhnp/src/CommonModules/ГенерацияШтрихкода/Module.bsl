...
#КонецЕсли
	...
	// Если шрифт не найден, будет испольован шрифт "Default" встроенный в ВК генерации штрихкода.
...
// Возвращает имя шрифта по умолчанию используемое для генерации надписей в штихкоде.
//
// Возвращаемое значение: 
//   Строка - Имя шрифта
//
