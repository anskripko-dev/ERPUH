...
// Представление данных внутреннего документа.
// 
// Параметры:
//  ДвоичныеДанныеАрхива - ДвоичныеДанные - Двоичные данные архива
// 
// Возвращаемое значение:
//  Структура - Представление данных внутреннего документа:
	...
	Для Каждого РаспакованныйФайл Из РаспакованныеФайлы Цикл
		Если ВРег(РаспакованныйФайл.Расширение) = ".MXL" Тогда
			...
			Если ТипЗнч(РаспакованныйФайл) = Тип("Структура") Тогда
				ТабличныйДокумент.Прочитать(РаспакованныйФайл.ДвоичныеДанные.ОткрытьПотокДляЧтения());
			Иначе
...
Функция ВнутреннийДокументооборотАктуален(ОбъектУчета, ВидЭлектронногоДокумента, ДвоичныеДанныеАрхива) Экспорт
	...
	ОписаниеВидаДокумента =
		ЭлектронныеДокументыЭДО.ОписаниеВидаДокумента(ВидЭлектронногоДокумента);
	КомандыПечати = УправлениеПечатью.КомандыПечатиФормы(ПолноеИмяФормы, СписокОбъектов);
	НайденнаяКоманда = КомандыПечати.Найти(ОписаниеВидаДокумента.ИдентификаторКомандыПечати, "Идентификатор"); 
