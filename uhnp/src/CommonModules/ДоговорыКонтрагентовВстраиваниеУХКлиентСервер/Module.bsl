...
Функция ИмяСправочникаДоговорыЛизинга() Экспорт

	Возврат "ДоговорыКонтрагентов";

КонецФункции // ИмяСправочникаДоговорыКонтрагентов()

Функция ИспользуетсяГрафикРасчетовВДоговоре(ГрафикДоговора) Экспорт  
	
	Возврат ГрафикДоговора = ПредопределенноеЗначение("Перечисление.ГрафикиДоговора.ГрафикПоставок")
			ИЛИ ГрафикДоговора = ПредопределенноеЗначение("Перечисление.ГрафикиДоговора.ГрафикРасчетов");
...
Функция ЭтоВерсияСоглашения(Ссылка) Экспорт
	...
	Возврат ТипСсылки = Тип("ДокументСсылка.ВерсияСоглашенияАккредитив")
		Или ТипСсылки = Тип("ДокументСсылка.ВерсияСоглашенияБанковскаяГарантия")
		Или ТипСсылки = Тип("ДокументСсылка.ВерсияСоглашенияВалютноПроцентныйСвоп")
		Или ТипСсылки = Тип("ДокументСсылка.ВерсияСоглашенияВалютныйСвоп")
		Или ТипСсылки = Тип("ДокументСсылка.ВерсияСоглашенияВалютныйФорвард")
		Или ТипСсылки = Тип("ДокументСсылка.ВерсияСоглашенияДепозит")
		Или ТипСсылки = Тип("ДокументСсылка.ВерсияСоглашенияКоммерческийДоговор") 
		Или ТипСсылки = Тип("ДокументСсылка.ВерсияСоглашенияКредит"); 
