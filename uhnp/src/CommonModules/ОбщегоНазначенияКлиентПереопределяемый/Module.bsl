...
Процедура ПриНачалеРаботыСистемы(Параметры) Экспорт
	...
	Если ПараметрыРаботыКлиента.Свойство("РольНалоговыйМониторинг") Тогда
		ПодключитьОбработчикОжидания("ЗаписатьДействияПользователя_Подключаемый",3);
		Если ПараметрыРаботыКлиента.Свойство("НалоговыйМониторингОбновитьИнтерфейс") Тогда
			ОбновитьИнтерфейс();
		КонецЕсли;
	КонецЕсли;
	#КонецОбласти
