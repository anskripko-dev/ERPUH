...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Документы инвентаризации ТМЦ в эксплуатации';
		|en = 'Documents of physical count of inventory in operation'", КодыЯзыков); // @НСтр-2
	...
	Набор.Используется = Истина;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Документы оприходования ТМЦ в эксплуатации';
		|en = 'Documents of receipt of inventory in operation'", КодыЯзыков); // @НСтр-2
	...
	Набор.Используется = Истина;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Ввод остатков ТМЦ в эксплуатации';
		|en = 'OB entry: inventory in operation'", КодыЯзыков); // @НСтр-2
