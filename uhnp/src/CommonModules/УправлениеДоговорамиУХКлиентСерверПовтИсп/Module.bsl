...
Функция ЭтоДоговорКредит(ВидДоговораУХ) Экспорт
	
	ВидыДоговоровКредит = РаботаСДоговорамиКонтрагентовУХКлиентСервер.ВидыДоговоровКредит();
	
	Возврат (ВидыДоговоровКредит.Найти(ВидДоговораУХ) <> Неопределено); 
	
КонецФункции

Функция ЭтоДоговорДепозит(ВидДоговораУХ) Экспорт
	
	ВидыДоговоровДепозит = РаботаСДоговорамиКонтрагентовУХКлиентСервер.ВидыДоговоровДепозит();
	
	Возврат (ВидыДоговоровДепозит.Найти(ВидДоговораУХ) <> Неопределено); 
	
КонецФункции  

Функция ЭтоДоговорЗаем(ВидДоговораУХ) Экспорт
	
	ВидыДоговоровЗаем = РаботаСДоговорамиКонтрагентовУХКлиентСервер.ВидыДоговоровЗаем();
	
	Возврат (ВидыДоговоровЗаем.Найти(ВидДоговораУХ) <> Неопределено); 
	
КонецФункции 

Функция ЭтоДоговорАренды(ВидДоговораУХ) Экспорт
	
	ВидыДоговоровАренды = РаботаСДоговорамиКонтрагентовУХКлиентСервер.ВидыДоговоровЛизинг();
	
	Возврат (ВидыДоговоровАренды.Найти(ВидДоговораУХ) <> Неопределено); 
