...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ru = 'УПД (Сведения о закупке комиссионером)';
										|en = 'UTD (Information on consignee''s purchase)'");
	...
	КомандаПечати.Представление = НСтр("ru = 'УКД (Сведения о закупке комиссионером)';
										|en = 'UAD (Information on consignee''s purchase)'");
	КомандаПечати.ДополнительныеПараметры.Вставить("ВыводитьТовары", Истина);
	КомандаПечати.ПроверкаПроведенияПередПечатью = Истина;
	КомандаПечати.ОсновнаяПечатнаяФорма = Истина;
...
Процедура КомплектПечатныхФорм(КомплектПечатныхФорм) Экспорт
	...
	РегистрыСведений.НастройкиПечатиОбъектов.ДобавитьПечатнуюФормуВКомплект(КомплектПечатныхФорм, "УПД", НСтр("ru = 'УПД (Комиссионное вознаграждение)';
																												|en = 'UTD (Commission fee)'"), 0);
	РегистрыСведений.НастройкиПечатиОбъектов.ДобавитьПечатнуюФормуВКомплект(КомплектПечатныхФорм, "УПДТовары", НСтр("ru = 'УПД (Сведения о закупке комиссионером)';
																													|en = 'UTD (Information on consignee''s purchase)'"), 0);
	РегистрыСведений.НастройкиПечатиОбъектов.ДобавитьПечатнуюФормуВКомплект(КомплектПечатныхФорм, "УКДТовары", НСтр("ru = 'УКД (Сведения о закупке комиссионером)';
																													|en = 'UAD (Information on consignee''s purchase)'"), 0);
...
Функция ТекстОтраженияВРеглУчете() Экспорт
	...
	|	ЕСТЬNULL(Назначения.НаправлениеДеятельности, Операция.НаправлениеДеятельности) КАК НаправлениеДеятельностиКт,
	|
	|	ЗНАЧЕНИЕ(ПланСчетов.Хозрасчетный.ПустаяСсылка) КАК СчетКт,
	...
	#Область ТекстВосстановлениеАвансовКлиентов
	ТекстЗапроса = "
