...
Процедура СоздатьОграниченияОсновныхСредств(МенеджерВременныхТаблиц, КонтекстЗаполненияОтчета, ОбщиеПравилаУчета, Классификаторы)
	...
	|	ГДЕ
	|		НЕ ВАрендеПоМестонахождениюНачало.Арендатор В (ЗНАЧЕНИЕ(Справочник.Контрагенты.ПустаяСсылка),
	...
	|	ГДЕ
	|		НЕ ВАрендеПоМестонахождениюКонец.Арендатор В (ЗНАЧЕНИЕ(Справочник.Контрагенты.ПустаяСсылка),
	|													ЗНАЧЕНИЕ(Справочник.Контрагенты.ПустаяСсылка),
	|													НЕОПРЕДЕЛЕНО)
