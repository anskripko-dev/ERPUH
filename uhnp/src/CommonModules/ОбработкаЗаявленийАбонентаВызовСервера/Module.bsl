...
Функция ПолучитьФайлыМЧД(МЧД, ВладелецЭЦПИНН, ВладелецЭЦПСНИЛС) Экспорт
	...
	Исключение
		...
		ТекстОшибки = НСтр("ru = 'Не удалось получить файлы МЧД по причине: ';
							|en = 'Не удалось получить файлы МЧД по причине: '") + ИнформацияОбОшибке;
		
		ЗаписьЖурналаРегистрации(
			НСтр("ru = 'Электронный документооборот с контролирующими органами. Получение файлов МЧД';
				|en = 'Электронный документооборот с контролирующими органами. Получение файлов МЧД'"),
