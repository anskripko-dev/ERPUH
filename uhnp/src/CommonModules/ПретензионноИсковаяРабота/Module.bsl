...
Процедура ОтразитьВерсииГрафиковРасчетов(ДополнительныеСвойства, Движения, Отказ) Экспорт

	Таблица = ДополнительныеСвойства.ТаблицыДляДвижений.ТаблицаВерсииГрафиковРасчетов;
	...
	Движения.ВерсииГрафиковРасчетов.Загрузить(Таблица);
	
КонецПроцедуры

Процедура ОтразитьХодПретензионноИсковойРаботы(ДополнительныеСвойства, Движения, Отказ) Экспорт

	Таблица= ДополнительныеСвойства.ТаблицыДляДвижений.ТаблицаХодПретензионноИсковойРаботы;
	
	Если Отказ ИЛИ Таблица.Количество() = 0 Тогда
		Возврат;
	КонецЕсли;

	Движения.ХодПретензионноИсковойРаботы.Записывать = Истина;
	Движения.ХодПретензионноИсковойРаботы.Загрузить(Таблица);
