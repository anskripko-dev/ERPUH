...
Функция ОкончаниеИнтервалаПланирования(Период, ИнтервалПланирования, ОкончаниеИнтервала = '00010101') Экспорт
	...
	Если ОкончаниеИнтервала = '00010101' Тогда
		...
		ИначеЕсли ИнтервалПланирования = ПредопределенноеЗначение("Перечисление.ТочностьГрафикаПроизводства.День")
			ИЛИ ИнтервалПланирования = ПредопределенноеЗначение("Перечисление.ТочностьГрафикаПроизводства.Смена") Тогда
...
Функция ПолучитьНормативнуюДлительностьИнтервала(Знач Интервал, Знач ЕдиницаИзмерения = Неопределено) Экспорт
	...
	Если ЕдиницаИзмерения = Неопределено
		...
		Если Интервал = ПредопределенноеЗначение("Перечисление.ТочностьГрафикаПроизводства.День")
			ИЛИ Интервал = ПредопределенноеЗначение("Перечисление.ТочностьГрафикаПроизводства.Смена") Тогда
			Возврат 1;
...
Процедура УточнениеГраницИнтервала(НачалоИнтервала, КонецИнтервала, ПараметрыВывода = Неопределено)
	...
	ИначеЕсли ТочностьПоШкалеВремени = ПредопределенноеЗначение("Перечисление.ТочностьГрафикаПроизводства.День")
		ИЛИ ТочностьПоШкалеВремени = ПредопределенноеЗначение("Перечисление.ТочностьГрафикаПроизводства.Смена") Тогда
