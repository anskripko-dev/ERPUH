...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	Набор.ИмяПредопределенногоНабора = "Справочник_ВидыРемонтов";
	Набор.Ссылка = Новый УникальныйИдентификатор("7ba176d4-92ec-4b1e-923f-d72dae040d2f");
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Виды ремонтов';
		|en = 'R&M works'", КодыЯзыков); // @НСтр-2
	
	Набор = Элементы.Добавить();
	Набор.ИмяПредопределенногоНабора = "Справочник_КлассыОбъектовЭксплуатации";
	Набор.Ссылка = Новый УникальныйИдентификатор("2e3f58f0-21e9-4246-9a7f-ae919ba2e145");
	Набор.Используется = ПолучитьФункциональнуюОпцию("ИспользоватьУправлениеРемонтами");
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Классы объектов эксплуатации';
		|en = 'Maintenance schemes'", КодыЯзыков); // @НСтр-2
	
	Набор = Элементы.Добавить();
	Набор.ИмяПредопределенногоНабора = "Справочник_ПодклассыОбъектовЭксплуатации";
	Набор.Ссылка = Новый УникальныйИдентификатор("8195ab63-ba10-4b63-9667-924a13b1c6b9");
	Набор.Используется = ПолучитьФункциональнуюОпцию("ИспользоватьУправлениеРемонтами");
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Подклассы объектов эксплуатации';
		|en = 'Maintenance scheme options'", КодыЯзыков); // @НСтр-2
	
	Набор = Элементы.Добавить();
	Набор.ИмяПредопределенногоНабора = "Документ_ВводИнформацииОПрошлыхРемонтах";
	Набор.Ссылка = Новый УникальныйИдентификатор("ac3bc6e2-0ce0-44b6-8439-f71d7a78bf88");
	Набор.Используется = ПолучитьФункциональнуюОпцию("ИспользоватьУправлениеРемонтами");
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Ввод информации о прошлых ремонтах';
		|en = 'Enter information about past R&M'", КодыЯзыков); // @НСтр-2
	
	Набор = Элементы.Добавить();
	Набор.ИмяПредопределенногоНабора = "Документ_РегистрацияДефекта";
	Набор.Ссылка = Новый УникальныйИдентификатор("53d7e79b-fd7f-499f-a402-288043527252");
	Набор.Используется = ПолучитьФункциональнуюОпцию("ИспользоватьУправлениеРемонтами");
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Регистрация дефектов объектов эксплуатации';
		|en = 'Asset R&M request'", КодыЯзыков); // @НСтр-2
...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	Отчеты.СостояниеОбъектовЭксплуатации.НастроитьВариантыОтчета(Настройки);
	Отчеты.СостояниеУзловОбъектовЭксплуатации.НастроитьВариантыОтчета(Настройки);
	Отчеты.СостояниеУзловОбъектовЭксплуатацииКонтекст.НастроитьВариантыОтчета(Настройки);
	Отчеты.ДефектыУзловОбъектовЭксплуатации.НастроитьВариантыОтчета(Настройки);
