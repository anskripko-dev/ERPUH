...
Функция ИмяПрикладногоСправочника(ИмяСправочника) Экспорт
	...
	Иначе
		ВызватьИсключение НСтр(
			...
			|en = 'Unknown catalog %1. Check the name and the definition in ИнтеграцияЭДО.ИмяПрикладногоСправочника.'",
			ИмяСправочника));
	КонецЕсли;
...
Функция СтавкаНДСПеречисление(СтавкаНДС) Экспорт
	...
	МассивСтавокСПроцентом = Новый Массив();
	МассивСтавокСПроцентом.Добавить("0");
	МассивСтавокСПроцентом.Добавить("5");
	МассивСтавокСПроцентом.Добавить("7");
	МассивСтавокСПроцентом.Добавить("9,09");
	МассивСтавокСПроцентом.Добавить("10");
	МассивСтавокСПроцентом.Добавить("16,67");
	МассивСтавокСПроцентом.Добавить("18,03");
	МассивСтавокСПроцентом.Добавить("18");
	МассивСтавокСПроцентом.Добавить("20");
	МассивСтавокСПроцентом.Добавить("22");
	
	Если МассивСтавокСПроцентом.Найти(Значение) <> Неопределено Тогда
		Значение = Значение + "%";
	КонецЕсли;
