...
Процедура ЗарегистрироватьОбработчикиОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение реквизита ""Изменить рабочее место"" в документе ""Перемещение в другое подразделение""';
									|en = 'Fill the ""Change workspace"" attribute in the ""Transfer to another business unit"" document'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполняет даты запрета редактирования документов ""Назначения рабочих мест сотрудникам"".';
									|en = 'Fills in closing dates of editing the ""Assignment of workplaces to employees"" documents.'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Обновление реквизитов и движений документов НазначениеРабочихМестСотрудникам для корректной работы с отпусками за вредность.';
									|en = 'Обновление реквизитов и движений документов НазначениеРабочихМестСотрудникам для корректной работы с отпусками за вредность.'");
		...
		Исключение
			...
			ТекстСообщения = СтрШаблон(
				НСтр("ru = 'Не удалось обработать документ %1 по причине: %2';
					|en = 'Не удалось обработать документ %1 по причине: %2'"),
				ДокументСсылка,
				ОбработкаОшибок.ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
