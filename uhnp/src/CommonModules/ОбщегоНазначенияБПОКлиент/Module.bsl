...
Процедура ПоказатьПредупреждениеДрайверНеСертифицирован(ОписаниеОшибки = Неопределено) Экспорт
	...
	ТекстСообщения = ТекстСообщения + НСтр("ru = 'Используемый драйвер оборудования не сертифицирован или снят с поддержки.';
											|en = 'The used hardware driver is not certified or is no longer supported.'") + Символы.ПС +  
			НСтр("ru = 'Пожалуйста, обратитесь к поставщику драйвера.';
				|en = 'Please contact the driver vendor.'") + Символы.ПС +  
			НСтр("ru = 'Со списком актуальных, сертифицированных драйверов можно ознакомиться';
				|en = 'You can find the list of up-to-date certified drivers'") + " ";
	МассивСтрок = Новый Массив;
	МассивСтрок.Добавить(Новый ФорматированнаяСтрока(ТекстСообщения));
	МассивСтрок.Добавить(Новый ФорматированнаяСтрока(Новый ФорматированнаяСтрока(НСтр("ru = 'на портале 1С.';
																						|en = 'on the 1C portal.'"),,,, СсылкаНаСертОборудование)));
