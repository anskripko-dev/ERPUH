...
Функция ПроверяемыеСервисыИнтернетСоединение(РезультатДиагностики, УчетныеЗаписи)
	...
	ДобавитьСервисыОблачногоЭДО(Сервисы, УчетныеЗаписи);
...
//  * Значение - Строка
//  УчетныеЗаписи - Массив из Строка
Процедура ДобавитьСервисыОблачногоЭДО(Сервисы, УчетныеЗаписи)
	...
	ОписанияСервисов = МодульИнтеграцияОблачногоЭДО.ОписанияСервисовУчетныхЗаписейЭДО(УчетныеЗаписи);
