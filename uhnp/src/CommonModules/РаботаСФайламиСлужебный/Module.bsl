		...
		Исключение
			ЖурналРегистрации.ДобавитьСообщениеДляЖурналаРегистрации(
				НСтр("ru = 'Работа с файлами.Ошибка установки времени изменения';
					|en = 'Работа с файлами.Ошибка установки времени изменения'", ОбщегоНазначения.КодОсновногоЯзыка()),
				УровеньЖурналаРегистрации.Ошибка,,, ОбработкаОшибок.ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		КонецПопытки;
	КонецЕсли;
КонецПроцедуры
...
Функция ИзвлечьТекст(Знач АдресВременногоХранилищаТекста, Знач ДвоичныеДанные = Неопределено, 
	...
	Если Не БезопасноеРасширение Тогда
		...
		ЗаписьЖурналаРегистрации(СобытиеЖурналаРегистрацииИзвлеченияТекста(),
			УровеньЖурналаРегистрации.Предупреждение,,,
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку
				(НСтр("ru = 'Попытка извлечения текста из файла с недопустимым расширением: %1';
						|en = 'Попытка извлечения текста из файла с недопустимым расширением: %1'"), Расширение));
...
Функция СобытиеЖурналаРегистрацииИзвлеченияТекста()
	...
	Возврат НСтр("ru = 'Файлы.Извлечение текста';
				|en = 'Файлы.Извлечение текста'", ОбщегоНазначения.КодОсновногоЯзыка());
