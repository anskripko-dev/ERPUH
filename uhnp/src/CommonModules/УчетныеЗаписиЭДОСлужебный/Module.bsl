...
Функция СоздатьУчетнуюЗапись(ОписаниеУчетнойЗаписи, АдресИзменен) Экспорт
	...
	Попытка
		...
		Если НастройкиЭДО.ИспользоватьИнтеграциюОблачногоЭДО() Тогда
			МодульУчетныеЗаписиЭДОИнтеграцияОблака = ОбщегоНазначения.ОбщийМодуль("УчетныеЗаписиЭДОИнтеграцияОблака");
			МодульУчетныеЗаписиЭДОИнтеграцияОблака.ПриСозданииУчетнойЗаписиЭДО(ОписаниеУчетнойЗаписи);
		КонецЕсли;
		...
		Для Каждого Сертификат Из Сертификаты Цикл 
			...
			Если ТребуетсяДоверенность И Не ЗначениеЗаполнено(НоваяЗапись.Доверенность) Тогда
				ТекстОшибки = НСтр("ru = 'Не указана доверенность при регистрации сертификата %1 в ЭДО';
									|en = 'Не указана доверенность при регистрации сертификата %1 в ЭДО'");	
