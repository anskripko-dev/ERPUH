...
Процедура ОбновитьПоставляемыеДрайвера(ДрайвераОборудования) Экспорт
	...
	Драйвер.Наименование = НСтр("ru = 'POScenter:Электронные весы SLIM NG';
								|en = 'POScenter:Digital retail scale SLIM NG'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'AQSI:Электронные весы';
								|en = 'AQSI:Электронные весы'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'ПОСЦЕНТР:Драйвер весов с печатью этикеток NG';
								|en = 'POSCENTER:Label printing scales driver NG'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Мертех:Электронные весы с устройством распознования';
								|en = 'Mertech:Digital retail scale with a recognition device'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Мертех:Весы с печатью этикеток';
								|en = 'Mertech:Label printing scales'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	Драйвер.ИдентификаторОбъекта = "Mertech";        
	Драйвер.ИмяМакетаДрайвера = "ДрайверМертехВесыСПечатьюЭтикетокРаспознаватель";    
	Драйвер.РекомендуемоеИспользование = Истина;                                  
	...
	Драйвер.Наименование = НСтр("ru = 'ДатаПринт:Электронные весы с печатью этикеток DP WASP';
								|en = 'ДатаПринт:Электронные весы с печатью этикеток DP WASP'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
