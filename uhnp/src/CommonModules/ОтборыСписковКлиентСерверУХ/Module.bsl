...
Процедура УстановитьОтборСпискаМежду(Список, 
									...
									ПроверятьЗаполнениеЗначения = Истина) Экспорт
	...
	УстановитьОтборЗначенияС = Ложь;
	УстановитьОтборЗначенияПо = Ложь;
	
	Если ПроверятьЗаполнениеЗначения тогда
		Если  ЗначениеЗаполнено(ЗначениеС) тогда
			УстановитьОтборЗначенияС = Истина;
		КонецЕсли;
		Если  ЗначениеЗаполнено(ЗначениеПо) тогда
			УстановитьОтборЗначенияПо = Истина;
		КонецЕсли;
	Иначе
		УстановитьОтборЗначенияС = Истина;	
		УстановитьОтборЗначенияПо = Истина;	
	...
	Если УстановитьОтборЗначенияС Тогда
	...
	Если УстановитьОтборЗначенияПо Тогда
		ОтборыСписковКлиентСерверУХ.УстановитьЭлементОтбораСписка(
			Список, 
			ИмяПоля, 
			ЗначениеПо, 
