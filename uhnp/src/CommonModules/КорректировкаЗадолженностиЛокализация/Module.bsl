...
#Область ТекстРезервыПоСомнительнымДолгамСКлиентом
	...
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	|		РасчетыСКлиентамиСвернутоДляРезервов КАК Расчеты
	|	ПО
	|		Операция.Ссылка = Расчеты.Ссылка
	|	
...
#Область ТекстРезервыПоСомнительнымДолгамСПоставщиком
	...
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	|		РасчетыСПоставщикамиСвернутоДляРезервов КАК Расчеты
	|	ПО
	|		Операция.Ссылка = Расчеты.Ссылка
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.РезервыПоСомнительнымДолгам КАК Резервы
...
Функция ТекстЗапросаВТОтраженияВРеглУчете() Экспорт
	...
	#Область РасчетыСКлиентамиСвернутоДляРезервов
	...
	|ПОМЕСТИТЬ РасчетыСКлиентамиСвернутоДляРезервов
	|
	|ИЗ
	...
	#Область РасчетыСПоставщикамиСвернутоДляРезервов
	...
	|	СУММА(Расчеты.Сумма) КАК Сумма,
	|	СУММА(Расчеты.СуммаРегл) КАК СуммаРегл
	|ПОМЕСТИТЬ РасчетыСПоставщикамиСвернутоДляРезервов
	|
	|ИЗ
