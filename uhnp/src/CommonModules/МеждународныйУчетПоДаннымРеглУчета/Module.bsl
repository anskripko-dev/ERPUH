...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	//++ Локализация
	Отчеты.СверкаОборотовМУиБУ.НастроитьВариантыОтчета(Настройки);
	Отчеты.СоответствиеСчетовМеждународногоИРегламентированногоУчета.НастроитьВариантыОтчета(Настройки);
	//-- Локализация
