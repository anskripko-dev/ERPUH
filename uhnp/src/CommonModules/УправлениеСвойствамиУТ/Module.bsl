...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	//++ НЕ УТ
	ВнеоборотныеАктивы.ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти);
	//-- НЕ УТ
	
	//++ НЕ УТКА
	УправлениеРемонтами.ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти);
	//-- НЕ УТКА
	...
	Если НЕ ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПодсистемы") Тогда
		...
		Набор.Используется = Истина;
		МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
			"ru = 'Виды документов физических лиц';
			|en = 'Document kinds of persons'", КодыЯзыков); // @НСтр-2
		...
		Набор.Используется = Истина;
		МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
			"ru = 'Зачисления ДС на лицевые счета';
			|en = 'Cash deposit into personal accounts'", КодыЯзыков); // @НСтр-2
	...
	Набор.Используется = Истина;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Сверки начальных остатков по складам';
		|en = 'Reconcile opening balances by warehouses'", КодыЯзыков); // @НСтр-2
	
	//++ НЕ УТ
	Набор = Элементы.Добавить();
	Набор.ИмяПредопределенногоНабора = "Документ_ОтражениеЗарплатыВФинансовомУчете2_5";
	Набор.Ссылка = Новый УникальныйИдентификатор("f6751afd-bf23-492f-a2b6-3d87df8751b3");
	Набор.Используется = Истина;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Отражение зарплаты в финансовом учете';
		|en = 'Post payroll expenses to accounting'", КодыЯзыков); // @НСтр-2
	
	Набор = Элементы.Добавить();
	Набор.ИмяПредопределенногоНабора = "Справочник_ВидыНачисленийУдержаний";
	Набор.Ссылка = Новый УникальныйИдентификатор("8b46e704-739f-4bf4-bff1-f6739989eaa6");
	Набор.Используется = Истина;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Виды начислений, удержаний';
		|en = 'Accrued payroll kinds'", КодыЯзыков); // @НСтр-2
	
	Набор = Элементы.Добавить();
	Набор.ИмяПредопределенногоНабора = "Справочник_ОбъектыВозникновенияЗатрат";
	Набор.Ссылка = Новый УникальныйИдентификатор("10afff39-4ca9-11ea-a3f0-4cedfb68273f");
	Набор.Используется = Истина;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Объекты возникновения затрат';
		|en = 'Cost centers'", КодыЯзыков); // @НСтр-2
	
	Набор = Элементы.Добавить();
	Набор.ИмяПредопределенногоНабора = "Документ_ОбесценениеВНА";
	Набор.Ссылка = Новый УникальныйИдентификатор("109b6a0d-f0c4-46a3-9061-405f492c9d24");
	Набор.Используется = Истина;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Документы обесценения внеоборотных активов';
		|en = 'Fixed asset impairment documents'", КодыЯзыков); // @НСтр-2
	
	Набор = Элементы.Добавить();
	Набор.ИмяПредопределенногоНабора = "Справочник_ЕдиницыГенерирующиеДенежныеСредства";
	Набор.Ссылка = Новый УникальныйИдентификатор("831d97ce-b357-46b9-82c7-240d0af76eb1");
	Набор.Используется = Истина;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'ЕГДС';
		|en = 'Cash-generating unit'", КодыЯзыков); // @НСтр-2
	
	//-- НЕ УТ
	
	//++ НЕ УТКА
	Набор = Элементы.Добавить();
	Набор.ИмяПредопределенногоНабора = "Документ_НачальныеОстаткиНЗППоПартиямПроизводства";
	Набор.Ссылка = Новый УникальныйИдентификатор("eb27c57c-ed52-47ae-950c-294984db1c1b");
	Набор.Используется = Истина;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Начальные остатки НЗП по партиям производства';
		|en = 'WIP opening balances by production lots'", КодыЯзыков); // @НСтр-2
	
	Набор = Элементы.Добавить();
	Набор.ИмяПредопределенногоНабора = "Документ_НачальныеОстаткиНЗППоПодразделениям";
	Набор.Ссылка = Новый УникальныйИдентификатор("68cc0222-1b01-4928-99de-80806db631ac");
	Набор.Используется = Истина;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Начальные остатки НЗП по подразделениям';
		|en = 'WIP opening balances by business units'", КодыЯзыков); // @НСтр-2
	
	Набор = Элементы.Добавить();
	Набор.ИмяПредопределенногоНабора = "Документ_УстановкаНормативовПроизводственныхРасходов";
	Набор.Ссылка = Новый УникальныйИдентификатор("fd6879f9-2e4e-43cb-b6a6-7b53e78efe51");
	Набор.Используется = Истина;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Нормативы производственных расходов';
		|en = 'Production overhead standards'", КодыЯзыков); // @НСтр-2
	
	Набор = Элементы.Добавить();
	Набор.ИмяПредопределенногоНабора = "Документ_ПлановаяКалькуляция2_2";
	Набор.Ссылка = Новый УникальныйИдентификатор("4c45141f-31b1-4823-8a1c-bb8369e082ea");
	Набор.Используется = Истина;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Плановые калькуляции';
		|en = 'Product standard costs'", КодыЯзыков); // @НСтр-2
	
	Набор = Элементы.Добавить();
	Набор.ИмяПредопределенногоНабора = "Справочник_ТехнологическиеПроцессы";
	Набор.Ссылка = Новый УникальныйИдентификатор("5d7e6c76-44f4-4234-89b5-a911ee94f167");
	Набор.Используется  = ПолучитьФункциональнуюОпцию("ИспользоватьТехнологическиеПроцессы");
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Технологические процессы';
		|en = 'Technological processes'", КодыЯзыков); // @НСтр-2
	...
	Набор.Используется = Истина;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Договоры подключения к платежным системам';
	...
	Набор.Используется = Истина;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Электронные билеты и бронирования';
		|en = 'Electronic tickets and bookings'", КодыЯзыков); // @НСтр-2
	...
	Набор.Используется = Истина;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Заявки на командировку';
		|en = 'Travel requests'", КодыЯзыков); // @НСтр-2
	...
	Набор.Используется = Истина;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Корректировка назначения товаров';
		|en = 'Inventory assignment adjustment'", КодыЯзыков); // @НСтр-2
	
	//Описание групп
	
	//++ НЕ УТКА
	Набор = Элементы.Добавить();
	Набор.ИмяПредопределенногоНабора = "Документ_ПроизводственнаяОперация2_2";
	Набор.Ссылка = Новый УникальныйИдентификатор("32542057-ad69-4117-812f-beeb230e5f06");
	Набор.ЭтоГруппа = Истина;
	Набор.Используется = Истина;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Производственные операции';
		|en = 'Routing operations'", КодыЯзыков); // @НСтр-2
	
	ДочернийНабор = Элементы.Добавить();
	ДочернийНабор.ИмяПредопределенногоНабора = "Документ_ПроизводственнаяОперация2_2_Общие";
	ДочернийНабор.Родитель = Новый УникальныйИдентификатор("32542057-ad69-4117-812f-beeb230e5f06");
	ДочернийНабор.Ссылка = Новый УникальныйИдентификатор("b657e8cf-b14b-4742-8049-286da4ed58f9");
	ДочернийНабор.Используется = Истина;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(ДочернийНабор, "Наименование",
		"ru = 'Общие';
		|en = 'Common'", КодыЯзыков); // @НСтр-2
	
	Набор = Элементы.Добавить();
	Набор.ИмяПредопределенногоНабора = "Справочник_УзлыОбъектовЭксплуатации";
	Набор.Ссылка = Новый УникальныйИдентификатор("4db038ec-08e6-4764-a271-e7e7a0f07839");
	Набор.ЭтоГруппа = Истина;
	Набор.Используется = Истина;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Узлы объектов эксплуатации';
		|en = 'Sub-assets'", КодыЯзыков); // @НСтр-2
	
	ДочернийНабор = Элементы.Добавить();
	ДочернийНабор.ИмяПредопределенногоНабора = "Справочник_УзлыОбъектовЭксплуатации_Общие";
	ДочернийНабор.Родитель = Новый УникальныйИдентификатор("4db038ec-08e6-4764-a271-e7e7a0f07839");
	ДочернийНабор.Ссылка = Новый УникальныйИдентификатор("14b16392-2c48-424a-92af-416c00c28dfc");
	ДочернийНабор.Используется = Истина;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(ДочернийНабор, "Наименование",
		"ru = 'Общие';
		|en = 'Common'", КодыЯзыков); // @НСтр-2
	...
	//++ НЕ УТ
	Набор = Элементы.Добавить();
	Набор.ИмяПредопределенногоНабора = "Справочник_ОбъектыЭксплуатации";
	Набор.Ссылка = Новый УникальныйИдентификатор("28ff3dfe-b65d-48f0-af5f-4962cea026ea");
	Набор.ЭтоГруппа = Истина;
	Набор.Используется = Истина;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Объекты эксплуатации';
		|en = 'Assets'", КодыЯзыков); // @НСтр-2
	
	ДочернийНабор = Элементы.Добавить();
	ДочернийНабор.ИмяПредопределенногоНабора = "Справочник_ОбъектыЭксплуатации_Общие";
	ДочернийНабор.Ссылка = Новый УникальныйИдентификатор("e9a88d39-aeb9-4892-b319-a984ad275132");
	ДочернийНабор.Родитель = Новый УникальныйИдентификатор("28ff3dfe-b65d-48f0-af5f-4962cea026ea");
	ДочернийНабор.Используется = Истина;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(ДочернийНабор, "Наименование",
		"ru = 'Общие';
		|en = 'Common'", КодыЯзыков); // @НСтр-2
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(ДочернийНабор, "Наименование",
		"ru = 'Клиенты';
		|en = 'Customers'", КодыЯзыков); // @НСтр-2
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(ДочернийНабор, "Наименование",
		"ru = 'Конкуренты';
		|en = 'Competitors'", КодыЯзыков); // @НСтр-2
	...
	Набор.Используется = Истина;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Серии номенклатуры';
		|en = 'Item batch'", КодыЯзыков); // @НСтр-2
	...
	Набор.Используется = Истина;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Характеристики номенклатуры';
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Инциденты';
		|en = 'Incidents'", КодыЯзыков); // @НСтр-2
	...
	Наименование = "ru = 'Авансовые отчеты';
					|en = 'Expense reports'"; // @НСтр
	...
	Наименование = "ru = 'Акты выполненных работ';
					|en = 'Customer invoices — Services'"; // @НСтр
	...
	Наименование = "ru = 'Акты о расхождениях после отгрузки';
					|en = 'Customer invoice disputes'"; // @НСтр
	...
	Наименование = "ru = 'Акт о расхождениях после перемещения';
					|en = 'Stock transfer discrepancy report'"; // @НСтр
	...
	Наименование = "ru = 'Акты о расхождениях после приемки';
					|en = 'Receipt discrepancy reports'"; // @НСтр
	...
	Наименование = "ru = 'Аннулирование подарочных сертификатов';
					|en = 'Void gift card'"; // @НСтр
	...
	Наименование = "ru = 'Документы ввода начальных остатков';
					|en = 'OB entry documents'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "64afc2f5-3111-4526-9125-41148861eadb", 
	"Документ_ВводОстатков", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Ввод остатков взаиморасчетов';
					|en = 'OB entry: AR/AP'"; // @НСтр
	...
	Наименование = "ru = 'Ввод остатков денежных средств';
					|en = 'OB entry: cash balance'"; // @НСтр
	...
	Наименование = "ru = 'Ввод остатков о продажах за прошлые периоды';
					|en = 'OB entry: sales for past periods'"; // @НСтр
	...
	Наименование = "ru = 'Ввод остатков по финансовым инструментам';
					|en = 'OB entry: financial instruments'"; // @НСтр
	...
	Наименование = "ru = 'Ввод остатков прочие расходы';
					|en = 'OB entry: other expenses'"; // @НСтр
	...
	Наименование = "ru = 'Ввод остатков прочих активов пассивов';
					|en = 'OB entry: other assets and liabilities'"; // @НСтр
	...
	Наименование = "ru = 'Ввод начальных остатков расчетов по эквайрингу';
					|en = 'OB entry: acquiring contract AR/AP'"; // @НСтр
	...
	Наименование = "ru = 'Ввод остатков с подотчетниками';
					|en = 'OB entry: AR/AP advance holders'"; // @НСтр
	...
	Наименование = "ru = 'Ввод остатков товаров';
					|en = 'OB entry: goods'"; // @НСтр
	...
	Наименование = "ru = 'Взаимозачеты задолженности';
					|en = 'AR/AP offset'"; // @НСтр
	...
	Наименование = "ru = 'Внесение денежных средств в кассу ККМ';
					|en = 'Put cash in the cash register'"; // @НСтр
	...
	Наименование = "ru = 'Документы внутреннего потребления товаров';
					|en = 'Inventory consumptions — Non-operational activities'"; // @НСтр
	...
	Наименование = "ru = 'Возвраты товаров между организациями';
					|en = 'Goods return — Intercompany'"; // @НСтр
	...
	Наименование = "ru = 'Возвраты товаров от клиентов';
					|en = 'Sales returns'"; // @НСтр
	...
	Наименование = "ru = 'Список возвратов поставщикам';
					|en = 'List of returns to vendors'"; // @НСтр
	...
	Наименование = "ru = 'Выемка денежных средств из кассы ККМ';
					|en = 'Take cash out of cash register'"; // @НСтр
	...
	Наименование = "ru = 'Выкупы возвратной тары клиентами';
					|en = 'Returnable packaging redemptions by customers'"; // @НСтр
	...
	Наименование = "ru = 'Выкупы возвратной тары у поставщиков';
					|en = 'Redemptions of returnable packaging from vendors'"; // @НСтр
	...
	Наименование = "ru = 'Выкупы товаров с хранения';
					|en = 'Purchase invoice — VMI'"; // @НСтр
	...
	Наименование = "ru = 'Выкупы товаров хранителем';
					|en = 'Sales invoices — VMI sold'"; // @НСтр
	...
	Наименование = "ru = 'Движения прочих активов и пассивов';
					|en = 'Flow of other assets and liabilities'"; // @НСтр
	...
	Наименование = "ru = 'Доверенности';
					|en = 'Authorization letters'"; // @НСтр
	...
	Наименование = "ru = 'Задания на перевозку';
					|en = 'Itineraries'"; // @НСтр
	...
	Наименование = "ru = 'Задания торговым представителям';
					|en = 'Sales representative tasks'"; // @НСтр
	...
	Наименование = "ru = 'Список заказов клиентов';
					|en = 'Sales order list'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "03dd5357-8b34-4da5-a195-8798e22640a3", 
	"Документ_ЗаказКлиента", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Заказы на внутреннее потребление';
					|en = 'Inventory consumption orders'"; // @НСтр
	...
	Наименование = "ru = 'Заказы на перемещение';
					|en = 'Transfer orders'"; // @НСтр
	...
	Наименование = "ru = 'Заказы на сборку (разборку)';
					|en = 'Kitting orders'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "4c278a13-c0bb-407f-8bb3-6428eebc2d61", 
	"Документ_ЗаказНаСборку", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Список заказов поставщикам';
					|en = 'Purchase order list'"; // @НСтр
	...
	Наименование = "ru = 'Заявки на возврат товаров от клиентов';
					|en = 'Sales return requests'"; // @НСтр
	...
	Наименование = "ru = 'Список заявок на расходование ДС';
					|en = 'List of payment requests'"; // @НСтр
	...
	Наименование = "ru = 'Заявления о ввозе товаров из ЕАЭС';
					|en = 'Applications for goods import from EAEU'"; // @НСтр
	...
	Наименование = "ru = 'Изменение ассортимента';
					|en = 'Product range change'"; // @НСтр
	...
	Наименование = "ru = 'Инвентаризационные описи';
					|en = 'Physical inventory registers'"; // @НСтр
	...
	Наименование = "ru = 'Инвентаризации наличных ДС';
					|en = 'Petty cash audits'"; // @НСтр
	...
	Наименование = "ru = 'Корректировки плановых потребностей';
					|en = 'Planned demand adjustments'"; // @НСтр
	...
	Наименование = "ru = 'Корректировки приобретений';
					|en = 'Purchase adjustments'"; // @НСтр
	...
	Наименование = "ru = 'Корректировки реализаций';
					|en = 'Sales adjustments'"; // @НСтр
	...
	Наименование = "ru = 'Корректировка регистров';
					|en = 'Register adjustment'"; // @НСтр
	...
	Наименование = "ru = 'Начисления реверсивного НДС';
					|en = 'Reverse VAT charge accruals'"; // @НСтр
	...
	Наименование = "ru = 'Начисления и списания бонусных баллов';
					|en = 'Accrual and write-off of bonus points'"; // @НСтр
	...
	Наименование = "ru = 'Нормативы распределения планов продаж по категориям';
					|en = 'Distribution standards of product categories'"; // @НСтр
	...
	Наименование = "ru = 'Ожидаемые поступления ДС';
					|en = 'Planned cash inflows'"; // @НСтр
	...
	Наименование = "ru = 'Эквайринговые операции';
					|en = 'Acquiring transactions'"; // @НСтр
	...
	Наименование = "ru = 'Оприходования излишков товаров';
					|en = 'Stock surplus recognition'"; // @НСтр
	...
	Наименование = "ru = 'Оприходования излишков товаров у клиента';
					|en = 'Stock surplus recognitions at customer'"; // @НСтр
	...
	Наименование = "ru = 'Ордера на отражение излишков товаров';
					|en = 'Stock surplus notes'"; // @НСтр
	...
	Наименование = "ru = 'Ордера на отражение недостач товаров';
					|en = 'Stock shortage notes'"; // @НСтр
	...
	Наименование = "ru = 'Ордера на отражение пересортицы товаров';
					|en = 'Stock reclass notes'"; // @НСтр
	...
	Наименование = "ru = 'Ордера на отражение порчи товаров';
					|en = 'Stock quality change notes'"; // @НСтр
	...
	Наименование = "ru = 'Ордера на перемещение товаров';
					|en = 'Internal stock transfer'"; // @НСтр
	...
	Наименование = "ru = 'Отборы (размещения) товаров';
					|en = 'Intra-warehouse transfers'"; // @НСтр
	...
	Наименование = "ru = 'Отгрузка товаров с хранения';
					|en = 'VMI pick-up request from vendor'"; // @НСтр
	...
	Наименование = "ru = 'Расхождения при инкассации денежных средств';
					|en = 'Cash deposit/withdrawal discrepancies'"; // @НСтр
	...
	Наименование = "ru = 'Отчеты банков по эквайрингу';
					|en = 'Merchant statements'"; // @НСтр
	...
	Наименование = "ru = 'Отчеты комиссионеров (агентов) о продажах';
					|en = 'Consignment issue notifications'"; // @НСтр
	...
	Наименование = "ru = 'Отчеты комиссионеров о списании';
					|en = 'Consignment stock adjustments'"; // @НСтр
	...
	Наименование = "ru = 'Отчеты комитентам (принципалам) о продажах';
					|en = 'Consignment notifications — Intercompany'"; // @НСтр
	...
	Наименование = "ru = 'Отчеты комитентам (принципалам) о закупках';
					|en = 'Purchase notifications'"; // @НСтр
	...
	Наименование = "ru = 'Отчеты комитентам о списании';
					|en = 'Write-off consignment notifications'"; // @НСтр
	...
	Наименование = "ru = 'Отчеты о розничных возвратах';
					|en = 'Retail return reports'"; // @НСтр
	...
	Наименование = "ru = 'Отчеты о розничных продажах';
					|en = 'Retail reports'"; // @НСтр
	...
	Наименование = "ru = 'Списания товаров у хранителя';
					|en = 'Customer stock adjustment'"; // @НСтр
	...
	Наименование = "ru = 'Отчеты по комиссии';
					|en = 'Commission reports'"; // @НСтр
	...
	Наименование = "ru = 'Передачи товаров';
					|en = 'Goods transfers'"; // @НСтр
	...
	Наименование = "ru = 'Передачи товаров хранителям/комиссионерам';
					|en = 'Put away goods to custodian or agent'"; // @НСтр
	...
	Наименование = "ru = 'Документы перемещения товаров';
					|en = 'Goods transfer documents'"; // @НСтр
	...
	Наименование = "ru = 'Пересортицы товаров';
					|en = 'Stock reclass'"; // @НСтр
	...
	Наименование = "ru = 'Пересортицы товаров у хранителей';
					|en = 'Stock reclass at custodians'"; // @НСтр
	...
	Наименование = "ru = 'Пересчеты товаров';
					|en = 'Inventory count sheets'"; // @НСтр
	...
	Наименование = "ru = 'Планы внутренних потреблений';
					|en = 'Inventory consumption plans'"; // @НСтр
	...
	Наименование = "ru = 'Планы сборки (разборки)';
					|en = 'Kitting plans'"; // @НСтр
	...
	Наименование = "ru = 'Поручения экспедиторам';
					|en = 'Delivery requests'"; // @НСтр
	...
	Наименование = "ru = 'Порчи товаров';
					|en = 'Stock quality changes'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "6468b535-c213-4b70-b39b-2275a88674a3", 
	"Документ_ПорчаТоваров", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Порчи товаров у хранителей';
					|en = 'VMI quality changes'"; // @НСтр
	...
	Наименование = "ru = 'Поступления безналичных ДС';
					|en = 'Incoming payments — Bank account'"; // @НСтр
	...
	Наименование = "ru = 'Поступления товаров на склад';
					|en = 'Receipts of goods to warehouse'"; // @НСтр
	...
	Наименование = "ru = 'Поступления товаров от хранителей/комиссионеров';
					|en = 'Receipts of goods from custodians/consignees'"; // @НСтр
	...
	Наименование = "ru = 'Поступления услуг в подразделение';
					|en = 'Receipts of services to business unit'"; // @НСтр
	...
	Наименование = "ru = 'Документы приемки товаров на хранение';
					|en = 'VMI procurement documents'"; // @НСтр
	...
	Наименование = "ru = 'Приобретение товаров и услуг';
					|en = 'Vendor invoice'"; // @НСтр
	...
	Наименование = "ru = 'Приобретение услуг и прочих активов';
					|en = 'Vendor invoice — Services and Assets'"; // @НСтр
	...
	Наименование = "ru = 'Приходные кассовые ордера';
					|en = 'Incoming payments — Cash account'"; // @НСтр
	...
	Наименование = "ru = 'Приходные ордера на товары';
					|en = 'Goods receipts'"; // @НСтр
	...
	Наименование = "ru = 'Прочие оприходования товаров';
					|en = 'Other goods recording as received'"; // @НСтр
	...
	Наименование = "ru = 'Отражение прочих доходов и расходов';
					|en = 'Non-operating income and expenses'"; // @НСтр
	...
	Наименование = "ru = 'Распоряжения на перемещение ДС';
					|en = 'Cash transfer orders'"; // @НСтр
	...
	Наименование = "ru = 'Распределение доходов по направлениям деятельности';
					|en = 'Allocation of income by lines of business'"; // @НСтр
	...
	Наименование = "ru = 'Распределение расходов';
					|en = 'Line of business — allocation base'"; // @НСтр
	...
	Наименование = "ru = 'Распределение РБП';
					|en = 'Deferred expense allocation'"; // @НСтр
	...
	Наименование = "ru = 'Расходные кассовые ордера';
					|en = 'Outgoing payments — Cash account'"; // @НСтр
	...
	Наименование = "ru = 'Расходные ордера на товары';
					|en = 'Goods issues'"; // @НСтр
	...
	Наименование = "ru = 'Реализации товаров и услуг';
					|en = 'Customer invoice'"; // @НСтр
	...
	Наименование = "ru = 'Реализации услуг и прочих активов';
					|en = 'Customer invoice — Services and Assets'"; // @НСтр
	...
	Наименование = "ru = 'Цены поставщиков';
					|en = 'Vendor prices'"; // @НСтр
	...
	Наименование = "ru = 'Документы сборки (разборки) товаров';
					|en = 'Documents of goods kitting'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "b5bfb826-6e0f-4278-8105-ed1ad27939f7", 
	"Документ_СборкаТоваров", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Сверки взаиморасчетов (2.4)';
					|en = 'AR/AP reconciliations (2.4)'"; // @НСтр
	...
	Наименование = "ru = 'Сверки взаиморасчетов (2.5.11)';
					|en = 'AR/AP reconciliations (2.5.11)'"; // @НСтр
	...
	Наименование = "ru = 'Списания безналичных ДС';
					|en = 'Outgoing payments — Bank account'"; // @НСтр
	...
	Наименование = "ru = 'Списание расхождений между поступлением и приобретением';
					|en = 'Write off discrepancies between receipt and purchase'"; // @НСтр
	...
	Наименование = "ru = 'Корректировки задолженностей';
					|en = 'AR/AP adjustments'"; // @НСтр
	...
	Наименование = "ru = 'Списания недостач товаров';
					|en = 'Inventory shortage write-offs'"; // @НСтр
	...
	Наименование = "ru = 'Отчеты о списании товаров с хранения';
					|en = 'VMI adjustment reports'"; // @НСтр
	...
	Наименование = "ru = 'Счета на оплату';
					|en = 'Proforma invoices'"; // @НСтр
	...
	Наименование = "ru = 'Таможенные декларации на импорт';
					|en = 'Customs import declarations'"; // @НСтр
	...
	Наименование = "ru = 'Упаковочные листы';
					|en = 'Packing lists'"; // @НСтр
	...
	Наименование = "ru = 'Установки блокировок ячеек';
					|en = 'Block storage bins'"; // @НСтр
	...
	Наименование = "ru = 'Квоты ассортимента';
					|en = 'Product mix quotas'"; // @НСтр
	...
	Наименование = "ru = 'История изменения цен';
					|en = 'Price change history'"; // @НСтр
	...
	Наименование = "ru = 'Каналы рекламных воздействий';
					|en = 'Advertising channels'"; // @НСтр
	...
	Наименование = "ru = 'Статьи активов и пассивов';
					|en = 'Asset and liability items'"; // @НСтр
	...
	Наименование = "ru = 'Статьи доходов';
					|en = 'Income items'"; // @НСтр
	...
	Наименование = "ru = 'Статьи расходов';
					|en = 'Expense items'"; // @НСтр
	...
	Наименование = "ru = 'Банковские счета';
					|en = 'Bank accounts'"; // @НСтр
	...
	Наименование = "ru = 'Банковские счета организаций';
					|en = 'Company bank accounts'"; // @НСтр
	...
	Наименование = "ru = 'Бизнес-регионы';
					|en = 'Business regions'"; // @НСтр
	...
	Наименование = "ru = 'Бонусные программы лояльности';
					|en = 'Loyalty programs'"; // @НСтр
	...
	Наименование = "ru = 'Варианты комплектации номенклатуры';
					|en = 'Product kit configurations'"; // @НСтр
	...
	Наименование = "ru = 'Виды карт лояльности';
					|en = 'Loyalty card kinds'"; // @НСтр
	...
	Наименование = "ru = 'Виды номенклатуры';
					|en = 'Item kinds'"; // @НСтр
	...
	Наименование = "ru = 'Виды подарочных сертификатов';
					|en = 'Gift card kinds'"; // @НСтр
	...
	Наименование = "ru = 'Группы настроек фин. учета номенклатуры';
					|en = 'Financial accounting groups'"; // @НСтр
	...
	Наименование = "ru = 'Договоры с контрагентами';
					|en = 'Contracts'"; // @НСтр
	...
	Наименование = "ru = 'Договоры кредитов и депозитов';
					|en = 'Loan and deposit contracts'"; // @НСтр
	...
	Наименование = "ru = 'Договоры между организациями';
					|en = 'Intercompany contracts'"; // @НСтр
	...
	Наименование = "ru = 'Задачи проекта';
					|en = 'Project tasks'"; // @НСтр
	...
	Наименование = "ru = 'Источники данных планирования';
					|en = 'Planning data sources'"; // @НСтр
	...
	Наименование = "ru = 'Карты лояльности';
					|en = 'Loyalty cards'"; // @НСтр
	...
	Наименование = "ru = 'Контактные лица';
					|en = 'Contact persons'"; // @НСтр
	...
	Наименование = "ru = 'Контрагенты';
					|en = 'Counterparties'"; // @НСтр
	...
	Наименование = "ru = 'Направления деятельности';
					|en = 'Lines of business'"; // @НСтр
	...
	Наименование = "ru = 'Области хранения';
					|en = 'Storage areas'"; // @НСтр
	...
	Наименование = "ru = 'Подарочные сертификаты';
					|en = 'Gift cards'"; // @НСтр
	...
	Наименование = "ru = 'Подключаемое оборудование';
					|en = 'Peripherals'"; // @НСтр
	...
	Наименование = "ru = 'Правила начисления и списания бонусных баллов';
					|en = 'Rules of accrual and write-off of bonus points'"; // @НСтр
	...
	Наименование = "ru = 'Правила обмена с подключаемым оборудованием offline';
					|en = 'Rules of exchange with offline peripherals'"; // @НСтр
	...
	Наименование = "ru = 'Прочие активы и пассивы';
					|en = 'Other assets and liabilities'"; // @НСтр
	...
	Наименование = "ru = 'Прочие расходы';
					|en = 'Other expenses'"; // @НСтр
	...
	Наименование = "ru = 'Рейтинги продаж номенклатуры';
					|en = 'Sales ranks'"; // @НСтр
	...
	Наименование = "ru = 'Сделки с клиентами';
					|en = 'Sales opportunities'"; // @НСтр
	...
	Наименование = "ru = 'Сегменты номенклатуры';
					|en = 'Inventory segments'"; // @НСтр
	...
	Наименование = "ru = 'Сегменты клиентов';
					|en = 'Customer segments'"; // @НСтр
	...
	Наименование = "ru = 'Сертификаты номенклатуры';
					|en = 'Quality certificates'"; // @НСтр
	...
	Наименование = "ru = 'Скидки (наценки)';
					|en = 'Discounts (markups)'"; // @НСтр
	...
	Наименование = "ru = 'Складские помещения';
					|en = 'Warerooms'"; // @НСтр
	...
	Наименование = "ru = 'Складские ячейки';
					|en = 'Storage bins'"; // @НСтр
	...
	Наименование = "ru = 'Склады и магазины';
					|en = 'Warehouses and stores'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "a9e936e8-0b20-4a5e-937d-adbb4348cba7", 
	"Справочник_Склады", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Соглашения об условиях продаж';
					|en = 'Terms of sale'"; // @НСтр
	...
	Наименование = "ru = 'Соглашения с поставщиками';
					|en = 'Terms of purchase'"; // @НСтр
	...
	Наименование = "ru = 'Статьи движения денежных средств';
					|en = 'Cash flow items'"; // @НСтр
	...
	Наименование = "ru = 'Структура целей';
					|en = 'Goal tree'"; // @НСтр
	...
	Наименование = "ru = 'Сценарии синхронизации данных';
					|en = 'Data synchronization scenarios'"; // @НСтр
	...
	Наименование = "ru = 'Товарные категории';
					|en = 'Product categories'"; // @НСтр
	...
	Наименование = "ru = 'Форматы магазинов';
					|en = 'Retail formats'"; // @НСтр
	...
	Наименование = "ru = 'Шаблоны этикеток и ценников';
					|en = 'Label and price tag templates'"; // @НСтр
	...
	Наименование = "ru = 'Эквайринговые терминалы';
					|en = 'POS terminals'"; // @НСтр
	...
	Наименование = "ru = 'Ввод остатков НДС предъявленного';
					|en = 'Enter of balance of VAT charged'"; // @НСтр
	...
	Наименование = "ru = 'Запросы коммерческих предложений';
					|en = 'Requests for quotation'"; // @НСтр
	...
	Наименование = "ru = 'Иные документы подтверждения НДС';
					|en = 'Other documents confirming VAT'"; // @НСтр
	...
	Наименование = "ru = 'Коммерческие предложения поставщиков';
					|en = 'Vendor sales quotations'"; // @НСтр
	...
	Наименование = "ru = 'Корректировки обособленного учета';
					|en = 'Adjusting entries of separate accounting'"; // @НСтр
	...
	Наименование = "ru = 'Кассовые книги';
					|en = 'Cash books'"; // @НСтр
	...
	Наименование = "ru = 'Маркировка товаров';
					|en = 'Goods marking'"; // @НСтр
	...
	Наименование = "ru = 'Операции по ЮKassa';
					|en = 'YooMoney transactions'"; // @НСтр
	...
	Наименование = "ru = 'Перемаркировка товаров';
					|en = 'Remark goods'"; // @НСтр
	...
	Наименование = "ru = 'Справки о подтверждающих документах';
					|en = 'Justification document certificates'"; // @НСтр
	...
	Наименование = "ru = 'Счета-фактуры выданные';
					|en = 'Issued tax invoices'"; // @НСтр
	...
	Наименование = "ru = 'Счета-фактуры выданные комиссионерам (агентам)';
					|en = 'Tax invoices issued to consignees'"; // @НСтр
	...
	Наименование = "ru = 'Счета-фактуры полученные от комитентов (принципалов)';
					|en = 'Tax invoices received from consignors'"; // @НСтр
	...
	Наименование = "ru = 'Счета-фактуры налогового агента';
					|en = 'Tax invoices of tax agent'"; // @НСтр
	...
	Наименование = "ru = 'Счет-фактура на неподтвержденную реализацию по ставке 0%';
					|en = 'Tax invoice for unconfirmed sale at 0% rate'"; // @НСтр
	...
	Наименование = "ru = 'Счета-фактуры полученные';
					|en = 'Received tax invoices'"; // @НСтр
	...
	Наименование = "ru = 'Счета-фактуры полученные (налоговый агент)';
					|en = 'Received tax invoices (tax agent)'"; // @НСтр
	...
	Наименование = "ru = 'Список патентов';
					|en = 'List of patents'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "7e9e8180-9cb9-4d04-8bd8-fd8666ce7ea9", 
	"Справочник_Патенты", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Государственные контракты';
					|en = 'State contracts'"; // @НСтр
	...
	Наименование = "ru = 'Ввод данных по налогу на прибыль';
					|en = 'Enter income tax data'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "195c5e5f-fb22-11e4-92f1-0050568b35ac", 
	"Документ_ВводДанныхПоНалогуНаПрибыль", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Ввод остатков расходов при УСН';
					|en = 'Enter of balance of expenses at STS'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "1f9d880d-7919-4a87-b042-043ca1fa10fd", 
	"Документ_ВводОстатковРасходовПриУСН", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Инвентаризация объектов учета';
					|en = 'Physical inventory count of accounting objects'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "6c539d3a-9b24-4bb5-81b6-29b2d3d7e78c", 
	"Документ_ИнвентаризацияОбъектовУчета", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Возвраты материалов из производства';
					|en = 'Returns of materials from production'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "ed020a91-b625-414b-b0ef-8b765f41cec5", 
	"Документ_ВозвратМатериаловИзПроизводства", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Восстановление НДС по объектам недвижимости';
					|en = 'Restore VAT for real estates'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "bd50e748-4f7c-4d69-bd49-47368c381736", 
	"Документ_ВосстановлениеНДСПоОбъектамНедвижимости", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Выбытия денежных документов';
					|en = 'Financial document outflows'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "99de7b42-97f9-4bd1-a2bc-e50e31ccb0d3", 
	"Документ_ВыбытиеДенежныхДокументов", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Выбытия РНПТ материалов из производства';
					|en = 'Retirements of RNPT materials from manufacturing'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "c9cde674-29b0-4550-9453-076f5cb83394", 
	"Документ_ВыбытиеРНПТМатериаловИзПроизводства", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Выпуск продукции и выполнение работ';
					|en = 'Product release and work performance'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "b857404e-ccf5-422f-975c-fcd02df3c7f1", 
	"Документ_ВыпускПродукции", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Депонирования зарплаты';
					|en = 'Salary depositing'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "12839455-2f48-4041-811e-9eb74a7a57f6", 
	"Документ_ДепонированиеЗарплаты", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Изделия и затраты незавершенного производства';
					|en = 'Products and costs in unfinished production'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "b78ceff7-6b08-460e-8ef3-8f105cb0d4b8", 
	"Документ_ИзделияИЗатратыНЗП", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Изменение параметров НМА (2.2)';
					|en = 'IA parameter change (2.2)'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "17c178cc-d648-4983-a132-37640d36ce8d", 
	"Документ_ИзменениеПараметровНМА", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Изменение параметров ОС (2.2)';
					|en = 'FA parameter change (2.2)'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "175d9356-c005-4746-9a44-b3afd291e202", 
	"Документ_ИзменениеПараметровОС", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Изменение состояния ОС (2.2)';
					|en = 'FA status change (2.2)'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "01332e91-6f4c-405e-8ba2-dc209c8e2b6b", 
	"Документ_ИзменениеСостоянияОС", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Инвентаризация НМА';
					|en = 'Intangible assets — Physical inventory'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "582e5ba1-d12e-48a3-96d7-2c76b42a6258", 
	"Документ_ИнвентаризацияНМА", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Инвентаризация ОС';
					|en = 'Fixed assets — Physical inventory'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "9b3ee5e0-96f3-48f4-93fb-ec2958733d98", 
	"Документ_ИнвентаризацияОС", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Акты инвентаризации расчетов';
					|en = 'Settlement inventory reports'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "db13d771-a799-44ed-a630-edb0f38827db", 
	"Документ_ИнвентаризацияРасчетов", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Модернизация ОС (2.2)';
					|en = 'FA renovation (2.2)'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "6b071a57-a9a3-4b3f-b71b-7e0cb5078c1f", 
	"Документ_МодернизацияОС", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Начисления дивидендов';
					|en = 'Dividend accruals'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "3d14e89b-9cdc-42ef-aabd-83a29094c2b4", 
	"Документ_НачислениеДивидендов", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Начисления ЕНП';
					|en = 'UTP charges'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "64be5aa0-8fe2-47e7-857b-550a01afaa7a", 
	"Документ_НачислениеЕНП", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Операции (регл. учет)';
					|en = 'Transactions (local accounting)'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "8350a657-8f54-4bb2-a2dd-7a026afe04d0", 
	"Документ_ОперацияБух", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Отчеты оператора системы ""Платон""';
					|en = 'Reports of Platon system operator'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "900eadd1-2e93-4bab-b12c-42082708df9e", 
	"Документ_ОтчетОператораСистемыПлатон", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Передачи материалов в производство';
					|en = 'Transfer materials to production'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "c35a46fb-b563-498c-9efe-324dd5d19656", 
	"Документ_ПередачаМатериаловВПроизводство", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Перемещение материалов в производстве';
					|en = 'Material transfer in production'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "350fcb68-dd4b-4467-ae42-f10dea286ec3", 
	"Документ_ПеремещениеМатериаловВПроизводстве", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Перемещение ОС (2.2)';
					|en = 'FA transfer (2.2)'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "15e434c7-2183-4647-9906-104889976440", 
	"Документ_ПеремещениеОС", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Переносы РНПТ материалов на продукцию';
					|en = 'Transfer of RNPT materials to manufactured products'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "cc4ce2ac-a6ca-42bb-bb18-7abaac36ee74", 
	"Документ_ПереносРНПТМатериаловНаПродукцию", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Подготовка к передаче ОС (2.2)';
					|en = 'Preparation for FA handover (2.2)'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "3714dc92-2f6f-4a6b-9aed-1bfddb723162", 
	"Документ_ПодготовкаКПередачеОС", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Поступления денежных документов';
					|en = 'Financial document receipts'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "ff9aa909-3d5e-4f0f-8422-9195ab41b976", 
	"Документ_ПоступлениеДенежныхДокументов", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Принятие к учету НМА (2.2)';
					|en = 'IA recognition (2.2)'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "727f7468-b723-4d9d-9b47-da4199b80b1d", 
	"Документ_ПринятиеКУчетуНМА", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Принятие к учету ОС (2.2)';
					|en = 'FA recognition (2.2)'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "db22e853-21ad-40d9-8b9e-5773bccf6bf4", 
	"Документ_ПринятиеКУчетуОС", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Списание затрат на выпуск';
					|en = 'Write off release costs'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "ed28bbe2-efa9-4a8e-892c-64572a416570", 
	"Документ_СписаниеЗатратНаВыпуск", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Списание НМА (2.2)';
					|en = 'IA retirement (2.2)'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "b64834ae-d986-428b-ab15-613855418d2c", 
	"Документ_СписаниеНМА", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Списание ОС (2.2)';
					|en = 'FA retirement (2.2)'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "26f74d35-4a92-4238-9198-687ccb498a21", 
	"Документ_СписаниеОС", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Таможенные декларации на экспорт';
					|en = 'Customs declarations for export'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "00f5da31-04b6-409e-86ba-03b1b931683f", 
	"Документ_ТаможеннаяДекларацияЭкспорт", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Заявления о ввозе товаров от покупателей из ЕАЭС';
					|en = 'Applications for import of goods from buyers from the EAEU'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "fe14a004-4b3d-4f28-90dd-0b2964cd3006", 
	"Документ_ЗаявлениеОВвозеТоваровПолученное", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Документация по контролируемым сделкам';
					|en = 'Документация по контролируемым сделкам'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "54b6b521-181e-4983-abda-a5ebdbd3ec56", 
	"Документ_ДокументацияПоКонтролируемымСделкам", Наименование, КодыЯзыков);

	//-- Локализация
	
	
	Наименование = "ru = 'Акты выполненных внутренних работ';
					|en = 'Internal works acceptance'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "114c5fc9-39cd-4d46-a72b-a2b88cc112eb", 
	"Документ_АктВыполненныхВнутреннихРабот", Наименование, КодыЯзыков);
	//++ Устарело_Переработка24
	
	Наименование = "ru = 'Возвраты сырья от переработчиков';
					|en = 'Returns of raw materials from subcontractors'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "cb04745a-05cc-405e-a74a-dda44c532047", 
	"Документ_ВозвратСырьяОтПереработчика", Наименование, КодыЯзыков);
	//-- Устарело_Переработка24
	
	Наименование = "ru = 'Выкуп арендованных ОС';
					|en = 'Vendor invoice — Leased assets'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "bb9ae340-7b48-461c-b96b-a03ddef16415", 
	"Документ_ВыкупАрендованныхОС", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Выработка НМА';
					|en = 'Intangible assets — Operating time'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "88eb2a4f-1f03-4efa-bcd2-ac68b24cebf4", 
	"Документ_ВыработкаНМА", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Выработка сотрудников';
					|en = 'Timesheets charge'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "89824a09-4486-4485-a771-e92f090e20d2", 
	"Документ_ВыработкаСотрудников", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Движение продукции и материалов';
					|en = 'Movement of products and materials'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "59e93f0b-738c-4576-b5c4-b68b67ea8f85", 
	"Документ_ДвижениеПродукцииИМатериалов", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Заказы материалов в производство';
					|en = 'Material orders for shop floor stockroom'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "a10b4f33-0225-4717-827f-0821a4fc9ac5", 
	"Документ_ЗаказМатериаловВПроизводство", Наименование, КодыЯзыков);
	//++ Устарело_Переработка24
	
	Наименование = "ru = 'Заказы переработчикам (2.4)';
					|en = 'Purchase orders — Subcontracting (2.4)'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "e250eb08-1ffc-4470-837a-2e258861b51b", 
	"Документ_ЗаказПереработчику", Наименование, КодыЯзыков);
	//-- Устарело_Переработка24
	
	Наименование = "ru = 'Заказы переработчикам';
					|en = 'Subcontracting purchase orders'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "627424a6-eb85-4b56-be26-11faf80f9d9d", 
	"Документ_ЗаказПереработчику2_5", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Заключение договоров аренды';
					|en = 'Rental contracts signing'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "498bfb4b-2638-4975-8a9d-fb50e0b84c7c", 
	"Документ_ЗаключениеДоговораАренды", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Изменение параметров НМА';
					|en = 'Adjust intangible asset financial details'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "834a7cc0-094d-40da-860a-b00aa10e8cab", 
	"Документ_ИзменениеПараметровНМА2_4", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Изменение параметров ОС';
					|en = 'Adjust fixed asset financial details'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "a54bd05c-a4a9-40b9-b0e3-975314db71aa", 
	"Документ_ИзменениеПараметровОС2_4", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Изменение условий договоров аренды';
					|en = 'Rental terms adjustment'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "13cced4a-ddfe-4aa5-9052-4b0651b66c6e", 
	"Документ_ИзменениеУсловийДоговораАренды", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Изменение условий передачи в аренду';
					|en = 'Change rental terms'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "8b6f7237-1f75-465b-835a-296b42517bac", 
	"Документ_ИзменениеУсловийПередачиВАренду", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Корректировка стоимости и амортизации НМА';
					|en = 'Adjust intangible assets cost and amortization'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "458eb5bd-ad91-425e-9b2d-740d238a2af2", 
	"Документ_КорректировкаСтоимостиИАмортизацииНМА", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Корректировка стоимости и амортизации ОС';
					|en = 'Adjust fixed asset cost and depreciation'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "c44e8926-8c2d-4d2a-82d1-5fbbfc33ef56", 
	"Документ_КорректировкаСтоимостиИАмортизацииОС", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Модернизация ОС';
					|en = 'Fixed assets — Cost additions'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "eb1ae85f-0ff9-4943-bd1c-26ff4cc4ccc7", 
	"Документ_МодернизацияОС2_4", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Объединение ОС';
					|en = 'Merge fixed assets'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "92e3a550-9e20-4937-967f-38fcd8d8e0e4", 
	"Документ_ОбъединениеОС", Наименование, КодыЯзыков);
	//++ Устарело_Переработка24
	
	Наименование = "ru = 'Отчеты переработчиков (2.4)';
					|en = 'Subcontractor reports (2.4)'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "3df128f7-a4cd-4c31-aa18-b88a891e3f06", 
	"Документ_ОтчетПереработчика", Наименование, КодыЯзыков);
	//-- Устарело_Переработка24
	
	Наименование = "ru = 'Отчеты переработчиков';
					|en = 'Subcontracting services notifications received'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "76741a5f-9dff-42cc-aabc-1e34d3885b72", 
	"Документ_ОтчетПереработчика2_5", Наименование, КодыЯзыков);
	//++ Устарело_Переработка24
	
	Наименование = "ru = 'Передачи сырья переработчикам';
					|en = 'Material transfers to subcontractors'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "1d55c963-af88-4d7b-993c-494a5e1f0445", 
	"Документ_ПередачаСырьяПереработчику", Наименование, КодыЯзыков);
	//-- Устарело_Переработка24
	
	Наименование = "ru = 'Перемещение ОС';
					|en = 'Transfer fixed assets'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "e3a78434-82f7-4d6d-a342-3fbefbefd069", 
	"Документ_ПеремещениеОС2_4", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Планы производства';
					|en = 'Production plans'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "ae919624-9533-4775-bc0c-ac5019059399", 
	"Документ_ПланПроизводства", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Подготовка к передаче ОС';
					|en = 'Prepare for sale of fixed assets'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "1d2705d6-f523-4b07-a638-190c77b8b002", 
	"Документ_ПодготовкаКПередачеОС2_4", Наименование, КодыЯзыков);
	//++ Устарело_Переработка24
	
	Наименование = "ru = 'Поступления от переработчиков';
					|en = 'Receipts from subcontractors'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "60ca4916-eff9-45ad-af01-6f503d32372c", 
	"Документ_ПоступлениеОтПереработчика", Наименование, КодыЯзыков);
	//-- Устарело_Переработка24
	
	Наименование = "ru = 'Поступление услуг по аренде';
					|en = 'Receiving rental services'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "c8f306e8-4c81-4eec-9be4-5456cc4756bf", 
	"Документ_ПоступлениеУслугПоАренде", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Прекращение договоров аренды';
					|en = 'Termination of rental contracts'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "66855b6a-dc14-4ba2-beb1-92fdf8d41818", 
	"Документ_ПрекращениеДоговораАренды", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Признание расходов по исследованиям и разработкам';
					|en = 'R&D expense recognition'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "b8cf2d72-6c64-4ba9-89ad-9f6d8e8b7713", 
	"Документ_ПризнаниеРасходовПоИсследованиямИРазработкам", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Принятие к учету НМА';
					|en = 'Intangible assets — Initial recognition'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "80a5c6e3-0281-4424-b62e-3ea2ab7e6fd9", 
	"Документ_ПринятиеКУчетуНМА2_4", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Список документов ""Принятие к учету ОС""';
					|en = '""Fixed assets — Initial recognition"" document list'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "2e960f2e-bf5d-4f4e-8f3e-24c6a818ae3b", 
	"Документ_ПринятиеКУчетуОС2_4", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Принятие к учету узлов и компонентов амортизации';
					|en = 'Recognize sub-assets and components of depreciation'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "280a6172-d24e-4cb2-a492-1eb3fb32da8d", 
	"Документ_ПринятиеКУчетуУзловКомпонентовАмортизации", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Производство без заказа';
					|en = 'Backflush production'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "9365622e-b582-4329-971d-dffd928eb5ec", 
	"Документ_ПроизводствоБезЗаказа", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Разукомплектация ОС';
					|en = 'Split fixed assets'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "23b4a057-b965-49eb-8b2f-de2a0d26abe2", 
	"Документ_РазукомплектацияОС", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Распределения возвратных отходов';
					|en = 'Recyclable waste allocation'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "ff767172-5efa-4b5c-ae58-dd3cb60cb169", 
	"Документ_РаспределениеВозвратныхОтходов", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Распределение материалов и работ';
					|en = 'Backflush of materials and works'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "5d382cc7-0c8c-4e7d-8f7f-ada5dc0edff9", 
	"Документ_РаспределениеПроизводственныхЗатрат", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Списание НМА';
					|en = 'Dispose intangible assets'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "c8b8cbf7-634b-43c6-bbb2-087497ad2a2b", 
	"Документ_СписаниеНМА2_4", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Список документов ""Списание ОС""';
					|en = '""Dispose fixed assets"" document list'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "58e7a2b2-7810-4bad-9a39-056fd8aff917", 
	"Документ_СписаниеОС2_4", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Улучшение НМА';
					|en = 'Intangible asset improvement'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "66f0a8af-c93d-433e-8d02-837f7877cb55", 
	"Документ_УлучшениеНМА", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Экземпляры бюджетов';
					|en = 'Budget entry forms'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "1b46fd46-d88e-43ab-a77f-b8fdc23c6045", 
	"Документ_ЭкземплярБюджета", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Бригады';
					|en = 'Work teams'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "bd297921-d608-4512-8c3e-2ec7439f0936", 
	"Справочник_Бригады", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Виды бюджетов';
					|en = 'Budget profiles'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "b159b10b-4ddc-4c04-a0bc-79716efde652", 
	"Справочник_ВидыБюджетов", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Виды работ сотрудников';
					|en = 'Employee activity kinds'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "294076d5-784c-405f-b5ff-cbb1363472c9", 
	"Справочник_ВидыРаботСотрудников", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Договоры аренды (лизинга)';
					|en = 'Rental (financial lease) contracts'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "1e77da49-a7f4-43e0-8aa0-f999bafcb1c7", 
	"Справочник_ДоговорыАренды", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'НМА и расходы на НИОКР';
					|en = 'Intangible assets and R&D expenses'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "9a376657-e800-49cc-822c-12f73cb43b5d", 
	"Справочник_НематериальныеАктивы", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Нефинансовые показатели бюджетов';
					|en = 'Non-financial items of budgets'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "40e12415-ec59-45e3-b25c-eaf2d880a6d7", 
	"Справочник_НефинансовыеПоказателиБюджетов", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Объекты строительства';
					|en = 'Assets under construction'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "e8235a22-2752-4e84-96c1-74512da4ae79", 
	"Справочник_ОбъектыСтроительства", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Объекты учета резервов предстоящих расходов';
					|en = 'Objects of provisions and contingent liabilities'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "d4ec47fc-c373-4e3e-8ebc-367b5bb292ec", 
	"Справочник_ОбъектыУчетаРезервовПредстоящихРасходов", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Партии производства';
					|en = 'Production lots'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "0b493c2f-1432-4bc5-b94a-8257cbfbe6eb", 
	"Справочник_ПартииПроизводства", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Показатели бюджетов';
					|en = 'Budget balance items'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "78b57f4f-93f2-487c-bcfa-8efa77c90003", 
	"Справочник_ПоказателиБюджетов", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Виды резервов и оценочных обязательств';
					|en = 'Types of provisions'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "7d340d32-0863-4e7d-a2b5-5bb8450c6f6b", 
	"Справочник_Резервы", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Ресурсные спецификации';
					|en = 'Bills of materials'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "4f1f948d-a242-4086-a0bc-7a2819813979", 
	"Справочник_РесурсныеСпецификации", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Статьи бюджетов';
					|en = 'Budget flow items'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "11ddb9cc-3508-4a40-a69b-9d5c4f9885a2", 
	"Справочник_СтатьиБюджетов", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Статьи калькуляции';
					|en = 'Product cost elements'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "5bdbbb97-9f58-4e0d-9515-53a408082ede", 
	"Справочник_СтатьиКалькуляции", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Темы, этапы исследований и разработок';
					|en = 'R&D topics, stages'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "2c0bfb5b-12e7-4b58-95f9-87b6707611fb", 
	"Справочник_ТемыЭтапыИсследованийИРазработок", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Этапы ресурсной спецификации';
					|en = 'Bill of materials stages'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "dae5dd83-1274-4f37-a9ca-8604bb97c3da", 
	"Справочник_ЭтапыПроизводства", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Способы отражения расходов';
					|en = 'Expense record methods'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "b83d56a8-e766-416b-add7-865e607e0cd2", 
	"Справочник_СпособыОтраженияРасходов", Наименование, КодыЯзыков);

	//++ НЕ УТКА

	//++ Локализация
	
	Наименование = "ru = 'Заказы на производство';
					|en = 'Production orders'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "1b289e3c-376b-4907-bcb7-168d39650a74", 
	"Документ_ЗаказНаПроизводство", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Маршрутные листы производства';
					|en = 'Production route sheets'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "9c55efd4-52e2-4c07-bdaa-acd6fa5c647b", 
	"Документ_МаршрутныйЛистПроизводства", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Плановые калькуляции';
					|en = 'Product standard costs'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "80959ec1-ba5e-4e27-92b1-0e9ab057d724", 
	"Документ_ПлановаяКалькуляция", Наименование, КодыЯзыков);
	//-- Локализация
	
	
	Наименование = "ru = 'Заказы давальцев';
					|en = 'Subcontracting sales orders'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "d6b0f9c2-16b7-40c6-ae8a-8ce7d89d71a2", 
	"Документ_ЗаказДавальца2_5", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Заказы на производство';
					|en = 'Production orders'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "2033a0f9-4544-4fd7-b9f0-39576d4436b2", 
	"Документ_ЗаказНаПроизводство2_2", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Список заказов на ремонт';
					|en = 'R&M order list'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "c814d3bb-6c98-4c47-9c58-b382d8dbde4d", 
	"Документ_ЗаказНаРемонт", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Отчеты давальцам';
					|en = 'Consumption reports — Subcontracting services delivered'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "21f43da9-1947-4e04-94e5-08a3a192c925", 
	"Документ_ОтчетДавальцу2_5", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Отчеты давальцам между организаций';
					|en = 'Intercompany consumption reports — Subcontracting services delivered'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "8002a98a-623d-4822-bdcf-54561124514c", 
	"Документ_ОтчетДавальцуМеждуОрганизациями", Наименование, КодыЯзыков);
	//++ Устарело_Переработка24
	
	Наименование = "ru = 'Возвраты сырья давальцам';
					|en = 'Returns to material providers'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "b6831ae6-e0c7-4b35-be6a-6b9ec7d4e11b", 
	"Документ_ВозвратСырьяДавальцу", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Заказы давальцев (2.4)';
					|en = 'Subcontracting sales orders (2.4)'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "df86a80c-383c-43e8-b7ae-170e3fd1f230", 
	"Документ_ЗаказДавальца", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Отчеты давальцам (2.4)';
					|en = 'Consumption reports — Subcontracting services delivered (2.4)'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "edf76781-9392-4f9a-abfd-b84b13b7501a", 
	"Документ_ОтчетДавальцу", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Передачи давальцам';
					|en = 'Goods issues — Subcontracting services delivered'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "dbbe1537-894a-4d99-a0b5-a587a512875a", 
	"Документ_ПередачаДавальцу", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Поступления сырья от давальцев';
					|en = 'Supplies from material providers'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "7f8f9d7a-7c04-4e31-81ba-14a2affd127f", 
	"Документ_ПоступлениеСырьяОтДавальца", Наименование, КодыЯзыков);
	//-- Устарело_Переработка24
	
	Наименование = "ru = 'Разрешения на замену материалов';
					|en = 'Engineering change orders'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "ee594808-3f12-454a-8e83-d2bde4e43e23", 
	"Документ_РазрешениеНаЗаменуМатериалов", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Сменные задания';
					|en = 'Shift tasks'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "ca69dd34-efe1-4768-86f0-0fb4a6292cc0", 
	"Документ_СменноеЗадание", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Этапы производства';
					|en = 'Production stages'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "92d08fd3-4d0a-4922-887a-86ef4e313706", 
	"Документ_ЭтапПроизводства2_2", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Виды рабочих центров';
					|en = 'Work center types'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "a070ee7e-3dca-471b-a0d4-a49bfed42c83", 
	"Справочник_ВидыРабочихЦентров", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Маршрутные карты';
					|en = 'Route sheets'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "7d45c880-b9e6-46da-a6cb-a558f14f6bde", 
	"Справочник_МаршрутныеКарты", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Производственные участки';
					|en = 'Production sites'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "525c0f81-2e46-4946-83b4-dfff5fdd417b", 
	"Справочник_ПроизводственныеУчастки", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Рабочие центры';
					|en = 'Work centers'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "1b8687a8-d9eb-48d2-b32c-4a0b906f0457", 
	"Справочник_РабочиеЦентры", Наименование, КодыЯзыков);
	
	Наименование = "ru = 'Технологические операции';
					|en = 'Manufacturing operations'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "4866c0e3-b01b-4b40-a78e-a7af83da2f79", 
	"Справочник_ТехнологическиеОперации", Наименование, КодыЯзыков);
	//-- НЕ УТКА
