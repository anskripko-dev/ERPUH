...
Функция ЗаголовокРеквизитаПартнерВЗависимостиОтХозяйственнойОперации(ХозяйственнаяОперация, ОбратнаяОперация = Ложь) Экспорт
	...
	ИначеЕсли ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ПередачаНаХранениеСПравомПродажи Тогда
		ЗаголовокПартнер = ?(Не ОбратнаяОперация, НСтр("ru = 'Хранитель';
														|en = 'Custodian'"), НСтр("ru = 'Клиент';
																				|en = 'Customer'"));
	...
	ИначеЕсли ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ВыкупТоваровДавальца Тогда
		ЗаголовокПартнер = НСтр("ru = 'Давалец';
								|en = 'Material provider'");
	ИначеЕсли ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ПередачаДавальцу2_5 Тогда
		ЗаголовокПартнер = НСтр("ru = 'Давалец';
								|en = 'Material provider'");
	...
	ИначеЕсли ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.СписаниеТоваровУПереработчика Тогда
		ЗаголовокПартнер = НСтр("ru = 'Переработчик';
								|en = 'Subcontractor'");
	ИначеЕсли ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ПересортицаТоваровУПереработчика Тогда
		ЗаголовокПартнер = НСтр("ru = 'Переработчик';
								|en = 'Subcontractor'");
	ИначеЕсли ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ПорчаТоваровУПереработчика Тогда
		ЗаголовокПартнер = НСтр("ru = 'Переработчик';
								|en = 'Subcontractor'");
	//-- НЕ УТ
	ИначеЕсли ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ПоставкаПодПринципала Тогда
		ЗаголовокПартнер = ?(Не ОбратнаяОперация, НСтр("ru = 'Клиент';
														|en = 'Customer'"), НСтр("ru = 'Принципал';
																				|en = 'Principal'"));
