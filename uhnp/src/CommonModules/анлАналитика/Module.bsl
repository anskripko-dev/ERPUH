...
// 
// Возвращаемое значение:
//  Схема 1С:Аналитика - Схема 1С:Аналитика, загруженные с сервера, отобранные с учетом владельца.
//
...
// 
// Возвращаемое значение:
//  Двоичные данные - Двоичные данные схемы 1С:Аналитика.
//
...
// 
// Параметры:
//  МассивВсехПапок - Массив - Массив  папок дерева поставляемых панелей 1С:Аналитика.
//  ИдентификаторПанели - Строка - Идентификатор поставляемой панели 1С:Аналитика.
//  МассивИдентификаторовКаталогов - Массив - Массив идентификаторов папок дерева поставляемых панелей 1С:Аналитика.
//
...
// 
// Возвращаемое значение:
//  Двоичные данные - Двоичные данные структуры поставляемой панели 1С:Аналитика.
//
...
Функция ОпубликоватьПанельДляВсехПользователей(Каталоги, КорневойКаталог, МассивИдентификаторовДляОбщейПапки);
	...
	Если ОбщаяПапка = Неопределено Или ОбщаяПапка.ОбъектСхемы["ownerName"] = Неопределено Тогда
		...
		ОбъектСхемыОбщегоКаталога["data"]		= анлАналитика.ЗначениеВJSON(СоответствиеОбщегоКаталога);
	...
	Иначе
		...
		СоответствиеОбщегоКаталога = анлАналитика.JSONВЗначение(ОбъектСхемыОбщегоКаталога["data"]);
