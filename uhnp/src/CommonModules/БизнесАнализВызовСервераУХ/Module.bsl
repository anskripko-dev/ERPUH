...
Функция ПолучитьАдресТаблицыДинамики(Показатель, Контекст, ИмяОперанда = "") Экспорт
	РезультатФункции = Справочники.УдалитьПанелиОтчетов.ПолучитьАдресТаблицыДинамики(Показатель, Контекст, ИмяОперанда);
...
Процедура ДобавитьЭлементыФормыДляМонитораПоказателя(Форма, Владелец, Знач ИмяОтчета, Знач ОтображениеМонитора, Знач НаименованиеОкна) Экспорт
	...
	ПолеПанельОтборов = Форма.Элементы.Добавить(ИмяОтчета + "_ПанельОтборов", Тип("ГруппаФормы"), Владелец); // ГруппаФормы
	...
	Если СтруктураОтображения.ОтображатьКарту И СтруктураОтображения.ОтображатьТаблицу Тогда
		...
		ПанельМонитора     = Форма.Элементы.Добавить(ИмяОтчета + "_Страницы", Тип("ГруппаФормы"), Владелец); // ГруппаФормы
		ПанельМонитора.Вид = ВидГруппыФормы.Страницы;
		ПанельМонитора.ОтображениеСтраниц = ОтображениеСтраницФормы.ЗакладкиСнизу;
		СтраницаКарта      = Форма.Элементы.Добавить(ИмяОтчета + "_СтраницаКарта", Тип("ГруппаФормы"), ПанельМонитора); // ГруппаФормы
		СтраницаКарта.Вид  = ВидГруппыФормы.Страница;
		СтраницаКарта.Заголовок = Нстр("ru = 'Карта показателей'");
		СтраницаМонитор     = Форма.Элементы.Добавить(ИмяОтчета + "_СтраницаМонитор", Тип("ГруппаФормы"), ПанельМонитора); // ГруппаФормы
	...
	Если СтруктураОтображения.ОтображатьКарту Тогда
		...
		ПолеФормы = Форма.Элементы.Добавить(ИмяОтчета + "_Окно", Тип("ПолеФормы"), ?(СтруктураОтображения.ОтображатьТаблицу, СтраницаКарта, Владелец)); // ПолеФормы
	...
	Если СтруктураОтображения.ОтображатьТаблицу Тогда
		...
		ЭлементОтчета = Форма.Элементы.Добавить(ИмяОтчета + "_Показатель", Тип("ПолеФормы"), ЭлементТаблица); // ПолеФормы
		ЭлементОтчета.Вид = ВидПоляФормы.ПолеВвода;
		ЭлементОтчета.ПутьКДанным = ИмяОтчета + "." + ИмяОтчета + "_Показатель";
		
		ЭлементОтчета = Форма.Элементы.Добавить(ИмяОтчета + "_Состояние", Тип("ПолеФормы"), ЭлементТаблица); // ПолеФормы
		...
		ЭлементОтчета = Форма.Элементы.Добавить(ИмяОтчета + "_Тренд", Тип("ПолеФормы"), ЭлементТаблица); // ПолеФормы
		ЭлементОтчета.Вид = ВидПоляФормы.ПолеКартинки;
		ЭлементОтчета.ПутьКДанным = ИмяОтчета + "." + ИмяОтчета + "_Тренд";
		ЭлементОтчета.ГоризонтальноеПоложение = ГоризонтальноеПоложениеЭлемента.Центр;
		
		ЭлементОтчета = Форма.Элементы.Добавить(ИмяОтчета + "_Ответственный", Тип("ПолеФормы"), ЭлементТаблица); // ПолеФормы
		ЭлементОтчета.Вид = ВидПоляФормы.ПолеВвода;
		...
		ГруппаКолонок_ФактическоеЗначение                  = Форма.Элементы.Добавить(ИмяОтчета + "_ГруппаЗначение", Тип("ГруппаФормы"), ЭлементТаблица); // ГруппаФормы
		ГруппаКолонок_ФактическоеЗначение.Вид              = ВидГруппыФормы.ГруппаКолонок;
		ГруппаКолонок_ФактическоеЗначение.Заголовок        = Нстр("ru = 'Значение'");
		...
		ЭлементОтчета = Форма.Элементы.Добавить(ИмяОтчета + "_ФактическоеЗначениеТекущегоПериода", Тип("ПолеФормы"), ГруппаКолонок_ФактическоеЗначение); // ПолеФормы
		ЭлементОтчета.Вид = ВидПоляФормы.ПолеВвода;
		ЭлементОтчета.ПутьКДанным = ИмяОтчета + "." + ИмяОтчета + "_ФактическоеЗначениеТекущегоПериода";
		
		ЭлементОтчета = Форма.Элементы.Добавить(ИмяОтчета + "_ФактическоеЗначениеПредыдущегоПериода", Тип("ПолеФормы"), ГруппаКолонок_ФактическоеЗначение); // ПолеФормы
		ЭлементОтчета.Вид = ВидПоляФормы.ПолеВвода;
		ЭлементОтчета.ПутьКДанным = ИмяОтчета + "." + ИмяОтчета + "_ФактическоеЗначениеПредыдущегоПериода";
		
		ГруппаКолонок_Изменение                  = Форма.Элементы.Добавить(ИмяОтчета + "_ГруппаКолонок", Тип("ГруппаФормы"), ЭлементТаблица); // ГруппаФормы
		ГруппаКолонок_Изменение.Вид              = ВидГруппыФормы.ГруппаКолонок;
		ГруппаКолонок_Изменение.Заголовок        = Нстр("ru = 'Изменение'");
		...
		ЭлементОтчета = Форма.Элементы.Добавить(ИмяОтчета + "_ИзменениеАбсолютное", Тип("ПолеФормы"), ГруппаКолонок_Изменение); // ПолеФормы
		ЭлементОтчета.Вид = ВидПоляФормы.ПолеВвода;
		ЭлементОтчета.ГоризонтальноеПоложениеВШапке = ГоризонтальноеПоложениеЭлемента.Центр;
		ЭлементОтчета.ПутьКДанным = ИмяОтчета + "." + ИмяОтчета + "_ИзменениеАбсолютное";
		
		ЭлементОтчета = Форма.Элементы.Добавить(ИмяОтчета + "_ИзменениеОтносительное", Тип("ПолеФормы"), ГруппаКолонок_Изменение); // ПолеФормы
		ЭлементОтчета.Вид = ВидПоляФормы.ПолеВвода;
		ЭлементОтчета.ГоризонтальноеПоложениеВШапке = ГоризонтальноеПоложениеЭлемента.Центр;
		ЭлементОтчета.ПутьКДанным = ИмяОтчета + "." + ИмяОтчета + "_ИзменениеОтносительное";
		
		ЭлементОтчета = Форма.Элементы.Добавить(ИмяОтчета + "_ПлановоеЗначение", Тип("ПолеФормы"), ЭлементТаблица); // ПолеФормы
		ЭлементОтчета.Вид = ВидПоляФормы.ПолеВвода;
		ЭлементОтчета.ГоризонтальноеПоложениеВШапке = ГоризонтальноеПоложениеЭлемента.Центр;
		ЭлементОтчета.ПутьКДанным = ИмяОтчета + "." + ИмяОтчета + "_ПлановоеЗначение";
		
		ГруппаКолонок_План                  = Форма.Элементы.Добавить(ИмяОтчета + "_ОтклонениеОтПлана", Тип("ГруппаФормы"), ЭлементТаблица); // ГруппаФормы
		...
		ЭлементОтчета = Форма.Элементы.Добавить(ИмяОтчета + "_ОтклонениеОтПланаАбсолютное", Тип("ПолеФормы"), ГруппаКолонок_План); // ПолеФормы
		ЭлементОтчета.Вид = ВидПоляФормы.ПолеВвода;
		ЭлементОтчета.ГоризонтальноеПоложениеВШапке = ГоризонтальноеПоложениеЭлемента.Центр;
		ЭлементОтчета.ПутьКДанным = ИмяОтчета + "." + ИмяОтчета + "_ОтклонениеОтПланаАбсолютное";
		
		ЭлементОтчета = Форма.Элементы.Добавить(ИмяОтчета + "_ОтклонениеОтПланаОтносительное", Тип("ПолеФормы"), ГруппаКолонок_План); // ПолеФормы
		ЭлементОтчета.Вид = ВидПоляФормы.ПолеВвода;
		ЭлементОтчета.ГоризонтальноеПоложениеВШапке = ГоризонтальноеПоложениеЭлемента.Центр;
		ЭлементОтчета.ПутьКДанным = ИмяОтчета + "." + ИмяОтчета + "_ОтклонениеОтПланаОтносительное";
		
		ЭлементОтчета = Форма.Элементы.Добавить(ИмяОтчета + "_ПроцентВыполненияПлана", Тип("ПолеФормы"), ЭлементТаблица); // ПолеФормы
		ЭлементОтчета.Вид = ВидПоляФормы.ПолеВвода;
		ЭлементОтчета.ГоризонтальноеПоложениеВШапке = ГоризонтальноеПоложениеЭлемента.Центр;
...
Функция ПолучитьСтруктуруОбъектаРасчета(Показатель, Операнд, Контекст, СтруктураОтборов, УникальныйИдентификатор, ИмяОперанда = "") Экспорт
	...
	АдресТаблицыРасшифровки = Справочники.УдалитьПанелиОтчетов.ПолучитьАдресТаблицыРасшифровкиПоАналитикам(Показатель, Контекст);
	...
	ПараметрыНастроек = УправлениеОтчетамиУХ.ПараметрыНастроекОбработкиШаблонов(РезультатФункции);
