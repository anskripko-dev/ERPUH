...
//Функция получает наименование системного пользователя "Бот задач и оповещений"
//
Функция ПолучитьПредставлениеБотаЗадачИОповещений() Экспорт
	
	Возврат НСтр("ru = 'Бот задач и оповещений'", ОбщегоНазначения.КодОсновногоЯзыка());
