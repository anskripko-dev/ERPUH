...
Функция ИнтервалПланированияСтрокой(Период, ИнтервалПланирования) Экспорт
	...
	ИначеЕсли ИнтервалПланирования = Перечисления.ТочностьГрафикаПроизводства.Смена Тогда
		ПериодСтрока = Формат(Период, НСтр("ru = 'ДФ=''dd MMMM HH:mm''';
											|en = 'ДФ=''дд ММММ ЧЧ:мм'''"));
	...
	ИначеЕсли ИнтервалПланирования = Перечисления.ТочностьГрафикаПроизводства.Неделя Тогда
		ПериодСтрока = Формат(Период, НСтр("ru = 'ДФ=''dd.MM.yy''';
											|en = 'ДФ=''дд.ММ.гг'''")) + " - " + Формат(КонецНедели(Период), НСтр("ru = 'ДФ=''dd.MM.yy''';
																												|en = 'ДФ=''дд.ММ.гг'''"));
...
//
// Параметры:
//  ТабличнаяЧасть - ДокументТабличнаяЧасть.МаршрутныйЛистПроизводства.МатериалыИУслуги,
//    ДокументТабличнаяЧасть.МаршрутныйЛистПроизводства.ВыходныеИзделия,
//    ДокументТабличнаяЧасть.МаршрутныйЛистПроизводства.ВозвратныеОтходы,
//    ДокументТабличнаяЧасть.МаршрутныйЛистПроизводства.Трудозатраты - табличная часть для обработки.
...
//
Процедура ПересчитатьКоличествоТабличнойЧасти(ТабличнаяЧасть, Коэффициент, ЕстьУпаковки, СуффиксКоличество = Неопределено, СуффиксКоличествоНорматив = Неопределено) Экспорт
