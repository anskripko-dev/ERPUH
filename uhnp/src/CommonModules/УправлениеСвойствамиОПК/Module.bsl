...
Процедура ПриПолученииПредопределенныхНаборовСвойств(Наборы) Экспорт
	...
	Набор = Наборы.Строки.Добавить();
	Набор.Имя = "Документ_УдалитьЗаявкаНаКорректировкуЛимитов";
	Набор.Идентификатор = Новый УникальныйИдентификатор("32180bc1-94a5-451f-826c-04b209ed4fe7");   	
	
	Набор = Наборы.Строки.Добавить();
	Набор.Имя = "Документ_УдалитьКорректировкаЛимитов";
	...
	//Если НЕ ЕстьПредопределенныйНаборДопРеквизитовСведений(ИмяНабора) 
	//	И Наборы.Строки.Найти(ИмяНабора) = Неопределено Тогда
	//	Набор = Наборы.Строки.Добавить();
	//	Набор.Имя = ИмяНабора;
