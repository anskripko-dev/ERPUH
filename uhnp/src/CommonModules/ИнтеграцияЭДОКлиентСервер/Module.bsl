...
Функция ВидОшибкиОбновлениеВерсииЭДЗакрытПринудительно() Экспорт
	...
	ОписаниеРешения = НСтр("ru = '<a href = ""%1"">Создайте</a> новый электронный документ';
							|en = '<a href = ""%1"">Create</a> new electronic document'");
	ВидОшибки.ОписаниеРешения = СтрШаблон(ОписаниеРешения, "Создайте");
...
Функция ВидОшибкиОбновлениеВерсииЭДСформированоИсправление() Экспорт
	...
	ВидОшибки.ОписаниеПроблемы = НСтр("ru = 'Были изменены ключевые реквизиты, участвующие в электронном документообороте';
										|en = 'The key attributes involved in Electronic Data Interchange have been changed'");
	ОписаниеРешения = НСтр("ru = '<a href = ""%1"">Сформировать</a> исправление электронного документа';
							|en = '<a href = ""%1"">Generate</a> electronic document correction'");
	ВидОшибки.ОписаниеРешения = СтрШаблон(ОписаниеРешения, "Сформировать");
...
Функция ВидОшибкиОбновлениеВерсииЭДТребуетсяАннулирование() Экспорт
	...
	ВидОшибки.ОписаниеПроблемы = НСтр("ru = 'Были изменены ключевые реквизиты, участвующие в электронном документообороте';
										|en = 'The key attributes involved in Electronic Data Interchange have been changed'");
	ОписаниеРешения = НСтр("ru = '<a href = ""%1"">Аннулируйте старый и создайте</a> новый электронный документ';
							|en = '<a href = ""%1"">Cancel the old one and create</a> a new electronic document'");
	ВидОшибки.ОписаниеРешения = СтрШаблон(ОписаниеРешения, "Создайте");
