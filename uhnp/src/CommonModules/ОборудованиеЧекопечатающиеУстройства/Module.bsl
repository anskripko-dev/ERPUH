...
Процедура ОбновитьПоставляемыеДрайвера(ДрайвераОборудования) Экспорт
	...
	Драйвер.Наименование = НСтр("ru = 'АТОЛ:ККТ с передачей данных в ОФД 10.x (ФФД 1.2) УСН НДС';
								|en = 'ATOL:Cash register with data transfer to FDO 10.X (FDF 1.2) STS VAT'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'АТОЛ:ККТ с передачей данных в ОФД 10.10.8.х';
								|en = 'АТОЛ:ККТ с передачей данных в ОФД 10.10.8.х'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'ПОСЦЕНТР:ККТ с передачей данных в ОФД NG';
								|en = 'ПОСЦЕНТР:ККТ с передачей данных в ОФД NG'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Мультисофт:Драйвер фискального ядра MSPOS';
								|en = 'Мультисофт:Драйвер фискального ядра MSPOS'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'ПОСЦЕНТР:ККТ с передачей данных в ОФД';
								|en = 'ПОСЦЕНТР:ККТ с передачей данных в ОФД'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'ККС:ККТ с передачей данных в ОФД (ФФД 1.2) УСН НДС';
								|en = 'KKS:Cash register with data transfer to FDO (FDF 1.2) STS VAT'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());    
	...
	Драйвер.Наименование = НСтр("ru = 'Дримкас:ККТ с передачей данных в ОФД';
								|en = 'Дримкас:ККТ с передачей данных в ОФД'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Инитпро:ККТ с передачей данных в ОФД (ФФД 1.2)';
								|en = 'Инитпро:ККТ с передачей данных в ОФД (ФФД 1.2)'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Эвотор:ККТ с передачей данных в ОФД (ФФД 1.2) УСН НДС';
								|en = 'Evotor:Cash register with data transfer to FDO (FDF 1.2) STS VAT'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	Драйвер.ИдентификаторОбъекта = "EvoKKMExtension47"; 
	
	Драйвер = ДрайвераОборудования.Добавить();
	Драйвер.ТипОборудования = Перечисления.ТипыПодключаемогоОборудования.ККТ;
	Драйвер.ИмяДрайвера  = "ДрайверИнкотексККТ54ФЗФФ12";
	Драйвер.Наименование = НСтр("ru = 'Инкотекс:ККТ с передачей данных в ОФД';
								|en = 'Инкотекс:ККТ с передачей данных в ОФД'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	Драйвер.ИдентификаторОбъекта = "INCOTEX_KKT_FFD12";   
	
	Драйвер = ДрайвераОборудования.Добавить();
	Драйвер.ТипОборудования = Перечисления.ТипыПодключаемогоОборудования.ККТ;
	Драйвер.ИмяДрайвера  = "ДрайверИнкотексККТ54ФЗМ";
	Драйвер.Наименование = НСтр("ru = 'Инкотекс:ККТ с передачей данных в ОФД серия М';
								|en = 'Инкотекс:ККТ с передачей данных в ОФД серия М'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	Драйвер.ИдентификаторОбъекта = "INCOTEX_KKT_V4";   
	
	Драйвер = ДрайвераОборудования.Добавить();
	Драйвер.ТипОборудования = Перечисления.ТипыПодключаемогоОборудования.ККТ;
	Драйвер.ИмяДрайвера  = "ДрайверНЕВА54ФЗ4ФФД12";
	Драйвер.Наименование = НСтр("ru = 'НЕВА:ККТ с передачей данных в ОФД';
								|en = 'НЕВА:ККТ с передачей данных в ОФД'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	Драйвер.ИдентификаторОбъекта = "NevaFiscalCoreCEL";      
	
	Драйвер = ДрайвераОборудования.Добавить();
	Драйвер.ТипОборудования = Перечисления.ТипыПодключаемогоОборудования.ККТ;
	Драйвер.ИмяДрайвера  = "ДрайверMitsu54ФЗ4ФФД12";
	Драйвер.Наименование = НСтр("ru = 'Mitsu:ККТ с передачей данных в ОФД (ФФД 1.2) УСН НДС';
								|en = 'Mitsu:Cash register with data transfer to FDO (FDF 1.2) STS VAT'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	Драйвер.ИдентификаторОбъекта = "fr_mitsu1c8x4n";        
	
	Драйвер = ДрайвераОборудования.Добавить();
	Драйвер.ТипОборудования = Перечисления.ТипыПодключаемогоОборудования.ККТ;
	Драйвер.ИмяДрайвера  = "ДрайверРРЭлектроККТ54ФЗ4ФФД12";
	Драйвер.Наименование = НСтр("ru = 'РР-Электро:ККТ с передачей данных в ОФД';
								|en = 'РР-Электро:ККТ с передачей данных в ОФД'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	Драйвер.ИдентификаторОбъекта = "RRDrvFR1C4";        
	
	Драйвер = ДрайвераОборудования.Добавить();
	Драйвер.ТипОборудования = Перечисления.ТипыПодключаемогоОборудования.ККТ;
	Драйвер.ИмяДрайвера  = "ДрайверККТКассатка54ФЗ";
	Драйвер.Наименование = НСтр("ru = 'Кассатка:ККТ с передачей данных Кассир-80Ф';
								|en = 'Кассатка:ККТ с передачей данных Кассир-80Ф'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	Драйвер.ИдентификаторОбъекта = "1KKKT";       
	
	Драйвер = ДрайвераОборудования.Добавить();
	Драйвер.ТипОборудования = Перечисления.ТипыПодключаемогоОборудования.ККТ;
	Драйвер.ИмяДрайвера  = "ДрайверККТТорговыйБаланс54ФЗ";
	Драйвер.Наименование = НСтр("ru = 'Торговый Баланс:ККТ с передачей данных в ОФД';
								|en = 'Торговый Баланс:ККТ с передачей данных в ОФД'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
		...
		Исключение
			ОбщегоНазначенияБПО.ЗаписатьОшибкуВЖурналРегистрации(
				НСтр("ru = 'Запись фискальной операции чека коррекции сторно';
					|en = 'Record fiscal transaction of cash register adjustment voucher storno'"), 
				ОбработкаОшибок.ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		КонецПопытки;
	КонецЕсли;
	...
	Исключение
		ОбщегоНазначенияБПО.ЗаписатьОшибкуВЖурналРегистрации(
			НСтр("ru = 'Запись фискальной операции чека коррекции';
				|en = 'Record fiscal transaction of cash register adjustment voucher'"), 
			ОбработкаОшибок.ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
	КонецПопытки;
		...
		ИначеЕсли ПараметрыККТ.Свойство("ВерсияФФДККТ") И ПараметрыККТ.ВерсияФФДККТ = "1.2" И ВедетсяУчетПродукцииИСМП Тогда
			Если НЕ ПараметрыККТ.ПродажаМаркированныхТоваров Тогда
				ТекстСообщения = НСтр("ru = 'ККТ не зарегистрирована для работы с маркированной продукцией.';
										|en = 'The cash register is not registered for marked product operations.'") + Символы.ПС 
				+ НСтр("ru = 'Необходимо провести перерегистрацию ККТ.';
						|en = 'Re-register the cash register.'"); 
				ОбщегоНазначенияБПО.СообщитьПользователю(ТекстСообщения);
			КонецЕсли;
		КонецЕсли;
	Иначе
	...
	Исключение
		ОбщегоНазначенияБПО.ЗаписатьОшибкуВЖурналРегистрации(
			НСтр("ru = 'Запись фискальной операции инкассация';
				|en = 'Record fiscal transaction cash deposit/withdrawal'"), 
			ОбработкаОшибок.ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
	КонецПопытки;
