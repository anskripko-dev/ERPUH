...
// Проверяет наличие у пользователя роли ПередачаМатериаловВПроизводствоСверхЗаказа
// Параметры:
// 	Пользователь - ПользовательИнформационнойБазы
// Возвращаемое значение:
//	Булево - наличие роли
...
// Проверяет наличие у пользователя роли РедактированиеПроизвольныхИсточниковДанныхБюджетирования
// Параметры:
// 	Пользователь - ПользовательИнформационнойБазы
// Возвращаемое значение:
//	Булево - наличие роли
...
Функция РазрешитьОформлениеВыпускаЗаднимЧислом(Пользователь = Неопределено) Экспорт
	...
	Результат = Ложь;
	//++ НЕ УТ
	Результат = Пользователи.РолиДоступны("РазрешитьОформлениеВыпускаЗаднимЧислом", Пользователь, Ложь);
	//-- НЕ УТ
...
// Проверяет наличие у пользователя роли ОтключитьКонтрольПередачиПродукцииПереработчиком
// Параметры:
// 	Пользователь - ПользовательИнформационнойБазы
// Возвращаемое значение:
//	Булево - наличие роли
...
// Проверяет наличие у пользователя роли ОтключитьКонтрольПередачиПродукцииДавальцу
// Параметры:
// 	Пользователь - ПользовательИнформационнойБазы
// Возвращаемое значение:
//	Булево - наличие роли
