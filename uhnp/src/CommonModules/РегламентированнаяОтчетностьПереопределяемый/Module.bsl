...
Функция ПолучитьСведенияОФизЛице(Знач ФизЛицо, Знач МассивПоказателей = Неопределено, Знач ДатаЗначения = Неопределено) Экспорт
	#Область УХ_Встраивание_МСО
	
	Если ТипЗнч(ФизЛицо) = Тип("Структура") Тогда
		Возврат Новый Структура("ТелефонРабочий, ТелефонДомашний, АдресЭлектроннойПочты");
	КонецЕсли;
...
Функция ПолучитьСведенияОПоказателяхОтчета(ИДОтчета, ИДРедакцииОтчета, ПараметрыОтчета = Неопределено) Экспорт
	...
	#Область УХ_ВстраиваниеКИК
	ИначеЕсли ИДОтчета = "РегламентированноеУведомлениеКИК" И ОбщегоНазначения.ПодсистемаСуществует("ПодсистемыУХ.ИнтеграцияКИК") Тогда
		МодульУХ = ОбщегоНазначения.ОбщийМодуль("РегламентированнаяОтчетностьКИК");
		МодульУХ.ПолучитьСведенияОПоказателяхКИК(ИДРедакцииОтчета, ПоказателиОтчета, ПараметрыОтчета);
	#КонецОбласти
	#Область УХ_ВстраиваниеМСО
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетСтрановойОтчет" И ОбщегоНазначения.ПодсистемаСуществует("ПодсистемыУХ.ИнтеграцияМежстрановаяОтчетность") Тогда
		МодульУХ = ОбщегоНазначения.ОбщийМодуль("РегламентированнаяОтчетностьМСО");
		МодульУХ.ПолучитьСведенияОПоказателяхСтрановойОтчет(ИДРедакцииОтчета, ПоказателиОтчета, ПараметрыОтчета);
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетУчастиеВМеждународнойГруппеКомпаний" И ОбщегоНазначения.ПодсистемаСуществует("ПодсистемыУХ.ИнтеграцияМежстрановаяОтчетность") Тогда
		МодульУХ = ОбщегоНазначения.ОбщийМодуль("РегламентированнаяОтчетностьМСО");
		МодульУХ.ПолучитьСведенияОПоказателяхУчастиеВМеждународнойГруппеКомпаний(ИДРедакцииОтчета, ПоказателиОтчета, ПараметрыОтчета);
	#КонецОбласти
	#Область УХ_ВстраиваниеНМ
	ИначеЕсли ИДОтчета = "РегламентированноеУведомлениеРискиОрганизацииНалоговыйМониторинг" И ОбщегоНазначения.ПодсистемаСуществует("ПодсистемыУХ.ИнтеграцияНалоговыйМониторинг") Тогда
		МодульУХ = ОбщегоНазначения.ОбщийМодуль("РегламентированнаяОтчетностьНМ");
		МодульУХ.ПолучитьСведенияОПоказателяхРискиОрганизацииНалоговыйМониторинг(ИДРедакцииОтчета, ПоказателиОтчета, ПараметрыОтчета);
	ИначеЕсли ИДОтчета = "РегламентированноеУведомлениеМатрицаРисковКП" И ОбщегоНазначения.ПодсистемаСуществует("ПодсистемыУХ.ИнтеграцияНалоговыйМониторинг") Тогда
		МодульУХ = ОбщегоНазначения.ОбщийМодуль("РегламентированнаяОтчетностьНМ");
		МодульУХ.ПолучитьСведенияОПоказателяхМатрицаРисковКП(ИДРедакцииОтчета, ПоказателиОтчета, ПараметрыОтчета);
	ИначеЕсли ИДОтчета = "РегламентированноеУведомлениеКонтрольныеПроцедуры" И ОбщегоНазначения.ПодсистемаСуществует("ПодсистемыУХ.ИнтеграцияНалоговыйМониторинг") Тогда
		МодульУХ = ОбщегоНазначения.ОбщийМодуль("РегламентированнаяОтчетностьНМ");
		МодульУХ.ПолучитьСведенияОПоказателяхКонтрольныеПроцедуры(ИДРедакцииОтчета, ПоказателиОтчета, ПараметрыОтчета);
	ИначеЕсли ИДОтчета = "РегламентированноеУведомлениеРезультатыВыполнения" И ОбщегоНазначения.ПодсистемаСуществует("ПодсистемыУХ.ИнтеграцияНалоговыйМониторинг") Тогда
		МодульУХ = ОбщегоНазначения.ОбщийМодуль("РегламентированнаяОтчетностьНМ");
		МодульУХ.ПолучитьСведенияОПоказателяхРезультатыВыполнения(ИДРедакцииОтчета, ПоказателиОтчета, ПараметрыОтчета);
	#КонецОбласти
...
Процедура ЗаполнитьОтчет(ИДОтчета, ИДРедакцииОтчета, ПараметрыОтчета, Контейнер) Экспорт
	...
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетПрибыль" Тогда
		...
		Иначе
			...
			КонецЕсли;
			#Область УХ_Встраивание_КИК
			Если ОбщегоНазначения.ПодсистемаСуществует("ПодсистемыУХ.ИнтеграцияКИК") Тогда
				МодульУХ = ОбщегоНазначения.ОбщийМодуль("РегламентированнаяОтчетностьКИК");
				МодульУХ.ЗаполнитьРегламентированныйОтчетНалогНаПрибыль(ПараметрыОтчета, Контейнер, ТаблицаРасшифровки, ИДРедакцииОтчета);
			КонецЕсли;
			#КонецОбласти
	...
	#Область УХ_Встраивание_КИК
	ИначеЕсли ИДОтчета = "РегламентированноеУведомлениеКИК" И ОбщегоНазначения.ПодсистемаСуществует("ПодсистемыУХ.ИнтеграцияКИК") Тогда
		Если ИДРедакцииОтчета = "Форма2021_1" Тогда
			МодульУХ = ОбщегоНазначения.ОбщийМодуль("РегламентированнаяОтчетностьКИК");
			МодульУХ.ЗаполнитьРегламентированныйОтчетКИК(ПараметрыОтчета, Контейнер);
		КонецЕсли;
	#КонецОбласти
    #Область УХ_Встраивание_МСО
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетСтрановойОтчет" И ОбщегоНазначения.ПодсистемаСуществует("ПодсистемыУХ.ИнтеграцияМежстрановаяОтчетность") Тогда
		МодульУХ = ОбщегоНазначения.ОбщийМодуль("РегламентированнаяОтчетностьМСО");
		МодульУХ.ЗаполнитьСтрановойОтчет(ПараметрыОтчета, Контейнер);
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетУчастиеВМеждународнойГруппеКомпаний" И ОбщегоНазначения.ПодсистемаСуществует("ПодсистемыУХ.ИнтеграцияМежстрановаяОтчетность") Тогда
		МодульУХ = ОбщегоНазначения.ОбщийМодуль("РегламентированнаяОтчетностьМСО");
		МодульУХ.ЗаполнитьУчастиеВМеждународнойГруппеКомпаний(ПараметрыОтчета, Контейнер);
	#КонецОбласти
	#Область УХ_Встраивание_НМ
	ИначеЕсли ИДОтчета = "РегламентированноеУведомлениеМатрицаРисковКП" И ОбщегоНазначения.ПодсистемаСуществует("ПодсистемыУХ.ИнтеграцияНалоговыйМониторинг") Тогда
		МодульУХ = ОбщегоНазначения.ОбщийМодуль("РегламентированнаяОтчетностьНМ");
		МодульУХ.ЗаполнитьМатрицуРисковКП(ПараметрыОтчета, Контейнер);
	ИначеЕсли ИДОтчета = "РегламентированноеУведомлениеРезультатыВыполнения" И ОбщегоНазначения.ПодсистемаСуществует("ПодсистемыУХ.ИнтеграцияНалоговыйМониторинг") Тогда
		МодульУХ = ОбщегоНазначения.ОбщийМодуль("РегламентированнаяОтчетностьНМ");
		МодульУХ.ЗаполнитьРезультатыВыполнения(ПараметрыОтчета, Контейнер);
	ИначеЕсли ИДОтчета = "РегламентированноеУведомлениеРискиОрганизацииНалоговыйМониторинг" И ОбщегоНазначения.ПодсистемаСуществует("ПодсистемыУХ.ИнтеграцияНалоговыйМониторинг") Тогда
		МодульУХ = ОбщегоНазначения.ОбщийМодуль("РегламентированнаяОтчетностьНМ");
		МодульУХ.ЗаполнитьРискиОрганизацииНалоговыйМониторинг(ПараметрыОтчета, Контейнер);
	ИначеЕсли ИДОтчета = "РегламентированноеУведомлениеКонтрольныеПроцедуры" И ОбщегоНазначения.ПодсистемаСуществует("ПодсистемыУХ.ИнтеграцияНалоговыйМониторинг") Тогда
		МодульУХ = ОбщегоНазначения.ОбщийМодуль("РегламентированнаяОтчетностьНМ");
		МодульУХ.ЗаполнитьКонтрольныеПроцедуры(ПараметрыОтчета, Контейнер);
	#КонецОбласти	
	Иначе
...
Процедура ПриСозданииФормыРеглОтчета(ИмяОтчета, ИмяФормы, Форма) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ПодсистемыУХ.ИнтеграцияНалоговыйМониторинг") Тогда
		...
		ОбщегоНазначения.ВыполнитьМетодКонфигурации("НалоговыйМониторингВызовСервера.ФормаРегламентированнойОтчетности_ПриСозданииНаСервере", Параметры);
	КонецЕсли;
	#КонецОбласти
КонецПроцедуры
...
Функция ПолучитьСписокРегламентированныхОтчетов() Экспорт
	...
	#Область УХ_Встраивание_БРО
	Если ОбщегоНазначения.ПодсистемаСуществует("ПодсистемыУХ.ИнтеграцияМежстрановаяОтчетность") Тогда
		СписокРегламентированныхОтчетов.Добавить("РегламентированныйОтчетСтрановойОтчет");
		СписокРегламентированныхОтчетов.Добавить("РегламентированныйОтчетУчастиеВМеждународнойГруппеКомпаний");
		СписокРегламентированныхОтчетов.Добавить("РегламентированноеУведомлениеКИК");
	КонецЕсли;
	#КонецОбласти
