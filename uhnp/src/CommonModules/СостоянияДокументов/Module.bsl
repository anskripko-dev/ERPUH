...
Функция РегистрыКОтражениюСостоянияЗаказов() Экспорт
	...
	//++ НЕ УТКА
	Параметры.Вставить("СостоянияЭтаповПроизводства",    Ложь);
	Параметры.Вставить("СостоянияЗаказовНаПроизводство", Ложь);
	//-- НЕ УТКА
...
Функция ОбслуживаемыеРегистры(РегистрыКОтражениюСостоянияЗаказов = Неопределено)
	...
	Если РегистрыКОтражениюСостоянияЗаказов = Неопределено Тогда
		...
		МассивРегистров.Добавить(Метаданные.РегистрыСведений.СостоянияЗаказовНаПроизводство.Имя);
		//-- НЕ УТКА
	...
	Иначе
		...
		//++ НЕ УТКА
		Если РегистрыКОтражениюСостоянияЗаказов.СостоянияЭтаповПроизводства Тогда
			МассивРегистров.Добавить(Метаданные.РегистрыСведений.СостоянияЭтаповПроизводства.Имя);
		КонецЕсли;
		
		Если РегистрыКОтражениюСостоянияЗаказов.СостоянияЗаказовНаПроизводство Тогда
			МассивРегистров.Добавить(Метаданные.РегистрыСведений.СостоянияЗаказовНаПроизводство.Имя);
		КонецЕсли;
		//-- НЕ УТКА
