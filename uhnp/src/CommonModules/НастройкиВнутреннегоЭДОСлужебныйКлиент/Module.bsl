...
Функция ВидОшибкиНеУстановленаПечатнаяФормаПоУмолчаниюВнутреннийЭДО()
	...
	ОписаниеРешения = НСтр("ru = '<a href = ""%1"">Выберите</a> печатную форму, которую следует использовать по умолчанию';
							|en = '<a href = ""%1"">Select</a>a default print form'");
	ВидОшибки.ОписаниеРешения = СтрШаблон(ОписаниеРешения, "Выберите");
