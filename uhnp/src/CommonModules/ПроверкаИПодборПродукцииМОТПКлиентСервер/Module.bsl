...
Функция ДопустимыеВложенияАгрегатовПоВидамПродукции() Экспорт
	...
	ДопустимыеВложенияАгретовАТП.Вставить(ПредопределенноеЗначение("Перечисление.ТипыШтрихкодов.SSCC20"),        ВложенияПоТипуШтрихкодаSSCC);
	...
	ДопустимыеВложенияАгретовНСП.Вставить(ПредопределенноеЗначение("Перечисление.ТипыШтрихкодов.SSCC20"),        ВложенияПоТипуШтрихкодаSSCC);
	...
	ДопустимыеВложенияАгретовТабак.Вставить(ПредопределенноеЗначение("Перечисление.ТипыШтрихкодов.SSCC20"),        ВложенияПоТипуШтрихкодаSSCC);
