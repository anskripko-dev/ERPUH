...
Функция АнализТекстаОшибкиОборудования(ИдентификаторУстройства, Знач ПараметрыПодключения, Знач ТекстОшибки) Экспорт
	...
	ИначеЕсли Не ДрайверПоставляетсяВКонфигурации Тогда
		...
		ПодробноеОписание = 
			НСтр("ru = 'Используемый драйвер оборудования не сертифицирован или снят с поддержки.';
				|en = 'Используемый драйвер оборудования не сертифицирован или снят с поддержки.'") + Символы.ПС +  
	...
	ИначеЕсли Не УстановленаАктуальнаяВерсияДрайвера Тогда
		...
		ПодробноеОписание = 
			СтрШаблон(НСтр("ru = 'Версия этого драйвера устарела, текущая версия драйвера %1, актуальная версия драйвера %2.';
							|en = 'Версия этого драйвера устарела, текущая версия драйвера %1, актуальная версия драйвера %2.'"), 
				ТекущаяВерсияДрайвера, 
				АктуальнаяВерсияДрайвера) + 
			Символы.ПС +  
			НСтр("ru = 'Обновите драйвер для корректной работы.';
				|en = 'Обновите драйвер для корректной работы.'");
		Результат.КраткоеОписание = НСтр("ru = 'Устаревшая версия драйвера';
										|en = 'Устаревшая версия драйвера'");
		Результат.ОписаниеОшибки = ТекстОшибки + Символы.ПС + ПодробноеОписание;
	КонецЕсли;
...
#Иначе
	...
	КраткоеСообщение = НСтр("ru = 'Произошла неизвестная ошибка. Пожалуйста, обратитесь в техническую поддержку';
							|en = 'Произошла неизвестная ошибка. Пожалуйста, обратитесь в техническую поддержку'");
