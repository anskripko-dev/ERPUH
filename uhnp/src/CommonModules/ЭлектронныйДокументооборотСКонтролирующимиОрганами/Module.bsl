...
Процедура ОпределитьТаблицуОписанияОбъектовРегламентированнойОтчетности(ТаблицаОписания) Экспорт
	...
	НоваяСтрока.Наименование                       = НСтр("ru = 'Машиночитаемая доверенность (СФР)';
															|en = 'Машиночитаемая доверенность (СФР)'");
	...
	Иначе
		НаименованиеУПУП = НСтр("ru = 'Уведомление о предоставлении полномочий представителю (ПФР, не применяется с 04.04.2026)';
								|en = 'Уведомление о предоставлении полномочий представителю (ПФР, не применяется с 04.04.2026)'");
		НаименованиеУПРУП = НСтр("ru = 'Уведомление о прекращении полномочий представителя (ПФР, не применяется с 04.04.2026)';
								|en = 'Уведомление о прекращении полномочий представителя (ПФР, не применяется с 04.04.2026)'");
	КонецЕсли;
...
Процедура ОпределитьТаблицуОписанияОбъектовЗаявленияПоЭлДокументооборотуСПФР(ТаблицаОписания) Экспорт
	...
	ДополнениеНаименования =
		...
		"", " (" + НСтр("ru = 'не применяется с 04.04.2026';
						|en = 'не применяется с 04.04.2026'") + ")");
...
Процедура ОбновитьНастройкиПодключенияСЭДО(Параметры = Неопределено) Экспорт
	...
	Исключение
		...
		ПрефиксОшибки = НСтр("ru = 'Ошибка при обновлении настроек обмена с СЭДО ФСС: ';
							|en = 'Ошибка при обновлении настроек обмена с СЭДО ФСС: '");
		...
		ИмяСобытия = НСтр("ru = 'Электронный документооборот с контролирующими органами. СЭДО СФР.';
							|en = 'Электронный документооборот с контролирующими органами. СЭДО СФР.'",
			ОбщегоНазначения.КодОсновногоЯзыка());
		ЗаписьЖурналаРегистрации(
			ИмяСобытия,
			УровеньЖурналаРегистрации.Ошибка, , ,
