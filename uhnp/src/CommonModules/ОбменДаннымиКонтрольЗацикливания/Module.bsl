	...
	Пока Выборка.Следующий() Цикл
		...
		Если Выборка.ОбновитьРеквизиты Тогда
			...
			Исключение
				...
				Событие = НСтр("ru = 'Контроль зацикливания.Обновление реквизитов записи контура синхронизации';
								|en = 'Контроль зацикливания.Обновление реквизитов записи контура синхронизации'", ОбщегоНазначения.КодОсновногоЯзыка());
		...
		ИначеЕсли Выборка.УдалитьУзелИзКонтура Тогда
			...
			Исключение
				...
				Событие = НСтр("ru = 'Контроль зацикливания.Удаление записи контура синхронизации';
								|en = 'Контроль зацикливания.Удаление записи контура синхронизации'", ОбщегоНазначения.КодОсновногоЯзыка());
		...
		ИначеЕсли Выборка.УстановитьПоследнееОбновление Тогда
			...
			Исключение
				...
				Событие = НСтр("ru = 'Контроль зацикливания.Очистка устаревшей версии';
								|en = 'Контроль зацикливания.Очистка устаревшей версии'", ОбщегоНазначения.КодОсновногоЯзыка());
...
Процедура СкрытьПоказатьПредупреждениеЗацикливанияОтПользователя(Направление) Экспорт
	...
	ОписаниеНастроек = НСтр("ru = 'Скрыть подсказку о цикличных настройках синхронизации.';
							|en = 'Hide the hint about cyclic settings of synchronization.'", ОбщегоНазначения.КодОсновногоЯзыка());
		...
		Если УзлыКонтура.Количество() > 0 
			...
			Для Каждого КоррУзелКонтура Из УзлыКонтура[0].Строки Цикл
				...
				Исключение
					...
					Событие = НСтр("ru = 'Контроль зацикливания.Обновление контура синхронизации';
									|en = 'Контроль зацикливания.Обновление контура синхронизации'", ОбщегоНазначения.КодОсновногоЯзыка());
...
Процедура ЗаменитьПрефиксы()
	...
	Пока Выборка.Следующий() Цикл
		...
		Исключение
			...
			Событие = НСтр("ru = 'Контроль зацикливания.Замена префиксов';
							|en = 'Контроль зацикливания.Замена префиксов'", ОбщегоНазначения.КодОсновногоЯзыка());
...
Процедура УстановитьПризнакЗацикливания(СписокУзлов = Неопределено)
	...
	Пока Выборка.Следующий() Цикл
		...
		Исключение
			...
			Событие = НСтр("ru = 'Контроль зацикливания.Изменение признака зацикливание';
							|en = 'Контроль зацикливания.Изменение признака зацикливание'", ОбщегоНазначения.КодОсновногоЯзыка());
...
Процедура СнятьПризнакЗацикливания()
	...
	Пока Выборка.Следующий() Цикл
		...
		Исключение
			...
			Событие = НСтр("ru = 'Контроль зацикливания.Изменение признака зацикливания';
							|en = 'Контроль зацикливания.Изменение признака зацикливания'", ОбщегоНазначения.КодОсновногоЯзыка());
...
Процедура УдалитьКоррУзел(КодУзла, КодУзлаКорреспондента)
	...
	Пока Выборка.Следующий() Цикл
		...
		Исключение
			...
			Событие = НСтр("ru = 'Контроль зацикливания.Удаление записи';
							|en = 'Контроль зацикливания.Удаление записи'", ОбщегоНазначения.КодОсновногоЯзыка());
