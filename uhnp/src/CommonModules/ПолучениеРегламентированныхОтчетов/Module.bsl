	...
	Если ХарактеристикаВерсийПрограмм.Количество() = 0 Тогда
		...
		СообщениеОбОшибке = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'В характеристиках отсутствует информация о версиях программ.
				...
				|Идентификатор: %1
				|Версия: %2';
				|en = 'Characteristics do not contain information about software versions.
				|Cannot process the default master data of the local report:
				|ID: %1
				|Version: %2'"),
			Идентификатор,
			Версия);
	...
	Если Не Результат Тогда
		...
		СообщениеОбОшибке = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'В переданной характеристике отсутствует информация о текущей версии программы.
				...
				|Идентификатор: %1
				|Версия: %2';
				|en = 'Passed characteristic does not contain information about the current software version.
				|Cannot process the default master data of the local report:
				|ID: %1
				|Version: %2'"),
			Идентификатор,
