...
//  Доверенность - Неопределено, СправочникСсылка.МашиночитаемыеДоверенностиОрганизаций, СправочникСсылка.МЧД003
Процедура ДобавитьСертификатВУчетныеЗаписиЭДО(УчетныеЗаписи, Сертификат, Знач Доверенность) Экспорт
	...
	Для каждого УчетнаяЗапись Из УчетныеЗаписи Цикл
		...
		КонецЕсли;
		УчетныеЗаписиЭДО.ЗаписатьСертификатыУчетнойЗаписи(
			УчетнаяЗапись, ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве(Сертификат), Ложь, Доверенности);
