...
Функция ПолучитьОперацииГрафикаПоВидуДоговора(ВидДоговораУХ) Экспорт
	...
	|	ИСТИНА КАК ИспользуетсяПланирование,
	...
	|	ОперацииГрафиковДоговоров.ЭтоВводНачальныхОстатков КАК ЭтоВводНачальныхОстатков,
	|	ОперацииГрафиковДоговоров.ФактическийВводНачальныхОстатков КАК ФактическийВводНачальныхОстатков
	|ИЗ
