...
Функция ОбработатьРезультатВыполненияНаСервере(Параметры) Экспорт
	...
	ЗаписатьИсториюПлатежнойОперации(ТипОперации, ПараметрыОперации, РезультатВыполнения, ТекстРезультата);
...
Процедура ЗаписатьИсториюПлатежнойОперации(ТипОперации, ДанныеОперации, РезультатВыполнения, ТекстОтветаJSON)
	...
	ДанныеОперации.Вставить("ТекстЗапроса" , ТекстЗапроса);
	ДанныеОперации.Вставить("ТекстОтвета"  , ТекстОтвета);
	ДанныеОперации.Вставить("СуммаОперации", СуммаОперации);    
	РезультатВыполнения.Вставить("ВидОплатыНаТерминале", Перечисления.ВидОплатыНаТерминале.Карта);   
	
	ОборудованиеПлатежныеСистемы.ЗаписатьПлатежнуюОперацию(ТипОперации, ДанныеОперации, РезультатВыполнения);
