...
// Возвращаемое значение:
//  См. ДлительныеОперации.ВыполнитьФункцию
Функция ОтразитьЭлектронныеДокументыВФоне(Знач СпособыОбработкиДокументов) Экспорт
	...
	Возврат ДлительныеОперации.ВыполнитьФункцию(ПараметрыВыполненияВФоне,
		"ОтражениеВУчетеЭДО.ОтразитьЭлектронныеДокументы", СпособыОбработкиДокументов);
