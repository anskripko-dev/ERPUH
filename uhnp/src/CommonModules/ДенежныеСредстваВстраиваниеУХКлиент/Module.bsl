...
Процедура ОбработкаВыбораДокументаПланирования(Форма, Элемент, ВыбранноеЗначение, СтандартнаяОбработка) Экспорт 
	...
	Иначе
		...
		ИдентификаторПозиции = ДенежныеСредстваВстраиваниеУХВызовСервера.ИдентификаторПозицииДокументаПланирования(Объект, ДанныеРасшифровки.ДокументПланирования);
		ДанныеРасшифровки.ИдентификаторПозиции = ИдентификаторПозиции;
	КонецЕсли;	
	...
	Если ТипЗнч(ДанныеРасшифровки.ДокументПланирования) = Тип("ДокументСсылка.ЗаявкаНаРасходованиеДенежныхСредств") Тогда 
		Реквизиты.Вставить("ЗаявкаНаРасходованиеДенежныхСредств", ДанныеРасшифровки.ДокументПланирования);
		ЗаполнитьЗначенияСвойств(ДанныеРасшифровки, Реквизиты);	
	КонецЕсли;
...
Функция СоздаватьЗаявкиНаОплатуВместоПлатежныхПоручений() Экспорт
	...
	Возврат ДенежныеСредстваВстраиваниеУХВызовСервера.СоздаватьЗаявкиНаОплатуВместоПлатежныхПоручений(); 
...
Функция МожноСоздатьВыплатыПоРасчетномуДокументу(РасчетныйДокумент)
	...
	Возврат ЗаявкиНаОперацииВызовСервера.МожноСоздатьВыплатыПоРасчетномуДокументу(РасчетныйДокумент);
