...
Функция ТекстЗапросаВТ_ДатыВозникновенияПраваПримененияИнвестиционногоВычета(Знач ИмяТаблицыДанных, 
	...
	|		И ПервоначальныеСведенияОС.Регистратор ССЫЛКА Документ.ВводОстатковВнеоборотныхАктивов2_4
	...
	|		И ПервоначальныеСведенияНМА.Регистратор ССЫЛКА Документ.ВводОстатковВнеоборотныхАктивов2_4
