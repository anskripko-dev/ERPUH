...
Процедура ДополнитьСоответствияРегистраторовОтчетаОДвижениях(Документ, СоответствиеРегистров) Экспорт
	...
	//++ НЕ УТКА
	Если ТипЗнч(Документ) = Тип("ДокументСсылка.РазрешениеНаЗаменуМатериалов") Тогда
		
		СоответствиеРегистров.Вставить(Регистры.ОбластиДействияАналоговМатериалов, "Разрешение");
