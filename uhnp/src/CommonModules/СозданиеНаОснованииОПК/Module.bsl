...
Процедура ПриОпределенииОбъектовСКомандамиСозданияНаОсновании(Объекты) Экспорт
	...
	Объекты.Добавить(Метаданные.Документы.СтрокаПланаЗакупок);
	Объекты.Добавить(Метаданные.Документы.Лот);
	Объекты.Добавить(Метаданные.Документы.ПротоколВыбораПобедителей);
	Объекты.Добавить(Метаданные.Документы.ЗаказПоставщику);
	Объекты.Добавить(Метаданные.Документы.ЗаявкаНаПривлечениеФинансирования);
	Объекты.Добавить(Метаданные.Документы.ПокрытиеПотребностиВФинансировании);
	Объекты.Добавить(Метаданные.Документы.РеестрПлатежей);
	
	// УХ_ОПК
	ОперативноеПланированиеКонтроль.ПриОпределенииОбъектовСКомандамиСозданияНаОсновании(Объекты);
	// Конец ОПК
