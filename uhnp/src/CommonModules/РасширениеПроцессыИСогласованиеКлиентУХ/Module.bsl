...
Процедура ТелеграмВложенныеФайлы(ФормаВход, СсылкаВход) Экспорт
	ДействияСогласованиеУХКлиент.ТелеграмВложенныеФайлы(ФормаВход, СсылкаВход);
КонецПроцедуры

Процедура ТелеграмВложенныеФайлыСписок(ФормаВход) Экспорт
	ДействияСогласованиеУХКлиент.ТелеграмВложенныеФайлыСписок(ФормаВход);
КонецПроцедуры
