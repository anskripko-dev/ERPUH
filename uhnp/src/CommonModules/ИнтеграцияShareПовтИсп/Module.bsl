...
Функция СлужебныеДанныеЗаголовковЗапроса() Экспорт
	...
	ДанныеЗаголовков.Вставить(ИмяЗаголовкаВерсииБЭД(), ОбновлениеИнформационнойБазыБЭД.ВерсияБиблиотеки());
	...
	ДанныеЗаголовков.Вставить(ИмяЗаголовкаПользователь(),
		СтроковыеФункции.СтрокаЛатиницей(Строка(Пользователи.АвторизованныйПользователь())));
...
Функция ИмяЗаголовкаВерсииБЭД()
	
	Возврат "x-version-bed";
