...
Процедура ВыполнитьДействиеСПриглашениямиЧерезОблачныйЭДО(Приглашения, Контекст)
	...
	ОбщийМодульПриглашенияЭДОИнтеграцияОблакаКлиент = ОбщегоНазначенияКлиент.ОбщийМодуль(
		"ПриглашенияЭДОИнтеграцияОблакаКлиент");
	
	Если Действие = ДействияСПриглашениями.Отправить Тогда
		ОбщийМодульПриглашенияЭДОИнтеграцияОблакаКлиент.ОтправитьПриглашения(Оповещение, Приглашения);
	ИначеЕсли Действие = ДействияСПриглашениями.Принять Тогда
		ОбщийМодульПриглашенияЭДОИнтеграцияОблакаКлиент.ПринятьПриглашения(Оповещение, Приглашения);
	ИначеЕсли Действие = ДействияСПриглашениями.Отклонить
		ИЛИ Действие = ДействияСПриглашениями.Отозвать Тогда
		ОбщийМодульПриглашенияЭДОИнтеграцияОблакаКлиент.ОтклонитьПриглашения(Оповещение, Приглашения);
	Иначе
		ВыполнитьОбработкуОповещения(Оповещение);
	КонецЕсли;
