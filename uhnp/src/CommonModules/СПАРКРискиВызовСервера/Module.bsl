...
//
Функция ИндексыСПАРККонтрагента(Знач Контрагент, Знач ВидКонтрагента) Экспорт
...
// Из результата работы веб-сервиса, сохраненного во временном хранилище.
//
// Параметры:
//  АдресВременногоХранилища - Строка - адрес временного хранилища, в котором хранится
//                                      результат вызова СПАРКРискиСервис.ЗагрузитьИндексыКонтрагентов.
//
// Возвращаемое значение:
...
// Возвращает адрес картинки во временном хранилище.
//
// Параметры:
//  ТекстКартинки - Строка - SVG текст картинки;
//  УникальныйИдентификатор - УникальныйИдентификатор - уникальный идентификатор формы.
// 
// Возвращаемое значение:
//  Строка - адрес во временном хранилище.
//
Функция АдресКартинки(Знач ТекстКартинки, Знач УникальныйИдентификатор) Экспорт
	
	Поток = Новый ПотокВПамяти;
	ЗаписьДанных = Новый ЗаписьДанных(Поток, КодировкаТекста.UTF8);
	ЗаписьДанных.ЗаписатьСтроку(ТекстКартинки);
...
Функция ДанныеДляПросмотраФайлаСправки(
	Знач Справка,
	Знач УникальныйИдентификатор) Экспорт
	
	Возврат СПАРКРиски.ДанныеДляПросмотраФайлаСправки(Справка, УникальныйИдентификатор);
КонецФункции

Функция ЗапроситьНовуюСправкуВСервисеСПАРКРиски(Знач Контрагент) Экспорт
	Возврат СПАРКРиски.ЗапроситьНовуюСправкуВСервисеСПАРКРиски(Контрагент);
КонецФункции
