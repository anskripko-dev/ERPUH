...
Процедура ПриДобавленииПодсистем(МодулиПодсистем) Экспорт
	...
	МодулиПодсистем.Добавить("ОбновлениеИнформационнойБазыБМ"); // Самая общая конфигурация
	
	МодулиПодсистем.Добавить("ОбновлениеИнформационнойБазыНМ");
	
	МодулиПодсистем.Добавить("ОбновлениеИнформационнойБазыЕХ");
	
	МодулиПодсистем.Добавить("ОбновлениеИнформационнойБазыБюджетированиеИОтчетность");
	
	#КонецОбласти
	
	// НАЧАЛО Урубков И. 29.05.2025 Выполнение задач №000053788
	тн_ОбновлениеИнформационнойБазы_ТН_Общий.ПриДобавленииПодсистем(МодулиПодсистем);
	// КОНЕЦ Урубков И. 29.05.2025 Выполнение задач №000053788
