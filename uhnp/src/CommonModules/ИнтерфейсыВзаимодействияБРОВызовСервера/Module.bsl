...
// Возвращает или статусы документа о предстоящей поставке или обновляет статус ДОПП.
// Параметры:
...
//     * Погашено - Строка - "6".
//
Функция СтатусыДОПП(ТекущийСтатус = Неопределено, НовыйСтатус = Неопределено) Экспорт
	
	Если ТекущийСтатус = Неопределено И НовыйСтатус = Неопределено Тогда
		Результат = Новый Структура;
	...
	Если Результат.ДанныеКвитанции <> Неопределено Тогда
		...
		Исключение
			...
			ИмяСобытия = НСтр("ru = 'Электронный документооборот с контролирующими органами. Квитанция о присвоении статуса ДОПП';
								|en = 'Электронный документооборот с контролирующими органами. Квитанция о присвоении статуса ДОПП'",
				ОбщегоНазначения.КодОсновногоЯзыка());
			ЗаписьЖурналаРегистрации(
				ИмяСобытия ,
				УровеньЖурналаРегистрации.Ошибка,,,
		...
		Исключение
			Результат.ОписаниеОшибки = СтрШаблон(
				НСтр("ru = 'Файл ""%1"" не является файлом выгрузки в формате XML';
					|en = 'Файл ""%1"" не является файлом выгрузки в формате XML'"),
			...
			ЗаписьЖурналаРегистрации(
				НСтр("ru = 'Электронный документооборот с контролирующими органами. Сведения для бакета';
					|en = 'Электронный документооборот с контролирующими органами. Сведения для бакета'"),
				УровеньЖурналаРегистрации.Ошибка,,,
				...
				Результат.ОписаниеОшибки = ?(ЗначениеЗаполнено(ВерсФорм),
					СтрШаблон(
						НСтр("ru = 'Файл ""%1"" декларации содержит неизвестную версию формата ""%2""';
							|en = 'Файл ""%1"" декларации содержит неизвестную версию формата ""%2""'"),
						КороткоеИмяФайлаВыгрузки,
						ВерсФорм),
					СтрШаблон(
						НСтр("ru = 'Не удалось определить версию формата файла ""%1"" декларации';
							|en = 'Не удалось определить версию формата файла ""%1"" декларации'"),
						КороткоеИмяФайлаВыгрузки))
				...
				Результат.ОписаниеОшибки = ?(ЗначениеЗаполнено(ВерсФорм),
					СтрШаблон(
						НСтр("ru = 'Файл ""%1"" расчета содержит неизвестную версию формата ""%2""';
							|en = 'Файл ""%1"" расчета содержит неизвестную версию формата ""%2""'"),
						КороткоеИмяФайлаВыгрузки,
						ВерсФорм),
					СтрШаблон(
						НСтр("ru = 'Не удалось определить версию формата файла ""%1"" расчета';
							|en = 'Не удалось определить версию формата файла ""%1"" расчета'"),
						КороткоеИмяФайлаВыгрузки))
				...
				Результат.ОписаниеОшибки = ?(ЗначениеЗаполнено(ВерсФорм),
					СтрШаблон(
						НСтр("ru = 'Файл ""%1"" уведомления содержит неизвестную версию формата ""%2""';
							|en = 'Файл ""%1"" уведомления содержит неизвестную версию формата ""%2""'"),
						КороткоеИмяФайлаВыгрузки,
						ВерсФорм),
					СтрШаблон(
						НСтр("ru = 'Не удалось определить версию формата файла ""%1"" уведомления';
							|en = 'Не удалось определить версию формата файла ""%1"" уведомления'"),
						КороткоеИмяФайлаВыгрузки))
		...
		Если ЗначениеЗаполнено(ИмяФайлаВыгрузки) Тогда
			Результат.ОписаниеОшибки = СтрШаблон(
				НСтр("ru = 'Файл ""%1"" содержит идентификатор, начинающийся с неизвестного префикса. Возможны: ""NO_NDS_"", ""NO_RASCHSV_"", ""UT_UVISCHSUMNAL_"".';
					|en = 'Файл ""%1"" содержит идентификатор, начинающийся с неизвестного префикса. Возможны: ""NO_NDS_"", ""NO_RASCHSV_"", ""UT_UVISCHSUMNAL_"".'"),
				КороткоеИмяФайлаВыгрузки);
			ЗаписьЖурналаРегистрации(
				НСтр("ru = 'Электронный документооборот с контролирующими органами. Сведения для бакета';
					|en = 'Электронный документооборот с контролирующими органами. Сведения для бакета'"),
