			...
			Если ОтменаТранзакции Тогда
				СистемаБыстрыхПлатежейСлужебный.ЗаписатьИнформациюВЖурналРегистрации(
					НСтр("ru = 'По завершении выполнения обработчика ПереводыСБПc2bПереопределяемый.ПриЗагрузкеСтатусаОперации
						...
						|en = 'The transaction was not closed upon completion of the ПереводыСБПc2bПереопределяемый.ПриЗагрузкеСтатусаОперации
						|handler.'"),
					Истина);
			КонецЕсли;
	...
	Если Не ПустаяСтрока(РезультатОтправки.КодОшибки) Тогда
		...
		РезультатОперации.ИнформацияОбОшибке = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Не удалось получить информацию о статусе операции.
				...
				|
				|%2';
				|en = 'Cannot get the transaction status information.
				|
				|%1
				|
				|%2'"),
...
Функция ОперацияДинамическаяСсылка(
	...
	СистемаБыстрыхПлатежейСлужебный.ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Создание динамической ссылки (с2b) СБП.';
			|en = 'Create a dynamic FPS link (c2b).'"),
		Ложь);
	...
	Если Не ПустаяСтрока(РезультатОтправки.КодОшибки) Тогда
		...
		РезультатОперации.ИнформацияОбОшибке = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Не удалось создать заказ на оплату в Системе быстрых платежей.
				...
				|
				|%2';
				|en = 'Cannot create an order for payment in the Faster Payments System.
				|
				|%1
				|
				|%2'"),
	...
	СистемаБыстрыхПлатежейСлужебный.ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Завершено создание заказа на оплату (с2b) в Системе быстрых платежей.';
			|en = 'The order for payment (c2b) is created in the Faster Payments System.'"),
		Ложь);
...
Функция ОперацияСтатусОплатыДинамическойСсылки(
	...
	СистемаБыстрыхПлатежейСлужебный.ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Проверка статуса заказа на оплату (с2b) в Системе быстрых платежей.';
			|en = 'Check the status of the order for payment (c2b) in the Faster Payments System.'"),
		Ложь);
	...
	СистемаБыстрыхПлатежейСлужебный.ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Проверка статуса заказа на оплату (с2b) в Системе быстрых платежей завершена.';
			|en = 'The status of the order for payment (c2b) is checked in the Faster Payments System.'"),
		Ложь);
...
Функция ОперацияРегистрацияКассовойСсылки(
	...
	СистемаБыстрыхПлатежейСлужебный.ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Регистрация новой кассовой ссылки (с2b) в Системе быстрых платежей.';
			|en = 'Register a new QR code payment link (c2b) in the Faster Payments System.'"),
		Ложь);
	...
	Если Не ПустаяСтрока(РезультатОтправки.КодОшибки) Тогда
		...
		РезультатОперации.ИнформацияОбОшибке = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Не удалось создать зарегистрировать кассовую ссылку.
				...
				|
				|%2';
				|en = 'Cannot create register the QR code payment link.
				|
				|%1
				|
				|%2'"),
	...
	СистемаБыстрыхПлатежейСлужебный.ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Завершена регистрация кассовой ссылки (с2b) в Системе быстрых платежей.';
			|en = 'The QR code payment link (c2b) is registered in the Faster Payments System.'"),
		Ложь);
...
Функция ОперацияАктивацияКассовойСсылки(
	...
	СистемаБыстрыхПлатежейСлужебный.ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Активация кассовой ссылки (с2b).';
			|en = 'Activate the QR code payment link (c2b).'"),
		Ложь);
	...
	СистемаБыстрыхПлатежейСлужебный.ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Завершена активация кассовой ссылки (с2b).';
			|en = 'The QR code payment link (c2b) is activated.'"),
		Ложь);
...
Функция ОперацияСтатусОплатыКассовойСсылки(
	...
	СистемаБыстрыхПлатежейСлужебный.ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Проверка статуса заказа на оплату кассовой ссылки (с2b) в Системе быстрых платежей.';
			|en = 'Check the status of the order for payment via the QR code payment link (c2b) in the Faster Payments System.'"),
		Ложь);
	...
	Если Не ПустаяСтрока(РезультатОтправки.КодОшибки) Тогда
		...
		РезультатОперации.ИнформацияОбОшибке = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Не удалось получить статус оплаты кассовой ссылки в Системе быстрых платежей.
				...
				|
				|%2';
				|en = 'Cannot get the status of payment via the QR code payment link in the Faster Payments System.
				|
				|%1
				|
				|%2'"),
	...
	СистемаБыстрыхПлатежейСлужебный.ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Проверка статуса заказа на оплату кассовой ссылки (с2b) в Системе быстрых платежей завершена.';
			|en = 'The status of the order for payment via the QR code payment link (c2b) is checked in the Faster Payments System.'"),
		Ложь);
...
Функция ОперацияДеактивироватьКассовуюСсылку(
	...
	СистемаБыстрыхПлатежейСлужебный.ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Деактивация кассовой ссылки (с2b) в Системе быстрых платежей.';
			|en = 'Deactivate the QR code payment link (c2b) in the Faster Payments System.'"),
		Ложь);
	...
	Если Не ПустаяСтрока(РезультатОтправки.КодОшибки) Тогда
		...
		РезультатОперации.ИнформацияОбОшибке = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Не удалось создать деактивировать кассовую ссылку.
				...
				|
				|%2';
				|en = 'Cannot create deactivate the QR code payment link.
				|
				|%1
				|
				|%2'"),
	...
	СистемаБыстрыхПлатежейСлужебный.ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Завершена деактивация кассовой ссылки (с2b) в Системе быстрых платежей.';
			|en = 'The QR code payment link (c2b) is deactivated in the Faster Payments System.'"),
		Ложь);
...
Функция ОперацияВозвратОплаты(ПараметрыВозврата, ПараметрыНастройкиПодключения)
	...
	СистемаБыстрыхПлатежейСлужебный.ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Создание заказа на возврат (с2b) в Системе быстрых платежей.';
			|en = 'Create an order for refund (c2b) in the Faster Payments System.'"),
		Ложь);
	...
	Иначе
		...
		СистемаБыстрыхПлатежейСлужебный.ЗаписатьИнформациюВЖурналРегистрации(
			НСтр("ru = 'Завершено создание заказа на возврат (с2b) в Системе быстрых платежей.';
				|en = 'The order for refund (c2b) is created in the Faster Payments System.'"),
			Ложь);
...
Функция ОперацияПодтверждениеВозврата(
	...
	СистемаБыстрыхПлатежейСлужебный.ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Подтверждение заказа на возврат (с2b) в Системе быстрых платежей.';
			|en = 'Confirm the order for refund (c2b) in the Faster Payments System.'"),
		Ложь);
	...
	Иначе
		...
		СистемаБыстрыхПлатежейСлужебный.ЗаписатьИнформациюВЖурналРегистрации(
			НСтр("ru = 'Завершено подтверждение заказа на возврат (с2b) в Системе быстрых платежей.';
				|en = 'The order for refund (c2b) is confirmed in the Faster Payments System.'"),
			Ложь);
...
Функция ОперацияСтатусВозврата(
	...
	СистемаБыстрыхПлатежейСлужебный.ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Проверка статуса заказа на возврат (с2b) в Системе быстрых платежей.';
			|en = 'Check the refund of the order for payment (c2b) in the Faster Payments System.'"),
		Ложь);
	...
	Иначе
		...
		СистемаБыстрыхПлатежейСлужебный.ЗаписатьИнформациюВЖурналРегистрации(
			НСтр("ru = 'Проверка статуса заказа на возврат (с2b) в Системе быстрых платежей завершена.';
				|en = 'The status of the order for refund (c2b) is checked in the Faster Payments System.'"),
			Ложь);
	...
	Если Не ПустаяСтрока(РезультатОтправки.КодОшибки) Тогда
		...
		РезультатОперации.ИнформацияОбОшибке = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Не удалось выполнить запрос отчета по сверке взаиморасчетов.
				...
				|
				|%2';
				|en = 'Cannot perform the AR/AP reconciliation report request.
				|
				|%1
				|
				|%2'"),
	...
	Если Не ПустаяСтрока(РезультатОтправки.КодОшибки) Тогда
		...
		РезультатОперации.ИнформацияОбОшибке = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Не удалось выполнить запрос отчета сверке взаиморасчетов по операциям.
				...
				|
				|%2';
				|en = 'Cannot perform the request of the transaction AR/AP reconciliation report.
				|
				|%1
				|
				|%2'"),
