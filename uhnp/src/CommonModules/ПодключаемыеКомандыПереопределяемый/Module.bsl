...
Процедура ПриОпределенииВидовПодключаемыхКоманд(ВидыПодключаемыхКоманд) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ПодсистемыУХ.ИнтеграцияНалоговыйМониторинг") Тогда
		МодульНалоговыйМониторинг = ОбщегоНазначения.ОбщийМодуль("НалоговыйМониторинг");
		МодульНалоговыйМониторинг.ПриОпределенииВидовПодключаемыхКоманд(ВидыПодключаемыхКоманд);
	КонецЕсли;
	#КонецОбласти
	
	#Область УХ_Риски
	Если ОбщегоНазначения.ПодсистемаСуществует("ПодсистемыУХ.ИнтеграцияУправлениеРисками") Тогда
		МодульНалоговыйМониторинг = ОбщегоНазначения.ОбщийМодуль("УправлениеРисками");
		МодульНалоговыйМониторинг.ПриОпределенииВидовПодключаемыхКоманд(ВидыПодключаемыхКоманд);
	КонецЕсли;
	#КонецОбласти
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ПодсистемыУХ.ПланированиеИКонтрольСлужебный") Тогда
		МодульКонтрольУХ = ОбщегоНазначения.ОбщийМодуль("КонтрольУХ");
		МодульКонтрольУХ.ПриОпределенииВидовПодключаемыхКоманд(ВидыПодключаемыхКоманд);
	КонецЕсли;
	#КонецОбласти
...
Процедура ПриОпределенииСоставаНастроекПодключаемыхОбъектов(НастройкиПрограммногоИнтерфейса) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ПодсистемыУХ.ПланированиеИКонтрольСлужебный") Тогда
		МодульКонтрольУХ = ОбщегоНазначения.ОбщийМодуль("КонтрольУХ");
		МодульКонтрольУХ.ПриОпределенииСоставаНастроекПодключаемыхОбъектов(НастройкиПрограммногоИнтерфейса);
	КонецЕсли;
	#КонецОбласти
...
Процедура ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ПодсистемыУХ.ИнтеграцияНалоговыйМониторинг") Тогда
		МодульНалоговыйМониторинг = ОбщегоНазначения.ОбщийМодуль("НалоговыйМониторинг");
		МодульНалоговыйМониторинг.ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды);
	КонецЕсли;
	#КонецОбласти
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ПодсистемыУХ.ПланированиеИКонтрольСлужебный") Тогда
		МодульКонтрольУХ = ОбщегоНазначения.ОбщийМодуль("КонтрольУХ");
		МодульКонтрольУХ.ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды);
	КонецЕсли;
	#КонецОбласти
