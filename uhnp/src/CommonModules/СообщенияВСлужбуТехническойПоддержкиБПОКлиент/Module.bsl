...
Процедура НачатьОтправкуСообщенияОбОшибке(ОповещениеОЗавершении, Параметры) Экспорт
	...
	Если Не ОтправлятьСообщенияВТехПоддержку() Тогда
		...
		РезультатОперации.СообщениеОбОшибке = НСтр("ru = 'Подсистема Сообщения в службу технической поддержки БПО отключена.';
													|en = 'Подсистема Сообщения в службу технической поддержки БПО отключена.'");
