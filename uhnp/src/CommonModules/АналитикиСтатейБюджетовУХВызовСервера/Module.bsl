...
Функция ВидыАналитикСтатей(СтатьиБюджета, ТолькоЛимитируемыеАналитики = Ложь, ПараметрыЛимитирования = неопределено) Экспорт
	...
	Для Каждого КлючЗначение Из Новый Структура("СтатьиДвиженияДенежныхСредств,СтатьиДоходовИРасходов") Цикл
...
Функция ВидыАналитикСтатьи(СтатьяБюджета, ТолькоЛимитируемыеАналитики = Ложь, ПараметрыЛимитирования = неопределено) Экспорт
	...
	ОписаниеВидовАналитик = ВидыАналитикСтатей(СтатьяВМассиве,ТолькоЛимитируемыеАналитики, ПараметрыЛимитирования);
...
Процедура ПриИзмененииГодаЛимитирования(Форма) Экспорт
	...
	АналитикиСтатейБюджетовУХ.ПриИзмененииГодаЛимитирования(Форма);	
