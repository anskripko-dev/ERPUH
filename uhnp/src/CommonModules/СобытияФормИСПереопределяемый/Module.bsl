...
//-- НЕ УТКА
	Тогда
		РаботаСТабличнымиЧастями.ИнициализироватьКэшСтрок(Форма.Элементы.МатериалыИРаботы);
//-- НЕ УТ
	
//++ НЕ УТКА
	ИначеЕсли Форма.ИмяФормы = "Документ.ЭтапПроизводства2_2.Форма.ФормаДокумента" Тогда
		РаботаСТабличнымиЧастями.ИнициализироватьКэшСтрок(Форма.Элементы.РасходМатериаловИРабот);
//-- НЕ УТКА
	КонецЕсли;
