...
Функция НовыйПараметрыПриложенияТорговыеПредложения()
	...
	Параметры.Вставить(ИмяПараметраРекомендацииОтключены(), Ложь);
...
// Имя параметра рекомендации отключены.
// 
// Возвращаемое значение:
//  Строка
Функция ИмяПараметраРекомендацииОтключены() Экспорт
	Возврат "РекомендацииОтключены";
КонецФункции
