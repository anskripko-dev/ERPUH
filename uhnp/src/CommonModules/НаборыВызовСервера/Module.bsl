...
Функция Комплектующие(Параметры, ДополнительныеПараметры) Экспорт
	...
	|		ИНАЧЕ ВЫБОР
	|				КОГДА ДоступностьТоваров.ВНаличииОстаток - ДоступностьТоваров.РезервироватьНаСкладеОстаток - ДоступностьТоваров.РезервироватьПоМереПоступленияОстаток > 0
	|					ТОГДА ДоступностьТоваров.ВНаличииОстаток - ДоступностьТоваров.РезервироватьНаСкладеОстаток - ДоступностьТоваров.РезервироватьПоМереПоступленияОстаток
	|				ИНАЧЕ 0
	|			КОНЕЦ
	|	КОНЕЦ КАК Свободно
