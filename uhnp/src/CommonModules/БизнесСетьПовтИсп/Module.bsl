...
// Использовать поставляемые данные организаций бизнес сеть.
// 
// Возвращаемое значение:
//  Булево - Истина, если следует использовать поставляемые данные для поиска организаций сервиса 1С:Бизнес-сеть.
//           Ложь, в ином случае.
Функция ИспользоватьПоставляемыеДанныеОрганизацийБизнесСеть() Экспорт
	Возврат БизнесСетьВМоделиСервиса.ИспользоватьПоставляемыеДанныеОрганизацийБизнесСеть();
КонецФункции
