	...
	Если ТребованияФНСВызовСервера.ОбязательностьЭДОНеОпределена(СсылкаНаОтчет) Тогда
		...
		КомментарийКСостоянию = Новый ФорматированнаяСтрока(
			НСтр("ru = 'С 5 февраля 2025 г. необходимость подтверждения приема зависит от того, обязателен ли для организации электронный документооборот.';
				|en = 'С 5 февраля 2025 г. необходимость подтверждения приема зависит от того, обязателен ли для организации электронный документооборот.'"),
			" ",
	...
	ИначеЕсли ТребованияФНСВызовСервера.ЭДООбязателенПоСсылке(СсылкаНаОтчет) Тогда
		...
		КомментарийКСостоянию = Новый ФорматированнаяСтрока(
			НСтр("ru = 'Поскольку электронный документооборот обязателен, то отправлять подтверждение приема не нужно.';
				|en = 'Поскольку электронный документооборот обязателен, то отправлять подтверждение приема не нужно.'"),
			" ",
			Новый ФорматированнаяСтрока(НСтр("ru = 'Изменить';
											|en = 'Изменить'"),,,, "ИзменитьНастройкиПодтверждения"));
	...
	ИначеЕсли ТребованияФНСВызовСервера.ЭДОНеОбязателен(СсылкаНаОтчет) Тогда
		...
		КомментарийКСостоянию = Новый ФорматированнаяСтрока(
			НСтр("ru = 'Поскольку электронный документооборот не обязателен, то нужно отправить подтверждение приема.';
				|en = 'Поскольку электронный документооборот не обязателен, то нужно отправить подтверждение приема.'"),
			" ",
			Новый ФорматированнаяСтрока(НСтр("ru = 'Изменить';
											|en = 'Изменить'"),,,, "ИзменитьНастройкиПодтверждения"));
	...
	ИначеЕсли ТребованияФНСВызовСервера.ЭтоТребованиеФНС(СсылкаНаОтчет) Тогда
		...
		Если РегламентированнаяОтчетностьПереопределяемый.ЭтоЮридическоеЛицо(СсылкаНаОтчет.Организация) Тогда
			КомментарийКСостоянию = НСтр("ru = 'Если прием требования не будет подтвержден в течение 6 рабочих дней с момента отправки, то ФНС вправе заблокировать расчетный счет организации';
										|en = 'Если прием требования не будет подтвержден в течение 6 рабочих дней с момента отправки, то ФНС вправе заблокировать расчетный счет организации'");
		Иначе
			КомментарийКСостоянию = НСтр("ru = 'Если прием требования не будет подтвержден в течение 6 рабочих дней с момента отправки из ФНС, то документы будут высланы по почте';
										|en = 'Если прием требования не будет подтвержден в течение 6 рабочих дней с момента отправки из ФНС, то документы будут высланы по почте'");
		КонецЕсли;
	...
	Иначе
		...
		Если МассивТребований.Количество() > 0 Тогда
			КомментарийКСостоянию = НСтр("ru = 'Этот документ получен вместе с требованием. Подтверждение приема происходит по всем документам одновременно';
										|en = 'Этот документ получен вместе с требованием. Подтверждение приема происходит по всем документам одновременно'");
		Иначе
			КомментарийКСостоянию = НСтр("ru = 'Если прием документов не будет подтвержден в течение 6 рабочих дней с момента отправки из ФНС, то документы будут высланы по почте';
										|en = 'Если прием документов не будет подтвержден в течение 6 рабочих дней с момента отправки из ФНС, то документы будут высланы по почте'");
		КонецЕсли;
	КонецЕсли;
...
Процедура ИзменитьОформлениеВопросаЗапомнитьПроЭДО(Форма, Организация, Обязателен) Экспорт
	...
	Шаблон = НСтр("ru = 'Запомнить, что для %1 электронный документооборот %2обязателен. ';
					|en = 'Запомнить, что для %1 электронный документооборот %2обязателен. '");
	...
	Элементы.ЗапомнитьТекст.Заголовок = Новый ФорматированнаяСтрока(
		...
		НСтр("ru = 'Вы сможете изменить свой выбор в ';
			|en = 'Вы сможете изменить свой выбор в '"),
		Новый ФорматированнаяСтрока(НСтр("ru = 'Настройках обмена';
										|en = 'Настройках обмена'"),,,,Ссылка));
