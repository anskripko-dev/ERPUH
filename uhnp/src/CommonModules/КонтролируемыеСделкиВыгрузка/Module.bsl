...
Функция ФайлВыгрузкиДокументацииКС(ОсновныеСведенияВыгрузки, ДанныеДокументации, УникальныйИдентификатор) Экспорт
	...
	СведенияИД.Вставить("Получатель", КодНалоговогоОрганаПолучателяДокументации());
	СведенияИД.Вставить("КонечныйПолучатель", КодНалоговогоОрганаПолучателяДокументации());
...
// Код налогового органа получателя документации.
// 
// Возвращаемое значение:
//  Строка - Код налогового органа получателя документации
Функция КодНалоговогоОрганаПолучателяДокументации() Экспорт
