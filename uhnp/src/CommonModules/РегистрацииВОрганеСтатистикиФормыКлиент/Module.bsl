...
Процедура ОбработкаВыбораРегистрацииВОрганеСтатистики(Ответ, ДопПараметры) Экспорт
	...
	Если Ответ <> Неопределено Тогда
		...
		Если Не ЭтоНовыйОтчет И ДопПараметры.Форма.РегистрацияРеспондента <> Ответ Тогда
			Текст = СтрШаблон(НСтр("ru = 'Перед заполнением по новой регистрации%1рекомендуется очистить отчет.%1См. меню ""Еще"" - ""Очистить""';
									|en = 'Before filling in a new registration,%1it is recommended that you clear the report.%1See ""More actions > Clear""'"), Символы.ПС);
