...
Процедура ОбновитьПоставляемыеДрайвера(ДрайвераОборудования) Экспорт
	...
	Драйвер = ДрайвераОборудования.Добавить();
	Драйвер.ТипОборудования = Перечисления.ТипыПодключаемогоОборудования.УстройствоРаспознавания;
	Драйвер.ИмяДрайвера  = "ДрайверМертехРаспознавательMertechAI";
	Драйвер.Наименование = НСтр("ru = 'Мертех:Устройство распознавания Mertech AI';
								|en = 'Mertech:Recognition device Mertech AI'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	Драйвер.ИдентификаторОбъекта = "RecognitionDevice"; 
	// -- НеМобильноеПриложение
	// -- Локализация
