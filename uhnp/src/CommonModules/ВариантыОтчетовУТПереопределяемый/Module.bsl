...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	//++ НЕ УТКА
	Отчеты.АнализРаспределенияНачальныхОстатковНЗП.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТКА
	
	//++ НЕ УТ
	Отчеты.АнализСебестоимостиВыпущеннойПродукции.НастроитьВариантыОтчета(Настройки);
	Отчеты.ДеревоСебестоимостиПродукции.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТ
	...
	//++ НЕ УТ
	Отчеты.БазаРаспределенияМатериаловИРабот.НастроитьВариантыОтчета(Настройки);
	Отчеты.БазаРаспределенияПроизводственныхРасходов.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТ
	...
	//++ НЕ УТКА
	Отчеты.ВыполнениеЗадачБюджетногоПроцесса.НастроитьВариантыОтчета(Настройки, ВыводитьВариантыОтчетов);
	//-- НЕ УТКА
	
	Отчеты.ВыполнениеУсловийСоглашенийСКлиентами.НастроитьВариантыОтчета(Настройки);
	
	//++ НЕ УТ
	Отчеты.ВыпускПродукции.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТ
	...
	//++ НЕ УТКА
	Отчеты.ГрафикПроизводстваПродукции2_2.НастроитьВариантыОтчета(Настройки);
	Отчеты.НормативныйГрафикПроизводстваПоЗаказам.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТКА
	...
	//++ НЕ УТКА
	Отчеты.ДиагностикаЭтапаПроизводства.НастроитьВариантыОтчета(Настройки);
	Отчеты.МониторингЗаказа.НастроитьВариантыОтчета(Настройки);
	Отчеты.ДиаграммаПроизводстваПартииЗапуска.НастроитьВариантыОтчета(Настройки);
	Отчеты.ДиаграммаСмежныхЭтаповПроизводства.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТКА
	...
	//++ НЕ УТКА
	Отчеты.ЗагрузкаВидовРабочихЦентров.НастроитьВариантыОтчета(Настройки);
	Отчеты.ЗагрузкаОборудованияПоМоделиГрафикаПроизводства.НастроитьВариантыОтчета(Настройки);
	Отчеты.ПараметрыПроизводственныхОпераций.НастроитьВариантыОтчета(Настройки);
	Отчеты.ХодВыполненияПроизводственныхОпераций.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТКА
	...
	//++ НЕ УТ
	Отчеты.ЗначенияНефинансовыхПоказателей.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТ
	...
	//++ НЕ УТ
	Отчеты.ИсполнениеПланаПроизводства.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТ
	...
	//++ НЕ УТКА
	Отчеты.КонтрольДвиженияПродукцииИМатериаловПоЭтапуПроизводства.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТКА
	...
	Отчеты.КонтрольПередачиПродукцииДавальцу.НастроитьВариантыОтчета(Настройки);
	//-- Устарело_Переработка24
	
	Отчеты.КонтрольПередачиПродукцииДавальцу2_5.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТКА
	
	//++ НЕ УТ

	//++ Устарело_Переработка24
	Отчеты.КонтрольПередачиСырьяИМатериаловПереработчику.НастроитьВариантыОтчета(Настройки);
	//-- Устарело_Переработка24
	
	Отчеты.КонтрольПередачиСырьяИМатериаловПереработчику2_5.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТ
	...
	//++ Устарело_Переработка24
	Отчеты.КонтрольПоставкиПродукцииПереработчиком.НастроитьВариантыОтчета(Настройки);
	//-- Устарело_Переработка24
	
	Отчеты.КонтрольПоставкиПродукцииПереработчиком2_5.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТ
	
	//++ НЕ УТКА

	//++ Устарело_Переработка24
	Отчеты.КонтрольПоставкиСырьяИМатериаловДавальцем.НастроитьВариантыОтчета(Настройки);
	//-- Устарело_Переработка24
	
	Отчеты.КонтрольПоставкиСырьяИМатериаловДавальцем2_5.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТКА
	
	//++ НЕ УТ
	Отчеты.ПрименениеПравилаРасчетаРезервовПодОбесценение.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТ
	...
	#Область ЛимитыПоДаннымБюджетирования
	ОписаниеОтчета = ВариантыОтчетов.ОписаниеОтчета(Настройки, Метаданные.Отчеты.ЛимитыПоДаннымБюджетирования);
	ОписаниеОтчета.ОпределитьНастройкиФормы = Истина;
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "ИспользованияЛимитовПоДаннымБюджетирования");
	ОписаниеВарианта.Описание = НСтр("ru = 'План-фактный анализ использования лимитов за период.';
									|en = 'View variance analysis of cash flow limits over the period.'");
	ОтключитьВариантОтчета(Настройки, ОписаниеОтчета, "ИспользованияЛимитовПоДаннымБюджетированияКонтекст");
	#КонецОбласти
	//-- НЕ УТ
	
	//++ НЕ УТКА
	Отчеты.МониторБюджетныхПроцессов.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТКА
	...
	//++ НЕ УТ
	Отчеты.ОборотнаяВедомостьБюджетирования.НастроитьВариантыОтчета(Настройки, ВыводитьВариантыОтчетов);
	Отчеты.ОборотноСальдоваяВедомостьБюджетирования.НастроитьВариантыОтчета(Настройки, ВыводитьВариантыОтчетов);
	//-- НЕ УТ
	...
	//++ Устарело_Переработка24
	Отчеты.ОстаткиТоваровПереданныхПереработчикам.НастроитьВариантыОтчета(Настройки);
	//-- Устарело_Переработка24
	...
	//++ НЕ УТКА
	Отчеты.ОшибкиВДанныхРаспределенияОстатковНЗП.НастроитьВариантыОтчета(Настройки);
	Отчеты.ОшибкиРасчетаКалькуляцииПродукции.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТКА
	...
	//++ НЕ УТ
	Отчеты.ПересечениеПравилРасчетаРезервовПодОбесценение.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТ
	...
	//++ НЕ УТКА
	Отчеты.ПлановыеИФактическиеЗатратыПеределов.НастроитьВариантыОтчета(Настройки);
	Отчеты.ПлановаяИФактическаяСебестоимостьПродукции.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТКА
	
	//++ НЕ УТ
	Отчеты.ПлановаяПотребностьВМатериалах.НастроитьВариантыОтчета(Настройки, ВыводитьВариантыОтчетов);
	Отчеты.ПлановаяПотребностьВПолуфабрикатах.НастроитьВариантыОтчета(Настройки, ВыводитьВариантыОтчетов);
	Отчеты.ПлановаяПотребностьВТрудовыхРесурсах.НастроитьВариантыОтчета(Настройки, ВыводитьВариантыОтчетов);
	//-- НЕ УТ	
	
	//++ НЕ УТКА
	Отчеты.ПлановаяПотребностьВВидахРЦ.НастроитьВариантыОтчета(Настройки, ВыводитьВариантыОтчетов);
	Отчеты.ПланПроизводстваПродукцииИПолуфабрикатов.НастроитьВариантыОтчета(Настройки, ВыводитьВариантыОтчетов);
	Отчеты.ПлановаяСебестоимостьПродукции.НастроитьВариантыОтчета(Настройки);
	Отчеты.ПлановыеИФактическиеНормативыПроизводственныхРасходов.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТКА
	
	Отчеты.ПланЗакупок.НастроитьВариантыОтчета(Настройки, ВыводитьВариантыОтчетов);
	
	//++ НЕ УТ
	Отчеты.ПланФактныйАнализФинансовыхИнструментов.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТ
	...
	//++ НЕ УТКА
	Отчеты.ПотребностьВМатериалахПоМоделиГрафикаПроизводства.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТКА
	...
	//++ НЕ УТ
	Отчеты.ПроверкаСвязейПоказателейБюджетов.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТ
	...
	//++ НЕ УТ
	Отчеты.ПроизводственныеЗатраты.НастроитьВариантыОтчета(Настройки);
	Отчеты.ПроизводственныеЗатратыПоПартиямПроизводства.НастроитьВариантыОтчета(Настройки);
	Отчеты.ПроизводственныеЗатратыПостатейные.НастроитьВариантыОтчета(Настройки);
	Отчеты.ПроизводственныеЗатратыТМЦ.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТ
	...
	//++ НЕ УТ
	Отчеты.РасшифровкаСостоянияВыполненияЗаказовПереработчикам.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТ
	
	//++ НЕ УТКА
	Отчеты.РасшифровкаСтоимостиПереработки.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТКА
	...
	//++ НЕ УТ
	Отчеты.ВедомостьПоРезервамПредстоящихРасходов.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТ
	
	//++ НЕ УТ
	Отчеты.РезультатРаботыПравилПолученияФактическихДанных.НастроитьВариантыОтчета(Настройки, ВыводитьВариантыОтчетов);
	//-- НЕ УТ
	...
	//++ НЕ УТ
	Отчеты.РекомендацииПоПовышениюСкоростиРасчетаЭкземпляраБюджета.НастроитьВариантыОтчета(Настройки);
	Отчеты.СбалансированностьПлановУП.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТ
	...
	//++ НЕ УТ
	Отчеты.СвязиПоказателейБюджетов.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТ
	...
	//++ НЕ УТ
	Отчеты.СправкаРасчетДвиженияРезервовПодОбесценение.НастроитьВариантыОтчета(Настройки);
	Отчеты.СправкаРасчетРезервовПодОбесценениеЗапасов.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТ
	...
	//++ НЕ УТКА
	Отчеты.СтруктураЗаказаНаПроизводство2_2.НастроитьВариантыОтчета(Настройки);
	Отчеты.СтруктураЗаказаНаПроизводствоДинамическая.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТКА	
	
	//++ НЕ УТ
	Отчеты.СтруктураЗатратНаКапитализацию.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТ
	
	Отчеты.СтруктураСерииНоменклатуры.НастроитьВариантыОтчета(Настройки, ИспользоватьПроизводство);

	//++ НЕ УТКА
	Отчеты.СхемаМаршрутнойКарты.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТКА
	...
	//++ Устарело_Переработка24
	Отчеты.ТоварыПереданныеПереработчикам.НастроитьВариантыОтчета(Настройки);
	//-- Устарело_Переработка24
	
	Отчеты.ТоварыПереданныеПереработчикам2_5.НастроитьВариантыОтчета(Настройки);
	
	//-- НЕ УТ
	
	//++ НЕ УТКА
	Отчеты.ТоварыПринятыеВПереработку2_5.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТКА
	...
	//++ НЕ УТ
	Отчеты.ФактическаяСебестоимостьПродукции.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТ
	...
	//++ НЕ УТКА
	Отчеты.ХодРемонтныхМероприятий.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТКА
	
	Отчеты.ЭффективностьСделокСКлиентами.НастроитьВариантыОтчета(Настройки);
	
	//++ НЕ УТКА
	Отчеты.ПартииВПроизводстве.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТКА	
	
	Отчеты.ВедомостьРасчетовПоФинансовымИнструментам.НастроитьВариантыОтчета(Настройки);
	
	//++ НЕ УТКА
	Отчеты.ПотребностиКФормированиюЭтаповПроизводства.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТКА
	
	//++ НЕ УТКА
	Отчеты.КонфликтыВОчередиЗаказовНаПроизводство.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТКА
	...
	//++ НЕ УТКА
	Отчеты.ГрафикПотребленияМатериаловПоЗаказамНаПроизводство.НастроитьВариантыОтчета(Настройки);
	Отчеты.ГрафикЗанятостиТрудовыхРесурсовПоЗаказамНаПроизводство.НастроитьВариантыОтчета(Настройки);
	Отчеты.ТрудоемкостьЗаказаНаПроизводство.НастроитьВариантыОтчета(Настройки);
	Отчеты.РасшифровкаПозицииНоменклатурногоПлана.НастроитьВариантыОтчета(Настройки);
	Отчеты.УкомплектованностьЗаказов.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТКА
