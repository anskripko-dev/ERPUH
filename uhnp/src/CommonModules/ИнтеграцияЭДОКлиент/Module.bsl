...
Процедура ПодготовитьКДокументообороту(Знач НаборОбъектовУчета, Знач ПараметрыДействия) Экспорт
	...
	ОбменСКонтрагентамиКлиентПереопределяемый.ПриПроверкеГотовностиКДокументообороту(НаборОбъектовУчета, ПараметрыДействия.ОбработчикЗавершения, СтандартнаяОбработка);
	
	Если СтандартнаяОбработка = Истина Тогда
		ВыполнитьОбработкуОповещения(ПараметрыДействия.ОбработчикЗавершения, НаборОбъектовУчета);
	КонецЕсли;
