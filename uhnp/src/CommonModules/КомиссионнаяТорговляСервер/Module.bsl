...
Функция ПодсказкаПриВыбореВерсииКомиссионнойТорговли() Экспорт
	...
	ПодсказкаШаблон = НСтр(
		...
		|en = '%2: only consignment sales model %2 is used, but you can read/edit documents of consignment sales %1.
		|%1/%2: both models are used. You can enter new documents/catalogs for both %1 and %2 models.'");
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Комментарий = НСтр("ru = 'Заполняет признак использования комиссионной торговли версии %1';
						|en = 'Fills the flag of using consignment sales version %1'");
