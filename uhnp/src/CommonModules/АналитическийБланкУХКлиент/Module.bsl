...
Процедура ЗаполнитьСписокТиповОтбора(СписокВыбораЗначение,СписокВыбораПредставление,ТекущиеДанные,ПериодЗаблокирован,Иерархический,ФиксированныйОтбор = Ложь) Экспорт
	...
	Если ТекущиеДанные.ПолеКод = "ПериодС" Тогда
		Если ПериодЗаблокирован Тогда
			СписокВыбораЗначение.Добавить(ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.ПериодНачалаСоСдвигом"));
			Возврат;
		Иначе	
			СписокВыбораЗначение.Добавить(ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.ПериодНачалаОтчета"));
            СписокВыбораЗначение.Добавить(ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.ПериодНачалаСоСдвигом"));
            СписокВыбораЗначение.Добавить(ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.ПериодОкончанияОтчета"));
            СписокВыбораЗначение.Добавить(ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.ПериодОкончанияСоСдвигом"));
            СписокВыбораЗначение.Добавить(ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.Равно"));
	...
	ИначеЕсли ТекущиеДанные.ПолеКод = "Сценарий"	Тогда
		...
		СписокВыбораЗначение.Добавить(ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.СценарийОтчета"));
		СписокВыбораЗначение.Добавить(ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.Равно"));
		СписокВыбораЗначение.Добавить(ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.НеРавно"));
		
		Если  Иерархический Тогда 
			СписокВыбораЗначение.Добавить(ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.ВИерархии"));  
			СписокВыбораЗначение.Добавить(ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.ВСпискеПоИерархии"));  
		КонецЕсли;
		
		СписокВыбораЗначение.Добавить(ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.ВСписке"));
		СписокВыбораЗначение.Добавить(ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.НеВСписке"));
		
		Если  НЕ ФиксированныйОтбор Тогда 
			СписокВыбораЗначение.Добавить(ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.ОтборНеПроизводится"));
		КонецЕсли;	
			
	ИначеЕсли ТекущиеДанные.ПолеКод = "Организация" Тогда	
		
		СписокВыбораЗначение.Добавить(ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.ОрганизацияОтчета"));
		СписокВыбораЗначение.Добавить(ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.Равно"));
		СписокВыбораЗначение.Добавить(ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.НеРавно"));
	...
	ИначеЕсли ТекущиеДанные.ПолеКод = "Проект"	Тогда
		...
		СписокВыбораЗначение.Добавить(ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.ПроектОтчета"));
		СписокВыбораЗначение.Добавить(ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.Равно"));
		СписокВыбораЗначение.Добавить(ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.НеРавно"));
...
Процедура ПараметрыОтбораОтборПриИзменении(Элемент,Элементы) Экспорт
	...
	ЗначениеОтбора = 	Элементы.ПараметрыОтбора.ТекущиеДанные.Отбор;
		
	ТекущийОтбор  = Элементы.ПараметрыОтбора.ТекущиеДанные.ЗначениеОтбора;
	
	Если ЗначениеОтбора = ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.Равно") 
		ИЛИ ЗначениеОтбора = ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.НеРавно") Тогда	
	...
	Если  ЗначениеОтбора = ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.ВСписке") 
		ИЛИ ЗначениеОтбора = ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.НеВСписке") Тогда	
	...
	Если  ЗначениеОтбора = ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.ВСпискеПоИерархии") 
		ИЛИ ЗначениеОтбора = ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.НеВСпискеПоИерархии") Тогда	
	...
	Если ЗначениеОтбора = ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.ОтборНеПроизводится") Тогда	
		Элементы.ПараметрыОтбора.ТекущиеДанные.ЗначениеОтбора = Неопределено; 
		Элементы.ПараметрыОтбораЗначениеОтбора.ТолькоПросмотр = Истина; 
	КонецЕсли;
	
	Если ЗначениеОтбора = ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.ВИерархии")  	
	    ИЛИ ЗначениеОтбора = ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.НеВИерархии") Тогда
	...
	Если  ЗначениеОтбора = ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.ПериодНачалаОтчета") 
		ИЛИ ЗначениеОтбора = ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.ПериодОкончанияОтчета") 
		ИЛИ ЗначениеОтбора = ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.СценарийОтчета")
		ИЛИ ЗначениеОтбора = ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.ОрганизацияОтчета")
		ИЛИ ЗначениеОтбора = ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.ПроектОтчета") Тогда	
		Элементы.ПараметрыОтбора.ТекущиеДанные.ЗначениеОтбора = Неопределено; 
		Элементы.ПараметрыОтбораЗначениеОтбора.ТолькоПросмотр = Истина; 
	КонецЕсли;
	
	Если ЗначениеОтбора = ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.ПериодНачалаСоСдвигом") 
		ИЛИ ЗначениеОтбора = ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.ПериодОкончанияСоСдвигом")  Тогда	
		Элементы.ПараметрыОтбораЗначениеОтбора.ТолькоПросмотр 		= Ложь;
...
Процедура ПараметрыОтбораВыбор(Элементы,Элемент,СтандартнаяОбработка) Экспорт
	...
	ИначеЕсли ЗначениеОтбора  = ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.ВСпискеПоИерархии")
		ИЛИ ЗначениеОтбора = ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.НеВСпискеПоИерархии") Тогда  	
	...
	ИначеЕсли  ЗначениеОтбора = ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.ПериодНачалаОтчета") 
		ИЛИ ЗначениеОтбора = ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.ПериодОкончанияОтчета") 
		ИЛИ ЗначениеОтбора = ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.СценарийОтчета")
		ИЛИ ЗначениеОтбора = ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.ОрганизацияОтчета")
		ИЛИ ЗначениеОтбора = ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.ПроектОтчета") Тогда	
	...
	ИначеЕсли ЗначениеОтбора = ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.Равно") 
		ИЛИ ЗначениеОтбора = ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.НеРавно") Тогда	
	...
	ИначеЕсли  ЗначениеОтбора = ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.ВИерархии")  	
		ИЛИ ЗначениеОтбора = ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.НеВИерархии") Тогда	
	...
	ИначеЕсли  ЗначениеОтбора = ПредопределенноеЗначение("Перечисление.ВидыСравненияПоказателейОтчетов.ОтборНеПроизводится")  Тогда 
...
Процедура ВставитьЗначениеВОбласть(СтруктураРасшифровки,ТекущееЗначениеПоказателяЧисло,ЗначениеОбласти,ЛогИзмененныхПоказателей,ОписаниеИзменений) Экспорт
	...
	нСтрЛога.ПредставлениеТранзакции        =  Нстр("ru = 'Редактирование показателя '")+СтруктураРасшифровки.ПоказательСсылка;
...
Процедура ЗаполнитьЗначенияРасшифровкиПоТекущемуКонтексту(ЭтаФорма,Область,СтруктураРасшифровки,тБыстрыеОтборы = Неопределено) Экспорт
	...
	Если Не тБыстрыеОтборы = Неопределено Тогда
		//Быстрые отборы сверху.
		СтруктураПроизводныхРеквизитов = Новый Структура;
		Для Каждого тБыстрыйОтбор Из тБыстрыеОтборы Цикл
			Если НЕ тБыстрыйОтбор.КодПоля = "Организация" И НЕ тБыстрыйОтбор.КодПоля = "Сценарий" И НЕ тБыстрыйОтбор.КодПоля = "Организация" Тогда 
				Если тБыстрыйОтбор.ЭтоПроизводноеПоле Тогда
					...
					СтруктураПроизводныхРеквизитов.Вставить(КодПоля,тБыстрыйОтбор.ПутьКРеквизиту);
					СтруктураРасшифровки.Вставить("ПутьКРеквизиту",СтруктураПроизводныхРеквизитов);
				Иначе	
					КодПоля = тБыстрыйОтбор.КодПоля;
				КонецЕсли;	
				СтруктураРасшифровки.Вставить(КодПоля,ЭтаФорма[КодПоля]);
			КонецЕсли;
		КонецЦикла;
	КонецЕсли;
...
Процедура СгенерироватьКонтекстноеМеню(ЭтаФорма,Элемент,Режим = Неопределено) Экспорт
	...
	Если Режим = "Диаграмма"  Тогда
		СписокКоманд.Добавить("ОтобразитьРаскрытиеДиаграмма",Нстр("ru = 'Отобразить раскрытие'"),,БиблиотекаКартинок.СводнаяТаблицаОткрытьРаскрытие);
		СписокКоманд.Добавить("РасшифроватьПоказательДиаграмма",Нстр("ru = 'Расшифровать по формуле расчета'"),,БиблиотекаКартинок.СводнаяТаблицаФормулаРавно);
	ИначеЕсли Режим = "ОбластьЯчеекЧтение" И НЕ ЭтаФорма.Заблокирован Тогда
		СписокКоманд.Добавить("ОтобразитьРаскрытие",Нстр("ru = 'Отобразить раскрытие'"),,БиблиотекаКартинок.СводнаяТаблицаОткрытьРаскрытие);
		СписокКоманд.Добавить("РасшифроватьПоказатель",Нстр("ru = 'Расшифровать по формуле расчета'"),,БиблиотекаКартинок.СводнаяТаблицаФормулаРавно);
	ИначеЕсли Режим = "ОбластьЯчеекЧтение" И ЭтаФорма.Заблокирован Тогда
		СписокКоманд.Добавить("ОтобразитьРаскрытие",Нстр("ru = 'Отобразить раскрытие'"),,БиблиотекаКартинок.СводнаяТаблицаОткрытьРаскрытие);
		СписокКоманд.Добавить("РасшифроватьПоказатель",Нстр("ru = 'Расшифровать по формуле расчета'"),,БиблиотекаКартинок.СводнаяТаблицаФормулаРавно);
        СписокКоманд.Добавить("СкопироватьДанныеПоСтроке",Нстр("ru = 'Копировать по строке'"),,БиблиотекаКартинок.СводнаяТаблицаСкопироватьПоСтроке);
		СписокКоманд.Добавить("СкопироватьДанныеПоКолонке",Нстр("ru = 'Копировать по колонке'"),,БиблиотекаКартинок.СводнаяТаблицаСкопироватьПоКолонке);
		СписокКоманд.Добавить("ОчиститьДиапазон",Нстр("ru = 'Очистить'"),,БиблиотекаКартинок.СводнаяТаблицаОчиститьДиапазон);
		СписокКоманд.Добавить("КомментироватьПоказатель",Нстр("ru = 'Комментировать показатель'"),,БиблиотекаКартинок.СводнаяТаблицаДобавитьПримечание);		
	КонецЕсли;
...
#Область РаботаСобытиямиОсновногоМакетаДанных

Функция ВернутьОбластиПоказателейТекущейСтроки(Область,тМакет) Экспорт
		
	СписокЯчеек = Новый СписокЗначений;
		
	Для ИндексКолонки =  Область.Лево По тМакет.ШиринаТаблицы Цикл
		ЯчейкаТекущейСтроки = тМакет.Область(Область.Верх,ИндексКолонки,Область.Верх,ИндексКолонки);
		Если   ТипЗнч(ЯчейкаТекущейСтроки.Расшифровка) = Тип("Структура")
			И ЯчейкаТекущейСтроки.Расшифровка.Свойство("Ссылка") Тогда //Это показатель
			//Нужно понять - является ли показатель, показателем текущего среза данных. 
			
			СписокЯчеек.Добавить(ЯчейкаТекущейСтроки.Расшифровка.Ссылка,ЯчейкаТекущейСтроки.Расшифровка.Уид);			
		КонецЕсли;	
...
// Возвращает результат проверки типа области ячеек табличного документа.
//
// Параметры:
//  Область              - ОбластьЯчеекТабличногоДокумента - Выделенная область
//  ОднаЯчейка           - Булево - Область применимости команды. Если Истина - одна ячейка, Ложь - область ячеек.
//  СтандартнаяОбработка - Булево - Флаг стандартной обработки.
// 
// Возвращаемое значение:
//  Булево - Результат проверки типа области ячеек.
//
Функция НекорректныйТипОбластиТабличногоДокумента(Область, ОднаЯчейка = Ложь, СтандартнаяОбработка = Ложь) Экспорт
	
	НекорректныйТипОбласти = Ложь;
	
	Если Область.ТипОбласти <> ТипОбластиЯчеекТабличногоДокумента.Прямоугольник Тогда
		
		ТекстОповещения = НСтр("ru = 'Для выделенной области команда неприменима'");
		
		Если ОднаЯчейка Тогда
			ТекстПояснения = НСтр("ru = 'Выделите одну ячейку.'");
		Иначе
			ТекстПояснения = НСтр("ru = 'Выделите прямоугольную область ячеек.'");
		КонецЕсли;
		
		ПоказатьОповещениеПользователя(ТекстОповещения,, ТекстПояснения, БиблиотекаКартинок.Внимание16);
		
		НекорректныйТипОбласти = Истина;
		СтандартнаяОбработка = Ложь;
		
	КонецЕсли;
	
	Возврат НекорректныйТипОбласти;
