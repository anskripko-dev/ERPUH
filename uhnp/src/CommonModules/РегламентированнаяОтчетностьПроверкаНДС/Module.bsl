				...
				Если ЗначПоказателя < 0 Тогда
					Если ИмяРаздела = "Раздел1" Тогда
						ОписаниеОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр(
							...
							|en = 'В строке %1 раздела %2 значение не должно быть отрицательным.'"),
							Сред(ИмяПоказателя, 9, 3), Прав(ИмяРаздела, 1));
					ИначеЕсли ИмяРаздела = "Раздел2" Тогда
						ОписаниеОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр(
							"ru = 'В разделе %1 на странице %2 в строке %3 значение не должно быть отрицательным.';
							|en = 'В разделе %1 на странице %2 в строке %3 значение не должно быть отрицательным.'"),
					...
					ИначеЕсли ИмяРаздела = "Раздел3" Тогда
						ОписаниеОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр(
							...
							|en = 'В строке %1 по графе %2 раздела %3 значение не должно быть отрицательным.'"),
					...
					ИначеЕсли ИмяРаздела = "Раздел3_Прил1" Тогда
						ОписаниеОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр(
							...
							|en = 'На странице %1 приложения 1 к разделу 3 в строке %2 значение не должно быть отрицательным.'"),
					...
					ИначеЕсли ИмяРаздела = "Раздел3_Прил2" Тогда
						ОписаниеОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр(
							...
							|en = 'В приложении 2 к разделу 3 в строке %1 по графе %2 значение не должно быть отрицательным.'"),
					...
					ИначеЕсли ИмяРаздела = "Раздел4" Тогда
						ОписаниеОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр(
							...
							|en = 'В разделе 4 в строке %1 группы строк %2 значение в строке %3 не должно быть отрицательным.'"),
					...
					ИначеЕсли ИмяРаздела = "Раздел5" Тогда
						Если КонтекстРаздела.НомерСтроки <> Неопределено Тогда
							ОписаниеОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр(
								...
								|en = 'В разделе 5 на странице %1 в строке %2 значение в строке %3 не должно быть отрицательным.'"),
						...
						Иначе
							ОписаниеОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр(
								...
								|en = 'В разделе 5 на странице %1 значение в строке %2 не должно быть отрицательным.'"),
								КонтекстРаздела.НомерСтраницы, Сред(ИмяПоказателя, 9, 3));
						КонецЕсли;
					ИначеЕсли ИмяРаздела = "Раздел6" Тогда
						Если КонтекстРаздела.НомерСтроки <> Неопределено Тогда
							ОписаниеОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр(
								...
								|en = 'В разделе 6 в строке %1 группы строк %2 значение в строке %3 не должно быть отрицательным.'"),
								Формат(КонтекстРаздела.НомерСтроки, "ЧГ="), КонтекстРаздела.ГруппаСтрок, Сред(ИмяПоказателя, 9, 3));
						Иначе
							ОписаниеОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр(
								"ru = 'В разделе 6 в строке %1 значение не должно быть отрицательным.';
								|en = 'В разделе 6 в строке %1 значение не должно быть отрицательным.'"), Сред(ИмяПоказателя, 9, 3));
						КонецЕсли;
					ИначеЕсли ИмяРаздела = "Раздел7" Тогда
						Если КонтекстРаздела.НомерСтроки <> Неопределено Тогда
							ОписаниеОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр(
								"ru = 'В разделе 7 в строке %1 по графе %2 значение не должно быть отрицательным.';
								|en = 'В разделе 7 в строке %1 по графе %2 значение не должно быть отрицательным.'"),
								Формат(КонтекстРаздела.НомерСтроки, "ЧГ="), Сред(ИмяПоказателя, 13, 1));
						Иначе
							ОписаниеОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр(
								"ru = 'В разделе 7 в строке %1 значение не должно быть отрицательным.';
								|en = 'В разделе 7 в строке %1 значение не должно быть отрицательным.'"), Сред(ИмяПоказателя, 9, 3));
						КонецЕсли;
					КонецЕсли;
