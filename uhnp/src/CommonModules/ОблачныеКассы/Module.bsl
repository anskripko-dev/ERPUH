...
//
// Серверные процедуры обмена данными к Облачным кассам:
...
// Формирует объект дополнительных параметров для операции см. ПробитьЧек.
//
// Возвращаемое значение:
//  Структура:
//    * ДокументПредоплаты - Неопределено, ОпределяемыйТип.ДокументОперацииОблачнойКассы - ссылка на документ
//        предоплаты.
//        Значение по умолчанию: Неопределено.
//
Функция НовыйПараметрыПробитияЧека() Экспорт
	
	Результат = Новый Структура();
	Результат.Вставить("ДокументПредоплаты", Неопределено);
...
//  ПараметрыПробитияЧека - см. НовыйПараметрыПробитияЧека
//
// Возвращаемое значение:
//  Структура:
//    * КодОшибки - Строка - строковый код возникшей ошибки, который может быть обработан вызывающим методом.
...
//                - Структура - данные ответа Облачный кассы.
//
Функция ПробитьЧек(ДокументОперации, Касса, ДанныеЧека, ПараметрыПробитияЧека = Неопределено) Экспорт
	...
	Возврат ОблачныеКассыСлужебный.ПробитьЧек(ДокументОперации, Касса, ДанныеЧека, ПараметрыПробитияЧека);
