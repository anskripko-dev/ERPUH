				...
				Для Каждого РеквизитыДокумента Из РеквизитыДокументов Цикл
					Если РеквизитыДокумента.Значение.Статус = Перечисления.СтатусыПланов.ВПодготовке
						...
						ТекстОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
							НСтр(
							"ru = 'Для выполнения задачи документ %1 должен быть проведен в статусе ""На утверждении"" или ""Утвержден""';
							|en = 'To complete the task, the %1 document must be posted in the ""Pending confirmation"" or ""Confirmed"" status'"),
...
Процедура ПриЗаписи(Отказ)
	...
	Если Выполнена И Не ПометкаУдаления
		И Не ДополнительныеСвойства.Свойство("ИгнорироватьФормированиеБюджетныхЗадач") Тогда
