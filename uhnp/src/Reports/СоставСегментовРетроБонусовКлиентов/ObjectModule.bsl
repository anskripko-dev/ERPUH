...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	КомментарийСегментыНеЗафиксированы = НСтр("ru = 'Данные о составе сегментов не зафиксированы, могут быть изменены по правилам формирования сегментов';
												|en = 'Segments are not recorded, they can be changed according to the segment generation rules'");
	...
	КомментарийСегментыЗафиксированы = НСтр("ru = 'Расчет и начисление ретро-бонуса осуществляется по данным зафиксированного состава сегментов';
											|en = 'Rebate is calculated and accrued according to the data of the recorded segments'");
	КомпоновкаДанныхКлиентСервер.УстановитьПараметр(
		НастройкиОтчета,
			...
			Если НЕ УРБСогласован
			   И НЕ ПоДаннымДокумента Тогда
				...
				ТекстСообщения = НСтр("ru = 'Формирование отчета предусмотрено только для согласованных условий и с настройкой по сегментам клиентов или товаров.';
										|en = 'The report can be generated only for approved conditions with customization by customer or goods segments.'");
			...
			ИначеЕсли НЕ СоставСегментыПоПартнерам
			   И НЕ СоставСегментыНоменклатуры Тогда
				...
				ТекстСообщения = НСтр("ru = 'Формирование отчета предусмотрено только для документов с настройкой по сегментам клиентов или товаров.';
										|en = 'The report can be generated only for documents with customization by customer or goods segments.'");
				ВызватьИсключение ТекстСообщения;
