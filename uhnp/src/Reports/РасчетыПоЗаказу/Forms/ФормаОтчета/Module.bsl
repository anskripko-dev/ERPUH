...
Процедура ТаблицаОтчетаВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	Если СтруктураПараметров.Действие = "ОткрытьЗначение" Тогда
...
Процедура СформироватьОтчет()
	...
	Отчеты.РасчетыПоЗаказу.СформироватьОтчетСостояниеВыполненияДокументов(ВходящиеДокументы, ТаблицаОтчета);
