...
Процедура СохранитьПредставлениеПояснений()
	...
	Исключение
		ТекстСообщения = СтрШаблон(НСтр("ru = 'Ошибка при удалении временного файла %1: %2';
										|en = 'Ошибка при удалении временного файла %1: %2'"),
...
Асинх Процедура ДобавитьФайл(ВидДополнительногоФайла, ЗаголовокОкнаВыбора)
	...
	Если РасширениеФайла <> "pdf" Тогда
		ТектПредупреждения = НСтр("ru = 'Отправка файла с расширением, отличным от ""pdf"", приведет к отказу в приеме бухгалтерской отчетности. Сохраните файл в формате ""pdf"" и приложите его к отчету.';
									|en = 'Отправка файла с расширением, отличным от ""pdf"", приведет к отказу в приеме бухгалтерской отчетности. Сохраните файл в формате ""pdf"" и приложите его к отчету.'");
