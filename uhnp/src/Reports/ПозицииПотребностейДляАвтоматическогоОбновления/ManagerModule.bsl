...
Функция ПолучитьКолвоСПЗКАвтоОбновлению(Автор, ПериодЗакупки, Субъекты223ФЗ = Неопределено) экспорт
	...
	//
	ВариантНастройки = СхемаКомпоновкиДанных.ВариантыНастроек.Найти("ДляОпределенияСПЗККорректировке");
