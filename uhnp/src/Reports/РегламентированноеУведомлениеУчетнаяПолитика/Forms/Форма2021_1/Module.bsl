...
Процедура СформироватьДеревоСтраниц() Экспорт
	...
	Стр001.МногострочныеЧасти.Добавить("МнгСтр12");
	Стр001.МногострочныеЧасти.Добавить("МнгСтр15");
	Стр001.МногострочныеЧасти.Добавить("МнгСтр16");
	Стр001.МногострочныеЧасти.Добавить("МнгСтр17");
	Стр001.МногострочныеЧасти.Добавить("МнгСтр18");
	Стр001.МногострочныеЧасти.Добавить("МнгСтр19");
	Стр001.МногострочныеЧасти.Добавить("МнгСтр21");
	...
	Стр001.ИндексКартинки = 1;
	Стр001.ИмяМакета = "НДПИ_2021";
	Стр001.Многостраничность = Ложь;
	Стр001.Многострочность = Истина;
	Стр001.УИД = Новый УникальныйИдентификатор;
	Стр001.ИДНаименования = "НДПИ";
	Стр001.МногострочныеЧасти.Добавить("МнгСтр13");
	Стр001.МногострочныеЧасти.Добавить("МнгСтр14");
	
	Стр001 = КорневойУровень.Добавить();
	Стр001.Наименование = "Акцизы";
	Стр001.ИндексКартинки = 1;
	Стр001.ИмяМакета = "Акциз_2021";
	Стр001.Многостраничность = Ложь;
	Стр001.Многострочность = Ложь;
	Стр001.УИД = Новый УникальныйИдентификатор;
