...
Процедура ПередКомпоновкойМакета(ПараметрыОтчета, Схема, КомпоновщикНастроек) Экспорт
	...
	ШаблонФормулыКолонка5 = НСтр("ru = 'Колонка [5] = [льготируемые из графы 2] и графа [4] * %1';
								|en = 'Column [5] = [subject to benefit from column 2] and column [4] * %1'", ОбщегоНазначения.КодОсновногоЯзыка());
...
Процедура НастроитьВариантыОтчета(Настройки) Экспорт
	...
	ОписаниеВарианта.Описание = НСтр("ru = 'По какой формуле рассчитано признание расходов по исследованиям и разработкам?';
									|en = 'What formula was used for calculating R&D expense recognition?'");
