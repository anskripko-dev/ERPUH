...
Функция ТекстЗапросаДенежныеСредства()
	...
	|ВЫБРАТЬ
	|	ЗНАЧЕНИЕ(Перечисление.ВидыСтатейУправленческогоБаланса.Актив) КАК ТипПоказателя,
	|	ЗНАЧЕНИЕ(ПланВидовХарактеристик.СтатьиАктивовПассивов.УпрБалансПрочиеАктивы) КАК Показатель,
	|	
...
Процедура УстановитьОбязательныеНастройки(ПользовательскиеНастройкиМодифицированы)
	...
	Если ПараметрСтатьиПрочихАктивовПассивов <> Неопределено Тогда
		...
		//++ НЕ УТ
		СтатьиПрочихАктивовПассивов.Добавить(ПланыВидовХарактеристик.СтатьиАктивовПассивов.УпрБалансОсновныеСредства);
		СтатьиПрочихАктивовПассивов.Добавить(ПланыВидовХарактеристик.СтатьиАктивовПассивов.УпрБалансЛизинг);
		//-- НЕ УТ
