...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	ВыводитьЗаказ = КомпоновкаДанныхКлиентСервер.ПолучитьПараметр(
		...
		"ВыводитьЗаказ");
	Если ТипЗнч(ВыводитьЗаказ) = Тип("ЗначениеПараметраНастроекКомпоновкиДанных") Тогда
	...
	УправлениеПроизводством.ПодстановкаАктуальногоРегистраГрафика(НаборДанных.Запрос);
