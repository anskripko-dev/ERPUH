...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УведомлениеОСпецрежимахНалогообложения.ЗаполнитьТаблицуТекстовыхФорматов(ЭтотОбъект, "Форматы2024_1");
	УведомлениеОСпецрежимахНалогообложения.ЗаполнитьТаблицуФорматов(ЭтотОбъект, "Форматы2024_1");
...
Процедура СформироватьДеревоСтраниц() Экспорт
	...
	Стр001.ИндексКартинки = 1;
	Стр001.ИмяМакета = "ЗапрМненНО_2024";
	Стр001.Многостраничность = Ложь;
	...
	Стр0001.ИмяМакета = "ОписСдел_2024";
	...
	Стр0001.Наименование = "Стр. 1";
	Стр0001.ИндексКартинки = 1;
	Стр0001.ИмяМакета = "ИнфКонтр_2024";
	Стр0001.Многостраничность = Истина;
	Стр0001.Многострочность = Ложь;
	Стр0001.УИД = Новый УникальныйИдентификатор;
