...
Функция СформироватьСоответствиеИмен()
	...
	СоответствиеИмен.Вставить("Р09С175", "СтоимПродСФ20Или18");	// 2026
	...
	СоответствиеИмен.Вставить("Р09С205", "СумНДССФ20Или18");	// 2026
	...
	СоответствиеИмен.Вставить("Р09С235", "СтПродБезНДС20Или18");// 2026
	...
	СоответствиеИмен.Вставить("Р09С265", "СумНДСВсКПр20Или18");	// 2026
	...
	СоответствиеИмен.Вставить("Р91С025", "ИтСтПродКПр20Или18");	// 2026
	...
	СоответствиеИмен.Вставить("Р91С055", "СумНДСИтКПр20Или18"); // 2026
	...
	СоответствиеИмен.Вставить("Р91С255", "СтоимПродСФ20Или18");	// 2026
	...
	СоответствиеИмен.Вставить("Р91С285", "СумНДССФ20Или18");	// 2026
	...
	СоответствиеИмен.Вставить("Р91С315", "СтПродВсП1Р9_20Или18");// 2026
	...
	СоответствиеИмен.Вставить("Р91С345", "СумНДСВсП1Р9_20Или18");// 2026
...
Процедура ПроверкаКС_1_37()
	...
	Заголовки.Вставить("Описание"			,
		НСтр("ru = 'Сумма налога по ставке 22% в стр.260 Раздела 9 = сумме стр.200 Раздела 9';
			|en = 'Сумма налога по ставке 22% в стр.260 Раздела 9 = сумме стр.200 Раздела 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет';
													|en = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_46()
	...
	Заголовки.Вставить("Описание"			,
		НСтр("ru = 'Сумма налога по ставке 20% или 18% в стр.265 Раздела 9 = стр.205 Раздела 9';
			|en = 'Сумма налога по ставке 20% или 18% в стр.265 Раздела 9 = стр.205 Раздела 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет';
													|en = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_42()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога по ставке 22% в стр.340 Приложения 1 к Разделу 9 = стр.(050 + 280) Приложения 1 ';
			|en = 'Сумма налога по ставке 22% в стр.340 Приложения 1 к Разделу 9 = стр.(050 + 280) Приложения 1 '") +
		НСтр("ru = 'к Разделу 9';
			|en = 'к Разделу 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %4 (%2 + %3)';
													|en = '%1 = %4 (%2 + %3)'"));
...
Процедура ПроверкаКС_1_48()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога по ставке 20% или 18% в стр.345 Приложения 1 к Разделу 9 = стр.(055 + 285) Приложения 1 ';
			|en = 'Сумма налога по ставке 20% или 18% в стр.345 Приложения 1 к Разделу 9 = стр.(055 + 285) Приложения 1 '") +
		НСтр("ru = 'к Разделу 9';
			|en = 'к Разделу 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %4 (%2 + %3)';
													|en = '%1 = %4 (%2 + %3)'"));
...
Процедура ПроверкаКС_1_04()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Требуется соблюдение равенства: гр.3 стр.(003 + 005 + 007 + 010 + 020 + 030 + 040 + 041 + 042) ';
			|en = 'Требуется соблюдение равенства: гр.3 стр.(003 + 005 + 007 + 010 + 020 + 030 + 040 + 041 + 042) '") +
		НСтр("ru = 'Раздела 3) / (гр.3 стр.(003 + 005 + 007 + 010 + 020 + 030 + 040 + 041 + 042) Раздела 3 + ';
			|en = 'Раздела 3) / (гр.3 стр.(003 + 005 + 007 + 010 + 020 + 030 + 040 + 041 + 042) Раздела 3 + '") +
		НСтр("ru = '(сумма гр.2 Раздела 7 по кодам 1010800 - 1010842, 1011450, 1011451 (кроме 1010821, 1010836))) ';
			|en = '(сумма гр.2 Раздела 7 по кодам 1010800 - 1010842, 1011450, 1011451 (кроме 1010821, 1010836))) '") +
		НСтр("ru = '= гр.3 стр.(120 + 135 + 150 + 160) Раздела 3 / (гр.3 стр.(120 + 135 + 150 + 160) Раздела 3 + ';
			|en = '= гр.3 стр.(120 + 135 + 150 + 160) Раздела 3 / (гр.3 стр.(120 + 135 + 150 + 160) Раздела 3 + '") +
		НСтр("ru = '(сумма гр.4 Раздела 7 по кодам 1010800 - 1010842, 1011450, 1011451 (кроме 1010821, 1010836)))';
			|en = '(сумма гр.4 Раздела 7 по кодам 1010800 - 1010842, 1011450, 1011451 (кроме 1010821, 1010836)))'"));
	...
	Заголовки.Вставить("ДляДокументации"	, НСтр("ru=''"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_07()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в гр.5 стр.118 Раздела 3 >= гр.5 стр.(003 + 005 + 007 + 010 + 020 + 021 + 022 + 030 ';
			|en = 'Сумма налога в гр.5 стр.118 Раздела 3 >= гр.5 стр.(003 + 005 + 007 + 010 + 020 + 021 + 022 + 030 '") +
		НСтр("ru = '+ 031 + 032 + 033 + 034 + 040 + 041 + 042 + 050 + 060 + 070 + 080 + 105 + 110 + 115) Раздела 3';
			|en = '+ 031 + 032 + 033 + 034 + 040 + 041 + 042 + 050 + 060 + 070 + 080 + 105 + 110 + 115) Раздела 3'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= %2';
													|en = '%1 >= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет';
													|en = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_11()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога, подлежащей вычету в гр.3 стр.170 Раздела 3 <= гр.5 стр.(003 + 005 + 007 ';
			|en = 'Сумма налога, подлежащей вычету в гр.3 стр.170 Раздела 3 <= гр.5 стр.(003 + 005 + 007 '") +
		НСтр("ru = '+ 020 + 021 + 022 + 032 + 033 + 034 + 040) Раздела 3';
			|en = '+ 020 + 021 + 022 + 032 + 033 + 034 + 040) Раздела 3'"));
...
Процедура ПроверкаКС_1_23_01()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Стоимость продаж по ставке 22% в стр.020 Приложения 1 к Разделу 9 >= стр.230 Раздела 9';
			|en = 'Стоимость продаж по ставке 22% в стр.020 Приложения 1 к Разделу 9 >= стр.230 Раздела 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= %2';
													|en = '%1 >= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет';
													|en = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_23_02()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Стоимость продаж по ставке 20% или 18% в стр.025 Приложения 1 к Разделу 9 >= стр.235 Раздела 9';
			|en = 'Стоимость продаж по ставке 20% или 18% в стр.025 Приложения 1 к Разделу 9 >= стр.235 Раздела 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= %2';
													|en = '%1 >= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет';
													|en = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_23_07()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога по ставке 22% в стр.050 Приложения 1 к Разделу 9 >= стр.260 Раздела 9';
			|en = 'Сумма налога по ставке 22% в стр.050 Приложения 1 к Разделу 9 >= стр.260 Раздела 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= %2';
													|en = '%1 >= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет';
													|en = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_23_08()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога по ставке 20% или 18% в стр.055 Приложения 1 к Разделу 9 >= стр.265 Раздела 9';
			|en = 'Сумма налога по ставке 20% или 18% в стр.055 Приложения 1 к Разделу 9 >= стр.265 Раздела 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= %2';
													|en = '%1 >= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет';
													|en = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_26_02()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru = '58, 59, 60, 61 + стр.(280 + 291 + 292) Приложения 1 к Разделу 9 в которых стр.090 = ';
			|en = '58, 59, 60, 61 + стр.(280 + 291 + 292) Приложения 1 к Разделу 9 в которых стр.090 = '") +
		НСтр("ru = '41, 42, 43, 44, 58, 59, 60, 61 - (стр.180 Раздела 8 в которых стр.010 = ';
			|en = '41, 42, 43, 44, 58, 59, 60, 61 - (стр.180 Раздела 8 в которых стр.010 = '") +
		НСтр("ru = '41, 42, 43, 44, 58, 59, 60, 61 + стр.180 Приложения 1 к Разделу 8 в которых стр.010 = ';
			|en = '41, 42, 43, 44, 58, 59, 60, 61 + стр.180 Приложения 1 к Разделу 8 в которых стр.010 = '") +
		НСтр("ru = '41, 42, 43, 44, 58, 59, 60, 61), с учетом погрешности округления (при наличии)';
			|en = '41, 42, 43, 44, 58, 59, 60, 61), с учетом погрешности округления (при наличии)'"));
...
Процедура ПроверкаКС_1_34()
	...
	Заголовки.Вставить("Описание"			,
		НСтр("ru = 'Стоимость продаж, облагаемых налогом по ставке 22% в стр.230 Раздела 9 >= сумме стр.170 Раздела 9';
			|en = 'Стоимость продаж, облагаемых налогом по ставке 22% в стр.230 Раздела 9 >= сумме стр.170 Раздела 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= %2';
													|en = '%1 >= %2'"));
...
Процедура ПроверкаКС_1_39()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Стоимость продаж по ставке 22% в стр.310 Приложения 1 к Разделу 9 >= стр.(020 + 250) Приложения 1 ';
			|en = 'Стоимость продаж по ставке 22% в стр.310 Приложения 1 к Разделу 9 >= стр.(020 + 250) Приложения 1 '") +
		НСтр("ru = 'к Разделу 9';
			|en = 'к Разделу 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= %4 (%2 + %3)';
													|en = '%1 >= %4 (%2 + %3)'"));
...
Процедура ПроверкаКС_1_45()
	...
	Заголовки.Вставить("Описание"			,
		НСтр("ru = 'Стоимость продаж, облагаемых налогом по ставке 20% или 18% в стр.235 Раздела 9 >= стр.175 Раздела 9';
			|en = 'Стоимость продаж, облагаемых налогом по ставке 20% или 18% в стр.235 Раздела 9 >= стр.175 Раздела 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= %2';
													|en = '%1 >= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможна ошибочная сумма НДС, подлежащая уплате в бюджет';
													|en = 'Возможна ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_47()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Стоимость продаж по ставке 20% или 18% в стр.315 Приложения 1 к Разделу 9 >= стр.(025 + 255) ';
			|en = 'Стоимость продаж по ставке 20% или 18% в стр.315 Приложения 1 к Разделу 9 >= стр.(025 + 255) '") +
		НСтр("ru = 'Приложения 1 к Разделу 9';
			|en = 'Приложения 1 к Разделу 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= %4 (%2 + %3)';
													|en = '%1 >= %4 (%2 + %3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет';
													|en = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_66()
	...
	Заголовки.Вставить("Описание"			, НСтр("ru = 'Код вида операции в стр.010 Раздела 8 (Приложения 1 к Разделу 8) ';
													|en = 'Код вида операции в стр.010 Раздела 8 (Приложения 1 к Разделу 8) '") +  
		НСтр("ru = '= 16, 17, 18, 22, 26, 43, либо 01 (в случае, когда стр.020, 030 = стр.060, 070 соответственно), если ';
			|en = '= 16, 17, 18, 22, 26, 43, либо 01 (в случае, когда стр.020, 030 = стр.060, 070 соответственно), если '") +
		НСтр("ru = 'стр.211, 212 Раздела 9 <> 0 или стр.291, 292 Приложения 1 к Разделу 9 <> 0';
			|en = 'стр.211, 212 Раздела 9 <> 0 или стр.291, 292 Приложения 1 к Разделу 9 <> 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2, если %3 (%4 + %5 + %6 + %7) > 0';
													|en = '%1 = %2, если %3 (%4 + %5 + %6 + %7) > 0'"));
	Заголовки.Вставить("Нарушение"			, 
		НСтр("ru = 'Возможно ошибочные коды операций в стр.010 Раздела 8 (Приложения 1 к Разделу 8)';
			|en = 'Возможно ошибочные коды операций в стр.010 Раздела 8 (Приложения 1 к Разделу 8)'"));
...
Процедура ПроверкаКС_1_67_1()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в стр.040 Раздела 1 >= стр.041 Раздела 1, если стр.041 Раздела 1 > 0';
			|en = 'Сумма налога в стр.040 Раздела 1 >= стр.041 Раздела 1, если стр.041 Раздела 1 > 0'"));
...
Процедура ПроверкаКС_1_67_2()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Если сумма налога в стр.040 Раздела 1 = 0, то стр.041 Раздела 1 = 0';
			|en = 'Если сумма налога в стр.040 Раздела 1 = 0, то стр.041 Раздела 1 = 0'"));
...
Процедура ПроверкаКС_1_68()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Если сумма налога в стр.041 Раздела 1 > 0, стр.041 Раздела 1 <= стр.(200 + 211 + 212) Раздела 9, ';
			|en = 'Если сумма налога в стр.041 Раздела 1 > 0, стр.041 Раздела 1 <= стр.(200 + 211 + 212) Раздела 9, '") +
		НСтр("ru = 'в которых стр.010 = 52, 53 + стр.(280 + 291 + 292) Приложения 1 к Разделу 9, в которых стр.090 = ';
			|en = 'в которых стр.010 = 52, 53 + стр.(280 + 291 + 292) Приложения 1 к Разделу 9, в которых стр.090 = '") +
		НСтр("ru = '52, 53 - (стр.180 Раздела 8, в которых стр.010 = 52, 53 + стр.180 Приложения 1 к Разделу 8, ';
			|en = '52, 53 - (стр.180 Раздела 8, в которых стр.010 = 52, 53 + стр.180 Приложения 1 к Разделу 8, '") +
		НСтр("ru = 'в которых стр.010 = 52, 53), с учетом погрешности округления (при наличии)';
			|en = 'в которых стр.010 = 52, 53), с учетом погрешности округления (при наличии)'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 <= %5 (%2 - (%3 + %4) + 0,49)';
													|en = '%1 <= %5 (%2 - (%3 + %4) + 0,49)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
...
Процедура ПроверкаКС_2_04_доп()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Код операции в стр.010 Раздела 4 <> 1010447 - 1010450, 1010494 - 1010499, 1011401 - 1011406';
			|en = 'Код операции в стр.010 Раздела 4 <> 1010447 - 1010450, 1010494 - 1010499, 1011401 - 1011406'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 <> 1010447 - 1010450, 1010494 - 1010499, 1011401 - 1011406';
													|en = '%1 <> 1010447 - 1010450, 1010494 - 1010499, 1011401 - 1011406'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочный код операции';
													|en = 'Возможно ошибочный код операции'"));
...
Процедура ПроверкаКС_2_05_доп()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Код операции в стр.010 Раздела 6 <> 1010447 - 1010450, 1010494 - 1010499, 1011401 - 1011406';
			|en = 'Код операции в стр.010 Раздела 6 <> 1010447 - 1010450, 1010494 - 1010499, 1011401 - 1011406'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 <> 1010447 - 1010450, 1010494 - 1010499, 1011401 - 1011406';
													|en = '%1 <> 1010447 - 1010450, 1010494 - 1010499, 1011401 - 1011406'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочный код операции';
													|en = 'Возможно ошибочный код операции'"));
		...
		Если СоединениеСтрок Тогда
			Если РезультатСверкиДекларации.НеУдалосьВыполнитьСверку Тогда
				...
				ТекстРезультатаСверки = НСтр("ru = ', не удалось произвести сверку счетов-фактур с контрагентами.';
											|en = ', не удалось произвести сверку счетов-фактур с контрагентами.'");
			ИначеЕсли РезультатСверкиДекларации.ЕстьРасхождения Тогда
				...
				ТекстРезультатаСверки.Добавить(НСтр("ru = ', и обнаружены ';
													|en = ', и обнаружены '"));
				ТекстРезультатаСверки.Добавить(Новый ФорматированнаяСтрока(НСтр("ru = 'расхождения';
																				|en = 'расхождения'"), , , , "ПоказатьРасхожденияСверки"));
				ТекстРезультатаСверки.Добавить(НСтр("ru = ' в счетах-фактурах сервисом 1С:Сверка 2.0';
													|en = ' в счетах-фактурах сервисом 1С:Сверка 2.0'"));
				
			ИначеЕсли РезультатСверкиДекларации.ЕстьНеСверенные Тогда
				ТекстРезультатаСверки = Новый Массив();
				ТекстРезультатаСверки.Добавить(НСтр("ru = ', и есть ';
													|en = ', и есть '"));
				ТекстРезультатаСверки.Добавить(Новый ФорматированнаяСтрока(НСтр("ru = 'не сверенные';
																				|en = 'не сверенные'"), , , , "ПоказатьРасхожденияСверки"));
				ТекстРезультатаСверки.Добавить(НСтр("ru = ' счета-фактуры сервисом 1С:Сверка 2.0';
													|en = ' счета-фактуры сервисом 1С:Сверка 2.0'"));
			Иначе
				ТекстРезультатаСверки = НСтр("ru = ', нет расхождений при сверке счетов-фактур с контрагентами';
											|en = ', нет расхождений при сверке счетов-фактур с контрагентами'");
