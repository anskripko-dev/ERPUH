...
Процедура НастроитьВариантыОтчета(Настройки) Экспорт
	...
	ОписаниеВарианта.Описание = НСтр("ru = 'Контроль остатков и движений товаров по организациям.';
									|en = 'Control stock balance and goods transfers by companies.'");
	...
	ОписаниеВарианта.Описание = НСтр("ru = 'Анализ движений товаров на складах и организациях.
		...
		|en = 'Analyze goods transfer in warehouses and companies.
		|Shows which company and warehouse have goods available and transfers over the period.'");
	...
	ОписаниеВарианта.Описание = НСтр("ru = 'Анализ движений товаров, переданных на хранение.
		...
		|en = 'Analyze transfer of VMI.
		|Check partners and contracts for our goods and transfers over the period.'");
	...
	ОписаниеВарианта.Описание = НСтр("ru = 'Анализ движений товаров, переданных на комиссию.
		|У каких партнеров и по каким договорам есть наш товар и были движения за период?';
		|en = 'Analyze transfers of consignment sales stock.
		|Check partners and contracts for our goods and transfers over the period.'");
	...
	ОписаниеВарианта.Описание = НСтр("ru = 'Анализ движений товаров, хранящихся у переработчиков.
									...
									|en = 'Analyze transfers of goods stored at subcontractors.
									|Check subcontractors and contracts for our goods and transfers over the period.'");
	ОписаниеВарианта.ФункциональныеОпции.Добавить("ИспользоватьПроизводствоНаСтороне2_5");
	
	ВариантыОтчетовУТПереопределяемый.ИзменитьРазмещениеВариантаОтчета(ОписаниеВарианта.Размещение, "Вставить", "Производство.ПередачаВПереработку2_5");
	ВариантыОтчетовУТПереопределяемый.ИзменитьРазмещениеВариантаОтчета(ОписаниеВарианта.Размещение, "Вставить", "Производство.ПередачаВПереработку2_5_СЗаголовками");
