...
Процедура ПоказатьПериод()
	...
	Если СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= КонецГода(Дата(2025,1,1)) Тогда
		СтрПериод = "по состоянию на 31 декабря " + Формат(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета, "ДФ='гггг ""г.""'");
	Иначе
