...
Асинх Процедура КолТовПриИзменении(Область)
	ДанныеСтраницы = ТекущаяСтраницаСДаннымиТовара();
	ОТЧ = ЭтотОбъект["ОТЧ"];
...
&НаКлиенте
Функция ТекущаяСтраницаСДаннымиТовара()
...
Процедура РасчетСуммНалогов()
	...
	ДанныеСтраницы.Вставить("СумАкцизТв", ОТЧ.ПривестиЗначение(ПредставлениеУведомления.Области["АкцТвСт"].Значение) 
		* ОТЧ.ПривестиЗначение(ПредставлениеУведомления.Области["АкцизТвБаза"].Значение) / 100);
...
Функция ЭтоОбластьОКСМ(Область)
	Возврат Область.Имя = "ОКСМПерев" Или Область.Имя = "ОКСМПроисх";
КонецФункции
