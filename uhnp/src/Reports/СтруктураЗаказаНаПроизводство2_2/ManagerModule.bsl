...
Функция ТекстЗапросаДанныеСтруктурыЗаказов()
	...
	ТекстЗапроса =
		...
		|	МАКСИМУМ(ЕСТЬNULL(График.Окончание, ДАТАВРЕМЯ(1, 1, 1)))      КАК ДатаОкончанияПлан
		...
		|		ЕСТЬNULL(ГрафикЭтаповПроизводства2_2.Окончание, ДАТАВРЕМЯ(1, 1, 1)) КАК ДатаОкончанияПлан,
		...
		|			ПО (ЭтапПроизводства2_2.Распоряжение = ГрафикЭтаповПроизводства2_2.ЗаказНаПроизводство)
		|				И ВТВыпуск.Этап = ГрафикЭтаповПроизводства2_2.Этап
		...
		|			ИНАЧЕ 0
		|		КОНЕЦ,
		|		ЕСТЬNULL(ГрафикЭтаповПроизводства2_2.Окончание, ДАТАВРЕМЯ(1, 1, 1)),
		...
		|			ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ГрафикЭтаповПроизводства2_2 КАК ГрафикЭтаповПроизводства2_2
		|			ПО (ЭтапПроизводства2_2.Распоряжение = ГрафикЭтаповПроизводства2_2.ЗаказНаПроизводство)
		|				И ВТВыпускРазныеЗаказы.Этап = ГрафикЭтаповПроизводства2_2.Этап
		|				И (ГрафикЭтаповПроизводства2_2.СтатусГрафика = &СтатусГрафика)
		|	ГДЕ
		...
		|	График.Окончание                   КАК ДатаОкончанияПлан,
