...
Функция СформироватьВнешниеНаборыДанных(НастройкиОсновнойСхемы)
	...
	Для каждого СтрокаВидРЦ Из СписокВидовРЦ Цикл
		...
		Пока ТекущийПериод <= ЗначенияОтбораДанных.ОкончаниеПериода Цикл
			...
			Если НЕ ЗначенияОтбораДанных.СкрыватьИнтервалыБезЗагрузки ИЛИ НайденнаяЗанятостьВРЦ.Количество() <> 0 И НайденнаяДоступностьВРЦ.Количество() <> 0 Тогда
...
Функция ПолучитьЗначенияОтбораДанных(НастройкиОсновнойСхемы)
	...
	СкрыватьИнтервалыБезЗагрузки = КомпоновкаДанныхКлиентСервер.ПолучитьПараметр(НастройкиОсновнойСхемы, "СкрыватьИнтервалыБезЗагрузки").Значение;
	...
	ЗначенияОтбораДанных.Вставить("СкрыватьИнтервалыБезЗагрузки", СкрыватьИнтервалыБезЗагрузки);
