...
Процедура ДобавитьСтроку(Команда)
	...
	Если КолСтрок = МаксимальноеКоличествоСтрокГруппы Тогда
		ТекстВопроса = НСтр(СтрЗаменить("ru = 'Количество строк на странице не может превышать #МаксимальноеКоличествоСтрокГруппы#. Добавить новую страницу?';
										|en = 'Количество строк на странице не может превышать #МаксимальноеКоличествоСтрокГруппы#. Добавить новую страницу?'","#МаксимальноеКоличествоСтрокГруппы#",МаксимальноеКоличествоСтрокГруппы));
