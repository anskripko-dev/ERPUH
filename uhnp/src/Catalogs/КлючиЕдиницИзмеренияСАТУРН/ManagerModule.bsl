...
Функция ДанныеОбъекта(ЭлементДанных) Экспорт
	...
	ИначеЕсли ОбщегоНазначенияКлиентСервер.ЕстьРеквизитИлиСвойствоОбъекта(ЭлементДанных, "puKgWeight") Тогда
		ДанныеПартии.Вставить("КоличествоСАТУРН",     ЭлементДанных.puKgWeight);
	...
	ИначеЕсли ОбщегоНазначенияКлиентСервер.ЕстьРеквизитИлиСвойствоОбъекта(ЭлементДанных, "puTitle") Тогда
		ДанныеПартии.Вставить("НаименованиеУпаковки", ЭлементДанных.puTitle);
	ИначеЕсли ОбщегоНазначенияКлиентСервер.ЕстьРеквизитИлиСвойствоОбъекта(ЭлементДанных, "puUnit") Тогда
		ДанныеПартии.Вставить("НаименованиеУпаковки", ЭлементДанных.puUnit);
