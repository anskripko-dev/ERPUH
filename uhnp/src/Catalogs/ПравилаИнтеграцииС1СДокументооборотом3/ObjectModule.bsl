...
Процедура ПроверитьНаличиеДублей()
	...
	ТекущиеКлючевыеРеквизитыИС = КлючевыеРеквизитыИС.Выгрузить(, КлючевыеРеквизитыИСКолонки);
		...
		Если ОбщегоНазначения.КоллекцииИдентичны(ТекущиеКлючевыеРеквизитыИС, Выборка.КлючевыеРеквизитыИС.Выгрузить()) Тогда
			ВызватьИсключение СтрШаблон(
				НСтр("ru = 'Правило интеграции объекта ""%1"" уже существует.
					|Для создания еще одного правила требуется изменить набор ключевых реквизитов.';
					|en = 'Правило интеграции объекта ""%1"" уже существует.
					|Для создания еще одного правила требуется изменить набор ключевых реквизитов.'"),
				ПредставлениеОбъектаИССКлючевымиПолями);
		КонецЕсли;
	КонецЦикла;
