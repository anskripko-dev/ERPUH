...
Процедура ДобавитьУсловноеОформление();
	...
	ЭлементОтбора.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("СоставПанели.СохраненнаяНастройка"); 
	ЭлементОтбора.ВидСравнения = ВидСравненияКомпоновкиДанных.НеЗаполнено; 
	
	ЭлементОформления.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = '(По умолчанию)'"));
	
	ПолеОформления = ЭлементОформления.Поля.Элементы.Добавить();
	ПолеОформления.Поле = Новый ПолеКомпоновкиДанных("СоставПанелиНастройкиОтчета");
...
Процедура ОткрытьОбщиеОтборыПродолжение()
    ...
    ОткрытьФорму("Справочник.УдалитьПанелиОтчетов.Форма.ФормаНастройкиОтборов_Управляемая", 
...
Процедура ОткрытьПанель(Команда)
	...
	ОткрытьФорму("Справочник.УдалитьПанелиОтчетов.Форма.ФормаЭлемента_Управляемая", Новый Структура("Ключ", Параметры.Ключ));
...
Процедура ПодчиненныеОтчеты(Команда)
	...
	Если ТекСтрока <> Неопределено Тогда
		...
		ОткрытьФорму("Справочник.УдалитьПанелиОтчетов.Форма.НастройкаПодчиненностиОтчетов", 
					ПараметрыФормы,,,,, Оповещение, РежимОткрытияОкнаФормы.БлокироватьВесьИнтерфейс);
	КонецЕсли;
...
Процедура СоставПанелиВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если Поле.Имя <> "СоставПанелиГруппировкаПанелей" И ТекущиеДанные.ВидПроизвольногоОтчета > 1 Тогда
		...
		Если ЗначениеЗаполнено(ТекущиеДанные.РасшифровываемаяОбласть) Тогда
			...
			ОткрытьФорму("Справочник.УдалитьПанелиОтчетов.Форма.ФормаНастройкиПанелиОтчета", 
							ПараметрыФормы,,,,, Оповещение, РежимОткрытияОкнаФормы.БлокироватьВесьИнтерфейс);
            Возврат;
