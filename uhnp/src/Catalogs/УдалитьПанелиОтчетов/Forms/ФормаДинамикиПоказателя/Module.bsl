...
Процедура Сформировать_Сервер()
	Если ЭтоАдресВременногоХранилища(АдресТаблицы) Тогда
		...
		// Получение макета.
		СхемаКД = Справочники.УдалитьПанелиОтчетов.ПолучитьМакет("МакетДинамика");
...
Функция ПолучитьАдресТаблицыРасшифровкиПоАналитикам(Показатель, Контекст)
	РезультатФункции = Справочники.УдалитьПанелиОтчетов.ПолучитьАдресТаблицыРасшифровкиПоАналитикам(Показатель, Контекст);
	Возврат РезультатФункции;
КонецФункции
