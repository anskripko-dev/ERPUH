...
Процедура Далее(Команда)
	...
	Если Элементы.ГруппаСтраницы.ТекущаяСтраница = Элементы.ГруппаСтраницы.ПодчиненныеЭлементы.СтраницаОрганизация
		...
		Для Каждого ОписаниеЗначения Из СписокРолей Цикл
			...
			Если НеДоступныеДляРедактированияРоли.НайтиПоЗначению(ОписаниеЗначения.Значение) <> Неопределено Тогда
				Продолжить;
			КонецЕсли;
...
Процедура УстановитьУсловноеОформление()
	...
	// Только чтение для недоступных для редактирования ролей.
	Элемент = УсловноеОформление.Элементы.Добавить();
	
	ПолеЭлемента = Элемент.Поля.Элементы.Добавить();
	ПолеЭлемента.Поле = Новый ПолеКомпоновкиДанных(Элементы.СписокРолей.Имя);
	
	ОтборЭлемента = Элемент.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
	ОтборЭлемента.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("СписокРолей.Значение");
	ОтборЭлемента.ВидСравнения = ВидСравненияКомпоновкиДанных.ВСписке;
	
	НеДоступныеДляРедактированияРоли.Очистить();
	
	НеДоступныеДляРедактированияРоли.Добавить(Перечисления.РолиКонтрагентовСАТУРН.ПроизводительПАТ);
	НеДоступныеДляРедактированияРоли.Добавить(Перечисления.РолиКонтрагентовСАТУРН.Дистрибьютор);
	НеДоступныеДляРедактированияРоли.Добавить(Перечисления.РолиКонтрагентовСАТУРН.Ритейлер);
	НеДоступныеДляРедактированияРоли.Добавить(Перечисления.РолиКонтрагентовСАТУРН.ОрганизацияУтилизатор);
	НеДоступныеДляРедактированияРоли.Добавить(Перечисления.РолиКонтрагентовСАТУРН.Импортер);
	НеДоступныеДляРедактированияРоли.Добавить(Перечисления.РолиКонтрагентовСАТУРН.ПроизводительСельхозпродукции);
	
	ОтборЭлемента.ПравоеЗначение = НеДоступныеДляРедактированияРоли;
...
Процедура ЗаполнитьСписокДоступныхРолей()
	...
	РедактированиеЗаписанногоОбъекта = ЗначениеЗаполнено(Организация);
	...
	Для Каждого ДоступноеЗначение Из Метаданные.Перечисления.РолиКонтрагентовСАТУРН.ЗначенияПеречисления Цикл
		...
		Если Не РедактированиеЗаписанногоОбъекта И НеДоступныеДляРедактированияРоли.НайтиПоЗначению(ЗначениеРоли) <> Неопределено Тогда
			Продолжить;
		КонецЕсли;
...
Процедура УправлениеЭлементамиНавигацииПомощника(Форма)
	...
	Если Элементы.ГруппаСтраницы.ТекущаяСтраница = Элементы.СтраницаОрганизация Тогда
		...
		Иначе
			...
			Элементы.Наименование.Видимость = Форма.РежимИзменения;
