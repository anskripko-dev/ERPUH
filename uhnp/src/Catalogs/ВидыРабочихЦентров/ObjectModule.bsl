...
Процедура ПроверитьМаксимальнуюДоступностьРЦ(Отказ)
	...
	Если Не ЗначениеЗаполнено(ИнтервалПланирования) Или ИнтервалПланирования = Перечисления.ТочностьГрафикаПроизводства.Смена Тогда
		Возврат;
	КонецЕсли;
	
	Если ЗначениеЗаполнено(МаксимальнаяДоступностьРЦ) И ЗначениеЗаполнено(ЕдиницаИзмеренияДоступностиРЦ) Тогда
