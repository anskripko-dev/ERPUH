...
Функция СведенияМЧД(МЧД) Экспорт
	...
	Реквизиты = "ДатаВыдачи, ДатаОкончания, ДатаОбновленияСтатуса, СтатусВРеестреФНС, ДоверительЮЛ_КПП,
				...
				|ЭлектроннаяПодпись, XMLфайлМЧД, ИмяФайлаЗаявленияНаОтзыв, ФайлЗаявленияНаОтзыв, ЭлектроннаяПодписьЗаявленияНаОтзыв";
	...
	ЗаполнитьЗначенияСвойств(СведенияМЧД, РеквизитыМЧД,
		...
		|ИННДоверителяРодительскойДоверенности, НомерДоверенности, НомерРодительскойДоверенности, ИмяФайлаЗаявленияНаОтзыв");
