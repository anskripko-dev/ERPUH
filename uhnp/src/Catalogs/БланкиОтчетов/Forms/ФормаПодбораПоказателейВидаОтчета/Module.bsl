...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)	
	...
	ШаблонОформленияБланковОтчетов = Константы.ШаблонОформленияБланковОтчетовПоУмолчанию.Получить();
	Если НЕ ЗначениеЗаполнено(ШаблонОформленияБланковОтчетов) Тогда
		ШаблонОформленияБланковОтчетов = Справочники.ШаблоныОформленияБланковОтчетов.Основной;
	КонецЕсли;
...
Процедура Применить(Команда)
	...
	Если ШаблонОформленияБланковОтчетов.Пустая() тогда
		СообщениеОбОшибке = Новый СообщениеПользователю;
		СообщениеОбОшибке.Текст = Нстр("ru = 'Не заполнен ""Шаблон оформления бланков отчетов""'");
		СообщениеОбОшибке.ПутьКДанным = "ШаблонОформленияБланковОтчетов";
...
Функция СформироватьПараметры()
	...
	СтруктураОтвета.Вставить("ШаблонОформленияБланковОтчетов", ШаблонОформленияБланковОтчетов);
	СтруктураОтвета.Вставить("ВыводитьРеквизиты",	   		ВыводитьРеквизиты);
