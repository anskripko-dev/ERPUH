...
//++ НЕ УТКА
	...
	РедакторПроизводственногоПроцесса.ЗаполнитьВидыРабочихЦентров(
		Объект, ВидыРабочихЦентров, ЕстьПараллельнаяЗагрузка, ЕстьСинхроннаяЗагрузка);
...
Процедура НастроитьЗависимыеЭлементыФормы(Форма, СписокРеквизитов = "")
	...
	Если СтруктураРеквизитов.Свойство("ВидыРабочихЦентров")
		...
		РедакторПроизводственногоПроцессаКлиентСервер.НастроитьЭлементОдновременноПроизводимоеКоличество(Объект, Форма);
