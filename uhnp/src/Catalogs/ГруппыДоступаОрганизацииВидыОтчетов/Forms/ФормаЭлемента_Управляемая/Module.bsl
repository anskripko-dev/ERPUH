...
Процедура ЗаполнитьОрганизации(ОрганизацияРодитель)
	...
	ТаблицаКЗаполнению=Запрос.Выполнить().Выгрузить();
	
	Если ТаблицаКЗаполнению.Количество()=0 Тогда
		
		СообщениеПользователю = Новый СообщениеПользователю;
		СообщениеПользователю.Текст = Нстр("ru = 'Все организации уже включены в группы доступа.'");
		СообщениеПользователю.Сообщить();
		Возврат;
		
	КонецЕсли;
	
	ОбщегоНазначенияУХ.ЗагрузитьВТаблицуЗначений(ТаблицаКЗаполнению,Объект.Организации);
