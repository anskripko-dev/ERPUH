...
Процедура ДеревоОтбораОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	МассивДобавляемых = ПроверитьДублированиеЗаписейВДеревеОтбораПриДобавлении(ВыбранноеЗначение);
	МашиночитаемыеДоверенностиКлиент.ДеревоОтбораОбработкаВыбора(Элемент, МассивДобавляемых, СтандартнаяОбработка);
