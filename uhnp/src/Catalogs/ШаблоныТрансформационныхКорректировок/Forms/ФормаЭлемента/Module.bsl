...
Процедура УстановитьВидимость()
	...
	Элементы.ДляОнлайнПроводок.Видимость=ОбщегоНазначения.ПодсистемаСуществует("ПодсистемыУХ.КорпоративноеКазначейство");
...
Процедура ДобавлениеШаблона_Завершение(Результат, Параметры) Экспорт
	...
	Если (РазрешатьДобавление) И (ЗначениеЗаполнено(Объект.Ссылка)) Тогда
		...
		Если Элементы.ГруппаНастройкаДвижений.ТекущаяСтраница=Элементы.ГруппаШаблоныПроводок Тогда
