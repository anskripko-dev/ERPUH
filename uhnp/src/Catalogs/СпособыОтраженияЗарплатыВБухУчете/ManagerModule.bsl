...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	СписокОписаний.Добавить(НСтр("ru = 'Обновление справочника ""Способы отражения зарплаты"":';
								|en = 'Update the ""Salary record methods"" catalog:'"));
	СписокОписаний.Добавить(НСтр("ru = '- замена аналитик активов/пассивов с перечисления ""Типы налогов"" на справочник ""Виды налогов и взносов"".';
								|en = '- Replace the ""Tax types"" enumeration type with the ""Tax and contribution kinds"" catalog in the values of dimensions of assets/liabilities.'"));
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	СписокОписаний.Добавить(НСтр("ru = 'Не удалось обработать справочник ""Способы отражения зарплаты"" по обработчику:';
								|en = 'Cannot process the ""Salary record methods"" catalog by the handler:'"));
