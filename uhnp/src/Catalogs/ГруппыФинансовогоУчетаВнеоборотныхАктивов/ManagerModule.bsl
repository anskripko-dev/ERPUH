...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Обновляет справочник ""Группы финансового учета внеоборотных активов"":
								  ...
								  |en = 'Updates the ""Fixed/Intangible assets accounting groups"" catalog:
								  |- Changes the asset type to ""Fixed assets provided to lessee"" if the 03.01 ledger account is selected.'");
