...
Процедура ПередЗаписью(Отказ)
	...
	Если Не ЭтоГруппа Тогда
		...
		Если Не ЗначениеЗаполнено(ВариантНастройки) Тогда
			ТекстОшибки = ТекстОшибки
				+ НСтр("ru = 'Поле ВариантНастройки не заполнено.';
						|en = 'The SetupOption field is not filled in.'")
				+ Символы.ПС;
		КонецЕсли;
	...
	СистемаБыстрыхПлатежейСлужебный.ДобавитьЗаданиеЗагрузкаСтатусовОперацийСБП();
