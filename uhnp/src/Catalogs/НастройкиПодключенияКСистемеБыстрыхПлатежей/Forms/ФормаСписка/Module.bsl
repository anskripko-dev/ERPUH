...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ФормаОткрытьКассовыеСсылки.Видимость = НастройкиПодключенияПрограммы.c2b.ИспользоватьНастройкуКассовыхСсылок;
	Если НастройкиПодключенияПрограммы.c2b.ШаблоныНазначений.Количество() = 0
		И НастройкиПодключенияПрограммы.b2b.ШаблоныНазначений.Количество() = 0 Тогда
...
Процедура ОткрытьКассовыеСсылки(Команда)
	...
	Если Не ДоступнаНастройкаКассовойСсылки(НастройкаПодключения) Тогда
		ПоказатьПредупреждение(
			Неопределено,
...
&НаСервереБезКонтекста
Функция ДоступнаНастройкаКассовойСсылки(Знач НастройкаПодключения)
