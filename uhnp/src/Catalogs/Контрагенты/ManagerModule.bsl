...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	СписокОписаний.Добавить(НСтр("ru = 'Не удалось обработать справочник ""Контрагенты"" по обработчику:';
								|en = 'Cannot process the ""Counterparties"" catalog by the handler:'"));
	СписокОписаний.Добавить(НСтр("ru = '- Заполнение xml данных контактной информации';
								|en = '- Fill XML contact information data'"));
	Запрос = Новый Запрос;
	Запрос.Текст = 
