...
Процедура ЗарегистрироватьНесертифицированныеДрайверы(ДрайверыОборудования) Экспорт
	...
	Для Каждого Драйвер Из ДрайверыОборудования Цикл // Структура
		...
		Если Не РеквизитыДрайвераЗаполнены(Драйвер) Тогда
			#Если НЕ МобильноеПриложениеСервер Тогда
				...
				|en = 'The ""%1"" driver attributes are incorrectly filled out.
				|For registration, fill out: Equipment type, Description, Object ID, Template name.'");
				ТекстСообщения = СтрШаблон(ТекстСообщения, Драйвер.Наименование);
