...
Функция НесовместимыеПрофилиГруппДоступа() Экспорт
	...
	НесовместимыеПрофили.Добавить(Справочники.ПрофилиГруппДоступа.Казначей);
	НесовместимыеПрофили.Добавить(Справочники.ПрофилиГруппДоступа.ФинансовыйАналитик);
	НесовместимыеПрофили.Добавить(Справочники.ПрофилиГруппДоступа.Кладовщик);
	НесовместимыеПрофили.Добавить(Справочники.ПрофилиГруппДоступа.МенеджерПоЗакупкам);
	НесовместимыеПрофили.Добавить(Справочники.ПрофилиГруппДоступа.МенеджерПоОбеспечениюПотребностей);
	НесовместимыеПрофили.Добавить(Справочники.ПрофилиГруппДоступа.РаботникСклада);
	НесовместимыеПрофили.Добавить(Справочники.ПрофилиГруппДоступа.УчастникСогласованияУсловийЗакупок);
	НесовместимыеПрофили.Добавить(Справочники.ПрофилиГруппДоступа.АналитикМеждународногоУчета);
	НесовместимыеПрофили.Добавить(Справочники.ПрофилиГруппДоступа.БухгалтерМеждународногоУчета);
	НесовместимыеПрофили.Добавить(Справочники.ПрофилиГруппДоступа.ПользовательОтчетностиМеждународногоУчета);
	НесовместимыеПрофили.Добавить(Справочники.ПрофилиГруппДоступа.АдминистраторБюджетнойМодели);
	НесовместимыеПрофили.Добавить(Справочники.ПрофилиГруппДоступа.ИсполнительБюджетногоПроцесса);
	НесовместимыеПрофили.Добавить(Справочники.ПрофилиГруппДоступа.КонтролерБюджетирования);
	НесовместимыеПрофили.Добавить(Справочники.ПрофилиГруппДоступа.КоординаторБюджетирования);
	НесовместимыеПрофили.Добавить(Справочники.ПрофилиГруппДоступа.УправлениеЛимитамиПоДаннымБюджетирования);
	#КонецОбласти
