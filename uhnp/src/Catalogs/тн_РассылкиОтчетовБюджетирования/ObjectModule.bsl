...
Процедура ПередЗаписью(Отказ)  
	...
	ИначеЕсли ЭтоГруппа Тогда 
		Личная = тн_РассылкаОтчетовБюджетирования.ПринадлежитГруппеЛичныхРассылок(Родитель);
		Возврат;
	КонецЕсли;
	...
	ГруппаВходитВИерархиюЛичныхРассылок = тн_РассылкаОтчетовБюджетирования.ПринадлежитГруппеЛичныхРассылок(Родитель);
	Если Личная <> ГруппаВходитВИерархиюЛичныхРассылок Тогда
		Родитель = ?(Личная, Справочники.тн_РассылкиОтчетовБюджетирования.ЛичныеРассылки, Справочники.тн_РассылкиОтчетовБюджетирования.ПустаяСсылка());
	КонецЕсли;        
