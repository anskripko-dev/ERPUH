...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ДополнительныеЯзыкиУХ.УстановитьВидимостьСинонимов(ЭтаФорма);
...
Процедура ОбновитьОтборПоВладельцу()
	...
	Если ТипБД=Справочники.ТипыБазДанных.ТекущаяИБ Тогда
		...
		Элементы.ВидКонтроляНСИ.Видимость=Истина;
		Элементы.ПоставщикПотребительНСИ.Видимость=Истина;
	...
	Иначе
		...
		Элементы.ВидКонтроляНСИ.Видимость=Ложь;
		Элементы.ПоставщикПотребительНСИ.Видимость=Ложь;
...
Процедура ЗаполнитьСписокСправочников(ТипБД)
	...
	РаботаСОбъектамиМетаданныхУХ.ЗаполнитьСписокСправочниковБД(ТипБД);
