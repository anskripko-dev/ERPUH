...
&НаКлиенте
Процедура Подключаемый_ЭлементПриИзмененииУХ(Элемент) Экспорт
	 ДоговорыКонтрагентовФормыУХКлиент.ДоговорыФормаСписка_ЭлементПриИзменении(ЭтотОбъект, Элемент);
КонецПроцедуры
#КонецОбласти