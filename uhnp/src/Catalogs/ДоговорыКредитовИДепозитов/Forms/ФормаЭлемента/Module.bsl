...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ДоговорыКонтрагентовФормыУХ.ДоговорКредитаИДепозитаПриСозданииНаСервере(ЭтотОбъект);
	#КонецОбласти
КонецПроцедуры
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	ДоговорыКонтрагентовФормыУХКлиент.ОбработатьОповещенияДоговораКредитаИДепозита(ЭтотОбъект, ИмяСобытия, Параметр, Источник);
	#КонецОбласти
