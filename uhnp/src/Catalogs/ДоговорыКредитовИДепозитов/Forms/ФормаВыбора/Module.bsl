...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	НеприоритетныеПоля.Добавить("ХарактерДоговора");
	НеприоритетныеПоля.Добавить("ВидДоговораУХ");
	
	УправлениеФормойУХ.УстановитьПредставлениеОтбора(ЭтотОбъект, , Метаданные.Справочники.ДоговорыКредитовИДепозитов, ПриоритетныеПоля, НеприоритетныеПоля);
