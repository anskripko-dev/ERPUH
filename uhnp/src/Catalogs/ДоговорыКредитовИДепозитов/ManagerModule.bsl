...
Функция ДанныеШапкиДокументаДДС(ДоговорКредитаДепозита, ЭтоДокументПоступления = Ложь)
	...
	ТекстДляЗамены = "ДоговорКредитаДепозита.Ссылка КАК ДоговорКредитаДепозита,";
	ТекстЗамены = "
	|	ДоговорКредитаДепозита.ВерсияСоглашения.ОсновнойЦФО КАК ЦФО,
	|	ДоговорКредитаДепозита.ВерсияСоглашения.ОсновнойПроект КАК Проект,
	|	ДоговорКредитаДепозита.ВерсияСоглашения.ОсновнаяВалютаПлатежей КАК ВалютаОплаты,
	|	ВЫБОР ДоговорКредитаДепозита.ХарактерДоговора
...
Процедура ДобавитьКомандыОтчетов(КомандыОтчетов, Параметры) Экспорт
	...
	//КонецЕсли;
	Отчеты.АнализГрафикаФинансовогоИнструмента.ДобавитьКомандуОтчета(КомандыОтчетов, 		"СводныйГрафик");
	Отчеты.АнализГрафикаФинансовогоИнструмента.ДобавитьКомандуОтчета(КомандыОтчетов, 		"ДинамикаЗадолженности");
	Отчеты.АнализГрафикаФинансовогоИнструмента.ДобавитьКомандуОтчета(КомандыОтчетов, 		"СтруктураЗадолженности");
	Отчеты.ОСВМСФО.ДобавитьКомандуОтчета(КомандыОтчетов, 									"АнализСубконто");
	Отчеты.ПланФактныйАнализФинансовыхИнструментовУХ.ДобавитьКомандуОтчета(КомандыОтчетов, 	"ПланФактныйАнализКредитыДепозитыКонтекстУХ");	
	Отчеты.ОтчетПоКовенантам.ДобавитьКомандуОтчета(КомандыОтчетов, 	"Основной");	
	#КонецОбласти
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	СписокОписаний.Добавить(НСтр("ru = 'Обновление элементов справочника ""Договоры кредитов и депозитов"":';
								|en = 'Updating ""Loan and Deposit Agreements"" catalog items:'"));
