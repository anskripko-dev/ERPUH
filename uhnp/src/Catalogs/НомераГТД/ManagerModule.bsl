...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполняет реквизит ""Единица измерения"" значением по умолчанию ""шт"" по ОКЕИ для элементов справочника типа РНПТ.';
									|en = 'Fills the ""Unit of measure"" attribute with the default ""pcs"" value by ID for the RNPT type catalog items.'");
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	СписокОписаний.Добавить(НСтр("ru = 'Не удалось обработать справочник ""Номера ГТД"" по обработчику:';
								|en = 'Не удалось обработать справочник ""Номера ГТД"" по обработчику:'"));
	СписокОписаний.Добавить(НСтр("ru = '- заполнение реквизита ""Единица измерения"" значением по умолчанию ""шт"" по ОКЕИ для элементов справочника типа РНПТ.';
								|en = '- заполнение реквизита ""Единица измерения"" значением по умолчанию ""шт"" по ОКЕИ для элементов справочника типа РНПТ.'"));
	...
	Для Каждого ДанныеСправочника Из ОбновляемыеДанные Цикл
		...
		Попытка
			...
			Рекомендация = НСтр("ru = 'Проверьте данные справочника вручную.';
								|en = 'Проверьте данные справочника вручную.'");
