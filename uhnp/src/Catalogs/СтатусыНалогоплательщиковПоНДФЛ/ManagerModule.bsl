...
Процедура ПроставитьКоды2026Года() Экспорт
	...
	ОписатьСтатусНалогоплательщика("ГражданинСтраныЕАЭС", НСтр("ru = 'Гражданин страны-участника Договора о ЕАЭС';
																|en = 'Гражданин страны-участника Договора о ЕАЭС'"), "-", "9", 7);
	ОписатьСтатусНалогоплательщика("Иноагент", НСтр("ru = 'Физическое лицо - иностранный агент';
													|en = 'Физическое лицо - иностранный агент'"), "-", "0", 10);
