...
&НаКлиенте
Функция ПолучитьПредставлениеГраницы(СпособВычисления,УточнениеСпособа)

	Возврат Строка(СпособВычисления)+" "+УточнениеСпособа;
	
КонецФункции // ПолучитьПредставлениеГраницы() 
...
Процедура Записать(Команда)
	...
	Если НЕ ЕстьУточнениеНачалаПериода Тогда
		...
		ГраницыПериода.Вставить(0,СпособВычисленияНачалаИнтервала);
	...
	Иначе
		...
		ГраницыПериода.Вставить(0,ГраницаНач,ПолучитьПредставлениеГраницы(СпособВычисленияНачалаИнтервала,УточнениеСпособаОпределенияНач));
	...
	Если Не ЕстьУточнениеОкончанияПериода Тогда
		...
		ГраницыПериода.Вставить(1,СпособВычисленияОкончанияИнтервала);
	...
	Иначе
		...
		ГраницыПериода.Вставить(1,ГраницаКон,ПолучитьПредставлениеГраницы(СпособВычисленияОкончанияИнтервала,УточнениеСпособаОпределенияКон));
