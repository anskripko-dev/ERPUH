...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "Запись_КлассификаторТранспортныхСредствСАТУРН"
		И ТипЗнч(Источник) = Тип("СправочникСсылка.КлассификаторТранспортныхСредствСАТУРН") Тогда
...
Процедура ЗагрузитьКлассификатор(Команда)
	...
	ЗагрузитьКлассификаторТранспортныхСредств_ДлительнаяОперация();
...
Процедура УстановитьЗаголовокФормы()
	...
	Если РежимВыбора Тогда
		ТекстЗаголовка = НСтр("ru = 'Выбор классификатора транспортных средств САТУРН';
								|en = 'Выбор классификатора транспортных средств САТУРН'");
	Иначе
		ТекстЗаголовка = НСтр("ru = 'Классификатор транспортных средств САТУРН';
								|en = 'Классификатор транспортных средств САТУРН'");
	КонецЕсли;
...
&НаКлиенте
Процедура ЗагрузитьКлассификаторТранспортныхСредств_ДлительнаяОперация()
	
	ПараметрыОбработкиДокументов = ИнтеграцияСАТУРНСлужебныйКлиентСервер.ПараметрыОбработкиДокументов();
	ПараметрыОбработкиДокументов.Ссылка             = ПредопределенноеЗначение("Справочник.КлассификаторТранспортныхСредствСАТУРН.ПустаяСсылка");
