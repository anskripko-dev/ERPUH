...
Процедура ДатаНачалаЗагрузкиОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	Если ВыбранноеЗначение < ОбщегоНазначенияБПОКлиент.ДатаСеанса() - 6*30*86400 И
		Не ТипОфлайнОборудования = ПредопределенноеЗначение("Перечисление.ТипыОфлайнОборудования.ОФД") Тогда
...
Процедура УстановитьМаксимальнуюДатуЗагрузки()
	...
	Если Не ТипОфлайнОборудования = Перечисления.ТипыОфлайнОборудования.ОФД Тогда
