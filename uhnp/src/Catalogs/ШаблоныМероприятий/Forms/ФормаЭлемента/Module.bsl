...
Процедура УправлениеДоступностью()
	...
	Элементы.СпособыВыбораПоставщика.Видимость = ЭтоВидМероприятияЗакупочнаяПроцедура;		
...
Процедура ЗаполнитьСтадииПоУмолчанию_Сервер(ОчисткаВход = Истина)
	...
	КонецЕсли;
	Если //НЕ 
		ОбщегоНазначения.ПодсистемаСуществует("ПодсистемыУХ.ИнтеграцияЦентрализованноеУправлениеЗакупками") Тогда
...
Процедура СвернутьДерево()
	...
	Для Каждого ТекЭлементыДерева Из ЭлементыДерева Цикл 
		...
		Если Элементы.ДеревоСтадий.Видимость И Элементы.ГруппаСтраницаСтадии.Видимость Тогда    
			Если Элементы.ДеревоСтадий.Видимость Тогда
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	КонецЕсли;
	Если Не ОбщегоНазначения.ПодсистемаСуществует("ПодсистемыУХ.ИнтеграцияЦентрализованноеУправлениеЗакупками") Тогда
...
Процедура СпособыВыбораПоставщикаПриИзменении(Элемент)
	Объект.СпособВыбораПоставщика = ЗначениеРеквизита(Объект.СпособыВыбораПоставщика,"СпособыВыбораПоставщика");
	УправлениеДоступностью();      
    ЗаполнитьСтадииПоУмолчанию_Сервер();	
КонецПроцедуры

&НаСервереБезКонтекста
Функция ЗначениеРеквизита(Объект, Имя)
	Возврат ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Объект, Имя);
КонецФункции
