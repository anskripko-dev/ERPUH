...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Обеспечение';
		...
		#Область ГарантияПолученная
		ИмяПредопределенныхДанных = "ГарантияПолученная";
		Элемент = Элементы.Добавить(); // см. СтрокаТЧПредопреденногоЭлемента
		Элемент.ИмяПредопределенныхДанных = ИмяПредопределенныхДанных;
		Элемент.Родитель = Справочники.ВидыДоговоровКонтрагентовУХ.Обеспечение;
		МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Гарантия полученная';
																						|en = ''", КодыЯзыков); // @НСтр-2
		Элемент.Ссылка = СсылкаНаПредопределенныйЭлемент(ИмяПредопределенныхДанных) ;
		ЗаполнитьСвойстваПредопределенногоЭлементаИзМакета(Элемент,СвойстваПредопределенныхЭлементовИзМакета);
		#КонецОбласти //ГарантияПолученная   
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Продажи и покупки';
		...
		Элемент.ИмяПредопределенныхДанных = ИмяПредопределенныхДанных;
		Элемент.Родитель = Справочники.ВидыДоговоровКонтрагентовУХ.ПродажиИПокупки;
		МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'С давальцем (2.4)';
																						|en = ''", КодыЯзыков); // @НСтр-2
		Элемент.Ссылка = СсылкаНаПредопределенныйЭлемент(ИмяПредопределенныхДанных) ;
		ЗаполнитьСвойстваПредопределенногоЭлементаИзМакета(Элемент,СвойстваПредопределенныхЭлементовИзМакета);
		#КонецОбласти //СДавальцем    
		
		#Область СДавальцем2_5
		ИмяПредопределенныхДанных = "СДавальцем2_5";
		Элемент = Элементы.Добавить(); // см. СтрокаТЧПредопреденногоЭлемента
		Элемент.ИмяПредопределенныхДанных = ИмяПредопределенныхДанных;
		Элемент.Родитель = Справочники.ВидыДоговоровКонтрагентовУХ.ПродажиИПокупки;
		МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'С давальцем (2.5)';
																						|en = ''", КодыЯзыков); // @НСтр-2
		Элемент.Ссылка = СсылкаНаПредопределенныйЭлемент(ИмяПредопределенныхДанных) ;
		ЗаполнитьСвойстваПредопределенногоЭлементаИзМакета(Элемент,СвойстваПредопределенныхЭлементовИзМакета);
		#КонецОбласти //СДавальцем2_5
		...
		Элемент.ИмяПредопределенныхДанных = ИмяПредопределенныхДанных;
		Элемент.Родитель = Справочники.ВидыДоговоровКонтрагентовУХ.ПродажиИПокупки;
		МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Передача в переработку (2.4)';
																						|en = ''", КодыЯзыков); // @НСтр-2
		Элемент.Ссылка = СсылкаНаПредопределенныйЭлемент(ИмяПредопределенныхДанных) ;
		ЗаполнитьСвойстваПредопределенногоЭлементаИзМакета(Элемент,СвойстваПредопределенныхЭлементовИзМакета);
		#КонецОбласти //СПереработчиком
		
		#Область СПереработчиком_25
		ИмяПредопределенныхДанных = "СПереработчиком2_5";
		Элемент = Элементы.Добавить(); // см. СтрокаТЧПредопреденногоЭлемента
		Элемент.ИмяПредопределенныхДанных = ИмяПредопределенныхДанных;
		Элемент.Родитель = Справочники.ВидыДоговоровКонтрагентовУХ.ПродажиИПокупки;
		МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Передача в переработку (2.5)';
																						|en = ''", КодыЯзыков); // @НСтр-2
		Элемент.Ссылка = СсылкаНаПредопределенныйЭлемент(ИмяПредопределенныхДанных) ;
		ЗаполнитьСвойстваПредопределенногоЭлементаИзМакета(Элемент,СвойстваПредопределенныхЭлементовИзМакета);
		#КонецОбласти //СПереработчиком    
		
		#Область СПереработчиком2_5_ЕАЭС
		ИмяПредопределенныхДанных = "СПереработчиком2_5_ЕАЭС";
		Элемент = Элементы.Добавить(); // см. СтрокаТЧПредопреденногоЭлемента
		Элемент.ИмяПредопределенныхДанных = ИмяПредопределенныхДанных;
		Элемент.Родитель = Справочники.ВидыДоговоровКонтрагентовУХ.ПродажиИПокупки;
		МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Передача в переработку (в страны ЕАЭС)';
																						|en = ''", КодыЯзыков); // @НСтр-2
		Элемент.Ссылка = СсылкаНаПредопределенныйЭлемент(ИмяПредопределенныхДанных) ;
		ЗаполнитьСвойстваПредопределенногоЭлементаИзМакета(Элемент,СвойстваПредопределенныхЭлементовИзМакета);
		#КонецОбласти //СПереработчиком
		...
		ИмяПредопределенныхДанных = "РеализацияЧерезКомиссионера";
		Элемент = Элементы.Добавить(); // см. СтрокаТЧПредопреденногоЭлемента
		Элемент.ИмяПредопределенныхДанных = ИмяПредопределенныхДанных;
		Элемент.Родитель = Справочники.ВидыДоговоровКонтрагентовУХ.ПродажиИПокупки;
		МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Реализация через комиссионера';
																						|en = ''", КодыЯзыков); // @НСтр-2
		Элемент.Ссылка = СсылкаНаПредопределенныйЭлемент(ИмяПредопределенныхДанных) ;
		ЗаполнитьСвойстваПредопределенногоЭлементаИзМакета(Элемент,СвойстваПредопределенныхЭлементовИзМакета);
		...
		#Область ПередачаВАренду
		ИмяПредопределенныхДанных = "ПередачаВАренду";
		Элемент = Элементы.Добавить(); // см. СтрокаТЧПредопреденногоЭлемента
		Элемент.ИмяПредопределенныхДанных = ИмяПредопределенныхДанных;
		Элемент.Родитель = Справочники.ВидыДоговоровКонтрагентовУХ.ПродажиИПокупки;
		МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Передача в аренду';
																						|en = ''", КодыЯзыков); // @НСтр-2
		Элемент.Ссылка = СсылкаНаПредопределенныйЭлемент(ИмяПредопределенныхДанных) ;
		ЗаполнитьСвойстваПредопределенногоЭлементаИзМакета(Элемент,СвойстваПредопределенныхЭлементовИзМакета);
		#КонецОбласти //ПередачаВАренду

		#Область Субаренда
		ИмяПредопределенныхДанных = "Субаренда";
		Элемент = Элементы.Добавить(); // см. СтрокаТЧПредопреденногоЭлемента
		Элемент.ИмяПредопределенныхДанных = ИмяПредопределенныхДанных;
		Элемент.Родитель = Справочники.ВидыДоговоровКонтрагентовУХ.ПродажиИПокупки;
		МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Субаренда';
																						|en = ''", КодыЯзыков); // @НСтр-2
		Элемент.Ссылка = СсылкаНаПредопределенныйЭлемент(ИмяПредопределенныхДанных) ;
		ЗаполнитьСвойстваПредопределенногоЭлементаИзМакета(Элемент,СвойстваПредопределенныхЭлементовИзМакета);
		#КонецОбласти //Субаренда
...
// УХ_Встраивание ++		
		МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = '(не используется) Прочее';
																					|en = ''", КодыЯзыков); // @НСтр-2
// УХ_Встраивание --		
		Элемент.Ссылка = СсылкаНаПредопределенныйЭлемент(ИмяПредопределенныхДанных) ;
		ЗаполнитьСвойстваПредопределенногоЭлементаИзМакета(Элемент,СвойстваПредопределенныхЭлементовИзМакета);
		...
		#Область ЦессияИсходящая
		ИмяПредопределенныхДанных = "ЦессияИсходящая";
		Элемент = Элементы.Добавить(); // см. СтрокаТЧПредопределенногоЭлемента
		Элемент.ИмяПредопределенныхДанных = ИмяПредопределенныхДанных;
		Элемент.Родитель = Справочники.ВидыДоговоровКонтрагентовУХ.ПрочиеВидыДоговоров;
		МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Цессия исходящая';
																						|en = ''", КодыЯзыков); // @НСтр-2
		Элемент.Ссылка = СсылкаНаПредопределенныйЭлемент(ИмяПредопределенныхДанных) ;
		ЗаполнитьСвойстваПредопределенногоЭлементаИзМакета(Элемент,СвойстваПредопределенныхЭлементовИзМакета);
		#КонецОбласти //ЦессияИсходящая   
		
		#Область ЦессияВходящая
		ИмяПредопределенныхДанных = "ЦессияВходящая";
		Элемент = Элементы.Добавить(); // см. СтрокаТЧПредопределенногоЭлемента
		Элемент.ИмяПредопределенныхДанных = ИмяПредопределенныхДанных;
		Элемент.Родитель = Справочники.ВидыДоговоровКонтрагентовУХ.ПрочиеВидыДоговоров;
		МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Цессия входящая';
																						|en = ''", КодыЯзыков); // @НСтр-2
		Элемент.Ссылка = СсылкаНаПредопределенныйЭлемент(ИмяПредопределенныхДанных) ;
		ЗаполнитьСвойстваПредопределенногоЭлементаИзМакета(Элемент,СвойстваПредопределенныхЭлементовИзМакета);
		#КонецОбласти //ЦессияВходящая
...
Процедура ЗаполнитьПредопределенныеЭлементыПоДанымИзКода()
	...
	Для Каждого ДанныеЭлемента Из ПредопределенныеДанные Цикл
		...
		Если НЕ ЭлементОбъект.ЭтоГруппа Тогда
			СписокРеквизитов = СписокРеквизитов + ",ВстречныйВидДоговора,ЭтоДоходныйДоговор,ЭтоРасходныйДоговор,ВидФинансовогоИнструмента,ВидДоговора,ЭтоФинансовыйИнструмент,ИмяДокумента,Порядок,ДопустимыУсловныеЕдиницы,ТипСправочникаДоговора,ВидОперацииУХПоступление,ВидОперацииУХСписание,ГруппаОперацийГрафика";
		КонецЕсли;
...
Процедура ОбработкаПолученияДанныхВыбора(ДанныеВыбора, Параметры, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("Отбор") 
		И Параметры.Отбор.Свойство("ТипСправочникаДоговора") Тогда 
		Запрос.Текст = СтрЗаменить(Запрос.Текст, "&ОтборТипСправочника", "ВидыДоговоровКонтрагентовУХ.ТипСправочникаДоговора = &ТипСправочникаДоговора");
		Запрос.УстановитьПараметр("ТипСправочникаДоговора", Параметры.Отбор.ТипСправочникаДоговора);
	Иначе
		Запрос.УстановитьПараметр("ОтборТипСправочника", Истина);
	КонецЕсли;	
