...
Процедура ПриСозданииЧтенииНаСервере()
	ЗаполнитьРеквизитыДляКонтроля(Объект.ТипВНА, Объект.РеквизитыДляКонтроля, РеквизитыДляКонтроля);
КонецПроцедуры
...
Процедура ЗаполнитьРеквизитыДляКонтроля(ТипВНА,
	...
	Запрос.УстановитьПараметр(
		"НастройкиМетаданных",
		Справочники.НазначенияВНА.ЭлементыФормыВНАДляУправленияВидимостью(ТипВНА));
