...
&НаКлиенте
Процедура ПараметрыУчетаВНАПриИзмененииУХ(Элемент)
...
Процедура ПриИзмененииНазначенияВНА()
	...
	Справочники.НазначенияВНА.УстановитьСвойстваЭлементовПоНазначениюВНАНаСервере(
		Элементы, Объект.НазначениеВНА, 
		Перечисления.ТипыВНА.ПолучитьКлассВНАПоСправочнику(Объект.Ссылка.Метаданные()));
