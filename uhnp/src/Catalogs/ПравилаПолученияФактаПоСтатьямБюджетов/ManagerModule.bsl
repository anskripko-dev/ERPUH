...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	СписокОписаний.Добавить(НСтр("ru = 'Обновление справочника ""Правила получения фактических данных по статьям бюджетов"":';
								|en = 'Update the ""Actual data query rules by budget flow items"" catalog:'"));
	СписокОписаний.Добавить(НСтр("ru = '- замена аналитики активов/пассивов с перечисления ""Типы налогов"" на справочник ""Виды налогов и взносов""';
								|en = '- Replace the dimension of assets/liabilities value ""Tax types"" enumeration type with the ""Tax and contribution kinds"" catalog.'"));
	СписокОписаний.Добавить(НСтр("ru = 'Заполняет параметр ""Кор тип данных учета"" в схеме компоновки данных правил получения факта по статьям бюджетов';
								|en = 'Fills the ""Cor accounting data type"" parameter in the data composition schema of actual data receipt rules by budget flow items'"));
	СписокОписаний.Добавить(НСтр("ru = 'для контроля лимитов расхода ДС по данным бюджетирования с произвольным запросом.';
								|en = 'to control cash flow limits by budgeting data with an arbitrary query.'"));
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	СписокОписаний.Добавить(НСтр("ru = 'Не удалось обработать справочник ""Правила получения фактических данных по статьям бюджетов"" по обработчику:';
								|en = 'Cannot process the ""Actual data query rules by budget flow items"" catalog by the handler:'"));
