...
Процедура ИзмеренияВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если Поле.Имя="ИзмеренияТипДанных" Тогда
		...
		ДанныеОбъекта.Вставить("ИмяОбъекта",СтрШаблон(Нстр("ru = 'регистр накопления %1'"), Объект.Синоним));
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка) 
	...
	Если Объект.ОтсутствуетВКонфигурации Тогда
		...
		ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Нстр("ru = 'Регистр накопления %1 отсутствует в конфигурации.'"),Объект.Наименование);
