...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ВстраиваниеУХДоговорыКонтрагентов.ДоговорыКонтрагентов_ФормаСпискаЗакупки_ПриСозданииНаСервере(ЭтотОбъект, Отказ, СтандартнаяОбработка);
	#КонецОбласти
...
&НаКлиенте
Процедура Подключаемый_ОтборВидДоговораПриИзмененииУХ(Элемент) Экспорт
	Если ОбщегоНазначенияКлиентСервер.ЕстьРеквизитИлиСвойствоОбъекта(ЭтаФорма, "ВидДоговораУХ") Тогда
		ВыбранныйВидДоговора = ЭтаФорма["ВидДоговораУХ"];
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(
		Список, 
		"ВидДоговораУХ", 
