...
Функция ВыбратьДанные(ПараметрыИсточникаДанных, ПользовательскиеНастройки, ДополнительныеПараметры, КомпоновщикНастроекКомпоновкиДанных = Неопределено) Экспорт
	...
	//++ НЕ УТКА
	Если Реквизиты.ИмяШаблонаСКД = "Обработка.ИсточникиДанныхПланированияУП.НоменклатурныйПланПредопределенный"
		ИЛИ Реквизиты.ИмяШаблонаСКД = "Обработка.ИсточникиДанныхПланированияУП.ОбеспечениеЗаказовПроизводстваПредопределенный" Тогда
...
Функция ШаблоныСхемыКомпоновкиДанных() Экспорт
	...
	ШаблоныУП = Обработки.ИсточникиДанныхПланированияУХ.ШаблоныСхемыКомпоновкиДанных();
