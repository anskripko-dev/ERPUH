...
Процедура НастройкаПолномочий(Команда)
	...
	ОткрытьФорму("Обработка.МатрицаПолномочий.Форма.ФормаУправленияМатрицейПолномочий", Новый Структура("ВерсияОрганизационнойСтруктуры,ОбъектБД,ШаблонДокументаБД", Неопределено,ДокументБД,Объект.Ссылка));
