...
Процедура ОтменитьСсылку(Команда)
	...
	ПоказатьВопрос(Оповещение,
		НСтр("ru = 'Платежная ссылка станет недоступна для оплаты покупателю. Продолжить?';
			|en = 'The payment link will become unavailable for customer payment. Continue?'"),
...
Процедура НачатьОтменуПлатежнойСсылки(Знач ОписаниеОповещения = Неопределено)
	...
	УправлениеЭлементамиФормаПриОжиданииОтветаСервиса(НСтр("ru = 'Ожидание отмены платежной ссылки.';
															|en = 'Pending for cancellation of the payment link.'"));
	...
	ИначеЕсли СсылкаОтменена Тогда
		...
		Элементы.ДекорацияПояснениеКФорме.Заголовок =
			НСтр("ru = 'Внимание! Ссылка была отменена, для повторной активации необходимо выполнить обновление ссылки.';
				|en = 'Attention! The link has been cancelled, to reactivate it you need to update the link.'");
