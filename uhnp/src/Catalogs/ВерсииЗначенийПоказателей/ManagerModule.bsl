...
Функция ПроверитьВозможностьИзмененияДанныхВерсии(Версия, МаскаИмени="", ЭтоУдаление = Ложь) Экспорт
	...
	Для Индекс = 1 По АналитикВидаОтчета Цикл
		ОбъектРасчета.Вставить("Аналитика" + Индекс);
	КонецЦикла;
	ЗаполнитьЗначенияСвойств(ОбъектРасчета, Версия);
	
	Если ЭтоУдаление Тогда
		ОбъектРасчета.Вставить("ЭтоУдаление", Истина);
	КонецЕсли;
...
Функция УдалитьЗаписиВерсии(Версия,ПроверятьВозможностьИзмененияДанных=Истина) Экспорт
	...
	Если ПроверятьВозможностьИзмененияДанных И (НЕ ПроверитьВозможностьИзмененияДанныхВерсии(Версия, , Истина)) Тогда
