...
Процедура ПроводкиСпособЗаполненияСубконтоПриИзменении(Элемент)
	...
	ТипЗначения = ТекущиеДанные["Тип_Субконто"+Суффикс];
				
	Если ТипЗначения = Неопределено Тогда
		//ТекущиеДанные["Тип_Субконто"+Суффикс] = Новый ОписаниеТипов("Неопределено");
		ТекущиеДанные["ЗначениеСубконто"+Суффикс] = Неопределено;
		
	Иначе
		//ТекущиеДанные["Тип_Субконто"+Суффикс] = ТипЗначения;
...
Процедура ПроводкиПриАктивизацииЯчейки(Элемент)
	...
	Иначе
		Элементы[ПрефиксИмениПоля +  Суффикс].ОграничениеТипа = СтрокаТаблицы["Тип_Субконто" + Суффикс];
		Элементы[ПрефиксИмениПоля +  Суффикс].ПодсказкаВвода 	= ИмяВидСубконто;
...
Процедура УстановитьСвойстваСубконто(СчетБД, Проводка, ДтКт) Экспорт
	Для НомерСубконто = 1 По 3 Цикл
		...
		Если ЗначениеЗаполнено(ВидСубконто) Тогда
			...
			Проводка["Тип_Субконто" + ДтКт + НомерСубконто] = ТипЗначения;
		...
		Иначе
			...
			Проводка["Тип_Субконто" + ДтКт + НомерСубконто] = Новый ОписаниеТипов("Неопределено");
		КонецЕсли;
	КонецЦикла;
КонецПроцедуры
