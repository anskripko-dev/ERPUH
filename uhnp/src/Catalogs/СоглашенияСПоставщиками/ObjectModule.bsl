...
Процедура ЗаполнитьДокументПоОтбору(Знач ДанныеЗаполнения)
	...
	Если ДанныеЗаполнения.Свойство("КонтролироватьЦеныЗакупки") Тогда
		КонтролироватьЦеныЗакупки = ДанныеЗаполнения.КонтролироватьЦеныЗакупки;
	КонецЕсли;
	
	Если ДанныеЗаполнения.Свойство("РегистрироватьЦеныПоставщика") Тогда
		РегистрироватьЦеныПоставщика = ДанныеЗаполнения.РегистрироватьЦеныПоставщика;
	КонецЕсли;
	
	Если ДанныеЗаполнения.Свойство("ИспользуютсяДоговорыКонтрагентов") Тогда
		ИспользуютсяДоговорыКонтрагентов = ДанныеЗаполнения.ИспользуютсяДоговорыКонтрагентов;
	КонецЕсли;
...
Процедура ИнициализироватьСправочник(ЗаполнятьВсеРеквизиты = Истина)
	...
	Если ЗаполнятьВсеРеквизиты Тогда
		...
		Реквизиты = Новый Структура("ПорядокРасчетов");
		ЗаполнениеОбъектовПоСтатистике.ЗаполнитьРеквизитыОбъекта(ЭтотОбъект, Реквизиты);
		ИспользуютсяДоговорыКонтрагентов = Истина;
		#КонецОбласти
