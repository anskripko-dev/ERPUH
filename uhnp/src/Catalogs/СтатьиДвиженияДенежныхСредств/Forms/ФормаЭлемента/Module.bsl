...
#Область УХ_ОбработчикиСобытий

&НаКлиенте
Процедура Подключаемый_ГруппаРаскрытияПриИзмененииУХ(Элемент)
	ЗаполнитьВидыАналитикПоГруппеРаскрытияНаСервере();
КонецПроцедуры

&НаКлиенте
Процедура Подключаемый_ОчередностьПлатежаПриИзмененииУХ(Элемент)
	ВстраиваниеУХСтатьиДвиженияДенежныхСредствКлиентСервер.ОбновитьПодсказкуОчередностьПлатежа(ЭтотОбъект);
КонецПроцедуры
...
&НаКлиенте
Процедура Подключаемый_ОпределяетсяСтатьейПриИзмененииУХ(Элемент)
...
&НаКлиенте
Процедура Подключаемый_ГруппаРаскрытияПереключательПриИзмененииУХ(Элемент)
