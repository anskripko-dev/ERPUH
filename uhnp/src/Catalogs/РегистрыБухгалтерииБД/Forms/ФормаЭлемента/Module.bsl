...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка) 
	...
	Если Объект.ОтсутствуетВКонфигурации Тогда
		...
		ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Нстр("ru = 'Регистр бухгалтерии %1 отсутствует в конфигурации.'"),Объект.Наименование);
