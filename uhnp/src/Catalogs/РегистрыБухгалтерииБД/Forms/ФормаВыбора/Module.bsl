...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИначеЕсли Параметры.Отбор.Свойство("ПланСчетов") И ЗначениеЗаполнено(Параметры.Отбор.ПланСчетов) Тогда
		
		ТипБД=Параметры.Отбор.ПланСчетов.Владелец;
	...
	РаботаСОбъектамиМетаданныхУХ.ПроверитьЗаполнитьСинонимы("РегистрыБухгалтерииБД",ТипБД);
