...
&НаКлиенте
Процедура СоздатьКонсолидирующую(Команда)
		
	ЗначенияЗаполнения = Новый Структура;
	ЗначенияЗаполнения.Вставить("ИспользоватьВРегламентированномУчете", Ложь);
...
&НаКлиенте
Процедура СоздатьЭлиминирующую(Команда)
	
	ЗначенияЗаполнения = Новый Структура;
	ЗначенияЗаполнения.Вставить("ЭлиминирующаяОрганизация", Истина);
	ЗначенияЗаполнения.Вставить("ИспользоватьВРегламентированномУчете", Ложь);
...
&НаКлиенте
Процедура СоздатьИностранныйНалоговыйРезидент(Команда)
		
	ЗначенияЗаполнения = Новый Структура;
	ЗначенияЗаполнения.Вставить("ИностранныйНалоговыйРезидент", Истина);
	ЗначенияЗаполнения.Вставить("ИспользоватьВРегламентированномУчете", Ложь);//**
...
&НаКлиенте
Процедура СоздатьИностраннаяСтруктура(Команда)
		
	ЗначенияЗаполнения = Новый Структура;
	ЗначенияЗаполнения.Вставить("ИспользоватьВРегламентированномУчете", 	Ложь);
	ЗначенияЗаполнения.Вставить("ИностранныйНалоговыйРезидент", 			Истина);	
	ЗначенияЗаполнения.Вставить("ИностраннаяСтруктураБезОбразованияЮрЛица", Истина);
