...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "Запись_КлассификаторТерриториальныхУправленийСАТУРН"
		И ТипЗнч(Источник) = Тип("СправочникСсылка.КлассификаторТерриториальныхУправленийСАТУРН") Тогда
...
Процедура ЗагрузитьКлассификатор(Команда)
	...
	ЗагрузитьКлассификаторТерриториальныхУправлений_ДлительнаяОперация();
...
Процедура УстановитьЗаголовокФормы()
	...
	Если РежимВыбора Тогда
		ТекстЗаголовка = НСтр("ru = 'Выбор классификатора территориальных управлений САТУРН';
								|en = 'Выбор классификатора территориальных управлений САТУРН'");
	Иначе
		ТекстЗаголовка = НСтр("ru = 'Классификатор территориальных управлений САТУРН';
								|en = 'Классификатор территориальных управлений САТУРН'");
	КонецЕсли;
...
&НаКлиенте
Процедура ЗагрузитьКлассификаторТерриториальныхУправлений_ДлительнаяОперация()
	
	ПараметрыОбработкиДокументов = ИнтеграцияСАТУРНСлужебныйКлиентСервер.ПараметрыОбработкиДокументов();
	ПараметрыОбработкиДокументов.Ссылка             = ПредопределенноеЗначение("Справочник.КлассификаторТерриториальныхУправленийСАТУРН.ПустаяСсылка");
