		...
		Исключение
			...
			ТекстОшибки = СтрШаблон(
				НСтр("ru = 'Ошибка при создании территориального управления с идентификатором %1:
				           |%2';
				           |en = 'Ошибка при создании территориального управления с идентификатором %1:
				           |%2'"),
				Идентификатор,
			...
			ОбщегоНазначенияИСВызовСервера.ЗаписатьОшибкуВЖурналРегистрации(
				ТекстОшибкиПодробно,
				НСтр("ru = 'Работа с классификатором территориальных управлений';
					|en = 'Работа с классификатором территориальных управлений'", ОбщегоНазначения.КодОсновногоЯзыка()));
