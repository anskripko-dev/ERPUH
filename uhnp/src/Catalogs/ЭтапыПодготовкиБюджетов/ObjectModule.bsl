...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если ЭтоГруппа Тогда
		...
		Если УсловиеЗапуска = Перечисления.ТипыУсловийЗапускаЭтаповПодготовкиБюджетов.Вручную Тогда
			ПроверенныеРеквизитыОбъекта.Добавить("ТипСрока");
...
Процедура ЗаполнитьПредставлениеРасписания()
	...
	Иначе
		Если УсловиеЗапуска = Перечисления.ТипыУсловийЗапускаЭтаповПодготовкиБюджетов.Вручную Тогда
			ПредставлениеРасписания = НСтр("ru = 'Начать вручную';
											|en = 'Start manually'");
		ИначеЕсли УсловиеЗапуска = Перечисления.ТипыУсловийЗапускаЭтаповПодготовкиБюджетов.ДоОкончанияПериода
