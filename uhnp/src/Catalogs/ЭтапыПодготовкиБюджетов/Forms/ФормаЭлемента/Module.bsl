...
Процедура НастроитьДействиеФрагмент(Знач Отказ)
	...
	ПараметрыФормы.Вставить("ТипДействия", Объект.Действие);
...
Процедура УправлениеФормой()
	...
	Иначе
		...
		СписокВыбораДействий.Добавить(Перечисления.ТипыДействийЭтаповПодготовкиБюджетов.КорректировкаИсправлениеБюджетов);
		СписокВыбораДействий.Добавить(Перечисления.ТипыДействийЭтаповПодготовкиБюджетов.ПовторГруппыЭтапов);
	...
	ЭтоВводБюджета = (Объект.Действие = Перечисления.ТипыДействийЭтаповПодготовкиБюджетов.ВводБюджетов
		Или Объект.Действие = Перечисления.ТипыДействийЭтаповПодготовкиБюджетов.КорректировкаИсправлениеБюджетов);
