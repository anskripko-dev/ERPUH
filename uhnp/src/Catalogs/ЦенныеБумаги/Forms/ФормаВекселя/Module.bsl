...
Процедура УправлениеФормой(Форма)
	...
	ЭтоФиксированнаяСтавка = (ПараметрыЦеннойБумаги.ТипПроцентнойСтавки = ПредопределенноеЗначение("Перечисление.ТипыСтавокДляРасчетаПериодическихОпераций.Фиксированная"));
	Элементы.ГруппаПроцентнаяСтавка.Видимость = ЭтоФиксированнаяСтавка;
	Элементы.ГруппаСтруктураПлавающейСтавки.Видимость = НЕ ЭтоФиксированнаяСтавка;
	...
	Элементы.ПараметрыЦеннойБумагиМаксимальнаяСуммаПроцентов.Видимость = ЭтоФиксированнаяСтавка;
