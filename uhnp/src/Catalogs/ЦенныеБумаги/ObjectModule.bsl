...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	//см. ЦенныеБумагиОбработкаПроверкиЗаполненияОбработкаПроверкиЗаполнения
КонецПроцедуры
...
Процедура ПередЗаписью(Отказ)
	...
	ИначеЕсли Не ЗначениеЗаполнено(ПараметрыЦеннойБумаги) Тогда
		...
		ИмяДокумента = ЦенныеБумагиКлиентСерверУХ.ПолучитьИмяДокумента(ВидФинансовогоИнструмента);
