...
Процедура ДобавитьКомандыОтчетов(КомандыОтчетов, Параметры) Экспорт
	...
	МодульУХ = ОбщегоНазначения.ОбщийМодуль("ФинансовыеИнструментыУХ");
	...
	МодульУХ.ДобавитьКомандуОтчет(КомандыОтчетов, "Отчет.ГрафикиЦенныхБумаг", НСтр("ru = 'График ценной бумаги'"));
	МодульУХ.ДобавитьКомандуОтчет(КомандыОтчетов, "Отчет.ВедомостьПоПартиямЦенныхБумаг", НСтр("ru = 'Ведомость по партиям ценной бумаги'"));
	
	//МСФО
	МодульУХ.ДобавитьКомандуОтчет(КомандыОтчетов, "Отчет.ГрафикиФИ", НСтр("ru = 'График ценной бумаги (МСФО)'"));
	МодульУХ.ДобавитьКомандуОтчет(КомандыОтчетов, "Отчет.РаспределениеНачисленийПоФинансовымИнструментамНаОбъекты", НСтр("ru = 'Распределение начислений по финансовым инструментам на объекты (МСФО)'"));
...
Процедура ДобавитьКомандыСозданияНаОсновании(КомандыСозданияНаОсновании, Параметры) Экспорт
	...
	МодульУХ.ДобавитьКомандуСоздатьНаОсновании(КомандыСозданияНаОсновании, "ПриобретениеЦеннойБумаги", Представление);
	
	Представление = НСтр("ru = 'Оплата ценной бумаги'");
	МодульУХ.ДобавитьКомандуСоздатьНаОсновании(КомандыСозданияНаОсновании, "ОплатаЦеннойБумаги", Представление);
	
	Представление = НСтр("ru = 'Продажа ценной бумаги'");
	МодульУХ.ДобавитьКомандуСоздатьНаОсновании(КомандыСозданияНаОсновании, "ПродажаЦеннойБумаги", Представление);
	
	Представление = НСтр("ru = 'Выпуск собственной ценной бумаги организацией-эмитентом'");
	МодульУХ.ДобавитьКомандуСоздатьНаОсновании(КомандыСозданияНаОсновании, "ВыпускЦеннойБумаги", Представление);
	
	Представление = НСтр("ru = 'Выкуп собственной ценной бумаги организацией-эмитентом'");
	МодульУХ.ДобавитьКомандуСоздатьНаОсновании(КомандыСозданияНаОсновании, "ВыкупЦеннойБумаги", Представление);
