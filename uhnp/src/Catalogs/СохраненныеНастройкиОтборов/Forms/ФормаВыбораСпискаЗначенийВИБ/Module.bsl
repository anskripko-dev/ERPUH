...
Процедура НаименованиеОткрытие(Элемент, СтандартнаяОбработка)
	...
	ТекущиеДанные=Элементы.ТабличноеПолеЗначенияВИБ.ТекущиеДанные;
	
	СтрокаGUID=?(ПустаяСтрока(ТекущиеДанные.Ссылка),ТекущиеДанные.Код,ТекущиеДанные.Ссылка);	
...
Функция ПолучитьДанныеОбъектаВИБ(СтрокаGUID)
	...
	ДанныеОбъекта.Вставить("ТипЗначения",ТипМетаДанных+"Ссылка."+СправочникБД);
