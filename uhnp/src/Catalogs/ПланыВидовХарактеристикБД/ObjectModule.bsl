...
Процедура ЗаполнитьРеквизитыОбъекта(Кэш = Неопределено, ЕстьИзменения = Истина) Экспорт
	...
	СтруктураОписания = РаботаСОбъектамиМетаданныхУХ.ПолучитьСтруктуруОписанияПланаВидовХарактеристикБД(
	...
	РаботаСОбъектамиМетаданныхУХ.ЗаполнитьИзмененныеРеквизиты(ЭтотОбъект, СтруктураОписания, "Реквизиты,ДополнительныеРеквизиты,ДополнительныеСведения,НаборыРеквизитовИСведений,Синоним", ЕстьИзменения);
