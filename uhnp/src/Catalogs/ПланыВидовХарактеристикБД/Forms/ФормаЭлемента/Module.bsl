...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)  
	...
	Если Объект.ОтсутствуетВКонфигурации Тогда
		...
		ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Нстр("ru = 'План видов характеристик %1 отсутствует в конфигурации.'"),Объект.Наименование);
