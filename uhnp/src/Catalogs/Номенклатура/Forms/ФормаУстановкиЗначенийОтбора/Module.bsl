...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ ЗначениеЗаполнено(Параметры.ВидНоменклатуры) Тогда
		Запрос.Текст = СтрЗаменить(Запрос.Текст, "ВидНоменклатуры = &ВидНоменклатуры", "ВидНоменклатуры <> &ВидНоменклатуры");
	КонецЕсли;
	#КонецОбласти
