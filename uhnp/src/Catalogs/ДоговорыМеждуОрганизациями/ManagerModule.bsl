...
Процедура ЗаполнитьБанковскиеСчетаПоДоговору(Договор, БанковскийСчетОрганизации, БанковскийСчетОрганизацииПолучателя) Экспорт
	...
	Если Метаданные.ОбщиеМодули.Найти("УправлениеФормойНСИСервер") <> Неопределено Тогда
		...
		КонецЕсли;
		Если МодульУправлениеНСИСервер.ЭлементНСИНеАктивный(БанковскийСчетОрганизацииПолучателя) Тогда
			БанковскийСчетОрганизацииПолучателя = Справочники.БанковскиеСчетаОрганизаций.ПустаяСсылка();
		КонецЕсли;
	КонецЕсли;	
	#КонецОбласти
...
Функция ПолучитьБлокируемыеРеквизитыОбъекта() Экспорт
	...
	ВстраиваниеУХДоговорыМеждуОрганизациями.ПолучитьБлокируемыеРеквизитыОбъекта(Результат);
	#КонецОбласти 
