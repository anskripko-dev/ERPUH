	...
	Если Не ЭтоГруппа
		...
		Если Не ЗначениеЗаполнено(ВалютаДенежныхСредств) И ТипЗнч(ДанныеЗаполнения) = Тип("Структура") И ДанныеЗаполнения.Свойство("Владелец") Тогда
			...
			Если ТипЗнч(ДанныеЗаполнения.Владелец) = Тип("СправочникСсылка.Организации") Тогда
				...
				ОрганизацииКлиентСерверУХ.ПроверитьВозможностьСозданияБанковскогоСчета(ДанныеЗаполнения.Владелец);
				#КонецОбласти
...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	#Область УХ_Встраивание
	ОрганизацииКлиентСерверУХ.ПроверитьВозможностьСозданияБанковскогоСчета(Владелец);
	#КонецОбласти
