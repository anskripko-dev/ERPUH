...
Процедура ПередЗаписью(Отказ)
	...
	МодульАналитикиСтатейБюджетовУХКлиентСервер = ОбщегоНазначения.ОбщийМодуль("АналитикиСтатейБюджетовУХКлиентСервер");
	КоличествоАналитикСтатьи = МодульАналитикиСтатейБюджетовУХКлиентСервер.КоличествоАналитикСтатьи();
