...
//++ НЕ УТКА
	...
	СлужебныеКонстанты.Вставить("ИспользоватьМетодикуББВ",                        Ложь);
	СлужебныеКонстанты.Вставить("ИспользоватьМетодикуПооперационноеПланирование", Ложь);
	СлужебныеКонстанты.Вставить("ИспользоватьМетодикуРегистрацияОпераций",        Ложь);
