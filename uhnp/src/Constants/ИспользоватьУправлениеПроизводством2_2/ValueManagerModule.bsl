...
Процедура ПриЗаписи(Отказ)
	...
	СлужебныеКонстанты.Вставить("ИспользоватьПооперационноеУправление",   Ложь);
	СлужебныеКонстанты.Вставить("ИспользоватьПооперационноеПланирование", Ложь);
	СлужебныеКонстанты.Вставить("ИспользоватьСменныеЗадания",             Ложь);
