...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СценарийКИК = ОбщегоНазначенияПовтИспУХ.СценарийКИК();
...
Процедура УстановтьПараметрыСписка()
	...
	Реестр.Параметры.УстановитьЗначениеПараметра("СценарийКИК", ОбщегоНазначенияПовтИспУХ.СценарийКИК());
...
Процедура СообщениеОбОтсутствииПрямыхДолей()
	...
	Сообщение = НСтр("ru = 'Для данного инвестора и объекта инвестирования отсутствует прямая доля участия (нет документов инвестиций).
