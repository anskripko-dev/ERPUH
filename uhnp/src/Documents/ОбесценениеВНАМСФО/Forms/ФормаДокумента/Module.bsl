...
Процедура УправлениеФормой(Форма)
	...
	Элементы.ВНАПереоценкаСтоимости.ТолькоПросмотр = Не Объект.БезРасчета;
	
	Элементы.СправедливаяСтоимость.ТолькоПросмотр 	= Объект.БезРасчета;
	Элементы.РасходыНаПродажу.ТолькоПросмотр 		= Объект.БезРасчета;
	Элементы.ЦенностьИспользования.ТолькоПросмотр 	= Объект.БезРасчета;
...
Процедура РассчитатьОбесценение(Форма)
	...
	Объект.ИзменениеОбесценения = - (Объект.ВНА.Итог("БалансоваяСтоимость") - Объект.ВозмещаемаяСтоимость);
