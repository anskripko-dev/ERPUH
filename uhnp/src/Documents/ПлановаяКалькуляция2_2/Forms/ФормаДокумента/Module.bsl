...
Процедура УстановитьУсловноеОформление()
	...
	ПараметрыУсловногоОформления.ИмяПоляЕдиницаИзмерения = "ОбъектыКалькуляцииЕдиницаИзмерения";
	ПараметрыУсловногоОформления.ПутьКПолюУпаковка = "Объект.ОбъектыКалькуляции.Упаковка";
...
Функция ДобавитьОбъектыКалькуляции(ВыбранноеЗначение)
	...
	ВыходныеИзделия = ВыбранноеЗначение[ИсточникВыходныхИзделий].Выгрузить();
	Для Каждого СтрокаПродукции Из ВыходныеИзделия Цикл
		...
		ОбрабатываемыеСтроки.Добавить(НовыйОбъектКалькуляции);
