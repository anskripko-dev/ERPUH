...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтраницаПанели = Элементы.Страницы.ТекущаяСтраница.Имя;
...
Процедура СтраницыПриСменеСтраницы(Элемент, ТекущаяСтраница)
	...
	Если СтраницаПанели = "ГруппаРасчеты" Тогда
...
&НаКлиенте
Процедура РедактироватьПроцентныеСтавкиОрганизация(Команда)
	
	СтруктураПараметров = Новый Структура;
	СтруктураПараметров.Вставить("ИсходныеДанные", Объект);
	СтруктураПараметров.Вставить("ТабличнаяЧасть", "ПроцентныеСтавкиОрганизация");
	
	ОписаниеОповещения = Новый ОписаниеОповещения("НадписьРедактироватьПроцентныеСтавкиПродолжениеОрганизация", ЭтотОбъект);
...
&НаКлиенте
Процедура РедактироватьПроцентныеСтавкиКонтрагент(Команда)
	
	СтруктураПараметров = Новый Структура;
	СтруктураПараметров.Вставить("ИсходныеДанные", Объект);
	СтруктураПараметров.Вставить("ТабличнаяЧасть", "ПроцентныеСтавкиКонтрагент");
	
	ОписаниеОповещения = Новый ОписаниеОповещения("НадписьРедактироватьПроцентныеСтавкиПродолжениеКонтрагент", ЭтотОбъект);
...
&НаКлиенте
Процедура НадписьРедактироватьПроцентныеСтавкиПродолжениеОрганизация(Результат, Параметры) Экспорт
	
	Если ЭтоАдресВременногоХранилища(Результат) Тогда
		ЗагрузитьТаблицуПроцентныхСтавок(Результат, "ПроцентныеСтавкиОрганизация");
		ВыполнитьКонтрольДокумента();
	КонецЕсли;
...
&НаКлиенте
Процедура НадписьРедактироватьПроцентныеСтавкиПродолжениеКонтрагент(Результат, Параметры) Экспорт
	
	Если ЭтоАдресВременногоХранилища(Результат) Тогда
		ЗагрузитьТаблицуПроцентныхСтавок(Результат, "ПроцентныеСтавкиКонтрагент");
		ВыполнитьКонтрольДокумента();
	КонецЕсли;
...
&НаСервере
Процедура ЗагрузитьТаблицуПроцентныхСтавок(АдресХранилища, ИмяТабличнойЧасти)
