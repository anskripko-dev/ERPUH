...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	ИначеЕсли ТипДанныхЗаполнения = Тип("Структура") Тогда 
		...
		Если ДанныеЗаполнения.Свойство("СтруктураДействий") Тогда 
			...
			Документы.ПоступлениеВНАМСФО.ЗаполнитьСтроки(ЭтотОбъект.ВНА, ЭтотОбъект, ДанныеЗаполнения.СтруктураДействий);
...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Документы.ПоступлениеВНАМСФО.ПодготовитьПараметрыПроведения(ДополнительныеСвойства, Отказ);
	...
	Документы.ПоступлениеВНАМСФО.СформироватьДвижения(Движения, ДополнительныеСвойства, Отказ);
...
Процедура ЗаполнитьИзПодсистемыНСБУ(ДокументыОснованияИсточник = Неопределено)
	...
	ИсточникЗаполнения = МСФОВНАУХ.ПолучитьДанные_ПоступлениеВНА(ПараметрыЗаполнения);
