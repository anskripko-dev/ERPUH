...
Процедура ДвиженияНачисленийПередНачаломИзменения(Элемент, Отказ)
	...
	ПоляФормы = Новый Структура("Субконто1, Субконто2, Субконто3",
		"ДвиженияНачисленийСубконтоДт1",
		"ДвиженияНачисленийСубконтоДт2",
		"ДвиженияНачисленийСубконтоДт3");
	
	МСФОКлиентСерверУХ.ПриВыбореСчета(
		ТекущиеДанные.СчетДт, ЭтотОбъект, ПоляФормы, Неопределено, Истина, Ложь);
	
	ИзменитьПараметрыВыбораПолейСубконто(ЭтотОбъект, "Дт");
	
	ПоляФормы = Новый Структура("Субконто1, Субконто2, Субконто3",
		"ДвиженияНачисленийСубконтоКт1",
		"ДвиженияНачисленийСубконтоКт2",
		"ДвиженияНачисленийСубконтоКт3");
	
	МСФОКлиентСерверУХ.ПриВыбореСчета(
		ТекущиеДанные.СчетКт, ЭтотОбъект, ПоляФормы, Неопределено, Истина, Ложь);
...
Процедура ПодготовитьФормуНаСервере(ТекущийОбъект = Неопределено)
	...
	МСФОУХ.ДобавитьРеквизитыТаблицыПроводок(ЭтотОбъект, "Объект.ДвиженияНачислений", "ДвиженияНачислений", Ложь);
...
Процедура ЗаполнитьКэшируемыеЗначения(Форма)
	...
	Для каждого КлючСчет Из Новый Структура("СчетДт,СчетКт") Цикл
		Элементы["ДвиженияНачислений" + КлючСчет.Ключ]
			.ПараметрыВыбора = ПараметрыВыбораСчетаБД;
	КонецЦикла;
...
Процедура УстановитьУсловноеОформление()
	...
	МСФОУХ.УсловноеОформление_Проводки(ЭтаФорма, "Объект.ДвиженияНачислений", "ДвиженияНачислений");
...
Процедура ОбработатьИзменениеСчета(Форма, ДтКт = "Дт")
	...
	ПоляФормы.Подразделение 			= "УчетПоПодразделениям" + ДтКт;
	ПоляФормы.НаправлениеДеятельности 	= "УчетПоНаправлениямДеятельности" + ДтКт;
