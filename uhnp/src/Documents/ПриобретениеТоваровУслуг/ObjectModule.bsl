...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	ВстраиваниеУХПриобретениеТоваровУслуг.ПроверитьСтранаПроисхождения(ЭтотОбъект, Отказ);
	#КонецОбласти
...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	ВстраиваниеУХПриобретениеТоваровУслуг.ОбработкаЗаполнения(ЭтотОбъект, ДанныеЗаполнения, СтандартнаяОбработка);
	#КонецОбласти
...
Процедура ЗаполнитьАналитикамиСУчетомСерий()
	...
	|en = 'Failed to retrieve the batch for the ""%1"" item with filtering by batch from the ""Goods"" tabular section. The batch was picked by the balance.
	|Check if the specified item batch is recorded in the ""Receipt of goods to warehouse"" document.'");
