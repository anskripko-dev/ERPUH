...
Функция ТекстЗапросаТаблицаДокументыПоОС(ТекстыЗапроса, Регистры, ДокументОбъект)
	...
	|
	|		ЛЕВОЕ СОЕДИНЕНИЕ ДанныеДокументаТаблицаРасходы КАК ТаблицаДубли
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	СписокОписаний.Добавить(НСтр("ru = 'Обновление документов ""Приобретение услуг и прочих активов"":';
								|en = 'Update the ""Vendor invoice — Services and Assets"" documents:'"));
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	СписокОписаний.Добавить(НСтр("ru = 'Не удалось обработать документы ""Приобретение услуг и прочих активов"" по обработчику:';
								|en = 'Cannot process the ""Vendor invoice — Services and Assets"" documents by the handler:'"));
