...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	ИначеЕсли ТипДанныхЗаполнения = Тип("Структура") Тогда 
		...
		Если ДанныеЗаполнения.Свойство("ЗаполнитьДокумент") Тогда
			...
			РезультатЗаполнения = Документы.Элиминация.ЗаполнитьРегистрПроводокДляЭлиминации(Ссылка);
...
Функция ЗаполнитьЗаписатьДвиженияЭлиминации()
	...
	РегистрБухгалтерии = Справочники.РегистрыБухгалтерииБД.ПолучитьПоПлануСчетовБД(РеквизитыУП.ПланСчетовМСФО);
