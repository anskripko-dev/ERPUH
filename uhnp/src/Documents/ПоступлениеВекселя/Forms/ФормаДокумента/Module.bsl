...
Процедура ОткрытьГрафик(Команда)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения(
		"ОткрытьГрафикЗавершение", ЭтотОбъект);
	
	ОткрытьФорму("Документ.ПоступлениеВекселя.Форма.ФормаГрафик",
...
Процедура ОткрытьГрафикЗавершение(Результат, Параметры) Экспорт
	...
	ОбновитьГрафикНачисленийПоВекселю(Результат);
...
Процедура ПриИзмененииСуммыОперацииНаСервере()
	...
	Документы.ПоступлениеВекселя.ПересчитатьСтрокуВекселя(Объект);
...
Процедура ЗаполнитьСтрокуВекселя()
	...
	Документы.ПоступлениеВекселя.ПрочитатьПараметрыВекселя(Объект);
	Документы.ПоступлениеВекселя.ПересчитатьСтрокуВекселя(Объект);
	ОбновитьГрафикНачисленийПоВекселю();
...
&НаСервере
Процедура ОбновитьГрафикНачисленийПоВекселю(АдресГрафика = Неопределено)
	
	ЦенныеБумагиУХ.ОбновитьГрафикНачисленийПоВекселю(Объект, АдресГрафика);
...
Процедура УправлениеФормой(Форма)
	...
	Элементы.ПроцентнаяСтавка.Видимость = Объект.ПредусмотренПроцентныйДоход И ТипПроцентнойСтавкиФиксированная(Объект.ФинансовыйИнструмент);
...
Функция ТипПроцентнойСтавкиФиксированная(ФИ)
	
	ТипСтавки = ОбщегоНазначенияУХ.ЗначениеРеквизитаОбъекта(ФИ, "ПараметрыЦеннойБумаги.ТипПроцентнойСтавки");
	Возврат ТипСтавки = ПредопределенноеЗначение("Перечисление.ТипыСтавокДляРасчетаПериодическихОпераций.Фиксированная");
