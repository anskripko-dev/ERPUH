...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	СписокОписаний.Добавить(НСтр("ru = 'Обновление документов ""Значения нефинансовых показателей"":';
								|en = 'Update the ""Non-financial item values"" documents:'"));
	СписокОписаний.Добавить(НСтр("ru = '- заполнение реквизитов ""Аналитика"" с типом значения ""Перечисление типы налогов""';
								|en = '- Fill the ""Dimension"" attributes with the ""Tax types enumeration"" value type.'"));
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	СписокОписаний.Добавить(НСтр("ru = 'Не удалось обработать документы ""Значения нефинансовых показателей"" по обработчику:';
								|en = 'Cannot process the ""Non-financial item values"" documents by the handler:'"));
	СписокОписаний.Добавить(НСтр("ru = '- заполнение реквизитов ""Аналитика"" с типом значения ""Перечисление типы налогов""';
								|en = '- Fill the ""Dimension"" attributes with the ""Tax types enumeration"" value type.'"));
