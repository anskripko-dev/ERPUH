...
Функция ПодготовитьПараметрыПроведения(ДополнительныеСвойства, Отказ) Экспорт
	...
	ДопРеквизиты = Новый Структура("ШаблонТрансляции, РежимЗаполнения, АлгоритмРСБУ, ПериодОтчета, ДатаНачала, ДатаОкончания", 
									"УП.ШаблонТрансляции");
...
Функция ТекстЗапросаТабличныеЧасти(НомераТаблиц = Неопределено) Экспорт
	...
	НомераТаблиц.Вставить("ТаблицаВНА_ОбесценениеВНАМСФО", 					НомераТаблиц.Количество());
	...
	|		КОГДА ОчередьСобытий.ВидОперации В (ЗНАЧЕНИЕ(Справочник.ВидыОпераций.ОбесценениеВНА))
	|			ТОГДА ""ОбесценениеВНАМСФО""
	|		ИНАЧЕ НЕОПРЕДЕЛЕНО
	...
	|	ТаблицаВНА.Валюта КАК Валюта,
	|	ТаблицаВНА.СуммаВВалютеНСБУ КАК СуммаВВалютеНСБУ,
	|	ТаблицаВНА.СуммаВВалютеНСБУ КАК СуммаВВалютеМСФО,
	|	ТаблицаВНА.СчетУчетаНСБУ КАК СчетУчетаНСБУ,
	|	ТаблицаВНА.СчетУчетаМСФО КАК СчетУчетаМСФО,
	|	ТаблицаВНА.СчетУчетаСубконто1НСБУ КАК СчетУчетаСубконто1НСБУ,
	|	ТаблицаВНА.СчетУчетаСубконто2НСБУ КАК СчетУчетаСубконто2НСБУ,
	...
	|	ТаблицаВНА.ВидОперации КАК ВидОперации,
	|	ТаблицаВНА.ПараметрыУчетаВНА КАК ГруппаВНАМСФО,
	|	ТаблицаВНА.ПараметрыУчетаВНА КАК НоваяГруппаВНАМСФО,
	|	ТаблицаВНА.ПараметрыАмортизацииВНАМСФО КАК ПараметрыАмортизацииВНАМСФО,
	|	ТаблицаВНА.ПараметрыАмортизацииВНАМСФО КАК НовыеПараметрыАмортизацииВНАМСФО,
	|	ТаблицаВНА.ЛиквидационнаяСтоимостьНСБУ КАК ЛиквидационнаяСтоимостьНСБУ,
	|	ТаблицаВНА.ЛиквидационнаяСтоимостьМСФО КАК ЛиквидационнаяСтоимостьМСФО,
	|	ТаблицаВНА.НачислятьАмортизациюНСБУ КАК НачислятьАмортизациюНСБУ,
	|	ТаблицаВНА.НачислятьАмортизациюМСФО КАК НачислятьАмортизациюМСФО,
	...
	|	ТаблицаВНА.ПараметрВыработкиНСБУ КАК ПараметрВыработкиНСБУ,
	|	ТаблицаВНА.ПараметрВыработкиМСФО КАК ПараметрВыработкиМСФО,
	|	ТаблицаВНА.ОбъемВыработкиНСБУ КАК ПредполагаемыйОбъемПродукцииНСБУ,
	|	ТаблицаВНА.ОбъемВыработкиМСФО КАК ПредполагаемыйОбъемПродукцииМСФО,
	|	ТаблицаВНА.КоэффициентУскоренияНСБУ КАК КоэффициентУскоренияНСБУ,
	|	ТаблицаВНА.КоэффициентУскоренияМСФО КАК КоэффициентУскоренияМСФО
	|ИЗ
	|	ТаблицаВНА КАК ТаблицаВНА
	...
	|	ТаблицаВНА.ПараметрыУчетаВНА КАК ГруппаВНА,
	|	ТаблицаВНА.ВидОперации КАК ВидОперации,
	|	ТаблицаВНА.СуммаНСБУ КАК ИзменениеОбесцененияНСБУ,
	|	ИСТИНА КАК СторнироватьДанныеНСБУ,
	|	ТаблицаВНА.КоррСчетНСБУ КАК СчетУчетаНСБУ,
	|	ТаблицаВНА.КоррСчетСубконто1НСБУ КАК СчетУчетаСубконто1НСБУ,
	|	ТаблицаВНА.КоррСчетСубконто2НСБУ КАК СчетУчетаСубконто2НСБУ,
	|	ТаблицаВНА.КоррСчетСубконто3НСБУ КАК СчетУчетаСубконто3НСБУ,
	|	ТаблицаВНА.КоррСчетМСФО КАК СчетУчетаМСФО,
	|	ТаблицаВНА.КоррСчетСубконто1МСФО КАК СчетУчетаСубконто1МСФО,
	|	ТаблицаВНА.КоррСчетСубконто2МСФО КАК СчетУчетаСубконто2МСФО,
	|	ТаблицаВНА.КоррСчетСубконто3МСФО КАК СчетУчетаСубконто3МСФО,
	|	ТаблицаВНА.СчетАмортизацииНСБУ КАК КоррСчетНСБУ,
	|	ТаблицаВНА.СчетАмортизацииСубконто1НСБУ КАК КоррСчетСубконто1НСБУ,
	|	ТаблицаВНА.СчетАмортизацииСубконто2НСБУ КАК КоррСчетСубконто2НСБУ,
	|	ТаблицаВНА.СчетАмортизацииСубконто3НСБУ КАК КоррСчетСубконто3НСБУ,
	|	ТаблицаВНА.СчетАмортизацииМСФО КАК КоррСчетМСФО,
	|	ТаблицаВНА.СчетАмортизацииСубконто1МСФО КАК КоррСчетСубконто1МСФО,
	|	ТаблицаВНА.СчетАмортизацииСубконто2МСФО КАК КоррСчетСубконто2МСФО,
	|	ТаблицаВНА.СчетАмортизацииСубконто3МСФО КАК КоррСчетСубконто3МСФО
	|ИЗ
	|	ТаблицаВНА КАК ТаблицаВНА
	|ГДЕ
	|	ТаблицаВНА.ВидОперации В (ЗНАЧЕНИЕ(Справочник.ВидыОпераций.ОбесценениеВНА))
	|
	|УПОРЯДОЧИТЬ ПО
	|	ДатаДокумента";
...
Процедура ЗаполнитьСтроки(КоллекцияСтрок, Источник, ПараметрыЗаполненияТЧ = Неопределено) Экспорт
	...
	Если ПараметрыЗаполненияТЧ.ЗаполнитьНСБУ Или ПараметрыЗаполненияТЧ.ЗаполнитьМСФО Тогда
		ГруппыВНА = МСФОВНАВызовСервераУХ.ПолучитьГруппыВНА(КоллекцияСтрок, ПараметрыЗаполнения);
	КонецЕсли;
...
Процедура ЗаполнитьЗависимостиРеквизитовДокумента(ФормаДокумента) Экспорт 
	...
	Реквизиты.Вставить("ПараметрыАмортизацииВНАМСФО", 	"ПараметрыАмортизации");
