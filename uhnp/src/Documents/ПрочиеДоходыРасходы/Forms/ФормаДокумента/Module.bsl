...
Процедура УправлениеФормойСервер()
	...
	Элементы.ДекорацияРасходыСуммыУпр.Заголовок =
		СтрШаблон(НСтр("ru = 'Суммы расходов в валюте документа (%1):';
						|en = 'Expense amounts in the document currency (%1):'"), ВалютаУпр);
	...
	ПрочиеРасходыСуммаШаблон = ?(ИспользоватьУчетНДС, НСтр("ru = 'Сумма с НДС (%1)';
															|en = 'Amount including VAT (%1)'"), НСтр("ru = 'Сумма (%1)';
																							|en = 'Amount (%1)'"));
	...
	Элементы.ПрочиеРасходыСуммаБезНДС.Заголовок =
		СтрШаблон(НСтр("ru = 'Сумма без НДС (%1)';
						|en = 'Amount excluding VAT (%1)'"), ВалютаУпр);
	...
	Элементы.ДекорацияДоходыСуммыУпр.Заголовок =
		СтрШаблон(НСтр("ru = 'Суммы доходов в валюте документа (%1):';
						|en = 'Income amounts in the document currency (%1):'"), ВалютаУпр);
	...
	Элементы.ПрочиеДоходыСумма.Заголовок =
		СтрШаблон(НСтр("ru = 'Сумма с НДС (%1)';
						|en = 'Amount including VAT (%1)'"), ВалютаУпр);
