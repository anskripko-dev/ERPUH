...
Функция ТекстЗапросаОчередьСобытий(НомераТаблиц)
	...
	|		И ТаблицаВНА.ГруппаВНА.ТипВНА В (ЗНАЧЕНИЕ(Перечисление.ТипыВНА.НезавершенноеСтроительство))
	|	
	|	ОБЪЕДИНИТЬ ВСЕ
	|	
	|	ВЫБРАТЬ
	...
	|	ГДЕ
	|		ТаблицаВНА.ДатаВводаНСБУ МЕЖДУ &ДатаНачалаПериода И &ДатаОкончанияПериода
	|		И ТаблицаВНА.ГруппаВНА.ТипВНА В (ЗНАЧЕНИЕ(Перечисление.ТипыВНА.ОсновноеСредство), ЗНАЧЕНИЕ(Перечисление.ТипыВНА.НематериальныйАктив), ЗНАЧЕНИЕ(Перечисление.ТипыВНА.БиологическийАктив), ЗНАЧЕНИЕ(Перечисление.ТипыВНА.ИнвестиционноеИмущество))
	|	
	|	ОБЪЕДИНИТЬ ВСЕ
	|	
	|	ВЫБРАТЬ
...
Функция ТекстЗапросаНачислениеАмортизацииВНАМСФО(НомераТаблиц)
	...
	|	И ТаблицаВНА.ГруппаВНА.ТипВНА <> ЗНАЧЕНИЕ(Перечисление.ТипыВНА.НезавершенноеСтроительство)";	
