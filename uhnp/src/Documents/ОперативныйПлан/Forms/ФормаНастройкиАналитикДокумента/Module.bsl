...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	Справочники.ВидыОперативныхПланов.УстановитьУсловноеОформлениеНастройкиАналитик(ЭтаФорма, Истина);
...
Процедура УправлениеФормой()
	...
	ВидимостьКоличества = ВидБюджета = ПланыВидовХарактеристик.ВидыБюджетов.БюджетДоходовИРасходов;
