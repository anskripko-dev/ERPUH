...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Параметры.Свойство("ВидБюджета", 	ВидБюджета);
...
&НаСервере
Функция ПараметрыДобавленныхРеквизитов()
	
	Перем ПараметрыДобавленныхРеквизитов;
	
	ПараметрыДобавленныхРеквизитов = Новый Структура;
	ПараметрыДобавленныхРеквизитов.Вставить("ДобавляемыеРеквизиты", Новый Массив);  
	ПараметрыДобавленныхРеквизитов.Вставить("УдаляемыеРеквизиты", 	Новый Массив);  
	ПараметрыДобавленныхРеквизитов.Вставить("СуществующиеРеквизиты",Новый Соответствие);
   	
	Возврат ПараметрыДобавленныхРеквизитов;
...
Процедура ЗаполнитьКроссТаблицу(ОписаниеКТ)             
	...
	ПараметрыДобавленныхРеквизитов = ПараметрыДобавленныхРеквизитов();    
	
	КроссТаблицыУХ.ИнициализироватьСуществующиеРеквизитыПараметровДобавленныхРеквизитовКТ(ОписаниеКТ, ЭтотОбъект, ПараметрыДобавленныхРеквизитов);
	
	// 2. Сохранение описания кросс-таблицы и создание необходимых реквизитов формы
	КроссТаблицыУХ.ЗарегистрироватьРеквизитыКроссТаблицы(ПараметрыДобавленныхРеквизитов, ЭтотОбъект, ОписаниеКТ);
	
	ЭтотОбъект.ИзменитьРеквизиты(ПараметрыДобавленныхРеквизитов.ДобавляемыеРеквизиты, 
									ПараметрыДобавленныхРеквизитов.УдаляемыеРеквизиты);
