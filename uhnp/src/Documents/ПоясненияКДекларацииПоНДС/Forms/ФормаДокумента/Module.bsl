...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УстановитьЗаголовокКолонокНомерТаможеннойДекларации();
...
&НаСервере
Процедура УстановитьЗаголовокКолонокНомерТаможеннойДекларации()
	
	Если Наступило Тогда
		
		НовыйЗаголовок = НСтр("ru = 'Декларация или партия';
								|en = 'Декларация или партия'");
		
		Элементы.КнигаПокупокНомерТаможеннойДекларации.Заголовок = НовыйЗаголовок;
		Элементы.КнигаПокупокДлНомерТаможеннойДекларации.Заголовок = НовыйЗаголовок;
