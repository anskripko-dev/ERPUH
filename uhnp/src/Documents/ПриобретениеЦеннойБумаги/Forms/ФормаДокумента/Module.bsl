...
Процедура СтоимостьПриИзменении(Элемент)
	ЗаполнитьДокумент(Новый Структура("ЗаполнитьКэшируемыеЗначения,ЗаполнитьНКД,РассчитатьСтоимостьНоминала,РассчитатьПремию"));
КонецПроцедуры
...
Процедура ЗаполнитьДокументНаСервере(СтруктураДействий = Неопределено)
	...
	Если СтруктураДействий = Неопределено Тогда
		СтруктураДействий = Новый Структура("ЗаполнитьКэшируемыеЗначения,ЗаполнитьНКД,РассчитатьСтоимостьНоминала,РассчитатьПремию");	
	КонецЕсли;

	КэшируемыеЗначения.Вставить("КонтекстДокумента", Новый Структура("Дата", Объект.Дата));	
	ФинансовыеИнструментыФормыВызовСервера.ОбработатьСтрокуЦБ(Объект, СтруктураДействий, КэшируемыеЗначения);
