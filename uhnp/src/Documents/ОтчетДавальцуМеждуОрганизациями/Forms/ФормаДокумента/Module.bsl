...
Процедура НастроитьЭлементыФормы()
	...
	ИсходнаяВидимостьРНПТМатериалов = Элементы.ГруппаРНПТМатериалов.Видимость;
	Элементы.ГруппаРНПТМатериалов.Видимость = Ложь;
	//++ Локализация
	Элементы.ГруппаРНПТМатериалов.Видимость = ИсходнаяВидимостьРНПТМатериалов;
	//-- Локализация
