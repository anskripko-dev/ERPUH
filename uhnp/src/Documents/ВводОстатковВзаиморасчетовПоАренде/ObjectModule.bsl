...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	ВстраиваниеУХДоговорыАренды.ВводОстатковВзаиморасчетовПоАренде_ОбработкаЗаполнения(ЭтотОбъект, ДанныеЗаполнения, СтандартнаяОбработка);
	#КонецОбласти
...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	#Область УХ_Встраивание
	ВстраиваниеУХДоговорыАренды.ВводОстатковВзаиморасчетовПоАренде_ПередЗаписью(ЭтотОбъект,Отказ);	
	#КонецОбласти   
...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	#Область УХ_Встраивание
	ВстраиваниеУХДоговорыАренды.ВводОстатковВзаиморасчетовПоАренде_ОбработкаПроведения(ЭтотОбъект, Отказ, РежимПроведения);
