...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ЗначениеЗаполнено(Объект.Ссылка) Тогда        
		...
		Если ЗначениеЗаполнено(Объект.План) И ТипЗнч(Объект.План) = Тип("ДокументСсылка.ПланЗакупок") Тогда    
			ФормированиеПотребностейПланомЗакупок = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Объект.План, "Сценарий.ФормированиеПотребностейПланомЗакупок");
			Если ФормированиеПотребностейПланомЗакупок = Истина Тогда  
				ОбщегоНазначения.СообщитьПользователю(НСтр("ru = 'Корректировка плановых потребностей не поддерживается для корпоративных планов закупки'"));
				Отказ = Истина;
				Возврат;
			КонецЕсли;
		КонецЕсли;
