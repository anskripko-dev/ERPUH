...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(АнкетаПоставщика) Тогда
		...
		КонецЕсли;            
		Если ДокументАккредитации.Пустая() И ДанныеАккредитации <> Неопределено Тогда
			ДокументАккредитации = ДанныеАккредитации.Регистратор;
		КонецЕсли;     
		Если ДокументАккредитации.Пустая() Тогда
			ВызватьИсключение СтрШаблон(Нстр("ru = 'Не удалось определить документ аккредитации'"), АнкетаПоставщика);
		КонецЕсли;
