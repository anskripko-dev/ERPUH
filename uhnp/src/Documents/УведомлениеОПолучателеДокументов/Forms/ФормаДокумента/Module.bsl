			...
			Если Объект.ДляВсехПодразделений Тогда
				ТекстСообщения =
					НСтр("ru = 'После отправки уведомления все входящие сообщения, в том числе требования, от налогового органа будут приходить на учетную запись организации - отправителя уведомления.';
						|en = 'После отправки уведомления все входящие сообщения, в том числе требования, от налогового органа будут приходить на учетную запись организации - отправителя уведомления.'");
			Иначе
				ТекстСообщения =
					НСтр("ru = 'После отправки уведомления все входящие сообщения, в том числе требования, по указанной регистрации будут приходить на учетную запись организации - отправителя уведомления.';
						|en = 'После отправки уведомления все входящие сообщения, в том числе требования, по указанной регистрации будут приходить на учетную запись организации - отправителя уведомления.'");
			КонецЕсли;
		Иначе
			ТекстСообщения =
				НСтр("ru = 'После отправки уведомления все входящие сообщения, в том числе требования, от налогового органа будут приходить на учетную запись индивидуального предпринимателя - отправителя уведомления.';
					|en = 'После отправки уведомления все входящие сообщения, в том числе требования, от налогового органа будут приходить на учетную запись индивидуального предпринимателя - отправителя уведомления.'");
		КонецЕсли;
	Иначе
		Если Объект.ДляВсехПодразделений Тогда
			ТекстСообщения =
				НСтр("ru = 'После отправки уведомления все входящие сообщения, в том числе требования, от налогового органа будут приходить на заданную учетную запись абонента.';
					|en = 'После отправки уведомления все входящие сообщения, в том числе требования, от налогового органа будут приходить на заданную учетную запись абонента.'");
		Иначе
			ТекстСообщения =
				НСтр("ru = 'После отправки уведомления все входящие сообщения, в том числе требования, по указанной регистрации будут приходить на заданную учетную запись абонента.';
					|en = 'После отправки уведомления все входящие сообщения, в том числе требования, по указанной регистрации будут приходить на заданную учетную запись абонента.'");
		КонецЕсли;
	КонецЕсли;
