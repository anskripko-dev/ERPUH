...
Процедура НастроитьЗависимыеЭлементыФормыНаСервере(Знач ИзмененныеРеквизиты = "")
	...
	Если ОбновитьВсе Тогда
		...
		СтрокаСТегами = НСтр("ru = 'Статья, по которой отражаются расходы, связанные с выбытием основных средств.
							 ...
							 |- <a href = %1>Expenses linked to the retirement of fixed assets</a> - used to record retirement via the 01.09 account
							 |- <a href = %2>Retirement of fixed assets</a> - used to record retirement via the 03.09 account'");
