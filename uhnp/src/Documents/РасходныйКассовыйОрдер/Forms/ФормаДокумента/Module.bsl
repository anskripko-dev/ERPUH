...
Процедура ХозяйственнаяОперацияПриИзмененииСервер()
	...
	ВстраиваниеУХРасходныйКассовыйОрдер.ХозяйственнаяОперацияПриИзменении(ЭтотОбъект);
	#КонецОбласти
...
Процедура ДоговорПриИзмененииНаСервере()
	...
	ЗаполнитьНалогообложениеНДС();
	#Область УХ_Встраивание
	ВстраиваниеУХРасходныйКассовыйОрдер.ПриИзмененииДоговора(ЭтотОбъект);
	#КонецОбласти
	УстановитьОграничениеТипаДоговораРасшифровкиПлатежа();
...
Процедура РасшифровкаПлатежаОбъектРасчетовОбработкаВыбораНаСервере(ВыбранноеЗначение)
	...
	#Область УХ_Встраивание
	ВстраиваниеУХРасходныйКассовыйОрдер.РасшифровкаПлатежаОбъектРасчетовПриИзменении(ЭтотОбъект, СтрокаТаблицы);
	#КонецОбласти
...
Процедура РасшифровкаПлатежаДоговорКредитаДепозитаПриИзмененииСервер()
	...
	ЗаполнитьВалютуВзаиморасчетовДокумента();
	#Область УХ_Встраивание
	ВстраиваниеУХРасходныйКассовыйОрдер.РасшифровкаПлатежаДоговорКредитаДепозитаПриИзменении(ЭтотОбъект, ТекущаяСтрока);
	#КонецОбласти
	НастроитьЗависимыеЭлементыФормыНаСервере();
...
Процедура РасшифровкаПлатежаДоговорАрендыПриИзмененииНаСервере()
	...
	#Область УХ_Встраивание
	ВстраиваниеУХРасходныйКассовыйОрдер.РасшифровкаПлатежаДоговорАрендыПриИзменении(ЭтотОбъект, ТекущаяСтрока);
	#КонецОбласти
	УстановитьВидимостьДоступностьЭлементовРасшифровкиБезРазбиения();
	УстановитьОграничениеТипаДоговораРасшифровкиПлатежа();
...
Процедура ПриЧтенииСозданииНаСервере()
	#Область УХ_Внедрение
	ВстраиваниеУХРасходныйКассовыйОрдер.ПриЧтенииСозданииНаСервере(ЭтаФорма);
	#КонецОбласти
...
Функция СтатьяДДСПоЭлементуСтруктурыЗадолженности(ТекущаяСтрока)
	...
	Возврат ВстраиваниеУХРасходныйКассовыйОрдер.СтатьяДДСПоЭлементуСтруктурыЗадолженности(
