...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	МножественноеУказание = ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(
								Параметры, "МножественноеУказаниеОбластиДействия", Ложь);
	...
	УстановитьВидимостьВЗависимостиОтМножественногоУказания();
...
Функция РезультатРедактированияНаСервере()
	...
	Результат.Вставить("Этап", ?(ЗначениеЗаполнено(Этап) И ИспользоватьЭтап И ИспользоватьИзделие И РежимИспользованиеИзделие = 1,
	...
	Результат.Вставить("ХарактеристикаИзделия", 
		?(ЗначениеЗаполнено(ХарактеристикаИзделия) И ИспользоватьХарактеристикуИзделия И ИспользоватьИзделие И РежимИспользованиеИзделие = 0,
		ХарактеристикаИзделия,
		Справочники.ХарактеристикиНоменклатуры.ПустаяСсылка()));
		
	Результат.Вставить("МножественноеУказание", МножественноеУказание);
...
&НаСервере
Процедура УстановитьВидимостьВЗависимостиОтМножественногоУказания()
	
	Если Не МножественноеУказание Тогда
		Возврат;
	КонецЕсли;
	
	ИменаЭлементов = Новый Массив;
	ИменаЭлементов.Добавить("ГруппаНаправлениеДеятельности");
	ИменаЭлементов.Добавить("ГруппаПодразделение");
	ИменаЭлементов.Добавить("ГруппаЗаказКлиента");
	ИменаЭлементов.Добавить("ГруппаЗаказНаПроизводство");
