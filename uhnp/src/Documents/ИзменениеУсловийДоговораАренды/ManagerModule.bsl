...
Функция ТекстЗапроса_ДатыОперацийДокумента() экспорт
	...
	|ИЗ
	|	Документ.ИзменениеУсловийДоговораАренды.ГрафикОплатУслуг КАК ЗаключениеДоговораАрендыГрафикОплатУслуг
	|ГДЕ
	...
	|ИЗ
	|	Документ.ИзменениеУсловийДоговораАренды.ГрафикНачисленияУслуг КАК ЗаключениеДоговораАрендыГрафикНачисленияУслуг
	|ГДЕ
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	СписокОписаний.Добавить(НСтр("ru = 'Обновление документов ""Изменение условий договора аренды"":';
								|en = 'Update the ""Rental term adjustment"" documents:'"));
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	СписокОписаний.Добавить(НСтр("ru = 'Не удалось обработать документы ""Изменение условий договора аренды"" по обработчику:';
								|en = 'Cannot process the ""Rental term adjustment"" documents by the handler:'"));
