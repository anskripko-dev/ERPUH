...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение реквизита ""Валюта"" в документе ""Ввод остатков расчетов по эквайрингу""';
									|en = 'Fill the ""Currency"" attribute in the ""OB entry: acquiring contract AR/AP"" document'");
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	СписокОписаний.Добавить(НСтр("ru = 'Не удалось обработать документы ""Ввод остатков расчетов по эквайрингу"" по обработчику:';
								|en = 'Cannot process the ""OB entry: acquiring contract AR/AP"" documents by the handler:'"));
	СписокОписаний.Добавить(НСтр("ru = '- заполнение реквизита ""Валюта""';
								|en = '- Fill the ""Currency"" attribute'"));
	...
	Иначе
		...
		ШаблонСообщения = НСтр("ru = 'Обработана порция документов ""Ввод остатков расчетов по эквайрингу"": %1';
								|en = 'A batch of ""OB entry: acquiring contract AR/AP"" documents is processed: %1'");
