...
Процедура АвтоурегулированиеНаСервере(ТекстОшибки)
	...
	Параметры_.ПериодСценария = ПериодСценария;
	Параметры_.Сценарий = Сценарий;
	...
	мДокументовУрегулирования = Документы.УрегулированиеРасхожденияВГО
		.АвтоматическоеУрегулированиеРасхождений(Параметры_, ТекстОшибки);
