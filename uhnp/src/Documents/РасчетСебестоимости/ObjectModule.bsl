...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	РеквизитыУП = МСФОВызовСервераУХ.РеквизитыДляФормыУП(Организация, Дата, Сценарий);
	...
	Если ЗначениеЗаполнено(ВариантИзУП) Тогда
		ВариантЗакрытияСчетов = ВариантИзУП;
	КонецЕсли;
	
	Если КорректировкиАмортизации Или КорректировкиЗапасов Или ЗакрытиеЗатрат Тогда
		СтандартнаяОбработка = Ложь;//Галки заполнены, не перезаполняем
	КонецЕсли;
