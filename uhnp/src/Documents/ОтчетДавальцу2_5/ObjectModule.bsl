...
Процедура ЗаполнитьДокументНаОснованииОтгрузкиТоваровСХранения(ДокументОснование)
	...
	УсловиеОтбораОстатков = "ТИПЗНАЧЕНИЯ(Распоряжение) = ТИП(Документ.ЗаказДавальца2_5)
...
Процедура ЗаполнитьДокументНаОснованииДоговора(ДоговорОснование, РеквизитыДоговора = Неопределено)
	...
	УсловиеОтбораОстатков = "ТИПЗНАЧЕНИЯ(Распоряжение) = ТИП(Документ.ЗаказДавальца2_5)
							|И ВЫРАЗИТЬ(Распоряжение КАК Документ.ЗаказДавальца2_5).Договор В (&Договор)";
...
Процедура ЗаполнитьДополнительныеПоляВидовЗапасов(МенеджерВременныхТаблиц)
	...
	// Заполнение поля КорВидЗапасов должно соответствовать процедуре ЗаполнитьДопКолонкиВидовЗапасов() 
	// в документе КорректировкаРеализации.
