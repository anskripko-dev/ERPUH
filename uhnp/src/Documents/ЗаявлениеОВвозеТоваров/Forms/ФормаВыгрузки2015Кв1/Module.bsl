...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	ИначеЕсли ИмяСобытия = "Запись_Организации" Тогда
		...
		Если ЗначениеЗаполнено(Организация) Тогда 
			...
			СтруктураПараметров = Новый Структура("Организация, ДатаЗначения, СведенияОбОрганизации", Организация, Неопределено, СведенияОбОрганизации);
			ЗаменитьСведенияОбОрганизацииСведениямиОКрупнейшемНалогоплательщикеНаСервере(СтруктураПараметров);
			СведенияОбОрганизации = СтруктураПараметров.СведенияОбОрганизации;
...
&НаСервере
Процедура ЗаменитьСведенияОбОрганизацииСведениямиОКрупнейшемНалогоплательщикеНаСервере(СтруктураПараметров)
