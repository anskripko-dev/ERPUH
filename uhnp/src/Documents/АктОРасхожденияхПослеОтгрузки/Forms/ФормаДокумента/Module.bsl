...
Процедура УправлениеРеквизитамиФормыВЗависимостиОтТипаОснования()
		...
		Если РасхожденияКлиентСервер.ТипОснованияВозвратПоставщику(Объект.ТипОснованияАктаОРасхождении) Тогда
			...
			СписокВыбораСпособОтраженияРасхожденийИзменениеДокумента.Добавить(
				...
				НСтр("ru = 'Изменить возврат товаров поставщику';
					|en = 'Change return of goods to the vendor'"));
	...
	ИначеЕсли Объект.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ОтгрузкаТоваровСХранения Тогда
		...
		СписокВыбораСпособОтраженияРасхожденийИзменениеДокумента.Добавить(
			...
			НСтр("ru = 'Изменить отгрузку товаров с хранения';
				|en = 'Change the VMI pick-up request from vendor'"));
		СписокВыбораСпособОтраженияРасхожденийКорректировкаИсправление.Добавить(
			...
			НСтр("ru = 'Оформить отгрузку товаров с хранения (исправление)';
				|en = 'Register the VMI pick-up request from vendor (correction)'"));
		...
		Если РасхожденияКлиентСервер.ТипОснованияПередачаТоваровХранителю(Объект.ТипОснованияАктаОРасхождении) Тогда
			...
			ИначеЕсли Объект.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ПередачаТоваровПереработчику Тогда
				ТекстСпособаОбработкиИсправление   = НСтр("ru = 'Изменить передачу сырья переработчику';
															|en = 'Change the Goods issue — Subcontracting services received'");
				ТекстСпособаОбработкиКорректировка = НСтр("ru = 'Оформить передачу сырья переработчику (исправление)';
															|en = 'Register the Goods issue — Subcontracting services received (correction)'");
			//-- НЕ УТ
			КонецЕсли;
			СписокВыбораСпособОтраженияРасхожденийИзменениеДокумента.Добавить(
				Перечисления.СпособыОтраженияРасхожденийАктПриемкиКлиента.ИсправлениеПервичныхДокументов,
		...
		Иначе
			СписокВыбораСпособОтраженияРасхожденийИзменениеДокумента.Добавить(
				...
				НСтр("ru = 'Изменить передачу на комиссию';
					|en = 'Change the consignment sales'"));
			СписокВыбораСпособОтраженияРасхожденийКорректировкаИсправление.Добавить(
				Перечисления.СпособыОтраженияРасхожденийАктПриемкиКлиента.ОформлениеКорректировкиКакИсправлениеПервичныхДокументов,
				НСтр("ru = 'Оформить передачу на комиссию (исправление)';
					|en = 'Register the consignment sales (correction)'"));
		КонецЕсли;
	...
	ИначеЕсли Объект.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ПередачаДавальцу
		...
		Элементы.ТоварыЕстьКомментарийКлиента.Заголовок   = НСтр("ru = 'от давальца';
																|en = 'from provider'");
		Элементы.НомерПоДаннымКлиента.Заголовок           = НСтр("ru = 'Номер акта 
																		|по данным давальца';
																		|en = 'Report number 
		...
		Если Объект.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ПередачаДавальцу Тогда
			...
			СписокВыбораСпособОтраженияРасхожденийИзменениеДокумента.Добавить(
				Перечисления.СпособыОтраженияРасхожденийАктПриемкиКлиента.ИсправлениеПервичныхДокументов,
				НСтр("ru = 'Изменить передачу давальцу';
					|en = 'Change the Goods issue — Subcontracting services delivered'"));
			СписокВыбораСпособОтраженияРасхожденийКорректировкаИсправление.Добавить(
				Перечисления.СпособыОтраженияРасхожденийАктПриемкиКлиента.ОформлениеКорректировкиКакИсправлениеПервичныхДокументов,
				НСтр("ru = 'Оформить передачу давальцу (исправление)';
					|en = 'Register the Goods issue — Subcontracting services delivered (correction)'"));
			...
			Элементы.ПоРеализациямБезНДС.Заголовок               = НСтр("ru = 'По передаче давальцу';
																		|en = 'By transfer to provider'");
			Элементы.ПоРеализациямСНДС.Заголовок                 = НСтр("ru = 'По передаче давальцу';
																		|en = 'By transfer to provider'");
		...
		ИначеЕсли Объект.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ВозвратДавальцу Тогда
			...
			СписокВыбораСпособОтраженияРасхожденийИзменениеДокумента.Добавить(
				Перечисления.СпособыОтраженияРасхожденийАктПриемкиКлиента.ИсправлениеПервичныхДокументов,
				НСтр("ru = 'Изменить возврат сырья давальцу';
					|en = 'Change the Goods return — Subcontracting services delivered'"));
			СписокВыбораСпособОтраженияРасхожденийКорректировкаИсправление.Добавить(
				Перечисления.СпособыОтраженияРасхожденийАктПриемкиКлиента.ОформлениеКорректировкиКакИсправлениеПервичныхДокументов,
				НСтр("ru = 'Оформить возврат сырья давальцу (исправление)';
					|en = 'Register the Goods return — Subcontracting services delivered (correction)'"));
			...
			Элементы.ПоРеализациямБезНДС.Заголовок               = НСтр("ru = 'По возврату сырья давальцу';
																		|en = 'By return of raw materials to provider'");
			Элементы.ПоРеализациямСНДС.Заголовок                 = НСтр("ru = 'По возврату сырья давальцу';
																		|en = 'By return of raw materials to provider'");
