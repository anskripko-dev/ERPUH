...
Процедура ПриЗаполненииСпискаТекущихДел(ТекущиеДела) Экспорт
	...
	Для Каждого Раздел Из Разделы Цикл
		...
		Дело.Представление  = НСтр("ru = 'Обработать (от банка получен отказ оплаты)';
									|en = 'Process (payment refusal is received from the bank)'");
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий     = НСтр("ru = 'Обработка уведомлений о статусе выплаты пособий (тип 110).';
										|en = 'Process notifications about the benefit payment status (type 110).'");
	...
	Обработчик.Комментарий     = НСтр("ru = 'СЭДО ЕЦП: Обработка сообщений типа 11010 ""Уведомление о статусе выплаты пособия"".';
										|en = 'Digital platform certificates EDI: Process messages whose type is 11010 ""Notification about benefit payment status"".'");
	...
	Обработчик.Комментарий     = НСтр("ru = 'СЭДО ЕЦП: Обработка сообщений типа 11000 ""Уведомление о статусе выплаты пособия"".';
										|en = 'СЭДО ЕЦП: Обработка сообщений типа 11000 ""Уведомление о статусе выплаты пособия"".'");
