	...
	Если Объект.ДатаНачала < Объект.Дата Тогда
		ОбщегоНазначения.СообщитьПользователю(
					НСтр("ru = 'Дата начала поездки не может быть меньше даты заявки.';
						|en = 'Business trip start date must be later than the application date.'")
					,
					,"ДатаНачала"
					,"Объект.ДатаНачала"
					,Отказ);
		...
		Если ЗначениеЗаполнено(Объект.ЖелательнаяДатаПлатежа) И Объект.ЖелательнаяДатаПлатежа < Объект.Дата Тогда
			ОбщегоНазначения.СообщитьПользователю(
						НСтр("ru = 'Дата платежа не может быть меньше даты заявки.';
							|en = 'Payment date must be later than the application date.'")
						,
...
Процедура ПриЧтенииСозданииНаСервере()
	...
	Элементы.Переместить(Элементы.НадписьСостояниеБронирования, ЭтотОбъект, Элементы.ГруппаСтатус);
	#КонецОбласти
...
Процедура ВызватьОбработчикДиспетчер(ИмяОбработчика, Элемент)
	...
	Если ИмяОбработчика = "РеквизитФормыПриИзменении" Тогда
		РеквизитФормыПриИзменении(Элемент);
	ИначеЕсли ИмяОбработчика = "СтатусПриИзменении" Тогда
		СтатусПриИзменении(Элемент);
	ИначеЕсли ИмяОбработчика = "СотрудникПриИзменении" Тогда
		СотрудникПриИзменении(Элемент);
	ИначеЕсли ИмяОбработчика = "СписокФизЛицПриИзменении" Тогда
		СписокФизЛицПриИзменении(Элемент);
	ИначеЕсли ИмяОбработчика = "ДатаНачалаПриИзменении" Тогда
		ДатаНачалаПриИзменении(Элемент);
	ИначеЕсли ИмяОбработчика = "ДатаОкончанияПриИзменении" Тогда
		ДатаОкончанияПриИзменении(Элемент);
	ИначеЕсли ИмяОбработчика = "ЧислоДнейПриИзменении" Тогда
		ЧислоДнейПриИзменении(Элемент);
	ИначеЕсли ИмяОбработчика = "СверхЛимитаПриИзменении" Тогда
		СверхЛимитаПриИзменении(Элемент);
	ИначеЕсли ИмяОбработчика = "БронироватьСамолетТудаПриИзменении" Тогда
		БронироватьСамолетТудаПриИзменении(Элемент);
	ИначеЕсли ИмяОбработчика = "БронироватьПоездТудаПриИзменении" Тогда
		БронироватьПоездТудаПриИзменении(Элемент);
	ИначеЕсли ИмяОбработчика = "БронироватьСамолетОбратноПриИзменении" Тогда
		БронироватьСамолетОбратноПриИзменении(Элемент);
	ИначеЕсли ИмяОбработчика = "БронироватьПоездОбратноПриИзменении" Тогда
		БронироватьПоездОбратноПриИзменении(Элемент);
	ИначеЕсли ИмяОбработчика = "КомандируемыеСотрудникиПриИзменении" Тогда
		КомандируемыеСотрудникиПриИзменении(Элемент);
	ИначеЕсли ИмяОбработчика = "ФормаОплатыПриИзменении" Тогда
		ФормаОплатыПриИзменении(Элемент);
	ИначеЕсли ИмяОбработчика = "СотрудникиПриИзменении" Тогда
		СотрудникиПриИзменении(Элемент);
	ИначеЕсли ИмяОбработчика = "Подключаемый_ПриИзмененииДополнительногоРеквизита" Тогда
