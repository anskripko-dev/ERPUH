...
Процедура ОбработкаПолученияПредставления(Данные, Представление, СтандартнаяОбработка)
	...
	Шаблон = НСтр("ru = 'Заявка на удержание ДСВ %1 от %2';
					|en = 'The %1 request for deduction of voluntary insurance contributions dated %2'");
...
Функция НаименованиеЗадачи(ДокументОбъект) Экспорт
	...
	ШаблонНаименования = НСтр("ru = 'Заявка на удержание ДСВ';
								|en = 'Request for deduction of voluntary insurance contributions'");
...
Функция СодержаниеЗадачи(ДокументОбъект) Экспорт
	...
	ШаблонНаименования = НСтр("ru = 'Обработать заявление на удержание добровольных страховых взносов';
								|en = 'Process the application for deductions of voluntary insurance contributions'");
