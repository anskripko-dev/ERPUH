...
Процедура ОбработатьРасшифровку(Элемент, Действие)
	...
	ИначеЕсли Действие.СпособРасшифровки = "ФормаДокументаПриложения" Тогда
		
		ИмяОткрываемойФормы = Действие.Объект + ".ФормаОбъекта";
		
		ПараметрыОткрываемойФормы = Новый Структура;
		ПараметрыОткрываемойФормы.Вставить("Ключ", Действие.Документ);
		Если Действие.Свойство("ИмяДерева") И Действие.Свойство("ИдентификаторДокумента") Тогда
			
			ЭлементДляАктивации = Новый Структура("Дерево, ИдентификаторДокумента",
				Действие.ИмяДерева, Действие.ИдентификаторДокумента);
			
			Если Действие.Свойство("ИдентификаторФайла") Тогда
				ЭлементДляАктивации.Вставить("ИдентификаторФайла", Действие.ИдентификаторФайла);
			КонецЕсли;
			
			ПараметрыОткрываемойФормы.Вставить("АктивироватьСтрокуПриложения", ЭлементДляАктивации);
