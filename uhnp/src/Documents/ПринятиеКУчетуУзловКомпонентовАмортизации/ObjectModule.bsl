	...
	Если НЕ ЭтоСписокОС Тогда
		...
		ИначеЕсли РеквизитыОснования.ТипОС <> Перечисления.ТипыОС.Узел
			...
			ТекстСообщения = НСтр("ru = 'Принятие к учету узлов и компонентов амортизации доступно для создания на основания типов ОС ""Объект эксплуатации"", ""Компонент амортизации"", ""Узел"".
								  ...
								  |en = 'You can create recognition of sub-assets and components of depreciation based on the ""Asset"", ""Depreciation component"", and ""Sub-asset"" fixed asset types.
								  |Select the available fixed asset type.'");
			ВызватьИсключение(ТекстСообщения);
...
Процедура ПроверитьОсновныеСредства(Отказ)
	...
	Пока Выборка.Следующий() Цикл
		...
		Если ОтражатьВУпрУчете
			...
			ТекстСообщения = СтрШаблон(НСтр("ru = 'Основное средство ""%1"" не принято к учету в управленческом учете.';
											|en = 'The ""%1"" fixed asset is not recognized in management accounting.'"), Выборка.ОсновноеСредствоПредставление);
		...
		ИначеЕсли ОтражатьВУпрУчете
			...
			ТекстСообщения = СтрШаблон(НСтр("ru = 'Основное средство ""%1"" снято с учета в управленческом учете.';
											|en = 'The ""%1"" fixed asset is derecognized in management accounting.'"), Выборка.ОсновноеСредствоПредставление);
		...
		Если ОтражатьВРеглУчете
			...
			ТекстСообщения = СтрШаблон(НСтр("ru = 'Основное средство ""%1"" не принято к учету в бухгалтерском учете.';
											|en = 'The ""%1"" fixed asset is not recognized in local accounting.'"), Выборка.ОсновноеСредствоПредставление);
		...
		ИначеЕсли ОтражатьВРеглУчете
			...
			ТекстСообщения = СтрШаблон(НСтр("ru = 'Основное средство ""%1"" снято с учета в бухгалтерском учете.';
											|en = 'The ""%1"" fixed asset is derecognized in local accounting.'"), Выборка.ОсновноеСредствоПредставление);
