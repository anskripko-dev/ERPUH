...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Обновляет документы ""Списание НМА"":
								  ...
								  |- Fills the new ""Residual value (management accounting)"" and ""Residual value (local)"" attributes.
								  |- Fills the ""Business unit and line of business match accounting data"" attribute.
								  |- Replaces the dimension value ""Tax types"" enumeration type with the ""Tax and contribution kinds"" catalog.'");
