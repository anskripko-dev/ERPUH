...
Процедура УстановитьУсловноеОформление()
	...
	#Область УХ_ЦентрализованныеЗакупкиВнедрение         
	...
	Элементы.ТоварыСтранаПроизводителя.Видимость = ПолучитьФункциональнуюОпцию("ВестиУчетПоСтранамКорпоративныеЗакупки");
	Элементы.ТоварыСтранаПроисхождения223ФЗ.Видимость = ПолучитьФункциональнуюОпцию("ВестиУчетПоСтранамКорпоративныеЗакупки");
	#КонецОбласти
