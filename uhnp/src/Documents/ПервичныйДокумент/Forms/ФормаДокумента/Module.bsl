...
Процедура УстановитьПараметрыВыбораДоговора()
	...
	Иначе
		...
		Если Объект.ТипПервичногоДокумента  = Перечисления.ТипыПервичныхДокументов.ОплатаОтКлиента
			...
			//++ НЕ УТКА
			Если НЕ Объект.ТипПервичногоДокумента  = Перечисления.ТипыПервичныхДокументов.ОплатаОтКлиента Тогда
				//++ Устарело_Переработка24
				НайденноеЗначение = МассивТиповДоговоров.Найти(ПредопределенноеЗначение("Перечисление.ТипыДоговоров.СДавальцем")); 
				Если НЕ НайденноеЗначение = Неопределено Тогда
					МассивТиповДоговоров.Удалить(НайденноеЗначение);
				КонецЕсли;
				//-- Устарело_Переработка24
			КонецЕсли;
			//-- НЕ УТКА
