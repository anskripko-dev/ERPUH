...
Функция ПривязатьСтрокиПоступленияКЗаказамПоставщикам(ОтобратьПоЗаказу, ЗаполнитьЦеныПоЗаказу = Ложь)
	...
	//++ НЕ УТКА
	СтруктураДействийСумма = Новый Структура;
	СтруктураДействийСумма.Вставить("ПересчитатьСумму");

	ОбрабатываемыеСтрокиСумма = Новый Массив;
	//-- НЕ УТКА
		...
		Если Выборка.КоличествоДублей < 2 Тогда
			...
			Для Каждого ТекСтрока Из НайденныеСтроки Цикл
				...
				ИначеЕсли ЗаполнитьЦеныПоЗаказу Тогда
					ОбрабатываемыеСтрокиСумма.Добавить(ТекСтрока);
				//-- НЕ УТКА
				КонецЕсли;
	...
	ПакетнаяОбработкаТабличнойЧастиСервер.ОбработатьСтрокуТЧ(
		ОбрабатываемыеСтрокиСумма,
		СтруктураДействийСумма,
		Неопределено,
		Объект.Товары);
