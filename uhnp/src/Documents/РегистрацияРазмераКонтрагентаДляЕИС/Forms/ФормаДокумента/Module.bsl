...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ГруппаОднаСтрока.Видимость = Объект.РазмерыКонтрагентов.Количество() = 1; 
	Элементы.ГруппаТаблица.Видимость = Не Элементы.ГруппаОднаСтрока.Видимость;  
	Элементы.РежимТаблицы.Видимость = Элементы.ГруппаОднаСтрока.Видимость;
КонецПроцедуры
...
&НаСервере
Процедура РежимТаблицыНаСервере()
