...
Процедура ОбновитьОтображениеЧА(Форма, ВидимостьТЧ = Истина, ДочерняяИлиМатеринская = Истина, ОтборСтрок = Неопределено)
	...
	Если ДочерняяИлиМатеринская Тогда
		Элементы.Страница_МетодДолевогоУчастия.Заголовок =  Нстр("ru = 'Метод полного приобретения'");
		Элементы.МетодДолевогоУчастияФинансовыйРезультат.Заголовок =  Нстр("ru = 'Результат для НДУ'");
	Иначе	
		Элементы.Страница_МетодДолевогоУчастия.Заголовок =  Нстр("ru = 'Метод долевого участия'");
		Элементы.МетодДолевогоУчастияФинансовыйРезультат.Заголовок =  Нстр("ru = 'Результат для инвестора'");
	КонецЕсли;
...
Процедура ОткрытьВерсиюРегламента(Команда)
	...
	ТекстОшибки = НСтр("ru = 'Не найдена версия регламента по периоду и сценарию'");
