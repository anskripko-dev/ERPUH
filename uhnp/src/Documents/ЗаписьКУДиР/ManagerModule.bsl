...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	СписокОписаний.Добавить(НСтр("ru = 'Обновление документов ""Запись книги учета доходов и расходов (УСН / ПСН)"":';
								|en = 'Update the ""Entry of ledger of income and expenditure (STS / PTS)"" documents:'"));
	СписокОписаний.Добавить(НСтр("ru = '- замена статьи с перечисления ""Типы налогов"" на справочник ""Виды налогов и взносов"".';
								|en = '- Replace the ""Tax types"" enumeration with the ""Tax and contribution kinds"" catalog in the item value.'"));
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	СписокОписаний.Добавить(НСтр("ru = 'Не удалось обработать документы ""Запись книги учета доходов и расходов (УСН / ПСН)"" по обработчику:';
								|en = 'Cannot process the ""Entry of ledger of income and expenditure (STS / PTS)"" documents by the handler:'"));
	Запрос = Новый Запрос;
	Запрос.Текст = 
		"ВЫБРАТЬ
