...
Процедура ЗаполнитьВыборПериода()
	...
	Для каждого ДанныеЗаполнения Из ДанныеДляФормирования Цикл
		Если ДанныеЗаполнения.ИнтервалПланирования = Перечисления.ТочностьГрафикаПроизводства.Час
			ИЛИ ДанныеЗаполнения.ИнтервалПланирования = Перечисления.ТочностьГрафикаПроизводства.Смена Тогда
