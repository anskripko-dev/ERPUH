...
Функция ЗагрузитьОтклоненияПоВидамПродукцииJSON(ДокументСсылка, ДополнительныеПараметры = Неопределено)
	...
	Для Каждого Организация Из Организации Цикл
		...
		Для Каждого ВидПродукции Из ВидыПродукцииУчета Цикл
			...
			Если Не ВидПродукцииПоддерживаетЗагрузкуОтклонений(ВидПродукции) Тогда
				Продолжить;
			КонецЕсли;
...
Функция ВидПродукцииПоддерживаетЗагрузкуОтклонений(ВидПродукции)
	
	Если ВидПродукции = Перечисления.ВидыПродукцииИС.МоторныеМасла
		Или ВидПродукции = Перечисления.ВидыПродукцииИС.ПолимерныеТрубы
		Или ВидПродукции = Перечисления.ВидыПродукцииИС.КабельнаяПродукция Тогда
