...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение табличной части Платежно-расчетные документы Счет-фактур на неподтвержденную реализацию по ставке 0%';
									|en = 'Заполнение табличной части Платежно-расчетные документы Счет-фактур на неподтвержденную реализацию по ставке 0%'");
...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.СчетФактураНаНеподтвержденнуюРеализацию0.ПлатежноРасчетныеДокументы КАК ПлатежныеДокументы
	...
	|			ИЛИ ПлатежныеДокументы.НомерСчетаФактурыНаАванс = """")
	|";
