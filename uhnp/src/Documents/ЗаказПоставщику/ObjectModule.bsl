...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если Не РежимЗаписи = РежимЗаписиДокумента.ОтменаПроведения Тогда 
		УправлениеЗакупкамиВстраиваниеПереопределяемыйУХ.ЗаполнитьЭтапыГрафикаОплаты(ЭтотОбъект);
		Если ПорядокРасчетов = Перечисления.ПорядокРасчетов.ПоЗаказам Тогда
			УправлениеЗакупкамиВстраиваниеПереопределяемыйУХ.ЗаполнитьИдентификаторыПозиции(ЭтотОбъект);					
		КонецЕсли;
...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если (ХозяйственнаяОперация <> Перечисления.ХозяйственныеОперации.ПриемНаХранениеСПравомПродажи)
		...
		//Убираем удаление реквизита "Договор" для УХ
...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	#Область УХ_ЦентрализованныеЗакупки
	УправлениеЗакупкамиВстраиваниеПереопределяемыйУХ.ОбработкаПроведенияЗаказПоставщику(ЭтотОбъект,Отказ,РежимПроведения);
	#КонецОбласти
...
Процедура ЗаполнитьДокументНаОснованииДоговора(Знач СправочникОснование)
	...
	#Область УХ_Встраивание
	// Исправлено некорректное имя параметра в ERP.
	// Оригинальный код:
	...
	#Область УХ_Встраивание
	АналитикиПланированияДокументов.ЗаполнитьАналитикиПланированияПоДоговору(СправочникОснование, ЭтотОбъект);
	#КонецОбласти
