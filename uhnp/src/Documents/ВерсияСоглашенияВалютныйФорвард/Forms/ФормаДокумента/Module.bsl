...
Процедура ЗаполнитьБанковскийСчетКонтрагентаПоУмолчанию(Контрагент, ОплатаВВалюте, БанковскийСчетКонтрагента, ВалютаСчета)
	...
	|	ИЛИ (БанковскиеСчетаКонтрагентов.ВалютаДенежныхСредств = &ВалютаСчета И &ОплатаВВалюте))
...
&НаСервереБезКонтекста
Процедура ПартнерПриИзмененииСервер(Партнер,
									Контрагент,	
									ОплатаВВалюте,
									БанковскийСчетКонтрагента, 
									СчетКонтрагентаВВалютеРасчетов,
									БазоваяВалюта, ВалютаРасчетов)
	
	ПартнерыИКонтрагенты.ЗаполнитьКонтрагентаПартнераПоУмолчанию(Партнер, Контрагент, Истина);
	ЗаполнитьБанковскийСчетКонтрагентаПоУмолчанию(Контрагент, ОплатаВВалюте, БанковскийСчетКонтрагента, БазоваяВалюта);
	ЗаполнитьБанковскийСчетКонтрагентаПоУмолчанию(Контрагент, ОплатаВВалюте, СчетКонтрагентаВВалютеРасчетов, ВалютаРасчетов);
...
Процедура ПартнерПриИзмененииНаСервере()
	...
	ПартнерПриИзмененииСервер(Объект.Партнер, 
								...
								Объект.СчетКонтрагентаВВалютеРасчетов,
								Объект.БазоваяВалюта,
								Объект.ВалютаРасчетов);
