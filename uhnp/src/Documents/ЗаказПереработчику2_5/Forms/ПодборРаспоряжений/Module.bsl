...
Процедура ЗаполнитьРаспоряжения()
	...
	|				И НЕ ЭтапыПроизводства.Этап ЕСТЬ NULL
	|			ТОГДА ЭтапыПроизводства.Начало
	...
	|		КОГДА &ПланируютсяЭтапыПроизводства
	|				И НЕ ЭтапыПроизводства.Этап ЕСТЬ NULL
	|			ТОГДА ЭтапыПроизводства.Начало < &ТекущаяДата
	|		КОГДА НормативныйГрафикСтруктурыЗаказа.Начало ЕСТЬ НЕ NULL
	...
	|	ПО &ПланируютсяЭтапыПроизводства
	|		И ЭтапыПроизводства.ЗаказНаПроизводство = ДокЭтапПроизводства.Распоряжение
	|		И ЭтапыПроизводства.Этап = ДокЭтапПроизводства.Ссылка
	...
	|	ПО НЕ &ПланируютсяЭтапыПроизводства
	|		И ДокЭтапПроизводства.Ссылка = НормативныйГрафикСтруктурыЗаказа.Этап
	|
	|ГДЕ
	...
	Запрос.УстановитьПараметр("ПланируютсяЭтапыПроизводства",	УправлениеПроизводствомПовтИсп.ИспользуетсяГрафикПроизводства());
