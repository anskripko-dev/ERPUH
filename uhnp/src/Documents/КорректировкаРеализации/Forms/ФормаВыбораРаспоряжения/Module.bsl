...
Функция ТекстЗапросаСписок()
	...
	|			РаспоряженияОбороты.КОформлениюОборот КАК КОформлению
	|		ИЗ
	|			РегистрНакопления.РаспоряженияНаОтгрузку.Обороты(,,, Распоряжение ССЫЛКА Документ.ЗаказДавальца2_5
	...
	//++ НЕ УТКА
	|				ИЛИ РаспоряженияДвижения.Распоряжение ССЫЛКА Документ.ЗаказДавальца2_5
	//-- НЕ УТКА
