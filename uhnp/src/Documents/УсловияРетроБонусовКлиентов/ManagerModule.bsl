...
Процедура ДобавитьКомандыСозданияНаОсновании(КомандыСозданияНаОсновании, Параметры) Экспорт
	...
	Если НоваяКоманда <> Неопределено Тогда
		...
		НоваяКоманда.Представление = НСтр("ru = 'Корректировка условий ретро-бонусов клиентов';
											|en = 'Correct conditions of customer rebates'");
...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ru = 'Карточка (с учетом корректировок)';
										|en = 'Card (taking adjustments into account)'");
	...
	Если ПолучитьФункциональнуюОпцию("ВыводитьПолныеНаименованияРетроБонусовКлиентов") Тогда
		...
		Если Исправление Тогда
			ШаблонЗаголовкаДокумента = НСтр("ru = 'Корректировка условий ретро-бонусов клиентов %1';
											|en = 'Correct conditions of customer rebates %1'");
		Иначе
			ШаблонЗаголовкаДокумента = НСтр("ru = 'Условия ретро-бонусов клиентов %1';
											|en = 'Conditions of customer rebates %1'");
		КонецЕсли;
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	МассивКомментариев.Добавить(НСтр("ru = 'Исправляет заполнение полей ""Отбор товаров"" для документа ""Условия ретро-бонусов клиентов"", если в них установлен флаг расчета суммы вне системы.';
									|en = 'Corrects filling of the ""Goods picking"" fields for the ""Customer rebate conditions"" document if the ""Bonus amount is calculated outside the system"" checkbox is selected for them.'"));
				...
				Если ДокументОбъект.БезРасчета Тогда
					...
					Если НЕ ДокументОбъект.ОтборТоваров.Пустая() Тогда
						...
						ОписаниеИзменений.Добавить(НСтр("ru = '- обновлено значение поля ""Отбор товаров"" для документа с признаком расчета вне системы';
														|en = '- Updated the ""Goods picking"" field value for the document calculated outside the system'"));
						Записывать = Истина;
