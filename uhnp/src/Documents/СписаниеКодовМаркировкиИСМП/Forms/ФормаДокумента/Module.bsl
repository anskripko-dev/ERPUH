...
Процедура ПричинаСписанияПриИзменении(Элемент)
	...
	Если Объект.ПричинаСписания = ПредопределенноеЗначение("Перечисление.ПричиныСписанияКодовМаркировкиИСМП.ВыбытиеДоОбязательностиМаркировки") Тогда
...
Процедура НастроитьЗависимыеЭлементыФормы(Форма, СписокРеквизитов = "")
	...
	ТребуетсяУказаниеПервичногоДокумента =
		ИнтеграцияИСКлиентСервер.ИспользуетсяОсновнойДокументСписания(Объект.ПричинаСписания)
...
Процедура ЗаполнитьДоступныеПричининыВыбытия(Форма)
	...
	ИначеЕсли ОбщегоНазначенияИСКлиентСервер.ЭтоПродукцияИСМП(Объект.ВидПродукции, Ложь, Ложь)
		...
		Если Не ЭтоМех Тогда
			Элементы.ПричинаСписания.СписокВыбора.Добавить(
				ПредопределенноеЗначение("Перечисление.ПричиныСписанияКодовМаркировкиИСМП.Уничтожен"));
			Элементы.ПричинаСписания.СписокВыбора.Добавить(
				ПредопределенноеЗначение("Перечисление.ПричиныСписанияКодовМаркировкиИСМП.ВыбытиеДоОбязательностиМаркировки"));
		КонецЕсли;
	КонецЕсли;
...
Процедура ЗаполнитьДоступныеВидыПервичногоДокумента(Форма)
	...
	Если ИнтеграцияИСКлиентСервер.ИспользуетсяОсновнойДокументСписания(Объект.ПричинаСписания) Тогда
...
Процедура НастроитьЭлементыФормы(Форма)
	...
	ИспользуетсяОсновнойДокументСписания = ИнтеграцияИСКлиентСервер.ИспользуетсяОсновнойДокументСписания(Объект.ПричинаСписания);
	...
	Иначе
		...
		Элементы.ТоварыПричинаСписания.Видимость = Не (ИспользуетсяОсновнойДокументСписания Или ЭтоСписаниеПриПоступлении);
	КонецЕсли;
	
	Элементы.ПроизводственныйОбъект.Видимость = ЭтоПродукцияМОТП
		Или ЭтоМех
		Или ЭтоПиво И ИспользуетсяОсновнойДокументСписания;
	...
	Если ЭтоПродукцияМОТП Тогда
		...
		Элементы.ГруппаПроизводственныйОбъектЛиния.Видимость = Истина;
		Элементы.ГруппаПервичныйДокумент.Видимость = (ЭтоАльтернативныйТабак Или ЭтоНСП)
			...
			Или ИспользуетсяОсновнойДокументСписания;
	ИначеЕсли ОбщегоНазначенияИСКлиентСервер.ЭтоПродукцияИСМП(Объект.ВидПродукции) Тогда
		Элементы.ГруппаДополнительныеСведения.Видимость = ИспользуетсяОсновнойДокументСписания;
		Элементы.ГруппаПроизводственныйОбъектЛиния.Видимость = Не ИспользуетсяОсновнойДокументСписания;
		Элементы.ПредставлениеАдресаПроизводственногоОбъекта.Видимость = ЭтоПиво И ИспользуетсяОсновнойДокументСписания;
		Элементы.ГруппаПервичныйДокумент.Видимость = ИспользуетсяОсновнойДокументСписания;
	КонецЕсли;
	
	Элементы.ГруппаКодФИАС.Видимость = ЭтоПиво И ИспользуетсяОсновнойДокументСписания;
