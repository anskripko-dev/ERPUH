...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	ИспользуетсяОсновнойДокументСписания = ИнтеграцияИСКлиентСервер.ИспользуетсяОсновнойДокументСписания(ПричинаСписания);
	...
	Если ОбщегоНазначенияИСПовтИсп.ЭтоПродукцияМОТП(ВидПродукции)
		Или Не ИспользуетсяОсновнойДокументСписания Тогда
	...
	Если ИнтеграцияИСКлиентСервер.ВидПродукцииИспользуетПередачуОтчетаОбОтбраковкеЧерезСУЗ(ВидПродукции)
		...
		Или ИспользуетсяОсновнойДокументСписания Тогда
	...
	Если ОбщегоНазначенияИСПовтИсп.ЭтоПродукцияМОТП(ВидПродукции)
		И ИспользуетсяОсновнойДокументСписания Тогда
