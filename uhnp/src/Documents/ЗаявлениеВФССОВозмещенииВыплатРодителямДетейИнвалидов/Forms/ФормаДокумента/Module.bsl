	...
	ИначеЕсли Состояние = ВариантыСостояний.Принят
		...
		Если ВыплатаСтатус = 2 Тогда
			Представление = НСтр("ru = '<a href=""1"">Документ СФР направлен на оплату</a>';
								|en = '<a href=""1"">The document of the Social Insurance Fund of Russia is sent for payment</a>'");
		ИначеЕсли ВыплатаСтатус = 3 Тогда
			Представление = НСтр("ru = '<a href=""1"">Пособие успешно выплачено</a>';
								|en = '<a href=""1"">The benefit is successfully paid</a>'");
		ИначеЕсли ВыплатаСтатус = 4 Тогда
			Представление = НСтр("ru = '<a href=""1"">Оплата не прошла, отказ от банка</a>';
								|en = '<a href=""1"">Payment failed, bank refusal</a>'");
		ИначеЕсли ВыплатаСтатус = 5 Тогда
			Представление = НСтр("ru = '<a href=""1"">Получено извещение СФР</a>';
								|en = '<a href=""1"">Notification of the Social Insurance Fund of Russia is received</a>'");
		Иначе
			Представление = СтрШаблон(НСтр("ru = '<a href=""1"">%1</a>';
											|en = '<a href=""1"">%1</a>'"), Строка(Состояние));
	...
	ИначеЕсли Состояние = ВариантыСостояний.НеПринят Тогда
		...
		Если РегистрацияСтатус = "2" Тогда
			...
			Представление      = НСтр("ru = 'Произошла <a href=""1"">техническая ошибка</a>. Повторите отправку позже.';
										|en = 'A <a href=""1"">technical error</a> occurred. Try again later.'");
		Иначе
			ЕстьОшибки    = Истина;
