...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий     = НСтр("ru = 'Заполнение вторичных данных документа ""Заявление в ФСС о возмещении выплат родителям детей-инвалидов"" необходимых для печати.';
										|en = 'Fill the secondary data required for printing the ""Application to SSF for accrual compensations to parents of disabled children"" document.'");
	...
	Обработчик.Комментарий     = НСтр("ru = 'Заполнение сведений о сотрудниках в документе ""Заявление в ФСС о возмещении выплат родителям детей-инвалидов"" необходимых для вывода в списке.';
										|en = 'Fill information on employees in the ""Application to SSF for compensation of payments to parents of disabled children"" document required to be displayed in the list.'");
	...
	Обработчик.Комментарий     = НСтр("ru = 'СЭДО ЕЦП: Обработка сообщений типа 12110 ""Результат обработки заявления о возмещении выплат родителям детей-инвалидов"".';
										|en = 'Digital platform certificates EDI: Process messages of the 12110 ""Result of processing an application for compensation of payments to parents of disabled children"" type.'");
	...
	Обработчик.Комментарий     = НСтр("ru = 'СЭДО ЕЦП: Обработка сообщений типа 12210 ""Отказ в возмещении выплат родителям детей инвалидов"".';
										|en = 'Digital platform certificates EDI: Process messages of the 12210 ""Refusal to compensate payments to parents of disabled children"" type.'");
	...
	Обработчик.Комментарий     = НСтр("ru = 'СЭДО ЕЦП: Обработка документов ""Заявление в ФСС о возмещении выплат родителям детей-инвалидов"".';
										|en = 'Digital platform certificates EDI: Process the ""Application to SSF for compensation of payments to parents of disabled children"" documents.'");
