...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	ИначеЕсли ТипДанныхЗаполнения = Тип("Структура") Тогда 
		...
		Если ДанныеЗаполнения.Свойство("СтруктураДействий") Тогда 
			...
			//Документы.МодернизацияВНАМСФО.ЗаполнитьСтроки(ЭтотОбъект.ВНА, ЭтотОбъект, ДанныеЗаполнения.СтруктураДействий);
...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Документы.МодернизацияВНАМСФО.ПодготовитьПараметрыПроведения(ДополнительныеСвойства, Отказ);
	...
	Документы.МодернизацияВНАМСФО.СформироватьДвижения(Движения, ДополнительныеСвойства, Отказ);
...
Процедура ИнициализироватьДокумент(ДокументИсточник = Неопределено)
	...
	Если ДокументИсточник <> Неопределено Тогда
		ЗаполнитьЗначенияСвойств(ЭтотОбъект, ДокументИсточник, "Организация, Сценарий, ТипВНА");
...
Процедура ЗаполнитьИзПодсистемыНСБУ(ДокументыОснованияИсточник = Неопределено)
	...
	ИсточникЗаполнения = МСФОВНАУХ.ПолучитьДанные_МодернизацияВНА(ПараметрыЗаполнения);
