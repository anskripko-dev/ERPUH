...
Процедура ЗаполнитьПараметрыИнициализации(Запрос, ДокументСсылка)
	...
	Запрос.УстановитьПараметр("Дополнительно", СтрШаблон("ru = 'Перемещено на подразделение ""%1""';
														|en = 'Transferred to the ""%1"" business unit'", Реквизиты.ПодразделениеПолучатель)); // @НСтр-2
