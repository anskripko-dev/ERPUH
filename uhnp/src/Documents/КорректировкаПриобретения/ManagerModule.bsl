...
Функция ТекстЗапросаПоИсходнымДаннымКорректировокПервичногоДокумента()
	...
	//++ НЕ УТ
	|	КорректировкаПриобретения.СтатьяКалькуляции      КАК СтатьяКалькуляции,
	//++ НЕ УТКА
	|	КорректировкаПриобретения.ЭтапПроизводства       КАК ЭтапПроизводства,
	//-- НЕ УТКА
	...
	//++ НЕ УТ
	|	КорректировкаПриобретения.НастройкаСчетовУчета	 КАК НастройкаСчетовУчета,
	//-- НЕ УТ
	|	ТаблицаТовары.АналитикаАктивовПассивов КАК АналитикаАктивовПассивов,
	|	ТаблицаТовары.АналитикаДоходов КАК АналитикаДоходов
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	СписокОписаний.Добавить(НСтр("ru = 'Обновление документов ""Корректировка приобретения"":';
								|en = 'Update the ""Purchase adjustment"" documents:'"));
	...
	СписокОписаний.Добавить(НСтр("ru = '- зполнение реквизита ""Вариант приемки товаров"".';
								|en = '- Fill the ""Goods receipt option"" attribute.'"));
	СписокОписаний.Добавить(НСтр("ru = '- зполнение реквизита ""Хозяйственная операция"".';
								|en = '- Fill the ""Business transaction"" attribute.'"));
