...
Процедура НаработкиОбъектФормыПриИзменении(Элемент)
	...
	ЗаполнитьОбъектЭксплуатацииВТекущейСтроке();
...
&НаКлиенте
Процедура ЗаполнитьОбъектЭксплуатацииВТекущейСтроке()
	...
	ИначеЕсли ЗначениеЗаполнено(ТекущиеДанные.ОбъектФормы) Тогда
		ТекущиеДанные.ОбъектЭксплуатации = ТекущиеДанные.ОбъектФормы;
	Иначе
		ТекущиеДанные.ОбъектЭксплуатации = Неопределено;
	КонецЕсли;
