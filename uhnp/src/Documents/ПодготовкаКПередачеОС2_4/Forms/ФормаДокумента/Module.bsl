...
Процедура НастроитьЗависимыеЭлементыФормыНаСервере(Знач ИзмененныеРеквизиты = "")
	...
	Если ОбновитьВсе Тогда
		...
		СтрокаСТегами = НСтр("ru = 'Статья, по которой отражаются расходы, связанные с выбытием основных средств.
							 ...
							 |en = 'The item which records the expenses linked to the retirement of fixed assets.
							 |The following items are accessible:
							 |-<a href = %1>Expenses linked to the sales of fixed assets</a> - used to record the retirement via the 01.09 account
							 |- <a href = %2>The sale of tangible assets</a> - used to record the retirement via the 03.09 account
							 |- <a href = %3>Long-rerm assets for sale</a> - used to record the retirement via the 41 account.Long-term assets'");
