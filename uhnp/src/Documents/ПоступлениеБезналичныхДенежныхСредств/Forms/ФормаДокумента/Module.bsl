...
Процедура ХозяйственнаяОперацияПриИзмененииСервер()
	...
	ВстраиваниеУХПоступлениеБезналичныхДенежныхСредств.ХозяйственнаяОперацияПриИзменении(ЭтотОбъект);
	#КонецОбласти
...
Процедура КонтрагентПриИзмененииСервер()
	...
	ВстраиваниеУХПоступлениеБезналичныхДенежныхСредств.УстановитьПараметрыВыбораДокументПланирования(ЭтотОбъект);
	#КонецОбласти
...
Процедура ДоговорПриИзмененииНаСервере()
	...
	ЗаполнитьНалогообложениеНДС();
	#Область УХ_Встраивание
	ВстраиваниеУХПоступлениеБезналичныхДенежныхСредств.ПриИзмененииДоговора(ЭтотОбъект);
	#КонецОбласти
	УстановитьОграничениеТипаДоговораРасшифровкиПлатежа();
...
Процедура РасшифровкаОбъектРасчетовПриИзмененииСервер(ИдСтроки)
	...
	#Область УХ_Встраивание
	СтрокаТаблицы = Объект.РасшифровкаПлатежа.НайтиПоИдентификатору(ИдСтроки);
	ВстраиваниеУХПоступлениеБезналичныхДенежныхСредств.РасшифровкаПлатежаОбъектРасчетовПриИзменении(ЭтотОбъект, СтрокаТаблицы);
	#КонецОбласти
КонецПроцедуры
...
Процедура РасшифровкаПлатежаДоговорКредитаДепозитаПриИзмененииСервер()
	...
	ЗаполнитьВалютуВзаиморасчетовДокумента();
	#Область УХ_Встраивание
	ВстраиваниеУХПоступлениеБезналичныхДенежныхСредств.РасшифровкаПлатежаДоговорКредитаДепозитаПриИзменении(ЭтотОбъект, ТекущаяСтрока);
	#КонецОбласти
	НастроитьЗависимыеЭлементыФормыНаСервере();
...
Процедура ОбъектРасчетовДоговорНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если Объект.ХозяйственнаяОперация = ПредопределенноеЗначение("Перечисление.ХозяйственныеОперации.ПоступлениеДенежныхСредствИзДругойОрганизации") 
		...
		Если Объект.ХозяйственнаяОперация = ПредопределенноеЗначение("Перечисление.ХозяйственныеОперации.ВозвратДенежныхСредствОтДругойОрганизации") Тогда
			...
			СтруктураОтбора.Организация = ОрганизацияПлательщик; // Исправление ошибки ERP
			#КонецОбласти 
		...
		Иначе
			...
			СтруктураОтбора.Вставить("ОрганизацияПолучатель", ОрганизацияПлательщик); // Исправление ошибки ERP
			#КонецОбласти 
		КонецЕсли;
...
Процедура РасшифровкаПлатежаДоговорАрендыПриИзмененииСервер()
	...
	#Область УХ_Встраивание
	ВстраиваниеУХПоступлениеБезналичныхДенежныхСредств.РасшифровкаПлатежаДоговорАрендыПриИзменении(ЭтотОбъект, ТекущаяСтрока);
	#КонецОбласти
...
Процедура ПодборПоОстаткамЗавершениеСервер()
	...
	Для каждого СтрокаТаблицы Из Объект.РасшифровкаПлатежа Цикл
		...
		// УХ_Казначейство ++
		ВстраиваниеУХПоступлениеБезналичныхДенежныхСредств.ЗаполнитьСтрокаТаблицы(СтрокаТаблицы, ЭтотОбъект);
		// УХ_Казначейство --
...
Процедура ПриЧтенииСозданииНаСервере()
	#Область УХ_Внедрение
	ВстраиваниеУХПоступлениеБезналичныхДенежныхСредств.ПриЧтенииСозданииНаСервере(ЭтаФорма);
	#КонецОбласти
...
&НаСервере
Процедура УправлениеДоступностьюУХ()
	Элементы.РасшифровкаПлатежаДокументПланирования.ТолькоПросмотр = ЗначениеЗаполнено(Объект.ДокументОснование);
КонецПроцедуры
...
Функция СтатьяДДСПоЭлементуСтруктурыЗадолженности(ТекущаяСтрока)
	...
	Возврат ВстраиваниеУХПоступлениеБезналичныхДенежныхСредств.СтатьяДДСПоЭлементуСтруктурыЗадолженности(
