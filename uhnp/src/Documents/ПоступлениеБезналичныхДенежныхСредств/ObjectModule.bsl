...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	ИначеЕсли ТипЗнч(ДанныеЗаполнения) = Тип("Структура")
		...
		И ДанныеЗаполнения.Свойство("РаспоряжениеОснование")
		И ТипЗнч(ДанныеЗаполнения.ДокументОснование) = Тип("Массив")
		И ТипЗнч(ДанныеЗаполнения.РаспоряжениеОснование) = Тип("Массив") Тогда
		
		Если ДанныеЗаполнения.РаспоряжениеОснование.Количество() > 0 Тогда
			
			Если ТипЗнч(ДанныеЗаполнения.РаспоряжениеОснование[0]) = Тип("ДокументСсылка.РаспоряжениеНаПеремещениеДенежныхСредств") Тогда
				Основание = ДанныеЗаполнения.ДокументОснование[0];
				ЗаявкиНаОперацииВстраивание.ЗаполнитьДокументПо2ПозицииРаспоряжения(
					ДанныеЗаполнения.РаспоряжениеОснование[0],
					ЭтотОбъект,
					ДанныеЗаполнения,
					РасшифровкаПлатежа);
				ДанныеЗаполнения.Вставить("ДокументОснование", Основание);
				ИдентификаторПозиции = ДанныеЗаполнения.ИдентификаторПозиции;
			ИначеЕсли ТипЗнч(ДанныеЗаполнения.РаспоряжениеОснование[0]) = Тип("ДокументСсылка.ЗаявкаНаРасходованиеДенежныхСредств") Тогда
				Основание = ДанныеЗаполнения.ДокументОснование[0];
				ДанныеЗаполнения.ДокументОснование = ДанныеЗаполнения.РаспоряжениеОснование;
				ЗаявкиНаОперацииВстраивание.ЗаполнитьДокументПоЗаявкамНаРасходованиеДенежныхСредств(
					ЭтотОбъект,
					ДанныеЗаполнения,
					РасшифровкаПлатежа,
				...
				ДанныеЗаполнения.Вставить("ДокументОснование", Основание);
				ИдентификаторПозиции = ДанныеЗаполнения.ИдентификаторПозиции;
			ИначеЕсли ТипЗнч(ДанныеЗаполнения.РаспоряжениеОснование[0]) = Тип("ДокументСсылка.ОжидаемоеПоступлениеДенежныхСредств") Тогда
				Основание = ДанныеЗаполнения.ДокументОснование[0];
				ДанныеЗаполнения.ДокументОснование = ДанныеЗаполнения.РаспоряжениеОснование;
				ЗаявкиНаОперацииВстраивание.ЗаполнитьДокументПоОжидаемомуПоступлениюДенежныхСредств(
					ДанныеЗаполнения,
					РасшифровкаПлатежа,
					Перечисления.ФормыОплаты.Безналичная);
				ДанныеЗаполнения.Вставить("ДокументОснование", Основание);
	...
	Если ЗначениеЗаполнено(ДокОснование) 
		И ТипЗнч(ДокОснование) = Тип("ДокументСсылка.СписаниеБезналичныхДенежныхСредств") Тогда
		
		ДокументПланированияОснование = ДокОснование.ДокументПланирования;		
		Если ЗначениеЗаполнено(ДокументПланированияОснование) 
			И Не ЗначениеЗаполнено(ДокументПланирования) Тогда	
			
			ДокументПланирования = ДокументПланированияОснование;			
			ИдентификаторПозиции = ДенежныеСредстваВстраиваниеУХВызовСервера.ИдентификаторПозицииДокументаПланирования(
...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	#Область УХ_Встраивание
	ВстраиваниеУХПоступлениеБезналичныхДенежныхСредств.ОбработкаПроверкиЗаполнения(ЭтотОбъект, Отказ, 
...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если ВестиУчетКомиссииВоВзаиморасчетах Тогда
		...
		НеиспользуемыеРеквизиты.Добавить("Подразделение");
	Иначе
	...
	КонецЕсли;
	#Область УХ_Встраивание
	ВстраиваниеУХПоступлениеБезналичныхДенежныхСредств.ПередЗаписью(ЭтотОбъект, Отказ, РежимЗаписи, РежимПроведения);
	#КонецОбласти
КонецПроцедуры
...
Процедура ПриЗаписи(Отказ)
	...
	ВстраиваниеУХПоступлениеБезналичныхДенежныхСредств.ПриЗаписи(ЭтотОбъект, Отказ);
	#КонецОбласти
