...
Процедура ДобавитьКомандыСозданияНаОсновании(КомандыСозданияНаОсновании, Параметры) Экспорт
	...
	СписокОпераций.Добавить(Перечисления.ХозяйственныеОперации.ПоступлениеДенежныхСредствИзБанка);
...
Функция ПолучитьДвиженияОперацииДокументаДляПлатежнойПозиции(ЗаявкаСсылка) экспорт
	...
	|	Распоряжение.АналитикаЗачисления1,
	|	Распоряжение.АналитикаЗачисления2,
	|	Распоряжение.АналитикаЗачисления3,
