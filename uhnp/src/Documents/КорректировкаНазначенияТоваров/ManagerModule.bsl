...
Функция ТаблицаСнятияРезерва(Назначение, Товары, Регистратор) Экспорт
	...
	СократитьСкорректироватьНазначенияДавальческихМатериаловНаНазначениеДавальцаВЦелом(
		ТаблицаТоваров,
		ТоварыОрганизаций,
		ТаблицаСкорректировано);
...
Процедура СократитьСкорректироватьНазначенияДавальческихМатериаловНаНазначениеДавальцаВЦелом(ТаблицаТовары, ТоварыОрганизаций, ТаблицаСкорректировано)
	...
	Для Счетчик = 1 По ВсегоСтрок Цикл
		...
		Если НайденныеСтроки.Количество() > 0 Тогда
			...
			КоличествоДавальческое = ТекСтрока.Запас - Количество;
			Если КоличествоДавальческое > 0 Тогда
				...
				Если НазначениеДавальца <> ТекСтрока.ИсходноеНазначение Тогда // давальческий вид запасов
					...
					НоваяСтрока.Запас = КоличествоДавальческое;
					НоваяСтрока.Резерв = Мин(КоличествоДавальческое, НоваяСтрока.Резерв);
					Резерв = Резерв - НоваяСтрока.Резерв;
					НоваяСтрока.Потребность = Мин(КоличествоДавальческое, НоваяСтрока.Потребность);
				...
				Иначе
					// Потребность и резерв сначала обеспечивается давальческим запасом.
					НоваяСтрока = ТаблицаСкорректировано.Добавить();
					ЗаполнитьЗначенияСвойств(НоваяСтрока, НайденныеСтроки[0]);
					НоваяСтрока.Количество = КоличествоДавальческое;
					Потребность = Макс(0, Потребность - КоличествоДавальческое);
					Резерв = Макс(0, Резерв - КоличествоДавальческое);
					ТекСтрока.Запас = Макс(0, ТекСтрока.Запас - КоличествоДавальческое); // собственный вид запасов
					ТекСтрока.Резерв = Резерв;
					ТекСтрока.Потребность = Потребность;
