...
Процедура Использование_РасчетКурсовыхРазниц(ПараметрыОбработчика) Экспорт
	...
	ТекстЗапроса = ВзаиморасчетыВстраиваниеУХ.ЗаменитьТекстЗапроса_РегламентнаяОперация_Использование_РасчетКурсовыхРазниц(ТекстЗапроса);
	#КонецОбласти
	...
	ВыборкаОрганизация = РезультатЗапроса[РезультатЗапроса.Количество() - 2].Выбрать(ОбходРезультатаЗапроса.ПоГруппировкам);
	#КонецОбласти
...
Функция ТекстЗапросаРасчетКурсовыхРазниц(ИспользоватьРаздельныйУчетПрибыли)
	...
	#Область УХ_Встраивание
	ТекстЗапроса = ВзаиморасчетыВстраиваниеУХ.ЗаменитьТекстЗапроса_РегламентнаяОперация_ТекстЗапросаРасчетКурсовыхРазниц(ТекстЗапроса);
	#КонецОбласти
