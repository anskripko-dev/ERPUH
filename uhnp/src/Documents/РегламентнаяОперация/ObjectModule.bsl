...
#Область РасчетыПоКредитамИДепозитам
	...
	|		ПО вт_ДолгосрочнаяЗадолженностьРасчетыПоФинансовымИнструментамПоКурсу.Контрагент = вт_ОстаткиБУ.Субконто1
	|			И вт_ДолгосрочнаяЗадолженностьРасчетыПоФинансовымИнструментамПоКурсу.Договор = вт_ОстаткиБУ.Субконто2
	|			И ВЫБОР КОГДА вт_ДолгосрочнаяЗадолженностьРасчетыПоФинансовымИнструментамПоКурсу.СчетУчетаДолгосрочный.УчетПоПодразделениям
	|					ТОГДА вт_ДолгосрочнаяЗадолженностьРасчетыПоФинансовымИнструментамПоКурсу.Подразделение = вт_ОстаткиБУ.Подразделение
	|				ИНАЧЕ ИСТИНА
	|				КОНЕЦ
	|			И ВЫБОР КОГДА вт_ДолгосрочнаяЗадолженностьРасчетыПоФинансовымИнструментамПоКурсу.СчетУчетаДолгосрочный.УчетПоНаправлениямДеятельности
	|					ТОГДА вт_ДолгосрочнаяЗадолженностьРасчетыПоФинансовымИнструментамПоКурсу.НаправлениеДеятельности = вт_ОстаткиБУ.НаправлениеДеятельности
	|				ИНАЧЕ ИСТИНА
	|				КОНЕЦ
	|ГДЕ
	...
	|	вт_ДолгосрочнаяЗадолженностьРасчетыПоФинансовымИнструментамПоКурсу КАК вт_ДолгосрочнаяЗадолженностьРасчетыПоФинансовымИнструментамПоКурсу
	|		ЛЕВОЕ СОЕДИНЕНИЕ вт_ОстаткиБУ КАК вт_ОстаткиБУ
	|		ПО вт_ДолгосрочнаяЗадолженностьРасчетыПоФинансовымИнструментамПоКурсу.Договор = вт_ОстаткиБУ.Субконто1
	|			И ВЫБОР КОГДА вт_ДолгосрочнаяЗадолженностьРасчетыПоФинансовымИнструментамПоКурсу.СчетУчетаДолгосрочный.УчетПоПодразделениям
	|					ТОГДА вт_ДолгосрочнаяЗадолженностьРасчетыПоФинансовымИнструментамПоКурсу.Подразделение = вт_ОстаткиБУ.Подразделение
	|				ИНАЧЕ ИСТИНА
	|				КОНЕЦ
...
#Область УХ_ГрафикиФИ
	ВстраиваниеУХ.РегламентнаяОперация_ДоработатьЗапрос_РеклассДепозитов(ТекстЗапроса);
#КонецОбласти
...
#Область РасчетыПоАренде
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ вт_ОстаткиБУ КАК вт_ОстаткиБУ
	|			ПО вт_ДолгосрочнаяЗадолженностьПоАренде.Контрагент = вт_ОстаткиБУ.Субконто1
	|			И вт_ДолгосрочнаяЗадолженностьПоАренде.Договор = вт_ОстаткиБУ.Субконто2
	|			И ВЫБОР КОГДА вт_ДолгосрочнаяЗадолженностьПоАренде.СчетУчетаДолгосрочный.УчетПоПодразделениям
	|					ТОГДА вт_ДолгосрочнаяЗадолженностьПоАренде.Подразделение = вт_ОстаткиБУ.Подразделение
	|				ИНАЧЕ ИСТИНА
	|				КОНЕЦ
	|			И ВЫБОР КОГДА вт_ДолгосрочнаяЗадолженностьПоАренде.СчетУчетаДолгосрочный.УчетПоНаправлениямДеятельности
	|					ТОГДА вт_ДолгосрочнаяЗадолженностьПоАренде.НаправлениеДеятельности = вт_ОстаткиБУ.НаправлениеДеятельности
	|				ИНАЧЕ ИСТИНА
	|				КОНЕЦ
	|	
	|;
...
#Область Расчеты
	...
	|		ПО Расчеты.Контрагент = вт_ОстаткиБУ.Контрагент
	|			И Расчеты.Договор = вт_ОстаткиБУ.Договор
	|			И Расчеты.СчетУчетаДолгосрочный = вт_ОстаткиБУ.Счет
	|			И ВЫБОР КОГДА Расчеты.СчетУчетаДолгосрочный.УчетПоПодразделениям
	|					ТОГДА Расчеты.Подразделение = вт_ОстаткиБУ.Подразделение
	|				ИНАЧЕ ИСТИНА
	|				КОНЕЦ
	|			И ВЫБОР КОГДА Расчеты.СчетУчетаДолгосрочный.УчетПоНаправлениямДеятельности
	|					ТОГДА Расчеты.НаправлениеДеятельности = вт_ОстаткиБУ.НаправлениеДеятельности
	|				ИНАЧЕ ИСТИНА
	|				КОНЕЦ
...
#Область РасчетыПоДисконтированию
	...
	|			И ВЫБОР КОГДА ДолгосрочныйСчет.УчетПоПодразделениям
	|					ТОГДА вт_ДанныеДляРеклассификацииРасчетовПоДисконтированию_СчетаУчета.Подразделение = вт_ОстаткиДисконтаБУ.Подразделение
	|					ИНАЧЕ ИСТИНА
	|				КОНЕЦ
	|			И ВЫБОР КОГДА ДолгосрочныйСчет.УчетПоНаправлениямДеятельности
	|					ТОГДА вт_ДанныеДляРеклассификацииРасчетовПоДисконтированию_СчетаУчета.НаправлениеДеятельности = вт_ОстаткиДисконтаБУ.НаправлениеДеятельности
	|					ИНАЧЕ ИСТИНА
	|				КОНЕЦ
	|ГДЕ
