...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	МассивТипов = Новый Массив;
	//++ НЕ УТКА
	МассивТипов.Добавить(Тип("СправочникСсылка.КлассыОбъектовЭксплуатации"));
	//-- НЕ УТКА
	ОписаниеТипа = Новый ОписаниеТипов(МассивТипов);
	Элемент.ТипЗначения = ОписаниеТипа;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Классы объектов эксплуатации';
																					|en = 'Maintenance schemes'", КодыЯзыков); // @НСтр-2
	Элемент.Код = "000000043";
	Элемент.УчитыватьПоВалюте = Ложь;
	Элемент.УчитыватьПоКоличеству = Ложь;
	Элемент.ПредставлениеТипаЗначения = НСтр("ru = 'Класс объектов эксплуатации';
											|en = 'Maintenance scheme'", КодОсновногоЯзыка);
	#КонецОбласти
