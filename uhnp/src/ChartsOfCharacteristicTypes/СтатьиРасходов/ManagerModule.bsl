...
Процедура ЗаполнитьСписокХозяйственныхОпераций(СписокОпераций, ВариантРаспределенияРасходовУпр = Неопределено, ВариантРаспределенияРасходовРегл = Неопределено) Экспорт
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьРетроБонусыКлиентов") Тогда
		СписокОпераций.Добавить(Перечисления.ХозяйственныеОперации.ОтражениеПремииКлиентаРетроБонус, НСтр("ru = 'Отражение премий клиентам (ретро-бонусы)';
																											|en = 'Record customer bonuses (rebates)'"));
	КонецЕсли;
...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Выбытие материальных ценностей';
																					|en = 'Tangible asset retirement'", КодыЯзыков); // @НСтр-2
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Продажа материальных ценностей';
																					|en = 'Tangible asset sale'", КодыЯзыков); // @НСтр-2
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Долгосрочные активы к продаже';
																					|en = 'Long-term assets to be sold'", КодыЯзыков); // @НСтр-2
...
Функция СоответствиеСтатейВариантамРаспределения() Экспорт
	...
	СоответствиеСтатейВариантамРаспределения.Вставить(ПланыВидовХарактеристик.СтатьиРасходов.ВыбытиеМатериальныхЦенностей, Перечисления.ВариантыРаспределенияРасходов.НеРаспределять);
	СоответствиеСтатейВариантамРаспределения.Вставить(ПланыВидовХарактеристик.СтатьиРасходов.ПродажаМатериальныхЦенностей, Перечисления.ВариантыРаспределенияРасходов.НеРаспределять);
	СоответствиеСтатейВариантамРаспределения.Вставить(ПланыВидовХарактеристик.СтатьиРасходов.ДолгосрочныеАктивыКПродаже, Перечисления.ВариантыРаспределенияРасходов.НеРаспределять);
	//-- НЕ УТ
...
Функция СоответствиеСтатейТипамРасходов() Экспорт
	...
	СоответствиеСтатейТипамРасходов.Вставить(ПланыВидовХарактеристик.СтатьиРасходов.ВыбытиеМатериальныхЦенностей, Перечисления.ТипыРасходов.ПрочиеРасходы);
	СоответствиеСтатейТипамРасходов.Вставить(ПланыВидовХарактеристик.СтатьиРасходов.ПродажаМатериальныхЦенностей, Перечисления.ТипыРасходов.ПрочиеРасходы);
	СоответствиеСтатейТипамРасходов.Вставить(ПланыВидовХарактеристик.СтатьиРасходов.ДолгосрочныеАктивыКПродаже, Перечисления.ТипыРасходов.ПрочиеРасходы);
	//-- НЕ УТ
...
#Область ЗаполнитьНастройкиНовыхПредопределенныхЭлементов
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение настроек новых предопределенных статей';
									|en = 'Filling new predefined item settings'");
