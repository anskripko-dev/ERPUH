...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполняет реквизит ""Вид статьи"" в статьях активов и пассивов,
		...
		|en = 'Fills in the ""Item kind"" attribute in asset and liability items
		|created by users based on the value of the ""Asset/Liability"" attribute'");
