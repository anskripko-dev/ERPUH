...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	// Таблица 8.7
	Если Не ФорматыЭДО_ФНС.ДействуютСтавкиНДС_2026() Тогда
		
		НеПоддерживаемыеСтавкиНДС = Новый Массив;
		СтавкиНДС_2026 = Новый Массив;
		СтавкиНДС_2026.Добавить("18,03%");
		СтавкиНДС_2026.Добавить("22%");
		СтавкиНДС_2026.Добавить("22/122");
		
		Для Каждого ЭлементПредмета Из Предмет Цикл
			
			Если ЗначениеЗаполнено(ЭлементПредмета.СтавкаНДС)
				И СтавкиНДС_2026.Найти(ЭлементПредмета.СтавкаНДС) <> Неопределено
				И НеПоддерживаемыеСтавкиНДС.Найти(ЭлементПредмета.СтавкаНДС) = Неопределено Тогда
					
					НеПоддерживаемыеСтавкиНДС.Добавить(ЭлементПредмета.СтавкаНДС);
		...
		Для Каждого СтавкаНДС Из НеПоддерживаемыеСтавкиНДС Цикл
			...
			|en = 'Ставка НДС %1 не поддерживается в данном формате электронного документа.
			|Укажите другую ставку НДС.'");
