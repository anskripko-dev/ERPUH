	...
	Для каждого ДанныеКлючевогоВидаРЦ Из КлючевыеВидыРабочихЦентров Цикл
		Если НЕ ДанныеКлючевогоВидаРЦ.Ключевой
			ИЛИ (ДанныеКлючевогоВидаРЦ.ИнтервалПланирования = Перечисления.ТочностьГрафикаПроизводства.Час
					...
					ИЛИ ДанныеКлючевогоВидаРЦ.ИнтервалПланирования = Перечисления.ТочностьГрафикаПроизводства.Смена)
...
Функция СостояниеРаботыРЦ(Параметры)
	...
	|				ИЛИ МаршрутныйЛистПроизводства.Подразделение.ИнтервалПланирования = ЗНАЧЕНИЕ(Перечисление.ТочностьГрафикаПроизводства.Смена))
...
Процедура ПодготовитьРасписание(Параметры, Результат, СтруктураДействий)
	...
	|							ИЛИ РасписаниеРаботыРабочихЦентров.МаршрутныйЛист.Подразделение.ИнтервалПланирования = ЗНАЧЕНИЕ(Перечисление.ТочностьГрафикаПроизводства.Смена))
