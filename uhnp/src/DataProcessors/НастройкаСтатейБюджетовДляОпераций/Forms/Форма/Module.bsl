	...
	Если Модифицированность Тогда
		...
		Если НЕ ЗавершениеРаботы Тогда
			Если ОтветПередЗакрытием <> Истина Тогда
				...
				ТекстВопроса = НСтр("ru = 'При закрытии формы все данные будут утеряны.'");
...
Процедура ДеревоПриАктивизацииСтроки(Элемент)
	...
	МассивПриходРасход = Новый Массив;
	МассивПриходРасход.Добавить(Элемент.ТекущиеДанные.ПриходРасход);
	МассивПриходРасход.Добавить(ПредопределенноеЗначение("Перечисление.ВидыДвиженийПриходРасход.ПустаяСсылка"));
	
	ФормыУХКлиентСервер.ДобавитьПараметрВыбора(
					Элементы.ОсновныеСтатьиВидовОперацийУХСтатьяБюджета,
					"Отбор.ПриходРасход", МассивПриходРасход); 		
...
Процедура УстановитьУсловноеОформление()
	...
	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(ЭлементУО.Поля, 
							Элементы.ОсновныеСтатьиВидовОперацийУХСтатьяБюджета.Имя);
	...
	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(ЭлементУО.Поля, 
								Элементы.ОсновныеСтатьиВидовОперацийУХВидОперацииУХ.Имя);
	...
	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(ЭлементУО.Поля, 
							Элементы.СтатьиОперацийФинансовыхИнструментовСтатьяБюджета.Имя);
	...
	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(ЭлементУО.Поля, 
							Элементы.СтатьиОперацийФинансовыхИнструментовОперация.Имя);
