...
Процедура НастроитьВнешнийВидФормы()
	...
	Если Не РежимВыбораЭлемента Тогда
		Заголовок = НСтр("ru = 'Загрузка классификатора ОКПД 2';
						|en = 'Загрузка классификатора ОКПД 2'");
		Элементы.ПодсказкаКФорме.Заголовок = 
			НСтр("ru = 'Выберите необходимые элементы классификатора и загрузите их в базу, нажав кнопку ""Загрузить данные"".';
				|en = 'Выберите необходимые элементы классификатора и загрузите их в базу, нажав кнопку ""Загрузить данные"".'"); 
	Иначе
		Заголовок = НСтр("ru = 'Выберите элемент классификатора ОКПД 2';
						|en = 'Выберите элемент классификатора ОКПД 2'");
	...
	Если ЭтоАдресВременногоХранилища(АдресКэша) Тогда
		...
		Если ТипЗнч(Кэш) <> Тип("ТаблицаЗначений") Тогда
			ОбщегоНазначения.СообщитьПользователю(НСтр("ru = 'Ошибка загрузки данных классификатора ОКПД 2.';
														|en = 'Error importing the RNCPA 2 classifier data.'"));
