...
Функция ИнформацияОЗагруженныхПравилах(ЭтоНачалоОбновления)
	...
	Пока Выборка.Следующий() Цикл
		...
		Если Выборка.ВидПравил = Перечисления.ВидыПравилДляОбменаДанными.ПравилаКонвертацииОбъектов Тогда
			...
			ИначеЕсли ОбщегоНазначенияКлиентСервер.СравнитьВерсии(СтруктураПравил.ВерсияКонфигурацииИсточника, СтруктураПравилКорреспондента.ВерсияКонфигурацииИсточника) >= 0 Тогда
			// -- УХ-Встраивание	
				Возврат Информация;
