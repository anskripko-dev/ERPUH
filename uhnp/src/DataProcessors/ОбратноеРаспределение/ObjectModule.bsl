...
Процедура РаспределитьПоПериодам(ДокументКорректировки)
	...
	Если НЕ ВсеСпособыПериоды Тогда
		...
		Запрос.УстановитьПараметр("СпособФормированияОтчета",Перечисления.СпособыФормированияОтчетов.СвернувПоПериоду);
...
Процедура РаспределитьПоОрганизациям(ДокументКорректировки)
	...
	Если НЕ ВсеСпособыОрганизации Тогда
		...
		Запрос.УстановитьПараметр("СпособФормированияОтчета", Перечисления.СпособыФормированияОтчетов.Консолидация);
...
Функция СформироватьКорректировки() Экспорт
	...
	ИначеЕсли СпособФормирования=Перечисления.СпособыФормированияОтчетов.СвернувПоАналитикам Тогда
		//
