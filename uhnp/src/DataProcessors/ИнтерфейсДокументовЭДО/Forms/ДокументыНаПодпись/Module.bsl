...
Функция ПодписываемыеДокументыСертификата(Сертификат)
	...
	|ГДЕ
	|	ДанныеДокументов.Сертификат = &Сертификат
	|	ИЛИ (ДанныеДокументов.Организация = &Организация
	|	И ДанныеДокументов.Сертификат = ЗНАЧЕНИЕ(Справочник.СертификатыКлючейЭлектроннойПодписиИШифрования.ПустаяСсылка))";
	...
	Запрос.УстановитьПараметр("Организация", ЗначениеРеквизитовСертификата.Организация);
