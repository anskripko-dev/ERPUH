...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИначеЕсли ЗначениеЗаполнено(ИсправляемыйФайл) Тогда
		Элементы.ГруппаДокумент.Видимость = Истина;
		Элементы.ДекорацияПредставление.Заголовок = СтрШаблон(НСтр("ru = 'Документ: %1';
																	|en = 'Документ: %1'"), ИсправляемыйФайл);
	Иначе
