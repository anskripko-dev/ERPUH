...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	РазвернутыеУровниДереваКэш = УправлениеДаннымиОбИзделияхКлиентСервер.РазвернутыеУровниДереваКэшКонструктор();
...
Процедура ДеревоСпецификацийПередРазворачиванием(Элемент, Строка, Отказ)
	...
	УправлениеДаннымиОбИзделияхКлиент.ДеревоСпецификацийПередРазворачиванием(ЭтотОбъект, Строка, Отказ);
...
Процедура ДеревоСпецификацийПередСворачиванием(Элемент, Строка, Отказ)
	...
	УправлениеДаннымиОбИзделияхКлиент.ДеревоСпецификацийПередСворачиванием(ЭтотОбъект, Строка, Отказ);
...
Процедура КомандаРазвернутьВсе(Команда)
	...
	УправлениеДаннымиОбИзделияхКлиент.РазвернутьВсеУровниДерева(ЭтотОбъект);
...
Процедура КомандаСвернутьВсе(Команда)
	...
	УправлениеДаннымиОбИзделияхКлиент.СвернутьВсеУровниДерева(ЭтотОбъект);
