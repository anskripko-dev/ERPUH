...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	НоваяСтрока.Наименование = Нстр("ru = 'Исполняющий'");
	...
	НоваяСтрока = ТабличноеПолеНастроек.Добавить();	
	НоваяСтрока.Наименование = Нстр("ru = 'Согласование'");
	...
	НоваяСтрока.ЭтоСогласование = Истина;
...
Процедура ТабличноеПолеНастроекПользовательНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если НЕ ЗначениеЗаполнено(ТекущаяСтрока.Пользователь) Тогда
		...
		СписокЗначений.Добавить(Новый ОписаниеТипов("СправочникСсылка.Пользователи"), Нстр("ru = 'Пользователь'"));
		СписокЗначений.Добавить(Новый ОписаниеТипов("СправочникСсылка.РолиКонтактныхЛиц"), Нстр("ru = 'Роль'"));
		
		Если ТекущаяСтрока.ЭтоСогласование Тогда	
			СписокЗначений.Добавить(Новый ОписаниеТипов("СправочникСсылка.ШаблоныУниверсальныхПроцессов"), 
				Нстр("ru = 'Маршрут согласования'"));
		КонецЕсли;
