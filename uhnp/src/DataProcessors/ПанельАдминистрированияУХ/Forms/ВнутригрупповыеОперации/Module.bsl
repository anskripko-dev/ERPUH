...
&НаКлиенте
Процедура АвтоматическиФормироватьПланируемыеПоступленияДСВГОПриИзменении(Элемент)
	Подключаемый_ПриИзмененииРеквизита(Элемент);
КонецПроцедуры

&НаКлиенте
Процедура АвтоматическиСоздаватьВнутригрупповыеДоговорыИЦессииПриИзменении(Элемент)
	Подключаемый_ПриИзмененииРеквизита(Элемент);
КонецПроцедуры

&НаКлиенте
Процедура СоздаватьОбновлятьКонтрагентовИБанковскиеСчетаВГОПриИзменении(Элемент)
	Подключаемый_ПриИзмененииРеквизита(Элемент);
КонецПроцедуры

&НаКлиенте
Процедура НадписьНастройкаВнутригрупповыхКонтрагентовНажатие(Элемент)
	ОткрытьФорму("Обработка.НастройкаВнутригрупповыхКонтрагентов.Форма.Форма");	
КонецПроцедуры
#КонецОбласти
