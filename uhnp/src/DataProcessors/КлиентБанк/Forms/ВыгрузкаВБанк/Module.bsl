...
Процедура Выгрузить(Команда)
	...
	Если НайденныеОшибки.Количество() > 0
		...
		ТекстСообщения = СтрШаблон(
			НСтр("ru = 'Выбраны счета, для которых установлен формат обмена ""Федеральное казначейство РФ"". Требуется включить настройку ""Поддержка банковского и казначейского сопровождения госконтрактов"".';
				|en = 'Выбраны счета, для которых установлен формат обмена ""Федеральное казначейство РФ"". Требуется включить настройку ""Поддержка банковского и казначейского сопровождения госконтрактов"".'"));
	...
	Для Каждого Счет Из НайденныеОшибки Цикл
		...
		ТекстСообщения = СтрШаблон(НСтр("ru = 'Не заполнено поле ""Код УБП"" для владельца счета %1.';
										|en = 'Не заполнено поле ""Код УБП"" для владельца счета %1.'"), Счет.Ссылка);
