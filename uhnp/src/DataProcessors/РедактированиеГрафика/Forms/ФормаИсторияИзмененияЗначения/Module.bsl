...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Запрос.Текст = 
	"ВЫБРАТЬ
	|	ВерсииГрафиковРасчетов.Регистратор КАК ВерсияГрафика,
	|	ВерсииГрафиковРасчетов.ОпорныйГрафик КАК Опорный,
	|	ВерсииГрафиковРасчетов.Период КАК Дата,
	...
	|		ПО ВерсииГрафиковРасчетов.Регистратор = ДокументГрафик.Ссылка
	|			И (ДокументГрафик.Дата = &Дата)
	|			И (ДокументГрафик.ОперацияГрафика = &ОперацияГрафика)
	|ГДЕ
	|	ВерсииГрафиковРасчетов.ПредметГрафика = &ФинансовыйИнструмент
	|
	|СГРУППИРОВАТЬ ПО
	|	ВерсииГрафиковРасчетов.Регистратор,
	|	ВерсииГрафиковРасчетов.ОпорныйГрафик,
	|	ВерсииГрафиковРасчетов.Период
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
