...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("ВалютаВзаиморасчетов") Тогда
	    Валюта = Параметры.ВалютаВзаиморасчетов;
	КонецЕсли; 
	
	Элементы.Валюта.ТолькоПросмотр = ЗначениеЗаполнено(Валюта);
	...
	Если Параметры.Свойство("ДанныеТекущейСтрокиГрафика") Тогда 
		Если ЗначениеЗаполнено(Валюта) Тогда 
			ЗаполнитьЗначенияСвойств(ЭтаФорма,Параметры.ДанныеТекущейСтрокиГрафика,,"Валюта");
		Иначе
			ЗаполнитьЗначенияСвойств(ЭтаФорма,Параметры.ДанныеТекущейСтрокиГрафика);	
		КонецЕсли;	
	КонецЕсли;	
