...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// Проверим, есть ли незаписанные значения показателей
	Если РасширениеБизнесЛогикиУХ.ЕстьДанныеВЛогеИзмененныхПоказателей(ОбъектРасчета.ИдентификаторСеанса) Тогда
		ТекстСообщения = НСтр("ru = 'Для вызова расшифровки необходимо выполнить запись рассчитанных значений показателей отчетов'");;
