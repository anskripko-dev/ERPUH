...
Процедура ПриОткрытии(Отказ)
	УстановитьИнтерфейсФормыБезКопированияВБуфер();
КонецПроцедуры
...
&НаКлиенте
Процедура УстановитьИнтерфейсФормыБезКопированияВБуфер()
	...
	Если ЭтоВебКлиент Тогда
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
			...
			"СтраницыФормы",
			"ТекущаяСтраница",
			Элементы.СтраницаОснованияВебКлиент);
	Иначе
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
			Элементы,
			"СтраницыФормы",
			"ТекущаяСтраница",
			Элементы.СтраницаОсновная);
	КонецЕсли;
		
	Для Каждого Страница Из Элементы.СтраницыФормы.ПодчиненныеЭлементы Цикл 
		
		Если Страница = Элементы.СтраницаБуфер Тогда
			// Страницу с буфером обмена нельзя убирать видимость, иначе не будет копироваться.
			Продолжить;
		КонецЕсли;
		
		ВидимостьСтраницы = Страница = Элементы.СтраницыФормы.ТекущаяСтраница;
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
			Элементы, Страница.Имя, "Видимость", ВидимостьСтраницы);
	КонецЦикла;
...
Процедура КопироватьСсылкуВБуфер()
	...
	ОповеститьПользователяСсылкаСкопирована();
	
КонецПроцедуры

&НаКлиенте
Процедура ОповеститьПользователяСсылкаСкопирована()
	
	ПоказатьОповещениеПользователя(НСтр("ru = 'Ссылка получена';
										|en = 'Link is received'"), ,
		НСтр("ru = 'Ссылка на документ скопирована в буфер обмена';
			|en = 'The link to the document is copied to the clipboard'"));
