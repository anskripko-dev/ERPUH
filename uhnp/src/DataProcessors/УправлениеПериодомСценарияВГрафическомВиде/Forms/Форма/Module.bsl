...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ПустаяСтрока(Параметры.Режим) Тогда
		Отказ = Истина;
...
Процедура УстановитьСтатус(Расшифровка,Статус)
	...
	Если НЕ ТекущаяРасшифровка.Ракурс.ЭтоГруппа Тогда
...
Процедура ВыполнитьАктуализацию(Команда)
	...
	ОткрытьФорму("Обработка.УправлениеПериодомСценарияВГрафическомВиде.Форма.ФормаАктуализацииБюджетов",СтруктураПараметров,ЭтотОбъект);
