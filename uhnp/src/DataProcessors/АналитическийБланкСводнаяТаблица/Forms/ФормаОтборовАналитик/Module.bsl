...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.ТекОтбор_="" ИЛИ  Параметры.ТекОтбор_=Нстр("ru = 'Не заполнять'") ИЛИ Параметры.ТекОтбор_= Нстр("ru = 'Все элементы'") Тогда
		НужныйОтбор="";
	Иначе	  
...
&НаКлиенте
Процедура ОтборСКДВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	
	Если Поле.Имя = "ОтборСКДЛевоеЗначение"  Тогда		
