...
Процедура ВыходныеИзделияХарактеристикаПриИзменении(Элемент)
	...
	ПакетнаяОбработкаТабличнойЧастиКлиент.ОбработатьСтрокуТЧ(Элементы.ВыходныеИзделия.ТекущиеДанные, Новый Структура, КэшированныеЗначения);
...
Процедура ВозвратныеОтходыХарактеристикаПриИзменении(Элемент)
	...
	ПакетнаяОбработкаТабличнойЧастиКлиент.ОбработатьСтрокуТЧ(Элементы.ВозвратныеОтходы.ТекущиеДанные, Новый Структура, КэшированныеЗначения);
...
Процедура МатериалыИУслугиХарактеристикаПриИзменении(Элемент)
	...
	ПакетнаяОбработкаТабличнойЧастиКлиент.ОбработатьСтрокуТЧ(ТекущаяСтрока, Новый Структура, КэшированныеЗначения);
