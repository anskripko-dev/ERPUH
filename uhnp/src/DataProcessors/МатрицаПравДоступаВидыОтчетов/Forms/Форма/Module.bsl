...
Процедура ЗаполнитьТекущиеНастройки()
	...
	|	И НастройкиПравДоступаПользователейВидыОтчетов.ВидОтчета ССЫЛКА Справочник.ВидыОтчетов
	|	И НастройкиПравДоступаПользователейВидыОтчетов.Пользователь ССЫЛКА Справочник.Пользователи";
	
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "Справочник.Организации", "Справочник."+СправочникОрганизации);
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "Справочник.ВидыОтчетов", "Справочник."+СправочникВидыОтчетов);
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "Справочник.Пользователи", "Справочник."+СправочникПользователи);
	...
	|ГДЕ
	|	НастройкиПравДоступаПользователейБланкиДанные.Организация ССЫЛКА Справочник.Организации
	|	И НастройкиПравДоступаПользователейБланкиДанные.ВидОтчета ССЫЛКА Справочник.ВидыОтчетов
	|	И НастройкиПравДоступаПользователейБланкиДанные.Пользователь ССЫЛКА Справочник.Пользователи";
...
Процедура ЗаполнитьТаблицуОтбора()
	...
	Если ПоГоризонталиОрганизации Тогда
		...
		Иначе
			...
			ТекстОтбор=ТекстОтбор+" И (НЕ СправочникСубъект.Наименование= &ТекстНеУказан)";  
