...
Процедура Далее(Команда)
	...
	ИначеЕсли Элементы.ГруппаСтраницы.ТекущаяСтраница = Элементы.ГруппаВыборУчастника Тогда
		...
		УчастникВыбран = Истина;
		
		Если Элементы.УчастникиОФД.ТекущаяСтрока = Неопределено Тогда
			УчастникВыбран = Ложь;
		Иначе
	...
	ИначеЕсли Результат.Статус = "Ошибка" Тогда
		...
		ДанныеОшибки = ОбщегоНазначенияКлиентСервер.УточнениеИсключения(
			...
			НСтр("ru = 'Ошибка подключения к ОФД.';
				|en = 'An error occurred while connecting to FDO.'"));
