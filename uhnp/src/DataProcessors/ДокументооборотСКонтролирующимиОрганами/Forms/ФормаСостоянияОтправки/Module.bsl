...
Процедура ПрорисоватьТаблицу(ТекущееСостояниеОтправки)
	...
	Элементы.ДокументыРеализацииПолномочийНО.Заголовок = ?(КоличествоДокументовРеализацииПолномочийНО = 1,
		?(ЭтоКвитанцияОПрисвоенииСтатусаДОПП,
			НСтр("ru = 'Квитанция о присвоении статуса ДОПП';
				|en = 'Квитанция о присвоении статуса ДОПП'"), НСтр("ru = 'Квитанция о присвоении РНПТ';
																	|en = 'Квитанция о присвоении РНПТ'")),
		СтрШаблон(
			?(ЭтоКвитанцияОПрисвоенииСтатусаДОПП,
				НСтр("ru = 'Квитанции о присвоении статуса ДОПП (%1)';
					|en = 'Квитанции о присвоении статуса ДОПП (%1)'"), НСтр("ru = 'Квитанции о присвоении РНПТ (%1)';
