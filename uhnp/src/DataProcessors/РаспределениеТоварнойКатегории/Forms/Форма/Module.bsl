...
Процедура УстановитьУсловноеОформлениеФормы()
	...
	НовыйПараметр = Новый ПараметрВыбора("Отбор.КатегорияЗакупок", ТоварнаяКатегория);
	НовыйМассив = Новый Массив();
	НовыйМассив.Добавить(НовыйПараметр);
	НовыеПараметры = Новый ФиксированныйМассив(НовыйМассив);	
	Элементы.ТоварыНоменклатура.ПараметрыВыбора = НовыеПараметры;
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(ВыборНоменклатуры,"КатегорияЗакупок",ТоварнаяКатегория,ВидСравненияКомпоновкиДанных.Равно,,Истина);
	ЭтаФорма.Заголовок = "Уточнение категории закупок:"+ ТоварнаяКатегория;
...
Процедура НоменклатураПриИзменении(Элемент)
	...
	Если Элементы.ПериодыПотребности.Видимость = Истина И ТекущиеДанные <> Неопределено Тогда
		...
		Если Элементы.ПериодыПотребности.Видимость Тогда
