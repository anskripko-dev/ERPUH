	 ...
	 ИЛИ РеквизитПутьКДанным = "" Тогда
	 	...
	 	ЗапрещеноОтключение = 
			...
			И (НаборКонстант.ИспользоватьПроизводство
				...
				ИЛИ НаборКонстант.ИспользоватьНачислениеЗарплаты
				//-- НЕ УТ
				ИЛИ Ложь);
		...
		Если НаборКонстант.ИспользоватьНачислениеЗарплаты Тогда
			ТекстОграничения = ТекстОграничения + "
			|- " + НСтр("ru = 'используется учет зарплаты и кадров';
						|en = 'Payroll accounting and HR recordkeeping is used'")
		КонецЕсли;
		//-- НЕ УТ
