...
Процедура УстановитьДоступность(РеквизитПутьКДанным = "")
	...
	Если РеквизитПутьКДанным = "НаборКонстант.ИспользоватьДоговорыСКлиентами" 
		...
		ТекстКомментария = НСтр("ru = 'Невозможно отключение договоров с клиентами, так как:';
								|en = 'It is not possible to disable contracts with customers because:'");
		...
		//++ НЕ УТКА
		ТекстКомментария = ТекстКомментария
			+ ?(ЗначениеКонстантыПриемаВПереработку,
			Символы.ПС + НСтр("ru = '— включена опция ""Производство из давальческого сырья""';
								|en = '— the ""Subcontracting"" check box is selected'"),
			"");
		//-- НЕ УТКА
