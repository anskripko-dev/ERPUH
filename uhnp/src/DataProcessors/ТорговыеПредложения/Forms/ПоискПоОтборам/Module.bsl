...
Процедура ПослеВыполненияДействияНадТоваром(Результат, ДополнительныеПараметры) Экспорт
	...
	РезультатыДействияНадТоваром = РезультатыДействияНадТоваром(Результат);
...
&НаСервереБезКонтекста
Функция РезультатыДействияНадТоваром(Знач РезультатФоновогоЗадания)
		
	Результат = Новый Структура;
	Результат.Вставить("Отказ", Ложь);
	Результат.Вставить("ДанныеКорзины");
	
	РезультатыДействияНадТоваром = ПолучитьИзВременногоХранилища(РезультатФоновогоЗадания.АдресРезультата);
