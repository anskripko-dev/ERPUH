...
Функция ОписаниеОперацийИТиповДокументов()
	...
	#Область ЗаявлениеОВвозеТоваровПолученное
	
	СтрокаЗаявлениеОВвозеТоваровПолученное = ТЗХозОперацииИТипыДокументов.Добавить();
	Строка = СтрокаЗаявлениеОВвозеТоваровПолученное;
	Строка.ХозяйственнаяОперация		= Перечисления.ХозяйственныеОперации.РеализацияКлиенту;
	Строка.ДобавитьКнопкуСоздать		= Истина;
	Строка.ТипДокумента					= Тип("ДокументСсылка.ЗаявлениеОВвозеТоваровПолученное");
	Строка.ПолноеИмяДокумента			= "Документ.ЗаявлениеОВвозеТоваровПолученное";
	Строка.КлючНазначенияИспользования	= "ДокументыВходящие";
	Строка.ЗаголовокРабочегоМеста = 
		НСтр("ru = 'Регистрация заявлений о ввозе товаров от покупателей из ЕАЭС для подтверждения ставки 0%';
			|en = 'Registration of applications for import of goods from the buyer from the EAEU for confirmation of 0% rate'");
	Строка.МенеджерРасчетаГиперссылкиКОформлению = "Документ.ЗаявлениеОВвозеТоваровПолученное";
	Строка.ИспользуютсяСтатусы			= Ложь;
	
	Строка = ТЗХозОперацииИТипыДокументов.Добавить();
	ЗаполнитьЗначенияСвойств(Строка, СтрокаЗаявлениеОВвозеТоваровПолученное);
	Строка.ХозяйственнаяОперация		= Перечисления.ХозяйственныеОперации.РеализацияЧерезКомиссионера;
	Строка.ДобавитьКнопкуСоздать		= Ложь;
