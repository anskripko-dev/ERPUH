...
Процедура ЗаполнитьСписокОснований(ДокументыОснованияСсылки)
	...
	Элементы.СписокСумма.Видимость = ДокументыОснования.Колонки.Найти("СуммаДокумента") <> Неопределено;
	Элементы.СписокВалюта.Видимость = ДокументыОснования.Колонки.Найти("Валюта") <> Неопределено;
	Элементы.СписокОтправитель.Видимость = ДокументыОснования.Колонки.Найти("Отправитель") <> Неопределено;
	Элементы.СписокОтправительАдрес.Видимость = ДокументыОснования.Колонки.Найти("ОтправительАдрес") <> Неопределено;
	Элементы.СписокПолучатель.Видимость = ДокументыОснования.Колонки.Найти("Получатель") <> Неопределено;
	Элементы.СписокДатаОтгрузки.Видимость = ДокументыОснования.Колонки.Найти("ДатаОтгрузки") <> Неопределено;
	Элементы.СписокДатаОтгрузки.Видимость = ДокументыОснования.Колонки.Найти("ДатаОтгрузки") <> Неопределено;
	Элементы.СписокСпособОтгрузки.Видимость = ДокументыОснования.Колонки.Найти("СпособОтгрузки") <> Неопределено;
	Элементы.СписокСпособДоставки.Видимость = ДокументыОснования.Колонки.Найти("СпособДоставки") <> Неопределено;
