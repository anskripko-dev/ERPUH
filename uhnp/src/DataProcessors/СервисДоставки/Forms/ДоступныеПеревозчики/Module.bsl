...
Процедура НастроитьФормуПоТипуГрузоперевозки()
	...
	Если ЭтоСДЭК Тогда
		КраткоеОписание = НСтр("ru = '<a href=""СДЭК (CDEK)"">СДЭК (CDEK)</a> – это крупная транспортная компания, которая занимается логистикой.
							   ...
							   |en = '<a href=""СДЭК (CDEK)"">CDEK</a> is a large transportation company that deals with logistics.
							   |
							   |The main advantage of the transport company is a fast delivery of parcels, goods, and documents throughout Russia.
							   |The company works with more than 500 cities, including remote and sparsely populated regions, which makes it even more convenient for customers and sellers.
							   |In addition, it has its own network of order issuing points, which allows recipients to pick up their shipments themselves at a convenient time and close to home.'");
		...
		Элементы.ДекорацияКонтакты.Заголовок = НСтр(
			...
			|en = 'Contacts: pr-d. Zavoda Serp i Molot 3, building unit 2, Moscow, Russian Federation, tel. +7 (495) 797-81-08'");
	КонецЕсли;
