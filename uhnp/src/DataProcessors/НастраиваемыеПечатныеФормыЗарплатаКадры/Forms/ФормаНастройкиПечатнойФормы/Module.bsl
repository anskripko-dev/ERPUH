...
Процедура ЗагрузитьШаблон(Команда)
	...
	Если Модифицированность Тогда
		...
		ТекстВопроса = НСтр("ru = 'При загрузке шаблона документа из файла,
			...
			|Продолжить?';
			|en = 'When importing the document template from the file,
