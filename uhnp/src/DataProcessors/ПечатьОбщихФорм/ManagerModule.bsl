...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	//++ НЕ УТКА
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "СчетФактураОтчетДавальцу") Тогда
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "СчетФактураОтчетДавальцу2_5") Тогда
		
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(
			КоллекцияПечатныхФорм,
			"СчетФактураОтчетДавальцу2_5",
			НСтр("ru = 'Счет-фактура';
				|en = 'Tax invoice'"),
			СформироватьПечатнуюФормуСчетФактура(СтруктураТипов, ОбъектыПечати, ПараметрыПечати));
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "СчетФактураОтчетДавальцуВВалюте") Тогда
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "СчетФактураОтчетДавальцуВВалюте2_5") Тогда
		
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(
			КоллекцияПечатныхФорм,
			"СчетФактураОтчетДавальцуВВалюте2_5",
			НСтр("ru = 'Счет-фактура';
				|en = 'Tax invoice'"),
			СформироватьПечатнуюФормуСчетФактура(СтруктураТипов, ОбъектыПечати, ПараметрыПечати));
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "УПДОтчетДавальцу") Тогда
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "УПДОтчетДавальцу2_5") Тогда
...
Функция ТекстСообщенияПостановление2026()
	...
	Возврат НСтр("ru = 'Для заполнения строки 5б включите опцию ""Использовать печатные формы СФ, УПД, УКД 2.5"" (раздел ""НСИ и администрирование"" - ""Учет НДС, импорт и экспорт"").';
				|en = 'Для заполнения строки 5б включите опцию ""Использовать печатные формы СФ, УПД, УКД 2.5"" (раздел ""НСИ и администрирование"" - ""Учет НДС, импорт и экспорт"").'");
