...
Процедура ПриЗагрузкеДанныхИзНастроекНаСервере(Настройки)
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьНачислениеЗарплаты")
		ИЛИ ПроизводствоСервер.ИспользуетсяУчетТрудозатратВРазрезеСотрудников(ДатаРаботы) Тогда
...
Процедура НастроитьФормуПоРежимуВыбора(Форма)
	...
	Элементы.РаботающиеНаДату.Видимость = Форма.РежимВыбора = "Работники";
	
	Элементы.ДатаРаботы.Видимость = Форма.РежимВыбора = "Работники";
		...
		Для каждого Строка Из Список.ВыделенныеСтроки Цикл
			Если ТипЗнч(Строка) <> Тип("СтрокаГруппировкиДинамическогоСписка") Тогда
				...
				Если ТипЗнч(Строка) = Тип("Число") Тогда
					Строка = Элементы.Работники.ДанныеСтроки(Строка).Сотрудник;
				КонецЕсли;
				//-- Локализация
