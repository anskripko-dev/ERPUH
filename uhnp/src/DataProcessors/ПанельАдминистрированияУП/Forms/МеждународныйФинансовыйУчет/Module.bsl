...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ИспользоватьМеждународныйФинансовыйУчет.РасширеннаяПодсказка.Заголовок
		= НСтр("ru = 'Работоспособность подсистемы не обеспечивается, оставлена для миграции на подсистему «Учет и отчетность МСФО» 1C: ERP Управление холдингом'");
	#КонецОбласти
...
Процедура УстановитьДоступность(РеквизитПутьКДанным = "")
	...
	Если РеквизитПутьКДанным = "НаборКонстант.ИспользоватьМеждународныйФинансовыйУчет"
		...
		Элементы.НастроитьПредопределенныйПланСчетов.Доступность = ЗначениеКонстанты;
