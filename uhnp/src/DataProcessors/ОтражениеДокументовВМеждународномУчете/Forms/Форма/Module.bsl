...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбновитьДанныеОСостоянииДокументовИНастройкахФормированияПроводок();
...
Процедура ПриОткрытии(Отказ)
	...
	ОбновитьДанныеОСостоянииПроверкиДокументов();
...
Процедура ДатаОкончанияПериодаПриИзменении(Элемент)
	...
	ДатаОкончанияПериодаПриИзмененииНаСервере();
	ОбновитьДанныеОСостоянииПроверкиДокументов();
...
&НаСервере
Процедура ОбновитьДанныеОСостоянииДокументовИНастройкахФормированияПроводок()
...
&НаКлиенте
Процедура ОбновитьДанныеОСостоянииПроверкиДокументов()
...
&НаСервере
Процедура ДатаОкончанияПериодаПриИзмененииНаСервере()
