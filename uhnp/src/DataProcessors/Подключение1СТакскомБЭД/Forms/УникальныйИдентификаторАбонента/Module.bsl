...
Процедура ПриЗакрытии(ЗавершениеРаботы)
	...
	Если СтатусЗаявки = "obtained" Тогда
		...
		Иначе
			...
			ИдентификаторФормы = Подключение1СТакскомКлиентБЭД.ЗначениеСессионногоПараметра(
	...
	Если Не ПрограммноеЗакрытие
		И Не Подключение1СТакскомКлиентБЭД.ФормаОткрыта(
			КонтекстВзаимодействия,
			"Обработка.Подключение1СТакскомБЭД.Форма.ЛичныйКабинетАбонента") Тогда
		Подключение1СТакскомКлиентБЭД.ЗавершитьБизнесПроцесс(КонтекстВзаимодействия, ЗавершениеРаботы);
	КонецЕсли;
...
Процедура НадписьОбновитьНажатие(Элемент)
	...
	Подключение1СТакскомКлиентБЭД.ОбработатьКомандуФормы(
		КонтекстВзаимодействия,
		ЭтотОбъект,
