...
Процедура ДекорацияЗаявлениеОВвозеТоваровПолученноеНажатие(Элемент)
	...
	// &ЗамерПроизводительности
	ИмяКлючевойОперации = "Обработка.ПомощникПоУчетуНДС.Форма.Элемент.ДекорацияЗаявлениеОВвозеТоваровПолученное.Нажатие";
	...
	Если КОформлению <> Неопределено Тогда
		ПараметрыФормы.Вставить("СтруктураБыстрогоОтбора", Отбор);
		Если КОформлению.ЗаявлениеОВвозеТоваровПолученное Тогда
			ПараметрыФормы.Вставить("ОтображатьСтраницуКОформлению");
		КонецЕсли;
	КонецЕсли;
	
	ОткрытьФорму("Документ.ЗаявлениеОВвозеТоваровПолученное.Форма.ФормаРабочееМесто", ПараметрыФормы);
	//-- НЕ УТ
	...
	ЗаголовкиЭлементов.Вставить("ЗаявлениеОВвозеТоваровПолученное", 
			Новый Структура("ЕстьДанныеОбработано, ЕстьДанныеКОбработке, НетДанных",
					НСтр("ru = 'Все заявления о ввозе товаров от покупателей из стран Таможенного союза оформлены';
						|en = 'Все заявления о ввозе товаров от покупателей из стран Таможенного союза оформлены'"),
					НСтр("ru = 'Оформить заявления о ввозе товаров от покупателей из стран Таможенного союза (%1)';
						|en = 'Оформить заявления о ввозе товаров от покупателей из стран Таможенного союза (%1)'"),
					НСтр("ru = 'Нет продаж в страны Таможенного союза';
						|en = 'Нет продаж в страны Таможенного союза'")));
