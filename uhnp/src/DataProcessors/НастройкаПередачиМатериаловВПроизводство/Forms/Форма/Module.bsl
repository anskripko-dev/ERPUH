...
Функция ПрочитатьНастройкиПоСпискуМатериаловНаСервере(СписокНоменклатуры)
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания =
		НСтр("ru = 'Заполнение настройки передачи материалов в производство';
	...
	РезультатФоновогоЗадания = Результат;
...
Процедура ПодключитьОжиданиеЧтенияНастройки()
	...
	ОповещениеОЗавершении = Новый ОписаниеОповещения("ЗагрузитьНастройкиИзХранилищаОповещение", ЭтотОбъект);
...
&НаКлиенте
Процедура ЗагрузитьНастройкиИзХранилищаОповещение(Результат, ДополнитеьлныеПараметры) Экспорт
