...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если Не ФорматыЭДО_ФНС.ДействуютСтавкиНДС_2026() Тогда
		...
		СтавкиНДС_2026.Добавить("9,09%");
		СтавкиНДС_2026.Добавить("16,67%");
		СтавкиНДС_2026.Добавить("18,03%");
		СтавкиНДС_2026.Добавить("22%");
		СтавкиНДС_2026.Добавить("5/105");
		СтавкиНДС_2026.Добавить("7/107");
		СтавкиНДС_2026.Добавить("10/110");
		СтавкиНДС_2026.Добавить("20/120");
		СтавкиНДС_2026.Добавить("22/122");
		Для Каждого Работа Из Этотобъект.ДанныеРабот Цикл
			Если ЗначениеЗаполнено(Работа.СтавкаНДС)
				И СтавкиНДС_2026.Найти(Работа.СтавкаНДС) <> Неопределено
